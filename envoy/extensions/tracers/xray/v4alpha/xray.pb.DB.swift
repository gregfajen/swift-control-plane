...
extension Envoy_Extensions_Tracers_Xray_V4alpha_XRayConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._daemonEndpoint)
      case 2: try decoder.decodeSingularStringField(value: &self.segmentName)
      case 3: try decoder.decodeSingularMessageField(value: &self._samplingRuleManifest)
      default: break
      }
    }
  }
