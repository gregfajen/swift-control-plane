...
public struct Envoy_Extensions_Tracers_Lightstep_V4alpha_LightstepConfig {
  ...
  public var propagationModes: [Envoy_Extensions_Tracers_Lightstep_V4alpha_LightstepConfig.PropagationMode] = []
...
extension Envoy_Extensions_Tracers_Lightstep_V4alpha_LightstepConfig.PropagationMode: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Extensions_Tracers_Lightstep_V4alpha_LightstepConfig.PropagationMode] = [
    .envoy,
    .lightstep,
    .b3,
    .traceContext,
...
fileprivate let _protobuf_package = "envoy.extensions.tracers.lightstep.v4alpha"

extension Envoy_Extensions_Tracers_Lightstep_V4alpha_LightstepConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularStringField(value: &self.accessTokenFile)
      case 3: try decoder.decodeRepeatedEnumField(value: &self.propagationModes)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Tracers_Lightstep_V4alpha_LightstepConfig, rhs: Envoy_Extensions_Tracers_Lightstep_V4alpha_LightstepConfig) -> Bool {
...
extension Envoy_Extensions_Tracers_Lightstep_V4alpha_LightstepConfig.PropagationMode: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "ENVOY"),
