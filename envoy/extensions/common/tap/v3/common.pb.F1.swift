...
public struct Envoy_Extensions_Common_Tap_V3_CommonExtensionConfig {
  ...
  public var tapdsConfig: Envoy_Extensions_Common_Tap_V3_CommonExtensionConfig.TapDSConfig {
    get {
      if case .tapdsConfig(let v)? = configType {return v}
      return Envoy_Extensions_Common_Tap_V3_CommonExtensionConfig.TapDSConfig()
    }
  ...
  public enum OneOf_ConfigType: Equatable {
    ...
    /// [#not-implemented-hide:] Configuration to use for TapDS updates for the filter.
    case tapdsConfig(Envoy_Extensions_Common_Tap_V3_CommonExtensionConfig.TapDSConfig)
...
extension Envoy_Extensions_Common_Tap_V3_CommonExtensionConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3:
        var v: Envoy_Extensions_Common_Tap_V3_CommonExtensionConfig.TapDSConfig?
        if let current = self.configType {
          try decoder.handleConflictingOneOf()
...
extension Envoy_Extensions_Common_Tap_V3_CommonExtensionConfig.TapDSConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Common_Tap_V3_CommonExtensionConfig.protoMessageName + ".TapDSConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Extensions_Common_Tap_V3_CommonExtensionConfig.TapDSConfig, rhs: Envoy_Extensions_Common_Tap_V3_CommonExtensionConfig.TapDSConfig) -> Bool {
