...
/// [#next-free-field: 11]
public struct Envoy_Extensions_Filters_Http_ExtAuthz_V3_ExtAuthz {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// External authorization service configuration.
  public var services: Envoy_Extensions_Filters_Http_ExtAuthz_V3_ExtAuthz.OneOf_Services? = nil

  /// gRPC service configuration (default timeout: 200ms).
  public var grpcService: Envoy_Config_Core_V3_GrpcService {
    get {
      if case .grpcService(let v)? = services {return v}
      return Envoy_Config_Core_V3_GrpcService()
    }
    set {services = .grpcService(newValue)}
  }

  /// HTTP service configuration (default timeout: 200ms).
  public var httpService: Envoy_Extensions_Filters_Http_ExtAuthz_V3_HttpService {
    get {
      if case .httpService(let v)? = services {return v}
      return Envoy_Extensions_Filters_Http_ExtAuthz_V3_HttpService()
    }
    set {services = .httpService(newValue)}
  }
  ...
  public var withRequestBody: Envoy_Extensions_Filters_Http_ExtAuthz_V3_BufferSettings {
    get {return _withRequestBody ?? Envoy_Extensions_Filters_Http_ExtAuthz_V3_BufferSettings()}
    set {_withRequestBody = newValue}
  }
  /// Returns true if `withRequestBody` has been explicitly set.
  public var hasWithRequestBody: Bool {return self._withRequestBody != nil}
  /// Clears the value of `withRequestBody`. Subsequent reads from it will return its default value.
  public mutating func clearWithRequestBody() {self._withRequestBody = nil}
  ...
  public var clearRouteCache_p: Bool = false

  /// Sets the HTTP status that is returned to the client when there is a network error between the
  /// filter and the authorization server. The default status is HTTP 403 Forbidden.
  public var statusOnError: Envoy_Type_V3_HttpStatus {
    get {return _statusOnError ?? Envoy_Type_V3_HttpStatus()}
    set {_statusOnError = newValue}
  }
  /// Returns true if `statusOnError` has been explicitly set.
  public var hasStatusOnError: Bool {return self._statusOnError != nil}
  /// Clears the value of `statusOnError`. Subsequent reads from it will return its default value.
  public mutating func clearStatusOnError() {self._statusOnError = nil}
  ...
  public enum OneOf_Services: Equatable {
    /// gRPC service configuration (default timeout: 200ms).
    case grpcService(Envoy_Config_Core_V3_GrpcService)
    /// HTTP service configuration (default timeout: 200ms).
    case httpService(Envoy_Extensions_Filters_Http_ExtAuthz_V3_HttpService)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_ExtAuthz.OneOf_Services, rhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_ExtAuthz.OneOf_Services) -> Bool {
      switch (lhs, rhs) {
      case (.grpcService(let l), .grpcService(let r)): return l == r
      case (.httpService(let l), .httpService(let r)): return l == r
  ...
  fileprivate var _withRequestBody: Envoy_Extensions_Filters_Http_ExtAuthz_V3_BufferSettings? = nil
  fileprivate var _statusOnError: Envoy_Type_V3_HttpStatus? = nil
  fileprivate var _filterEnabled: Envoy_Config_Core_V3_RuntimeFractionalPercent? = nil
}

/// Configuration for buffering the request data.
public struct Envoy_Extensions_Filters_Http_ExtAuthz_V3_BufferSettings {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// for details.
/// [#next-free-field: 9]
public struct Envoy_Extensions_Filters_Http_ExtAuthz_V3_HttpService {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Sets the HTTP server URI which the authorization requests must be sent to.
  public var serverUri: Envoy_Config_Core_V3_HttpUri {
    get {return _serverUri ?? Envoy_Config_Core_V3_HttpUri()}
  ...
  public var authorizationRequest: Envoy_Extensions_Filters_Http_ExtAuthz_V3_AuthorizationRequest {
    get {return _authorizationRequest ?? Envoy_Extensions_Filters_Http_ExtAuthz_V3_AuthorizationRequest()}
  ...
  public var authorizationResponse: Envoy_Extensions_Filters_Http_ExtAuthz_V3_AuthorizationResponse {
    get {return _authorizationResponse ?? Envoy_Extensions_Filters_Http_ExtAuthz_V3_AuthorizationResponse()}
  ...
  fileprivate var _serverUri: Envoy_Config_Core_V3_HttpUri? = nil
  fileprivate var _authorizationRequest: Envoy_Extensions_Filters_Http_ExtAuthz_V3_AuthorizationRequest? = nil
  fileprivate var _authorizationResponse: Envoy_Extensions_Filters_Http_ExtAuthz_V3_AuthorizationResponse? = nil
}

public struct Envoy_Extensions_Filters_Http_ExtAuthz_V3_AuthorizationRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// its payload size.
  public var allowedHeaders: Envoy_Type_Matcher_V3_ListStringMatcher {
    get {return _allowedHeaders ?? Envoy_Type_Matcher_V3_ListStringMatcher()}
  ...
  public var headersToAdd: [Envoy_Config_Core_V3_HeaderValue] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _allowedHeaders: Envoy_Type_Matcher_V3_ListStringMatcher? = nil
}

public struct Envoy_Extensions_Filters_Http_ExtAuthz_V3_AuthorizationResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var allowedUpstreamHeaders: Envoy_Type_Matcher_V3_ListStringMatcher {
    get {return _allowedUpstreamHeaders ?? Envoy_Type_Matcher_V3_ListStringMatcher()}
  ...
  public var allowedClientHeaders: Envoy_Type_Matcher_V3_ListStringMatcher {
    get {return _allowedClientHeaders ?? Envoy_Type_Matcher_V3_ListStringMatcher()}
  ...
  fileprivate var _allowedUpstreamHeaders: Envoy_Type_Matcher_V3_ListStringMatcher? = nil
  fileprivate var _allowedClientHeaders: Envoy_Type_Matcher_V3_ListStringMatcher? = nil
}

/// Extra settings on a per virtualhost/route/weighted-cluster level.
public struct Envoy_Extensions_Filters_Http_ExtAuthz_V3_ExtAuthzPerRoute {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var override: Envoy_Extensions_Filters_Http_ExtAuthz_V3_ExtAuthzPerRoute.OneOf_Override? = nil
  ...
  public var checkSettings: Envoy_Extensions_Filters_Http_ExtAuthz_V3_CheckSettings {
    get {
      if case .checkSettings(let v)? = override {return v}
      return Envoy_Extensions_Filters_Http_ExtAuthz_V3_CheckSettings()
    }
  ...
  public enum OneOf_Override: Equatable {
    ...
    case disabled(Bool)
    /// Check request settings for this route.
    case checkSettings(Envoy_Extensions_Filters_Http_ExtAuthz_V3_CheckSettings)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_ExtAuthzPerRoute.OneOf_Override, rhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_ExtAuthzPerRoute.OneOf_Override) -> Bool {
      switch (lhs, rhs) {
      case (.disabled(let l), .disabled(let r)): return l == r
      case (.checkSettings(let l), .checkSettings(let r)): return l == r
      default: return false
      }
    }
  #endif
...
public struct Envoy_Extensions_Filters_Http_ExtAuthz_V3_CheckSettings {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "envoy.extensions.filters.http.ext_authz.v3"

extension Envoy_Extensions_Filters_Http_ExtAuthz_V3_ExtAuthz: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1:
        var v: Envoy_Config_Core_V3_GrpcService?
        if let current = self.services {
          try decoder.handleConflictingOneOf()
          if case .grpcService(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.services = .grpcService(v)}
      case 2: try decoder.decodeSingularBoolField(value: &self.failureModeAllow)
      case 3:
        var v: Envoy_Extensions_Filters_Http_ExtAuthz_V3_HttpService?
        if let current = self.services {
          try decoder.handleConflictingOneOf()
          if case .httpService(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.services = .httpService(v)}
      case 5: try decoder.decodeSingularMessageField(value: &self._withRequestBody)
      case 6: try decoder.decodeSingularBoolField(value: &self.clearRouteCache_p)
      case 7: try decoder.decodeSingularMessageField(value: &self._statusOnError)
      case 8: try decoder.decodeRepeatedStringField(value: &self.metadataContextNamespaces)
      case 9: try decoder.decodeSingularMessageField(value: &self._filterEnabled)
      case 10: try decoder.decodeSingularBoolField(value: &self.includePeerCertificate)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if case .grpcService(let v)? = self.services {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }
    if self.failureModeAllow != false {
      try visitor.visitSingularBoolField(value: self.failureModeAllow, fieldNumber: 2)
    }
    if case .httpService(let v)? = self.services {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }
    if let v = self._withRequestBody {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
    }
    if self.clearRouteCache_p != false {
      try visitor.visitSingularBoolField(value: self.clearRouteCache_p, fieldNumber: 6)
    }
    if let v = self._statusOnError {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 7)
    }
    if !self.metadataContextNamespaces.isEmpty {
      try visitor.visitRepeatedStringField(value: self.metadataContextNamespaces, fieldNumber: 8)
    }
    if let v = self._filterEnabled {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 9)
    }
    if self.includePeerCertificate != false {
      try visitor.visitSingularBoolField(value: self.includePeerCertificate, fieldNumber: 10)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_ExtAuthz, rhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_ExtAuthz) -> Bool {
    if lhs.services != rhs.services {return false}
    if lhs.failureModeAllow != rhs.failureModeAllow {return false}
    if lhs._withRequestBody != rhs._withRequestBody {return false}
    if lhs.clearRouteCache_p != rhs.clearRouteCache_p {return false}
    if lhs._statusOnError != rhs._statusOnError {return false}
    if lhs.metadataContextNamespaces != rhs.metadataContextNamespaces {return false}
...
extension Envoy_Extensions_Filters_Http_ExtAuthz_V3_BufferSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularUInt32Field(value: &self.maxRequestBytes)
      case 2: try decoder.decodeSingularBoolField(value: &self.allowPartialMessage)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_BufferSettings, rhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_BufferSettings) -> Bool {
...
extension Envoy_Extensions_Filters_Http_ExtAuthz_V3_HttpService: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._serverUri)
      case 2: try decoder.decodeSingularStringField(value: &self.pathPrefix)
      case 7: try decoder.decodeSingularMessageField(value: &self._authorizationRequest)
      case 8: try decoder.decodeSingularMessageField(value: &self._authorizationResponse)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_HttpService, rhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_HttpService) -> Bool {
...
extension Envoy_Extensions_Filters_Http_ExtAuthz_V3_AuthorizationRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._allowedHeaders)
      case 2: try decoder.decodeRepeatedMessageField(value: &self.headersToAdd)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_AuthorizationRequest, rhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_AuthorizationRequest) -> Bool {
...
extension Envoy_Extensions_Filters_Http_ExtAuthz_V3_AuthorizationResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._allowedUpstreamHeaders)
      case 2: try decoder.decodeSingularMessageField(value: &self._allowedClientHeaders)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_AuthorizationResponse, rhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_AuthorizationResponse) -> Bool {
...
extension Envoy_Extensions_Filters_Http_ExtAuthz_V3_ExtAuthzPerRoute: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2:
        var v: Envoy_Extensions_Filters_Http_ExtAuthz_V3_CheckSettings?
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_ExtAuthzPerRoute, rhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_ExtAuthzPerRoute) -> Bool {
...
extension Envoy_Extensions_Filters_Http_ExtAuthz_V3_CheckSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.ProtobufString>.self, value: &self.contextExtensions)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_CheckSettings, rhs: Envoy_Extensions_Filters_Http_ExtAuthz_V3_CheckSettings) -> Bool {
