...
public struct Envoy_Config_Listener_V4alpha_UdpListenerConfig {
  ...
  public var configType: Envoy_Config_Listener_V4alpha_UdpListenerConfig.OneOf_ConfigType? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Listener_V4alpha_UdpListenerConfig.OneOf_ConfigType, rhs: Envoy_Config_Listener_V4alpha_UdpListenerConfig.OneOf_ConfigType) -> Bool {
      switch (lhs, rhs) {
...
public struct Envoy_Config_Listener_V4alpha_ActiveRawUdpListenerConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Envoy_Config_Listener_V4alpha_UdpListenerConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Listener_V4alpha_UdpListenerConfig, rhs: Envoy_Config_Listener_V4alpha_UdpListenerConfig) -> Bool {
...
extension Envoy_Config_Listener_V4alpha_ActiveRawUdpListenerConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Listener_V4alpha_ActiveRawUdpListenerConfig, rhs: Envoy_Config_Listener_V4alpha_ActiveRawUdpListenerConfig) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
