...
/// [#next-free-field: 21]
public struct Envoy_Config_Cluster_V3_OutlierDetection {
...
extension Envoy_Config_Cluster_V3_OutlierDetection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularMessageField(value: &_storage._consecutive5Xx)
        case 2: try decoder.decodeSingularMessageField(value: &_storage._interval)
        case 3: try decoder.decodeSingularMessageField(value: &_storage._baseEjectionTime)
        case 4: try decoder.decodeSingularMessageField(value: &_storage._maxEjectionPercent)
        case 5: try decoder.decodeSingularMessageField(value: &_storage._enforcingConsecutive5Xx)
        case 6: try decoder.decodeSingularMessageField(value: &_storage._enforcingSuccessRate)
        case 7: try decoder.decodeSingularMessageField(value: &_storage._successRateMinimumHosts)
        case 8: try decoder.decodeSingularMessageField(value: &_storage._successRateRequestVolume)
        case 9: try decoder.decodeSingularMessageField(value: &_storage._successRateStdevFactor)
        case 10: try decoder.decodeSingularMessageField(value: &_storage._consecutiveGatewayFailure)
        case 11: try decoder.decodeSingularMessageField(value: &_storage._enforcingConsecutiveGatewayFailure)
        case 12: try decoder.decodeSingularBoolField(value: &_storage._splitExternalLocalOriginErrors)
        case 13: try decoder.decodeSingularMessageField(value: &_storage._consecutiveLocalOriginFailure)
        case 14: try decoder.decodeSingularMessageField(value: &_storage._enforcingConsecutiveLocalOriginFailure)
        case 15: try decoder.decodeSingularMessageField(value: &_storage._enforcingLocalOriginSuccessRate)
        case 16: try decoder.decodeSingularMessageField(value: &_storage._failurePercentageThreshold)
        case 17: try decoder.decodeSingularMessageField(value: &_storage._enforcingFailurePercentage)
        case 18: try decoder.decodeSingularMessageField(value: &_storage._enforcingFailurePercentageLocalOrigin)
        case 19: try decoder.decodeSingularMessageField(value: &_storage._failurePercentageMinimumHosts)
        case 20: try decoder.decodeSingularMessageField(value: &_storage._failurePercentageRequestVolume)
        default: break
        }
      }
    }
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V3_OutlierDetection, rhs: Envoy_Config_Cluster_V3_OutlierDetection) -> Bool {
