...
public struct Envoy_Config_GrpcCredential_V3_FileBasedMetadataConfig {
  ...
  public var secretData: Envoy_Config_Core_V3_DataSource {
    get {return _secretData ?? Envoy_Config_Core_V3_DataSource()}
  ...
  fileprivate var _secretData: Envoy_Config_Core_V3_DataSource? = nil
}
...
extension Envoy_Config_GrpcCredential_V3_FileBasedMetadataConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._secretData)
      case 2: try decoder.decodeSingularStringField(value: &self.headerKey)
      case 3: try decoder.decodeSingularStringField(value: &self.headerPrefix)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_GrpcCredential_V3_FileBasedMetadataConfig, rhs: Envoy_Config_GrpcCredential_V3_FileBasedMetadataConfig) -> Bool {
