...
/// Next id: 5
public struct Envoy_Config_Listener_V3_QuicProtocolOptions {
...
extension Envoy_Config_Listener_V3_QuicProtocolOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._maxConcurrentStreams)
      case 2: try decoder.decodeSingularMessageField(value: &self._idleTimeout)
      case 3: try decoder.decodeSingularMessageField(value: &self._cryptoHandshakeTimeout)
      case 4: try decoder.decodeSingularMessageField(value: &self._enabled)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Listener_V3_QuicProtocolOptions, rhs: Envoy_Config_Listener_V3_QuicProtocolOptions) -> Bool {
