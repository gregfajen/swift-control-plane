...
/// [#next-free-field: 6]
public struct Envoy_Config_Endpoint_V3_ClusterLoadAssignment {
  ...
  public var endpoints: [Envoy_Config_Endpoint_V3_LocalityLbEndpoints] = []

  /// Map of named endpoints that can be referenced in LocalityLbEndpoints.
  /// [#not-implemented-hide:]
  public var namedEndpoints: Dictionary<String,Envoy_Config_Endpoint_V3_Endpoint> = [:]

  /// Load balancing policy settings.
  public var policy: Envoy_Config_Endpoint_V3_ClusterLoadAssignment.Policy {
    get {return _policy ?? Envoy_Config_Endpoint_V3_ClusterLoadAssignment.Policy()}
  ...
  public struct Policy {
    ...
    /// [#not-implemented-hide:]
    public var dropOverloads: [Envoy_Config_Endpoint_V3_ClusterLoadAssignment.Policy.DropOverload] = []
    ...
    public struct DropOverload {
      ...
      public var dropPercentage: Envoy_Type_V3_FractionalPercent {
        get {return _dropPercentage ?? Envoy_Type_V3_FractionalPercent()}
      ...
      fileprivate var _dropPercentage: Envoy_Type_V3_FractionalPercent? = nil
    }
  ...
  fileprivate var _policy: Envoy_Config_Endpoint_V3_ClusterLoadAssignment.Policy? = nil
}
...
extension Envoy_Config_Endpoint_V3_ClusterLoadAssignment: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try decoder.decodeSingularMessageField(value: &self._policy)
      case 5: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Config_Endpoint_V3_Endpoint>.self, value: &self.namedEndpoints)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.namedEndpoints.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Config_Endpoint_V3_Endpoint>.self, value: self.namedEndpoints, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Endpoint_V3_ClusterLoadAssignment, rhs: Envoy_Config_Endpoint_V3_ClusterLoadAssignment) -> Bool {
...
extension Envoy_Config_Endpoint_V3_ClusterLoadAssignment.Policy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Endpoint_V3_ClusterLoadAssignment.protoMessageName + ".Policy"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 2: try decoder.decodeRepeatedMessageField(value: &self.dropOverloads)
      case 3: try decoder.decodeSingularMessageField(value: &self._overprovisioningFactor)
      case 4: try decoder.decodeSingularMessageField(value: &self._endpointStaleAfter)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Endpoint_V3_ClusterLoadAssignment.Policy, rhs: Envoy_Config_Endpoint_V3_ClusterLoadAssignment.Policy) -> Bool {
...
extension Envoy_Config_Endpoint_V3_ClusterLoadAssignment.Policy.DropOverload: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Endpoint_V3_ClusterLoadAssignment.Policy.protoMessageName + ".DropOverload"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularMessageField(value: &self._dropPercentage)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Endpoint_V3_ClusterLoadAssignment.Policy.DropOverload, rhs: Envoy_Config_Endpoint_V3_ClusterLoadAssignment.Policy.DropOverload) -> Bool {
