...
public struct Envoy_Type_TokenBucket {
...
extension Envoy_Type_TokenBucket: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularUInt32Field(value: &self.maxTokens)
      case 2: try decoder.decodeSingularMessageField(value: &self._tokensPerFill)
      case 3: try decoder.decodeSingularMessageField(value: &self._fillInterval)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Type_TokenBucket, rhs: Envoy_Type_TokenBucket) -> Bool {
