...
extension Envoy_Extensions_Filters_Network_DubboProxy_V3_MethodMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufUInt32,Envoy_Extensions_Filters_Network_DubboProxy_V3_MethodMatch.ParameterMatchSpecifier>.self, value: &self.paramsMatch)
      default: break
      }
    }
  }
