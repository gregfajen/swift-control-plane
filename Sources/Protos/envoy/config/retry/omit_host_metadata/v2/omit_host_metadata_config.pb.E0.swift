...
public struct Envoy_Config_Retry_OmitHostMetadata_V2_OmitHostMetadataConfig {
...
fileprivate let _protobuf_package = "envoy.config.retry.omit_host_metadata.v2"

extension Envoy_Config_Retry_OmitHostMetadata_V2_OmitHostMetadataConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._metadataMatch) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Retry_OmitHostMetadata_V2_OmitHostMetadataConfig, rhs: Envoy_Config_Retry_OmitHostMetadata_V2_OmitHostMetadataConfig) -> Bool {
