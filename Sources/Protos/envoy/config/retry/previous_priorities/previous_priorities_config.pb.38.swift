...
public struct Envoy_Config_Retry_PreviousPriorities_PreviousPrioritiesConfig {
...
fileprivate let _protobuf_package = "envoy.config.retry.previous_priorities"

extension Envoy_Config_Retry_PreviousPriorities_PreviousPrioritiesConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularInt32Field(value: &self.updateFrequency)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Retry_PreviousPriorities_PreviousPrioritiesConfig, rhs: Envoy_Config_Retry_PreviousPriorities_PreviousPrioritiesConfig) -> Bool {
