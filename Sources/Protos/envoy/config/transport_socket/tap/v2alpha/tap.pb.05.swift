...
public struct Envoy_Config_TransportSocket_Tap_V2alpha_Tap {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Common configuration for the tap transport socket.
  public var commonConfig: Envoy_Config_Common_Tap_V2alpha_CommonExtensionConfig {
    get {return _commonConfig ?? Envoy_Config_Common_Tap_V2alpha_CommonExtensionConfig()}
  ...
  fileprivate var _commonConfig: Envoy_Config_Common_Tap_V2alpha_CommonExtensionConfig? = nil
  fileprivate var _transportSocket: Envoy_Api_V2_Core_TransportSocket? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.config.transport_socket.tap.v2alpha"

extension Envoy_Config_TransportSocket_Tap_V2alpha_Tap: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_TransportSocket_Tap_V2alpha_Tap, rhs: Envoy_Config_TransportSocket_Tap_V2alpha_Tap) -> Bool {
