...
public struct Envoy_Config_Filter_Accesslog_V2_AccessLog {
  ...
  public var filter: Envoy_Config_Filter_Accesslog_V2_AccessLogFilter {
    get {return _filter ?? Envoy_Config_Filter_Accesslog_V2_AccessLogFilter()}
  ...
  public var configType: Envoy_Config_Filter_Accesslog_V2_AccessLog.OneOf_ConfigType? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_AccessLog.OneOf_ConfigType, rhs: Envoy_Config_Filter_Accesslog_V2_AccessLog.OneOf_ConfigType) -> Bool {
  ...
  fileprivate var _filter: Envoy_Config_Filter_Accesslog_V2_AccessLogFilter? = nil
}

/// [#next-free-field: 12]
public struct Envoy_Config_Filter_Accesslog_V2_AccessLogFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var filterSpecifier: Envoy_Config_Filter_Accesslog_V2_AccessLogFilter.OneOf_FilterSpecifier? = nil

  /// Status code filter.
  public var statusCodeFilter: Envoy_Config_Filter_Accesslog_V2_StatusCodeFilter {
    get {
      if case .statusCodeFilter(let v)? = filterSpecifier {return v}
      return Envoy_Config_Filter_Accesslog_V2_StatusCodeFilter()
    }
    set {filterSpecifier = .statusCodeFilter(newValue)}
  }

  /// Duration filter.
  public var durationFilter: Envoy_Config_Filter_Accesslog_V2_DurationFilter {
    get {
      if case .durationFilter(let v)? = filterSpecifier {return v}
      return Envoy_Config_Filter_Accesslog_V2_DurationFilter()
    }
    set {filterSpecifier = .durationFilter(newValue)}
  }

  /// Not health check filter.
  public var notHealthCheckFilter: Envoy_Config_Filter_Accesslog_V2_NotHealthCheckFilter {
    get {
      if case .notHealthCheckFilter(let v)? = filterSpecifier {return v}
      return Envoy_Config_Filter_Accesslog_V2_NotHealthCheckFilter()
    }
    set {filterSpecifier = .notHealthCheckFilter(newValue)}
  }

  /// Traceable filter.
  public var traceableFilter: Envoy_Config_Filter_Accesslog_V2_TraceableFilter {
    get {
      if case .traceableFilter(let v)? = filterSpecifier {return v}
      return Envoy_Config_Filter_Accesslog_V2_TraceableFilter()
    }
    set {filterSpecifier = .traceableFilter(newValue)}
  }

  /// Runtime filter.
  public var runtimeFilter: Envoy_Config_Filter_Accesslog_V2_RuntimeFilter {
    get {
      if case .runtimeFilter(let v)? = filterSpecifier {return v}
      return Envoy_Config_Filter_Accesslog_V2_RuntimeFilter()
    }
    set {filterSpecifier = .runtimeFilter(newValue)}
  }

  /// And filter.
  public var andFilter: Envoy_Config_Filter_Accesslog_V2_AndFilter {
    get {
      if case .andFilter(let v)? = filterSpecifier {return v}
      return Envoy_Config_Filter_Accesslog_V2_AndFilter()
    }
    set {filterSpecifier = .andFilter(newValue)}
  }

  /// Or filter.
  public var orFilter: Envoy_Config_Filter_Accesslog_V2_OrFilter {
    get {
      if case .orFilter(let v)? = filterSpecifier {return v}
      return Envoy_Config_Filter_Accesslog_V2_OrFilter()
    }
    set {filterSpecifier = .orFilter(newValue)}
  }

  /// Header filter.
  public var headerFilter: Envoy_Config_Filter_Accesslog_V2_HeaderFilter {
    get {
      if case .headerFilter(let v)? = filterSpecifier {return v}
      return Envoy_Config_Filter_Accesslog_V2_HeaderFilter()
    }
    set {filterSpecifier = .headerFilter(newValue)}
  }

  /// Response flag filter.
  public var responseFlagFilter: Envoy_Config_Filter_Accesslog_V2_ResponseFlagFilter {
    get {
      if case .responseFlagFilter(let v)? = filterSpecifier {return v}
      return Envoy_Config_Filter_Accesslog_V2_ResponseFlagFilter()
    }
    set {filterSpecifier = .responseFlagFilter(newValue)}
  }

  /// gRPC status filter.
  public var grpcStatusFilter: Envoy_Config_Filter_Accesslog_V2_GrpcStatusFilter {
    get {
      if case .grpcStatusFilter(let v)? = filterSpecifier {return v}
      return Envoy_Config_Filter_Accesslog_V2_GrpcStatusFilter()
    }
    set {filterSpecifier = .grpcStatusFilter(newValue)}
  }

  /// Extension filter.
  public var extensionFilter: Envoy_Config_Filter_Accesslog_V2_ExtensionFilter {
    get {
      if case .extensionFilter(let v)? = filterSpecifier {return v}
      return Envoy_Config_Filter_Accesslog_V2_ExtensionFilter()
    }
  ...
  public enum OneOf_FilterSpecifier: Equatable {
    /// Status code filter.
    case statusCodeFilter(Envoy_Config_Filter_Accesslog_V2_StatusCodeFilter)
    /// Duration filter.
    case durationFilter(Envoy_Config_Filter_Accesslog_V2_DurationFilter)
    /// Not health check filter.
    case notHealthCheckFilter(Envoy_Config_Filter_Accesslog_V2_NotHealthCheckFilter)
    /// Traceable filter.
    case traceableFilter(Envoy_Config_Filter_Accesslog_V2_TraceableFilter)
    /// Runtime filter.
    case runtimeFilter(Envoy_Config_Filter_Accesslog_V2_RuntimeFilter)
    /// And filter.
    case andFilter(Envoy_Config_Filter_Accesslog_V2_AndFilter)
    /// Or filter.
    case orFilter(Envoy_Config_Filter_Accesslog_V2_OrFilter)
    /// Header filter.
    case headerFilter(Envoy_Config_Filter_Accesslog_V2_HeaderFilter)
    /// Response flag filter.
    case responseFlagFilter(Envoy_Config_Filter_Accesslog_V2_ResponseFlagFilter)
    /// gRPC status filter.
    case grpcStatusFilter(Envoy_Config_Filter_Accesslog_V2_GrpcStatusFilter)
    /// Extension filter.
    case extensionFilter(Envoy_Config_Filter_Accesslog_V2_ExtensionFilter)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_AccessLogFilter.OneOf_FilterSpecifier, rhs: Envoy_Config_Filter_Accesslog_V2_AccessLogFilter.OneOf_FilterSpecifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Envoy_Config_Filter_Accesslog_V2_ComparisonFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Comparison operator.
  public var op: Envoy_Config_Filter_Accesslog_V2_ComparisonFilter.Op = .eq

  /// Value to compare against.
  public var value: Envoy_Api_V2_Core_RuntimeUInt32 {
    get {return _value ?? Envoy_Api_V2_Core_RuntimeUInt32()}
    set {_value = newValue}
  }
  ...
  fileprivate var _value: Envoy_Api_V2_Core_RuntimeUInt32? = nil
}

#if swift(>=4.2)

extension Envoy_Config_Filter_Accesslog_V2_ComparisonFilter.Op: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Filter_Accesslog_V2_ComparisonFilter.Op] = [
    .eq,
    .ge,
    .le,
  ]
...
public struct Envoy_Config_Filter_Accesslog_V2_StatusCodeFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Comparison.
  public var comparison: Envoy_Config_Filter_Accesslog_V2_ComparisonFilter {
    get {return _comparison ?? Envoy_Config_Filter_Accesslog_V2_ComparisonFilter()}
  ...
  fileprivate var _comparison: Envoy_Config_Filter_Accesslog_V2_ComparisonFilter? = nil
}

/// Filters on total request duration in milliseconds.
public struct Envoy_Config_Filter_Accesslog_V2_DurationFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Filter_Accesslog_V2_NotHealthCheckFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Filter_Accesslog_V2_TraceableFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Filter_Accesslog_V2_RuntimeFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var percentSampled: Envoy_Type_FractionalPercent {
    get {return _percentSampled ?? Envoy_Type_FractionalPercent()}
  ...
  fileprivate var _percentSampled: Envoy_Type_FractionalPercent? = nil
}

/// Performs a logical “and” operation on the result of each filter in filters.
/// Filters are evaluated sequentially and if one of them returns false, the
/// filter returns false immediately.
public struct Envoy_Config_Filter_Accesslog_V2_AndFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var filters: [Envoy_Config_Filter_Accesslog_V2_AccessLogFilter] = []
...
public struct Envoy_Config_Filter_Accesslog_V2_OrFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Filter_Accesslog_V2_HeaderFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var header: Envoy_Api_V2_Route_HeaderMatcher {
    get {return _header ?? Envoy_Api_V2_Route_HeaderMatcher()}
  ...
  fileprivate var _header: Envoy_Api_V2_Route_HeaderMatcher? = nil
}

/// Filters requests that received responses with an Envoy response flag set.
/// A list of the response flags can be found
/// in the access log formatter :ref:`documentation<config_access_log_format_response_flags>`.
public struct Envoy_Config_Filter_Accesslog_V2_ResponseFlagFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Filter_Accesslog_V2_GrpcStatusFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Logs only responses that have any one of the gRPC statuses in this field.
  public var statuses: [Envoy_Config_Filter_Accesslog_V2_GrpcStatusFilter.Status] = []
...
extension Envoy_Config_Filter_Accesslog_V2_GrpcStatusFilter.Status: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Filter_Accesslog_V2_GrpcStatusFilter.Status] = [
    .ok,
    .canceled,
    .unknown,
    .invalidArgument,
...
public struct Envoy_Config_Filter_Accesslog_V2_ExtensionFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var configType: Envoy_Config_Filter_Accesslog_V2_ExtensionFilter.OneOf_ConfigType? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_ExtensionFilter.OneOf_ConfigType, rhs: Envoy_Config_Filter_Accesslog_V2_ExtensionFilter.OneOf_ConfigType) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
fileprivate let _protobuf_package = "envoy.config.filter.accesslog.v2"

extension Envoy_Config_Filter_Accesslog_V2_AccessLog: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_AccessLog, rhs: Envoy_Config_Filter_Accesslog_V2_AccessLog) -> Bool {
...
extension Envoy_Config_Filter_Accesslog_V2_AccessLogFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Envoy_Config_Filter_Accesslog_V2_StatusCodeFilter?
      ...
      case 2: try {
        var v: Envoy_Config_Filter_Accesslog_V2_DurationFilter?
        if let current = self.filterSpecifier {
          try decoder.handleConflictingOneOf()
      ...
      case 3: try {
        var v: Envoy_Config_Filter_Accesslog_V2_NotHealthCheckFilter?
        if let current = self.filterSpecifier {
          try decoder.handleConflictingOneOf()
      ...
      case 4: try {
        var v: Envoy_Config_Filter_Accesslog_V2_TraceableFilter?
        if let current = self.filterSpecifier {
          try decoder.handleConflictingOneOf()
      ...
      case 5: try {
        var v: Envoy_Config_Filter_Accesslog_V2_RuntimeFilter?
        if let current = self.filterSpecifier {
          try decoder.handleConflictingOneOf()
      ...
      case 6: try {
        var v: Envoy_Config_Filter_Accesslog_V2_AndFilter?
        if let current = self.filterSpecifier {
          try decoder.handleConflictingOneOf()
      ...
      case 7: try {
        var v: Envoy_Config_Filter_Accesslog_V2_OrFilter?
        if let current = self.filterSpecifier {
          try decoder.handleConflictingOneOf()
      ...
      case 8: try {
        var v: Envoy_Config_Filter_Accesslog_V2_HeaderFilter?
        if let current = self.filterSpecifier {
          try decoder.handleConflictingOneOf()
      ...
      case 9: try {
        var v: Envoy_Config_Filter_Accesslog_V2_ResponseFlagFilter?
        if let current = self.filterSpecifier {
          try decoder.handleConflictingOneOf()
      ...
      case 10: try {
        var v: Envoy_Config_Filter_Accesslog_V2_GrpcStatusFilter?
        if let current = self.filterSpecifier {
          try decoder.handleConflictingOneOf()
      ...
      case 11: try {
        var v: Envoy_Config_Filter_Accesslog_V2_ExtensionFilter?
        if let current = self.filterSpecifier {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_AccessLogFilter, rhs: Envoy_Config_Filter_Accesslog_V2_AccessLogFilter) -> Bool {
...
extension Envoy_Config_Filter_Accesslog_V2_ComparisonFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_ComparisonFilter, rhs: Envoy_Config_Filter_Accesslog_V2_ComparisonFilter) -> Bool {
...
extension Envoy_Config_Filter_Accesslog_V2_ComparisonFilter.Op: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "EQ"),
    1: .same(proto: "GE"),
    2: .same(proto: "LE"),
...
extension Envoy_Config_Filter_Accesslog_V2_StatusCodeFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_StatusCodeFilter, rhs: Envoy_Config_Filter_Accesslog_V2_StatusCodeFilter) -> Bool {
...
extension Envoy_Config_Filter_Accesslog_V2_DurationFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_DurationFilter, rhs: Envoy_Config_Filter_Accesslog_V2_DurationFilter) -> Bool {
    if lhs._comparison != rhs._comparison {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Envoy_Config_Filter_Accesslog_V2_NotHealthCheckFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_NotHealthCheckFilter, rhs: Envoy_Config_Filter_Accesslog_V2_NotHealthCheckFilter) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Filter_Accesslog_V2_TraceableFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_TraceableFilter, rhs: Envoy_Config_Filter_Accesslog_V2_TraceableFilter) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Filter_Accesslog_V2_RuntimeFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_RuntimeFilter, rhs: Envoy_Config_Filter_Accesslog_V2_RuntimeFilter) -> Bool {
...
extension Envoy_Config_Filter_Accesslog_V2_AndFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_AndFilter, rhs: Envoy_Config_Filter_Accesslog_V2_AndFilter) -> Bool {
...
extension Envoy_Config_Filter_Accesslog_V2_OrFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_OrFilter, rhs: Envoy_Config_Filter_Accesslog_V2_OrFilter) -> Bool {
    if lhs.filters != rhs.filters {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Envoy_Config_Filter_Accesslog_V2_HeaderFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_HeaderFilter, rhs: Envoy_Config_Filter_Accesslog_V2_HeaderFilter) -> Bool {
...
extension Envoy_Config_Filter_Accesslog_V2_ResponseFlagFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_ResponseFlagFilter, rhs: Envoy_Config_Filter_Accesslog_V2_ResponseFlagFilter) -> Bool {
...
extension Envoy_Config_Filter_Accesslog_V2_GrpcStatusFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_GrpcStatusFilter, rhs: Envoy_Config_Filter_Accesslog_V2_GrpcStatusFilter) -> Bool {
...
extension Envoy_Config_Filter_Accesslog_V2_GrpcStatusFilter.Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "OK"),
...
extension Envoy_Config_Filter_Accesslog_V2_ExtensionFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Accesslog_V2_ExtensionFilter, rhs: Envoy_Config_Filter_Accesslog_V2_ExtensionFilter) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.configType != rhs.configType {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
