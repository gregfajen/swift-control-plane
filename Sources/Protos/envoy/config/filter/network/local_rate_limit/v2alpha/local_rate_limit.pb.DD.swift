...
public struct Envoy_Config_Filter_Network_LocalRateLimit_V2alpha_LocalRateLimit {
  ...
  ///   refills.
  public var tokenBucket: Envoy_Type_TokenBucket {
    get {return _tokenBucket ?? Envoy_Type_TokenBucket()}
  ...
  fileprivate var _tokenBucket: Envoy_Type_TokenBucket? = nil
  fileprivate var _runtimeEnabled: Envoy_Api_V2_Core_RuntimeFeatureFlag? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.config.filter.network.local_rate_limit.v2alpha"

extension Envoy_Config_Filter_Network_LocalRateLimit_V2alpha_LocalRateLimit: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_LocalRateLimit_V2alpha_LocalRateLimit, rhs: Envoy_Config_Filter_Network_LocalRateLimit_V2alpha_LocalRateLimit) -> Bool {
