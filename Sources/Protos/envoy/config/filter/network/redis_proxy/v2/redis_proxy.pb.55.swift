...
/// [#next-free-field: 7]
public struct Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy {
  ...
  public var settings: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.ConnPoolSettings {
    get {return _storage._settings ?? Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.ConnPoolSettings()}
  ...
  /// milliseconds.
  public var latencyInMicros: Bool {
    get {return _storage._latencyInMicros}
    set {_uniqueStorage()._latencyInMicros = newValue}
  }
  ...
  public var prefixRoutes: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes {
    get {return _storage._prefixRoutes ?? Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes()}
    set {_uniqueStorage()._prefixRoutes = newValue}
  }
  /// Returns true if `prefixRoutes` has been explicitly set.
  public var hasPrefixRoutes: Bool {return _storage._prefixRoutes != nil}
  /// Clears the value of `prefixRoutes`. Subsequent reads from it will return its default value.
  public mutating func clearPrefixRoutes() {_uniqueStorage()._prefixRoutes = nil}
  ...
  public var downstreamAuthPassword: Envoy_Api_V2_Core_DataSource {
    get {return _storage._downstreamAuthPassword ?? Envoy_Api_V2_Core_DataSource()}
    set {_uniqueStorage()._downstreamAuthPassword = newValue}
  }
  /// Returns true if `downstreamAuthPassword` has been explicitly set.
  public var hasDownstreamAuthPassword: Bool {return _storage._downstreamAuthPassword != nil}
  /// Clears the value of `downstreamAuthPassword`. Subsequent reads from it will return its default value.
  public mutating func clearDownstreamAuthPassword() {_uniqueStorage()._downstreamAuthPassword = nil}
  ...
  public struct ConnPoolSettings {
    ...
    public var readPolicy: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.ConnPoolSettings.ReadPolicy = .master
  ...
  public struct PrefixRoutes {
    ...
    public var routes: [Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes.Route] = []
    ...
    ///   route<envoy_api_field_config.filter.network.redis_proxy.v2.RedisProxy.PrefixRoutes.catch_all_route>`
    ///   instead.
    public var catchAllCluster: String = String()

    /// Optional catch-all route to forward commands that doesn't match any of the routes. The
    /// catch-all route becomes required when no routes are specified.
    public var catchAllRoute: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes.Route {
      get {return _catchAllRoute ?? Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes.Route()}
    ...
    public struct Route {
      ...
      public var requestMirrorPolicy: [Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes.Route.RequestMirrorPolicy] = []
    ...
    fileprivate var _catchAllRoute: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes.Route? = nil
  }
...
extension Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.ConnPoolSettings.ReadPolicy: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.ConnPoolSettings.ReadPolicy] = [
    .master,
    .preferMaster,
    .replica,
    .preferReplica,
...
public struct Envoy_Config_Filter_Network_RedisProxy_V2_RedisProtocolOptions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var authPassword: Envoy_Api_V2_Core_DataSource {
    get {return _authPassword ?? Envoy_Api_V2_Core_DataSource()}
  ...
  fileprivate var _authPassword: Envoy_Api_V2_Core_DataSource? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.config.filter.network.redis_proxy.v2"

extension Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _settings: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.ConnPoolSettings? = nil
    var _latencyInMicros: Bool = false
    var _prefixRoutes: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes? = nil
    var _downstreamAuthPassword: Envoy_Api_V2_Core_DataSource? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _latencyInMicros = source._latencyInMicros
      _prefixRoutes = source._prefixRoutes
      _downstreamAuthPassword = source._downstreamAuthPassword
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularStringField(value: &_storage._cluster) }()
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._settings) }()
        case 4: try { try decoder.decodeSingularBoolField(value: &_storage._latencyInMicros) }()
        case 5: try { try decoder.decodeSingularMessageField(value: &_storage._prefixRoutes) }()
        case 6: try { try decoder.decodeSingularMessageField(value: &_storage._downstreamAuthPassword) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._cluster.isEmpty {
        try visitor.visitSingularStringField(value: _storage._cluster, fieldNumber: 2)
      }
      if let v = _storage._settings {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      }
      if _storage._latencyInMicros != false {
        try visitor.visitSingularBoolField(value: _storage._latencyInMicros, fieldNumber: 4)
      }
      if let v = _storage._prefixRoutes {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
      }
      if let v = _storage._downstreamAuthPassword {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy, rhs: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._latencyInMicros != rhs_storage._latencyInMicros {return false}
        if _storage._prefixRoutes != rhs_storage._prefixRoutes {return false}
        if _storage._downstreamAuthPassword != rhs_storage._downstreamAuthPassword {return false}
        return true
      }
...
extension Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.ConnPoolSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.protoMessageName + ".ConnPoolSettings"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._opTimeout) }()
      case 2: try { try decoder.decodeSingularBoolField(value: &self.enableHashtagging) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.enableRedirection) }()
      case 4: try { try decoder.decodeSingularUInt32Field(value: &self.maxBufferSizeBeforeFlush) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._bufferFlushTimeout) }()
      case 6: try { try decoder.decodeSingularMessageField(value: &self._maxUpstreamUnknownConnections) }()
      case 7: try { try decoder.decodeSingularEnumField(value: &self.readPolicy) }()
      case 8: try { try decoder.decodeSingularBoolField(value: &self.enableCommandStats) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.ConnPoolSettings, rhs: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.ConnPoolSettings) -> Bool {
...
extension Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.ConnPoolSettings.ReadPolicy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "MASTER"),
...
extension Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.protoMessageName + ".PrefixRoutes"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "routes"),
    2: .standard(proto: "case_insensitive"),
    3: .standard(proto: "catch_all_cluster"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularBoolField(value: &self.caseInsensitive) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.catchAllCluster) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._catchAllRoute) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.catchAllCluster.isEmpty {
      try visitor.visitSingularStringField(value: self.catchAllCluster, fieldNumber: 3)
    }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes, rhs: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes) -> Bool {
    if lhs.routes != rhs.routes {return false}
    if lhs.caseInsensitive != rhs.caseInsensitive {return false}
    if lhs.catchAllCluster != rhs.catchAllCluster {return false}
...
extension Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes.Route: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes.protoMessageName + ".Route"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "prefix"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularBoolField(value: &self.removePrefix) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.cluster) }()
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.requestMirrorPolicy) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes.Route, rhs: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes.Route) -> Bool {
...
extension Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes.Route.RequestMirrorPolicy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes.Route.protoMessageName + ".RequestMirrorPolicy"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._runtimeFraction) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.excludeReadCommands) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes.Route.RequestMirrorPolicy, rhs: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProxy.PrefixRoutes.Route.RequestMirrorPolicy) -> Bool {
    if lhs.cluster != rhs.cluster {return false}
...
extension Envoy_Config_Filter_Network_RedisProxy_V2_RedisProtocolOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._authPassword) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProtocolOptions, rhs: Envoy_Config_Filter_Network_RedisProxy_V2_RedisProtocolOptions) -> Bool {
