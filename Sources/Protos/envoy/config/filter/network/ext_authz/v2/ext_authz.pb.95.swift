...
public struct Envoy_Config_Filter_Network_ExtAuthz_V2_ExtAuthz {
...
fileprivate let _protobuf_package = "envoy.config.filter.network.ext_authz.v2"

extension Envoy_Config_Filter_Network_ExtAuthz_V2_ExtAuthz: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularBoolField(value: &self.failureModeAllow) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self.includePeerCertificate) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_ExtAuthz_V2_ExtAuthz, rhs: Envoy_Config_Filter_Network_ExtAuthz_V2_ExtAuthz) -> Bool {
