...
public struct Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteConfiguration {
  ...
  public var routes: [Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_Route] = []
...
public struct Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_Route {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Route matching parameters.
  public var match: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteMatch {
    get {return _match ?? Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteMatch()}
    set {_match = newValue}
  }
  ...
  public var route: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteAction {
    get {return _route ?? Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteAction()}
    set {_route = newValue}
  }
  ...
  fileprivate var _match: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteMatch? = nil
  fileprivate var _route: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteAction? = nil
}

public struct Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteMatch {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var matchSpecifier: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteMatch.OneOf_MatchSpecifier? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteMatch.OneOf_MatchSpecifier, rhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteMatch.OneOf_MatchSpecifier) -> Bool {
...
/// [#next-free-field: 7]
public struct Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteAction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var clusterSpecifier: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteAction.OneOf_ClusterSpecifier? = nil
  ...
  public var weightedClusters: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_WeightedCluster {
    get {
      if case .weightedClusters(let v)? = clusterSpecifier {return v}
      return Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_WeightedCluster()
    }
  ...
  public enum OneOf_ClusterSpecifier: Equatable {
    ...
    /// request is routed to one of the upstream clusters based on weights
    /// assigned to each cluster.
    case weightedClusters(Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_WeightedCluster)
    /// Envoy will determine the cluster to route to by reading the value of the
    /// Thrift header named by cluster_header from the request headers. If the
    /// header is not found or the referenced cluster does not exist Envoy will
    /// respond with an unknown method exception or an internal error exception,
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteAction.OneOf_ClusterSpecifier, rhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteAction.OneOf_ClusterSpecifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_WeightedCluster {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Specifies one or more upstream clusters associated with the route.
  public var clusters: [Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_WeightedCluster.ClusterWeight] = []
...
extension Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteConfiguration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteConfiguration, rhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteConfiguration) -> Bool {
...
extension Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_Route: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_Route, rhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_Route) -> Bool {
...
extension Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteMatch, rhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteMatch) -> Bool {
...
extension Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_WeightedCluster?
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteAction, rhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_RouteAction) -> Bool {
...
extension Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_WeightedCluster: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_WeightedCluster, rhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_WeightedCluster) -> Bool {
...
extension Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_WeightedCluster.ClusterWeight: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_WeightedCluster.protoMessageName + ".ClusterWeight"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .same(proto: "weight"),
    3: .standard(proto: "metadata_match"),
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_WeightedCluster.ClusterWeight, rhs: Envoy_Config_Filter_Network_ThriftProxy_V2alpha1_WeightedCluster.ClusterWeight) -> Bool {
    if lhs.name != rhs.name {return false}
