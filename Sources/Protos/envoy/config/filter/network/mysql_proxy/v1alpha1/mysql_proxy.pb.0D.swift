...
public struct Envoy_Config_Filter_Network_MysqlProxy_V1alpha1_MySQLProxy {
...
fileprivate let _protobuf_package = "envoy.config.filter.network.mysql_proxy.v1alpha1"

extension Envoy_Config_Filter_Network_MysqlProxy_V1alpha1_MySQLProxy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_MysqlProxy_V1alpha1_MySQLProxy, rhs: Envoy_Config_Filter_Network_MysqlProxy_V1alpha1_MySQLProxy) -> Bool {
