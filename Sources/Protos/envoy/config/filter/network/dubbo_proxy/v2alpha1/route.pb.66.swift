...
/// [#next-free-field: 6]
public struct Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteConfiguration {
  ...
  public var routes: [Envoy_Config_Filter_Network_DubboProxy_V2alpha1_Route] = []
...
public struct Envoy_Config_Filter_Network_DubboProxy_V2alpha1_Route {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Route matching parameters.
  public var match: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteMatch {
    get {return _match ?? Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteMatch()}
    set {_match = newValue}
  }
  ...
  public var route: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteAction {
    get {return _route ?? Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteAction()}
    set {_route = newValue}
  }
  ...
  fileprivate var _match: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteMatch? = nil
  fileprivate var _route: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteAction? = nil
}

public struct Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteMatch {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Method level routing matching.
  public var method: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch {
    get {return _method ?? Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch()}
  ...
  fileprivate var _method: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch? = nil
}

public struct Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteAction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var clusterSpecifier: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteAction.OneOf_ClusterSpecifier? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteAction.OneOf_ClusterSpecifier, rhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteAction.OneOf_ClusterSpecifier) -> Bool {
...
public struct Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The name of the method.
  public var name: Envoy_Type_Matcher_StringMatcher {
    get {return _name ?? Envoy_Type_Matcher_StringMatcher()}
    set {_name = newValue}
  }
  ...
  public var paramsMatch: Dictionary<UInt32,Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch.ParameterMatchSpecifier> = [:]
  ...
  public struct ParameterMatchSpecifier {
    ...
    public var parameterMatchSpecifier: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch.ParameterMatchSpecifier.OneOf_ParameterMatchSpecifier? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch.ParameterMatchSpecifier.OneOf_ParameterMatchSpecifier, rhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch.ParameterMatchSpecifier.OneOf_ParameterMatchSpecifier) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
  ...
  fileprivate var _name: Envoy_Type_Matcher_StringMatcher? = nil
}
...
extension Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteConfiguration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteConfiguration, rhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteConfiguration) -> Bool {
...
extension Envoy_Config_Filter_Network_DubboProxy_V2alpha1_Route: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_Route, rhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_Route) -> Bool {
...
extension Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteMatch, rhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteMatch) -> Bool {
...
extension Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteAction, rhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_RouteAction) -> Bool {
...
extension Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufUInt32,Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch.ParameterMatchSpecifier>.self, value: &self.paramsMatch) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.paramsMatch.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufUInt32,Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch.ParameterMatchSpecifier>.self, value: self.paramsMatch, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch, rhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch) -> Bool {
...
extension Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch.ParameterMatchSpecifier: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch.protoMessageName + ".ParameterMatchSpecifier"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch.ParameterMatchSpecifier, rhs: Envoy_Config_Filter_Network_DubboProxy_V2alpha1_MethodMatch.ParameterMatchSpecifier) -> Bool {
