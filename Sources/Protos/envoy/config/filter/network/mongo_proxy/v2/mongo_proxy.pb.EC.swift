...
public struct Envoy_Config_Filter_Network_MongoProxy_V2_MongoProxy {
  ...
  public var delay: Envoy_Config_Filter_Fault_V2_FaultDelay {
    get {return _delay ?? Envoy_Config_Filter_Fault_V2_FaultDelay()}
    set {_delay = newValue}
  }
  ...
  fileprivate var _delay: Envoy_Config_Filter_Fault_V2_FaultDelay? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.config.filter.network.mongo_proxy.v2"

extension Envoy_Config_Filter_Network_MongoProxy_V2_MongoProxy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_MongoProxy_V2_MongoProxy, rhs: Envoy_Config_Filter_Network_MongoProxy_V2_MongoProxy) -> Bool {
