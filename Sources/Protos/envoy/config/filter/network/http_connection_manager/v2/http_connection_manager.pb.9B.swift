...
/// [#next-free-field: 37]
public struct Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Supplies the type of codec that the connection manager should use.
  public var codecType: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.CodecType {
  ...
  public var rds: Envoy_Config_Filter_Network_HttpConnectionManager_V2_Rds {
    get {
      if case .rds(let v)? = _storage._routeSpecifier {return v}
      return Envoy_Config_Filter_Network_HttpConnectionManager_V2_Rds()
    }
    set {_uniqueStorage()._routeSpecifier = .rds(newValue)}
  }

  /// The route table for the connection manager is static and is specified in this property.
  public var routeConfig: Envoy_Api_V2_RouteConfiguration {
    get {
      if case .routeConfig(let v)? = _storage._routeSpecifier {return v}
      return Envoy_Api_V2_RouteConfiguration()
    }
  ...
  public var scopedRoutes: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes {
    get {
      if case .scopedRoutes(let v)? = _storage._routeSpecifier {return v}
      return Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes()
    }
  ...
  public var httpFilters: [Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpFilter] {
  ...
  public var tracing: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.Tracing {
    get {return _storage._tracing ?? Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.Tracing()}
  ...
  public var commonHTTPProtocolOptions: Envoy_Api_V2_Core_HttpProtocolOptions {
    get {return _storage._commonHTTPProtocolOptions ?? Envoy_Api_V2_Core_HttpProtocolOptions()}
  ...
  public var httpProtocolOptions: Envoy_Api_V2_Core_Http1ProtocolOptions {
    get {return _storage._httpProtocolOptions ?? Envoy_Api_V2_Core_Http1ProtocolOptions()}
  ...
  public var http2ProtocolOptions: Envoy_Api_V2_Core_Http2ProtocolOptions {
    get {return _storage._http2ProtocolOptions ?? Envoy_Api_V2_Core_Http2ProtocolOptions()}
  ...
  /// server_name.
  public var serverHeaderTransformation: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.ServerHeaderTransformation {
  ...
  public var internalAddressConfig: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.InternalAddressConfig {
    get {return _storage._internalAddressConfig ?? Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.InternalAddressConfig()}
  ...
  /// header.
  public var forwardClientCertDetails: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.ForwardClientCertDetails {
  ...
  /// value.
  public var setCurrentClientCertDetails: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.SetCurrentClientCertDetails {
    get {return _storage._setCurrentClientCertDetails ?? Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.SetCurrentClientCertDetails()}
  ...
  public var upgradeConfigs: [Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.UpgradeConfig] {
  ...
  public var requestIDExtension: Envoy_Config_Filter_Network_HttpConnectionManager_V2_RequestIDExtension {
    get {return _storage._requestIDExtension ?? Envoy_Config_Filter_Network_HttpConnectionManager_V2_RequestIDExtension()}
  ...
  public enum OneOf_RouteSpecifier: Equatable {
    /// The connection manager’s route table will be dynamically loaded via the RDS API.
    case rds(Envoy_Config_Filter_Network_HttpConnectionManager_V2_Rds)
    /// The route table for the connection manager is static and is specified in this property.
    case routeConfig(Envoy_Api_V2_RouteConfiguration)
    /// A route table will be dynamically assigned to each request based on request attributes
    /// (e.g., the value of a header). The "routing scopes" (i.e., route tables) and "scope keys" are
    /// specified in this message.
    case scopedRoutes(Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.OneOf_RouteSpecifier, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.OneOf_RouteSpecifier) -> Bool {
  ...
  public struct Tracing {
    ...
    public var operationName: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.Tracing.OperationName = .ingress
    ...
    public var requestHeadersForTags: [String] = []
    ...
    /// Default: 100%
    public var clientSampling: Envoy_Type_Percent {
      get {return _clientSampling ?? Envoy_Type_Percent()}
    ...
    /// Default: 100%
    public var randomSampling: Envoy_Type_Percent {
      get {return _randomSampling ?? Envoy_Type_Percent()}
    ...
    /// :ref:`HTTP Connection Manager <config_http_conn_man_runtime>`.
    /// Default: 100%
    public var overallSampling: Envoy_Type_Percent {
      get {return _overallSampling ?? Envoy_Type_Percent()}
    ...
    ///   on OpenCensus side.
    public var provider: Envoy_Config_Trace_V2_Tracing.Http {
      get {return _provider ?? Envoy_Config_Trace_V2_Tracing.Http()}
    ...
    fileprivate var _clientSampling: Envoy_Type_Percent? = nil
    fileprivate var _randomSampling: Envoy_Type_Percent? = nil
    fileprivate var _overallSampling: Envoy_Type_Percent? = nil
    fileprivate var _maxPathTagLength: SwiftProtobuf.Google_Protobuf_UInt32Value? = nil
    fileprivate var _provider: Envoy_Config_Trace_V2_Tracing.Http? = nil
  }
  ...
  public struct UpgradeConfig {
    ...
    public var filters: [Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpFilter] = []
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.CodecType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.CodecType] = [
    .auto,
    .http1,
    .http2,
    .http3,
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.ServerHeaderTransformation: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.ServerHeaderTransformation] = [
    .overwrite,
    .appendIfAbsent,
    .passThrough,
  ]
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.ForwardClientCertDetails: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.ForwardClientCertDetails] = [
    .sanitize,
    .forwardOnly,
    .appendForward,
    .sanitizeSet,
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.Tracing.OperationName: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.Tracing.OperationName] = [
    .ingress,
    .egress,
  ]
}
...
public struct Envoy_Config_Filter_Network_HttpConnectionManager_V2_Rds {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Configuration source specifier for RDS.
  public var configSource: Envoy_Api_V2_Core_ConfigSource {
    get {return _configSource ?? Envoy_Api_V2_Core_ConfigSource()}
  ...
  fileprivate var _configSource: Envoy_Api_V2_Core_ConfigSource? = nil
}

/// This message is used to work around the limitations with 'oneof' and repeated fields.
public struct Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRouteConfigurationsList {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var scopedRouteConfigurations: [Envoy_Api_V2_ScopedRouteConfiguration] = []
...
/// [#next-free-field: 6]
public struct Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var scopeKeyBuilder: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder {
    get {return _storage._scopeKeyBuilder ?? Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder()}
  ...
  public var rdsConfigSource: Envoy_Api_V2_Core_ConfigSource {
    get {return _storage._rdsConfigSource ?? Envoy_Api_V2_Core_ConfigSource()}
  ...
  /// in this message.
  public var scopedRouteConfigurationsList: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRouteConfigurationsList {
    get {
      if case .scopedRouteConfigurationsList(let v)? = _storage._configSpecifier {return v}
      return Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRouteConfigurationsList()
    }
  ...
  /// :ref:`ScopeKeyBuilder<envoy_api_msg_config.filter.network.http_connection_manager.v2.ScopedRoutes.ScopeKeyBuilder>`
  /// in this message.
  public var scopedRds: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRds {
    get {
      if case .scopedRds(let v)? = _storage._configSpecifier {return v}
      return Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRds()
    }
  ...
  public enum OneOf_ConfigSpecifier: Equatable {
    ...
    /// :ref:`ScopeKeyBuilder<envoy_api_msg_config.filter.network.http_connection_manager.v2.ScopedRoutes.ScopeKeyBuilder>`
    /// in this message.
    case scopedRouteConfigurationsList(Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRouteConfigurationsList)
    /// The set of routing scopes associated with the HCM will be dynamically loaded via the SRDS
    /// API. A scope is assigned to a request by matching a key constructed from the request's
    /// attributes according to the algorithm specified by the
    /// :ref:`ScopeKeyBuilder<envoy_api_msg_config.filter.network.http_connection_manager.v2.ScopedRoutes.ScopeKeyBuilder>`
    /// in this message.
    case scopedRds(Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRds)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.OneOf_ConfigSpecifier, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.OneOf_ConfigSpecifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
  ...
  public struct ScopeKeyBuilder {
    ...
    public var fragments: [Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder] = []
    ...
    public struct FragmentBuilder {
      ...
      public var type: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.OneOf_Type? = nil

      /// Specifies how a header field's value should be extracted.
      public var headerValueExtractor: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor {
        get {
          if case .headerValueExtractor(let v)? = type {return v}
          return Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor()
        }
      ...
      public enum OneOf_Type: Equatable {
        /// Specifies how a header field's value should be extracted.
        case headerValueExtractor(Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor)

      #if !swift(>=4.1)
        public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.OneOf_Type, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.OneOf_Type) -> Bool {
          // The use of inline closures is to circumvent an issue where the compiler
          // allocates stack space for every case branch when no optimizations are
          // enabled. https://github.com/apple/swift-protobuf/issues/1034
          switch (lhs, rhs) {
      ...
      public struct HeaderValueExtractor {
        ...
        public var extractType: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.OneOf_ExtractType? = nil
        ...
        public var element: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement {
          get {
            if case .element(let v)? = extractType {return v}
            return Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement()
          }
        ...
        public enum OneOf_ExtractType: Equatable {
          ...
          case index(UInt32)
          /// Specifies the key value pair to extract the value from.
          case element(Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement)

        #if !swift(>=4.1)
          public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.OneOf_ExtractType, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.OneOf_ExtractType) -> Bool {
            // The use of inline closures is to circumvent an issue where the compiler
            // allocates stack space for every case branch when no optimizations are
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch (lhs, rhs) {
...
public struct Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRds {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Configuration source specifier for scoped RDS.
  public var scopedRdsConfigSource: Envoy_Api_V2_Core_ConfigSource {
    get {return _scopedRdsConfigSource ?? Envoy_Api_V2_Core_ConfigSource()}
  ...
  fileprivate var _scopedRdsConfigSource: Envoy_Api_V2_Core_ConfigSource? = nil
}

public struct Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var configType: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpFilter.OneOf_ConfigType? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpFilter.OneOf_ConfigType, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpFilter.OneOf_ConfigType) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Envoy_Config_Filter_Network_HttpConnectionManager_V2_RequestIDExtension {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "envoy.config.filter.network.http_connection_manager.v2"

extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    11: .standard(proto: "idle_timeout"),
  ...
  fileprivate class _StorageClass {
    var _codecType: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.CodecType = .auto
    var _statPrefix: String = String()
    var _routeSpecifier: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.OneOf_RouteSpecifier?
    var _httpFilters: [Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpFilter] = []
    var _addUserAgent: SwiftProtobuf.Google_Protobuf_BoolValue? = nil
    var _tracing: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.Tracing? = nil
    var _commonHTTPProtocolOptions: Envoy_Api_V2_Core_HttpProtocolOptions? = nil
    var _httpProtocolOptions: Envoy_Api_V2_Core_Http1ProtocolOptions? = nil
    var _http2ProtocolOptions: Envoy_Api_V2_Core_Http2ProtocolOptions? = nil
    var _serverName: String = String()
    var _serverHeaderTransformation: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.ServerHeaderTransformation = .overwrite
    ...
    var _accessLog: [Envoy_Config_Filter_Accesslog_V2_AccessLog] = []
    var _useRemoteAddress: SwiftProtobuf.Google_Protobuf_BoolValue? = nil
    var _xffNumTrustedHops: UInt32 = 0
    var _internalAddressConfig: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.InternalAddressConfig? = nil
    ...
    var _forwardClientCertDetails: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.ForwardClientCertDetails = .sanitize
    var _setCurrentClientCertDetails: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.SetCurrentClientCertDetails? = nil
    var _proxy100Continue: Bool = false
    var _representIpv4RemoteAddressAsIpv4MappedIpv6: Bool = false
    var _upgradeConfigs: [Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.UpgradeConfig] = []
    var _normalizePath: SwiftProtobuf.Google_Protobuf_BoolValue? = nil
    var _mergeSlashes: Bool = false
    var _requestIDExtension: Envoy_Config_Filter_Network_HttpConnectionManager_V2_RequestIDExtension? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try {
          var v: Envoy_Config_Filter_Network_HttpConnectionManager_V2_Rds?
        ...
        case 4: try {
          var v: Envoy_Api_V2_RouteConfiguration?
          if let current = _storage._routeSpecifier {
            try decoder.handleConflictingOneOf()
        ...
        case 11: try { try decoder.decodeSingularMessageField(value: &_storage._idleTimeout) }()
        ...
        case 31: try {
          var v: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes?
          if let current = _storage._routeSpecifier {
            try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager) -> Bool {
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.CodecType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "AUTO"),
    1: .same(proto: "HTTP1"),
    2: .same(proto: "HTTP2"),
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.ServerHeaderTransformation: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.ForwardClientCertDetails: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.Tracing: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.protoMessageName + ".Tracing"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "operation_name"),
    2: .standard(proto: "request_headers_for_tags"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.operationName) }()
      case 2: try { try decoder.decodeRepeatedStringField(value: &self.requestHeadersForTags) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.operationName != .ingress {
      try visitor.visitSingularEnumField(value: self.operationName, fieldNumber: 1)
    }
    if !self.requestHeadersForTags.isEmpty {
      try visitor.visitRepeatedStringField(value: self.requestHeadersForTags, fieldNumber: 2)
    }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.Tracing, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.Tracing) -> Bool {
    if lhs.operationName != rhs.operationName {return false}
    if lhs.requestHeadersForTags != rhs.requestHeadersForTags {return false}
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.Tracing.OperationName: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.InternalAddressConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.protoMessageName + ".InternalAddressConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.InternalAddressConfig, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.InternalAddressConfig) -> Bool {
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.SetCurrentClientCertDetails: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.protoMessageName + ".SetCurrentClientCertDetails"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.SetCurrentClientCertDetails, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.SetCurrentClientCertDetails) -> Bool {
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.UpgradeConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.protoMessageName + ".UpgradeConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.UpgradeConfig, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpConnectionManager.UpgradeConfig) -> Bool {
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_Rds: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.routeConfigName) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_Rds, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_Rds) -> Bool {
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRouteConfigurationsList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRouteConfigurationsList, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRouteConfigurationsList) -> Bool {
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _scopeKeyBuilder: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder? = nil
    var _rdsConfigSource: Envoy_Api_V2_Core_ConfigSource? = nil
    var _configSpecifier: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.OneOf_ConfigSpecifier?
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try {
          var v: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRouteConfigurationsList?
        ...
        case 5: try {
          var v: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRds?
          if let current = _storage._configSpecifier {
            try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.protoMessageName + ".ScopeKeyBuilder"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder) -> Bool {
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.protoMessageName + ".FragmentBuilder"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor?
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder) -> Bool {
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.protoMessageName + ".HeaderValueExtractor"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try {
        var v: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement?
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor) -> Bool {
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.protoMessageName + ".KvElement"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement) -> Bool {
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRds: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRds, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_ScopedRds) -> Bool {
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpFilter, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_HttpFilter) -> Bool {
    if lhs.name != rhs.name {return false}
...
extension Envoy_Config_Filter_Network_HttpConnectionManager_V2_RequestIDExtension: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_RequestIDExtension, rhs: Envoy_Config_Filter_Network_HttpConnectionManager_V2_RequestIDExtension) -> Bool {
