...
/// [#next-free-field: 7]
public struct Envoy_Config_Filter_Network_RateLimit_V2_RateLimit {
...
fileprivate let _protobuf_package = "envoy.config.filter.network.rate_limit.v2"

extension Envoy_Config_Filter_Network_RateLimit_V2_RateLimit: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _descriptors: [Envoy_Api_V2_Ratelimit_RateLimitDescriptor] = []
  ...
  public static func ==(lhs: Envoy_Config_Filter_Network_RateLimit_V2_RateLimit, rhs: Envoy_Config_Filter_Network_RateLimit_V2_RateLimit) -> Bool {
