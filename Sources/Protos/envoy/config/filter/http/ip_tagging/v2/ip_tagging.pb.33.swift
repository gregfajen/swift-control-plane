...
public struct Envoy_Config_Filter_Http_IpTagging_V2_IPTagging {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The type of request the filter should apply to.
  public var requestType: Envoy_Config_Filter_Http_IpTagging_V2_IPTagging.RequestType = .both

  /// [#comment:TODO(ccaraman): Extend functionality to load IP tags from file system.
  /// Tracked by issue https://github.com/envoyproxy/envoy/issues/2695]
  /// The set of IP tags for the filter.
  public var ipTags: [Envoy_Config_Filter_Http_IpTagging_V2_IPTagging.IPTag] = []
  ...
  public struct IPTag {
    ...
    public var ipList: [Envoy_Api_V2_Core_CidrRange] = []
...
extension Envoy_Config_Filter_Http_IpTagging_V2_IPTagging.RequestType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Filter_Http_IpTagging_V2_IPTagging.RequestType] = [
    .both,
    .internal,
    .external,
  ]
...
fileprivate let _protobuf_package = "envoy.config.filter.http.ip_tagging.v2"

extension Envoy_Config_Filter_Http_IpTagging_V2_IPTagging: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_IpTagging_V2_IPTagging, rhs: Envoy_Config_Filter_Http_IpTagging_V2_IPTagging) -> Bool {
...
extension Envoy_Config_Filter_Http_IpTagging_V2_IPTagging.RequestType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "BOTH"),
...
extension Envoy_Config_Filter_Http_IpTagging_V2_IPTagging.IPTag: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Http_IpTagging_V2_IPTagging.protoMessageName + ".IPTag"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_IpTagging_V2_IPTagging.IPTag, rhs: Envoy_Config_Filter_Http_IpTagging_V2_IPTagging.IPTag) -> Bool {
