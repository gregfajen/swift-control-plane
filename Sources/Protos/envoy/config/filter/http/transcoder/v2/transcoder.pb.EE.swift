...
/// [#next-free-field: 10]
public struct Envoy_Config_Filter_Http_Transcoder_V2_GrpcJsonTranscoder {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var descriptorSet: Envoy_Config_Filter_Http_Transcoder_V2_GrpcJsonTranscoder.OneOf_DescriptorSet? = nil
  ...
  public var printOptions: Envoy_Config_Filter_Http_Transcoder_V2_GrpcJsonTranscoder.PrintOptions {
    get {return _printOptions ?? Envoy_Config_Filter_Http_Transcoder_V2_GrpcJsonTranscoder.PrintOptions()}
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Http_Transcoder_V2_GrpcJsonTranscoder.OneOf_DescriptorSet, rhs: Envoy_Config_Filter_Http_Transcoder_V2_GrpcJsonTranscoder.OneOf_DescriptorSet) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.protoDescriptor, .protoDescriptor): return {
        guard case .protoDescriptor(let l) = lhs, case .protoDescriptor(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.protoDescriptorBin, .protoDescriptorBin): return {
        guard case .protoDescriptorBin(let l) = lhs, case .protoDescriptorBin(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
  ...
  fileprivate var _printOptions: Envoy_Config_Filter_Http_Transcoder_V2_GrpcJsonTranscoder.PrintOptions? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.config.filter.http.transcoder.v2"

extension Envoy_Config_Filter_Http_Transcoder_V2_GrpcJsonTranscoder: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularMessageField(value: &self._printOptions) }()
      case 4: try {
        if self.descriptorSet != nil {try decoder.handleConflictingOneOf()}
        var v: Data?
      ...
      case 5: try { try decoder.decodeSingularBoolField(value: &self.matchIncomingRequestRoute) }()
      case 6: try { try decoder.decodeRepeatedStringField(value: &self.ignoredQueryParameters) }()
      case 7: try { try decoder.decodeSingularBoolField(value: &self.autoMapping) }()
      case 8: try { try decoder.decodeSingularBoolField(value: &self.ignoreUnknownQueryParameters) }()
      case 9: try { try decoder.decodeSingularBoolField(value: &self.convertGrpcStatus) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_Transcoder_V2_GrpcJsonTranscoder, rhs: Envoy_Config_Filter_Http_Transcoder_V2_GrpcJsonTranscoder) -> Bool {
...
extension Envoy_Config_Filter_Http_Transcoder_V2_GrpcJsonTranscoder.PrintOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Http_Transcoder_V2_GrpcJsonTranscoder.protoMessageName + ".PrintOptions"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.addWhitespace) }()
      case 2: try { try decoder.decodeSingularBoolField(value: &self.alwaysPrintPrimitiveFields) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.alwaysPrintEnumsAsInts) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self.preserveProtoFieldNames) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_Transcoder_V2_GrpcJsonTranscoder.PrintOptions, rhs: Envoy_Config_Filter_Http_Transcoder_V2_GrpcJsonTranscoder.PrintOptions) -> Bool {
