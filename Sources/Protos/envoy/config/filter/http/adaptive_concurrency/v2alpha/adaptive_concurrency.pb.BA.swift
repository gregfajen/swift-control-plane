...
public struct Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The percentile to use when summarizing aggregated samples. Defaults to p50.
  public var sampleAggregatePercentile: Envoy_Type_Percent {
    get {return _sampleAggregatePercentile ?? Envoy_Type_Percent()}
  ...
  public var concurrencyLimitParams: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig.ConcurrencyLimitCalculationParams {
    get {return _concurrencyLimitParams ?? Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig.ConcurrencyLimitCalculationParams()}
  ...
  public var minRttCalcParams: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig.MinimumRTTCalculationParams {
    get {return _minRttCalcParams ?? Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig.MinimumRTTCalculationParams()}
  ...
  public struct MinimumRTTCalculationParams {
    ...
    public var jitter: Envoy_Type_Percent {
      get {return _jitter ?? Envoy_Type_Percent()}
    ...
    ///
    /// Defaults to 25%.
    public var buffer: Envoy_Type_Percent {
      get {return _buffer ?? Envoy_Type_Percent()}
    ...
    fileprivate var _jitter: Envoy_Type_Percent? = nil
    fileprivate var _minConcurrency: SwiftProtobuf.Google_Protobuf_UInt32Value? = nil
    fileprivate var _buffer: Envoy_Type_Percent? = nil
  }

  public init() {}

  fileprivate var _sampleAggregatePercentile: Envoy_Type_Percent? = nil
  fileprivate var _concurrencyLimitParams: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig.ConcurrencyLimitCalculationParams? = nil
  fileprivate var _minRttCalcParams: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig.MinimumRTTCalculationParams? = nil
}

public struct Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_AdaptiveConcurrency {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var concurrencyControllerConfig: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_AdaptiveConcurrency.OneOf_ConcurrencyControllerConfig? = nil

  /// Gradient concurrency control will be used.
  public var gradientControllerConfig: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig {
    get {
      if case .gradientControllerConfig(let v)? = concurrencyControllerConfig {return v}
      return Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig()
    }
  ...
  public var enabled: Envoy_Api_V2_Core_RuntimeFeatureFlag {
    get {return _enabled ?? Envoy_Api_V2_Core_RuntimeFeatureFlag()}
  ...
  public enum OneOf_ConcurrencyControllerConfig: Equatable {
    /// Gradient concurrency control will be used.
    case gradientControllerConfig(Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_AdaptiveConcurrency.OneOf_ConcurrencyControllerConfig, rhs: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_AdaptiveConcurrency.OneOf_ConcurrencyControllerConfig) -> Bool {
  ...
  fileprivate var _enabled: Envoy_Api_V2_Core_RuntimeFeatureFlag? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.config.filter.http.adaptive_concurrency.v2alpha"

extension Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig, rhs: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig) -> Bool {
...
extension Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig.ConcurrencyLimitCalculationParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig.protoMessageName + ".ConcurrencyLimitCalculationParams"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig.ConcurrencyLimitCalculationParams, rhs: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig.ConcurrencyLimitCalculationParams) -> Bool {
...
extension Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig.MinimumRTTCalculationParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig.protoMessageName + ".MinimumRTTCalculationParams"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig.MinimumRTTCalculationParams, rhs: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig.MinimumRTTCalculationParams) -> Bool {
...
extension Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_AdaptiveConcurrency: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_GradientControllerConfig?
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_AdaptiveConcurrency, rhs: Envoy_Config_Filter_Http_AdaptiveConcurrency_V2alpha_AdaptiveConcurrency) -> Bool {
