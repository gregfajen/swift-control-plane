...
/// RBAC filter config.
public struct Envoy_Config_Filter_Http_Rbac_V2_RBAC {
...
public struct Envoy_Config_Filter_Http_Rbac_V2_RBACPerRoute {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var rbac: Envoy_Config_Filter_Http_Rbac_V2_RBAC {
    get {return _rbac ?? Envoy_Config_Filter_Http_Rbac_V2_RBAC()}
    set {_rbac = newValue}
  }
  ...
  fileprivate var _rbac: Envoy_Config_Filter_Http_Rbac_V2_RBAC? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.config.filter.http.rbac.v2"

extension Envoy_Config_Filter_Http_Rbac_V2_RBAC: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_Rbac_V2_RBAC, rhs: Envoy_Config_Filter_Http_Rbac_V2_RBAC) -> Bool {
...
extension Envoy_Config_Filter_Http_Rbac_V2_RBACPerRoute: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_Rbac_V2_RBACPerRoute, rhs: Envoy_Config_Filter_Http_Rbac_V2_RBACPerRoute) -> Bool {
