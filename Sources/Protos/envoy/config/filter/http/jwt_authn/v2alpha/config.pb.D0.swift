...
///
/// [#next-free-field: 10]
public struct Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtProvider {
  ...
  public var jwksSourceSpecifier: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtProvider.OneOf_JwksSourceSpecifier? = nil
  ...
  ///      cache_duration:
  ///        seconds: 300
  public var remoteJwks: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_RemoteJwks {
    get {
      if case .remoteJwks(let v)? = jwksSourceSpecifier {return v}
      return Envoy_Config_Filter_Http_JwtAuthn_V2alpha_RemoteJwks()
    }
  ...
  public var localJwks: Envoy_Api_V2_Core_DataSource {
    get {
  ...
  public var fromHeaders: [Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtHeader] = []
  ...
  public enum OneOf_JwksSourceSpecifier: Equatable {
    ...
    ///      cache_duration:
    ///        seconds: 300
    case remoteJwks(Envoy_Config_Filter_Http_JwtAuthn_V2alpha_RemoteJwks)
    /// JWKS is in local data source. It could be either in a local file or embedded in the
    /// inline_string.
    ///
    /// Example: local file
    ...
    ///    local_jwks:
    ///      inline_string: ACADADADADA
    case localJwks(Envoy_Api_V2_Core_DataSource)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtProvider.OneOf_JwksSourceSpecifier, rhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtProvider.OneOf_JwksSourceSpecifier) -> Bool {
...
public struct Envoy_Config_Filter_Http_JwtAuthn_V2alpha_RemoteJwks {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtHeader {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Filter_Http_JwtAuthn_V2alpha_ProviderWithAudiences {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///
/// [#next-free-field: 7]
public struct Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirement {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var requiresType: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirement.OneOf_RequiresType? = nil
  ...
  /// Specify a required provider with audiences.
  public var providerAndAudiences: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_ProviderWithAudiences {
    get {
      if case .providerAndAudiences(let v)? = requiresType {return v}
      return Envoy_Config_Filter_Http_JwtAuthn_V2alpha_ProviderWithAudiences()
    }
  ...
  public var requiresAny: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementOrList {
    get {
      if case .requiresAny(let v)? = requiresType {return v}
      return Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementOrList()
    }
  ...
  public var requiresAll: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementAndList {
    get {
      if case .requiresAll(let v)? = requiresType {return v}
      return Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementAndList()
    }
  ...
  public enum OneOf_RequiresType: Equatable {
    ...
    /// Specify a required provider with audiences.
    case providerAndAudiences(Envoy_Config_Filter_Http_JwtAuthn_V2alpha_ProviderWithAudiences)
    /// Specify list of JwtRequirement. Their results are OR-ed.
    /// If any one of them passes, the result is passed.
    case requiresAny(Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementOrList)
    /// Specify list of JwtRequirement. Their results are AND-ed.
    /// All of them must pass, if one of them fails or missing, it fails.
    case requiresAll(Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementAndList)
    /// The requirement is always satisfied even if JWT is missing or the JWT
    /// verification fails. A typical usage is: this filter is used to only verify
    /// JWTs and pass the verified JWT payloads to another filter, the other filter
    /// will make decision. In this mode, all JWT tokens will be verified.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirement.OneOf_RequiresType, rhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirement.OneOf_RequiresType) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementOrList {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Specify a list of JwtRequirement.
  public var requirements: [Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirement] = []
...
public struct Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementAndList {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// from "provider-A".
public struct Envoy_Config_Filter_Http_JwtAuthn_V2alpha_RequirementRule {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var match: Envoy_Api_V2_Route_RouteMatch {
    get {return _match ?? Envoy_Api_V2_Route_RouteMatch()}
    set {_match = newValue}
  }
  ...
  public var requires: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirement {
    get {return _requires ?? Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirement()}
  ...
  fileprivate var _match: Envoy_Api_V2_Route_RouteMatch? = nil
  fileprivate var _requires: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirement? = nil
}
...
public struct Envoy_Config_Filter_Http_JwtAuthn_V2alpha_FilterStateRule {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var requires: Dictionary<String,Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirement> = [:]
...
public struct Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtAuthentication {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  ///        local_jwks:
  ///          inline_string: jwks_string
  public var providers: Dictionary<String,Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtProvider> = [:]
  ...
  ///             - provider_name: provider1
  ///             - provider_name: provider2
  public var rules: [Envoy_Config_Filter_Http_JwtAuthn_V2alpha_RequirementRule] = []

  /// This message specifies Jwt requirements based on stream_info.filterState.
  /// Other HTTP filters can use it to specify Jwt requirements dynamically.
  /// The *rules* field above is checked first, if it could not find any matches,
  /// check this one.
  public var filterStateRules: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_FilterStateRule {
    get {return _filterStateRules ?? Envoy_Config_Filter_Http_JwtAuthn_V2alpha_FilterStateRule()}
  ...
  fileprivate var _filterStateRules: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_FilterStateRule? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.config.filter.http.jwt_authn.v2alpha"

extension Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtProvider: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try {
        var v: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_RemoteJwks?
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtProvider, rhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtProvider) -> Bool {
...
extension Envoy_Config_Filter_Http_JwtAuthn_V2alpha_RemoteJwks: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_RemoteJwks, rhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_RemoteJwks) -> Bool {
...
extension Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtHeader: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtHeader, rhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtHeader) -> Bool {
...
extension Envoy_Config_Filter_Http_JwtAuthn_V2alpha_ProviderWithAudiences: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_ProviderWithAudiences, rhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_ProviderWithAudiences) -> Bool {
...
extension Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirement: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_ProviderWithAudiences?
      ...
      case 3: try {
        var v: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementOrList?
        if let current = self.requiresType {
          try decoder.handleConflictingOneOf()
      ...
      case 4: try {
        var v: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementAndList?
        if let current = self.requiresType {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirement, rhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirement) -> Bool {
...
extension Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementOrList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementOrList, rhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementOrList) -> Bool {
...
extension Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementAndList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementAndList, rhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirementAndList) -> Bool {
    if lhs.requirements != rhs.requirements {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Envoy_Config_Filter_Http_JwtAuthn_V2alpha_RequirementRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._requires) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_RequirementRule, rhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_RequirementRule) -> Bool {
...
extension Envoy_Config_Filter_Http_JwtAuthn_V2alpha_FilterStateRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.name) }()
      case 3: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirement>.self, value: &self.requires) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.requires.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtRequirement>.self, value: self.requires, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_FilterStateRule, rhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_FilterStateRule) -> Bool {
    if lhs.name != rhs.name {return false}
...
extension Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtAuthentication: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtProvider>.self, value: &self.providers) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.providers.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtProvider>.self, value: self.providers, fieldNumber: 1)
    }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtAuthentication, rhs: Envoy_Config_Filter_Http_JwtAuthn_V2alpha_JwtAuthentication) -> Bool {
