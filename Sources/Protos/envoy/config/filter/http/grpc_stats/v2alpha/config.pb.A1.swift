...
public struct Envoy_Config_Filter_Http_GrpcStats_V2alpha_FilterConfig {
  ...
  public var perMethodStatSpecifier: Envoy_Config_Filter_Http_GrpcStats_V2alpha_FilterConfig.OneOf_PerMethodStatSpecifier? = nil
  ...
  public var individualMethodStatsAllowlist: Envoy_Api_V2_Core_GrpcMethodList {
    get {
      if case .individualMethodStatsAllowlist(let v)? = perMethodStatSpecifier {return v}
      return Envoy_Api_V2_Core_GrpcMethodList()
    }
  ...
  public enum OneOf_PerMethodStatSpecifier: Equatable {
    ...
    /// emitted for them. Any call that does not match the allowlist will be counted
    /// in a stat with no method specifier: `cluster.<name>.grpc.*`.
    case individualMethodStatsAllowlist(Envoy_Api_V2_Core_GrpcMethodList)
    /// If set to true, emit stats for all service/method names.
    ///
    /// If set to false, emit stats for all service/message types to the same stats without including
    /// the service/method in the name, with prefix `cluster.<name>.grpc`. This can be useful if
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Http_GrpcStats_V2alpha_FilterConfig.OneOf_PerMethodStatSpecifier, rhs: Envoy_Config_Filter_Http_GrpcStats_V2alpha_FilterConfig.OneOf_PerMethodStatSpecifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.individualMethodStatsAllowlist, .individualMethodStatsAllowlist): return {
        guard case .individualMethodStatsAllowlist(let l) = lhs, case .individualMethodStatsAllowlist(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.statsForAllMethods, .statsForAllMethods): return {
        guard case .statsForAllMethods(let l) = lhs, case .statsForAllMethods(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
public struct Envoy_Config_Filter_Http_GrpcStats_V2alpha_FilterObject {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "envoy.config.filter.http.grpc_stats.v2alpha"

extension Envoy_Config_Filter_Http_GrpcStats_V2alpha_FilterConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.emitFilterState) }()
      case 2: try {
        var v: Envoy_Api_V2_Core_GrpcMethodList?
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .individualMethodStatsAllowlist?: try {
      guard case .individualMethodStatsAllowlist(let v)? = self.perMethodStatSpecifier else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }()
    case .statsForAllMethods?: try {
      guard case .statsForAllMethods(let v)? = self.perMethodStatSpecifier else { preconditionFailure() }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_GrpcStats_V2alpha_FilterConfig, rhs: Envoy_Config_Filter_Http_GrpcStats_V2alpha_FilterConfig) -> Bool {
...
extension Envoy_Config_Filter_Http_GrpcStats_V2alpha_FilterObject: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt64Field(value: &self.requestMessageCount) }()
      case 2: try { try decoder.decodeSingularUInt64Field(value: &self.responseMessageCount) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_GrpcStats_V2alpha_FilterObject, rhs: Envoy_Config_Filter_Http_GrpcStats_V2alpha_FilterObject) -> Bool {
