...
/// CSRF filter config.
public struct Envoy_Config_Filter_Http_Csrf_V2_CsrfPolicy {
  ...
  public var filterEnabled: Envoy_Api_V2_Core_RuntimeFractionalPercent {
    get {return _filterEnabled ?? Envoy_Api_V2_Core_RuntimeFractionalPercent()}
  ...
  public var additionalOrigins: [Envoy_Type_Matcher_StringMatcher] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _filterEnabled: Envoy_Api_V2_Core_RuntimeFractionalPercent? = nil
  fileprivate var _shadowEnabled: Envoy_Api_V2_Core_RuntimeFractionalPercent? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.config.filter.http.csrf.v2"

extension Envoy_Config_Filter_Http_Csrf_V2_CsrfPolicy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._filterEnabled) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._shadowEnabled) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.additionalOrigins) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_Csrf_V2_CsrfPolicy, rhs: Envoy_Config_Filter_Http_Csrf_V2_CsrfPolicy) -> Bool {
