...
/// [#next-free-field: 12]
public struct Envoy_Config_Filter_Http_ExtAuthz_V2_ExtAuthz {
  ...
  public var grpcService: Envoy_Api_V2_Core_GrpcService {
    get {
      ...
      return Envoy_Api_V2_Core_GrpcService()
    }
    set {_uniqueStorage()._services = .grpcService(newValue)}
  }

  /// HTTP service configuration (default timeout: 200ms).
  public var httpService: Envoy_Config_Filter_Http_ExtAuthz_V2_HttpService {
    get {
      if case .httpService(let v)? = _storage._services {return v}
      return Envoy_Config_Filter_Http_ExtAuthz_V2_HttpService()
    }
  ...
  public var useAlpha: Bool {
    get {return _storage._useAlpha}
    set {_uniqueStorage()._useAlpha = newValue}
  }

  /// Enables filter to buffer the client request body and send it within the authorization request.
  /// A ``x-envoy-auth-partial-body: false|true`` metadata header will be added to the authorization
  /// request message indicating if the body data is partial.
  public var withRequestBody: Envoy_Config_Filter_Http_ExtAuthz_V2_BufferSettings {
    get {return _storage._withRequestBody ?? Envoy_Config_Filter_Http_ExtAuthz_V2_BufferSettings()}
  ...
  public var statusOnError: Envoy_Type_HttpStatus {
    get {return _storage._statusOnError ?? Envoy_Type_HttpStatus()}
  ...
  public var filterEnabled: Envoy_Api_V2_Core_RuntimeFractionalPercent {
    get {return _storage._filterEnabled ?? Envoy_Api_V2_Core_RuntimeFractionalPercent()}
  ...
  public var denyAtDisable: Envoy_Api_V2_Core_RuntimeFeatureFlag {
    get {return _storage._denyAtDisable ?? Envoy_Api_V2_Core_RuntimeFeatureFlag()}
  ...
  public enum OneOf_Services: Equatable {
    /// gRPC service configuration (default timeout: 200ms).
    case grpcService(Envoy_Api_V2_Core_GrpcService)
    /// HTTP service configuration (default timeout: 200ms).
    case httpService(Envoy_Config_Filter_Http_ExtAuthz_V2_HttpService)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Http_ExtAuthz_V2_ExtAuthz.OneOf_Services, rhs: Envoy_Config_Filter_Http_ExtAuthz_V2_ExtAuthz.OneOf_Services) -> Bool {
...
public struct Envoy_Config_Filter_Http_ExtAuthz_V2_BufferSettings {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// for details.
/// [#next-free-field: 9]
public struct Envoy_Config_Filter_Http_ExtAuthz_V2_HttpService {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Sets the HTTP server URI which the authorization requests must be sent to.
  public var serverUri: Envoy_Api_V2_Core_HttpUri {
    get {return _serverUri ?? Envoy_Api_V2_Core_HttpUri()}
  ...
  public var authorizationRequest: Envoy_Config_Filter_Http_ExtAuthz_V2_AuthorizationRequest {
    get {return _authorizationRequest ?? Envoy_Config_Filter_Http_ExtAuthz_V2_AuthorizationRequest()}
  ...
  public var authorizationResponse: Envoy_Config_Filter_Http_ExtAuthz_V2_AuthorizationResponse {
    get {return _authorizationResponse ?? Envoy_Config_Filter_Http_ExtAuthz_V2_AuthorizationResponse()}
  ...
  fileprivate var _serverUri: Envoy_Api_V2_Core_HttpUri? = nil
  fileprivate var _authorizationRequest: Envoy_Config_Filter_Http_ExtAuthz_V2_AuthorizationRequest? = nil
  fileprivate var _authorizationResponse: Envoy_Config_Filter_Http_ExtAuthz_V2_AuthorizationResponse? = nil
}

public struct Envoy_Config_Filter_Http_ExtAuthz_V2_AuthorizationRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// its payload size.
  public var allowedHeaders: Envoy_Type_Matcher_ListStringMatcher {
    get {return _allowedHeaders ?? Envoy_Type_Matcher_ListStringMatcher()}
  ...
  public var headersToAdd: [Envoy_Api_V2_Core_HeaderValue] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _allowedHeaders: Envoy_Type_Matcher_ListStringMatcher? = nil
}

public struct Envoy_Config_Filter_Http_ExtAuthz_V2_AuthorizationResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var allowedUpstreamHeaders: Envoy_Type_Matcher_ListStringMatcher {
    get {return _allowedUpstreamHeaders ?? Envoy_Type_Matcher_ListStringMatcher()}
  ...
  public var allowedClientHeaders: Envoy_Type_Matcher_ListStringMatcher {
    get {return _allowedClientHeaders ?? Envoy_Type_Matcher_ListStringMatcher()}
  ...
  fileprivate var _allowedUpstreamHeaders: Envoy_Type_Matcher_ListStringMatcher? = nil
  fileprivate var _allowedClientHeaders: Envoy_Type_Matcher_ListStringMatcher? = nil
}

/// Extra settings on a per virtualhost/route/weighted-cluster level.
public struct Envoy_Config_Filter_Http_ExtAuthz_V2_ExtAuthzPerRoute {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var override: Envoy_Config_Filter_Http_ExtAuthz_V2_ExtAuthzPerRoute.OneOf_Override? = nil
  ...
  public var checkSettings: Envoy_Config_Filter_Http_ExtAuthz_V2_CheckSettings {
    get {
      if case .checkSettings(let v)? = override {return v}
      return Envoy_Config_Filter_Http_ExtAuthz_V2_CheckSettings()
    }
  ...
  public enum OneOf_Override: Equatable {
    ...
    case disabled(Bool)
    /// Check request settings for this route.
    case checkSettings(Envoy_Config_Filter_Http_ExtAuthz_V2_CheckSettings)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Http_ExtAuthz_V2_ExtAuthzPerRoute.OneOf_Override, rhs: Envoy_Config_Filter_Http_ExtAuthz_V2_ExtAuthzPerRoute.OneOf_Override) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Envoy_Config_Filter_Http_ExtAuthz_V2_CheckSettings {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "envoy.config.filter.http.ext_authz.v2"

extension Envoy_Config_Filter_Http_ExtAuthz_V2_ExtAuthz: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _services: Envoy_Config_Filter_Http_ExtAuthz_V2_ExtAuthz.OneOf_Services?
    var _failureModeAllow: Bool = false
    var _useAlpha: Bool = false
    var _withRequestBody: Envoy_Config_Filter_Http_ExtAuthz_V2_BufferSettings? = nil
    var _clearRouteCache_p: Bool = false
    var _statusOnError: Envoy_Type_HttpStatus? = nil
    var _metadataContextNamespaces: [String] = []
    var _filterEnabled: Envoy_Api_V2_Core_RuntimeFractionalPercent? = nil
    var _denyAtDisable: Envoy_Api_V2_Core_RuntimeFeatureFlag? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        switch fieldNumber {
        case 1: try {
          var v: Envoy_Api_V2_Core_GrpcService?
        ...
        case 3: try {
          var v: Envoy_Config_Filter_Http_ExtAuthz_V2_HttpService?
          if let current = _storage._services {
            try decoder.handleConflictingOneOf()
        ...
        case 4: try { try decoder.decodeSingularBoolField(value: &_storage._useAlpha) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._useAlpha != false {
        try visitor.visitSingularBoolField(value: _storage._useAlpha, fieldNumber: 4)
      }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_ExtAuthz_V2_ExtAuthz, rhs: Envoy_Config_Filter_Http_ExtAuthz_V2_ExtAuthz) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._useAlpha != rhs_storage._useAlpha {return false}
...
extension Envoy_Config_Filter_Http_ExtAuthz_V2_BufferSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_ExtAuthz_V2_BufferSettings, rhs: Envoy_Config_Filter_Http_ExtAuthz_V2_BufferSettings) -> Bool {
...
extension Envoy_Config_Filter_Http_ExtAuthz_V2_HttpService: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_ExtAuthz_V2_HttpService, rhs: Envoy_Config_Filter_Http_ExtAuthz_V2_HttpService) -> Bool {
...
extension Envoy_Config_Filter_Http_ExtAuthz_V2_AuthorizationRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_ExtAuthz_V2_AuthorizationRequest, rhs: Envoy_Config_Filter_Http_ExtAuthz_V2_AuthorizationRequest) -> Bool {
...
extension Envoy_Config_Filter_Http_ExtAuthz_V2_AuthorizationResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_ExtAuthz_V2_AuthorizationResponse, rhs: Envoy_Config_Filter_Http_ExtAuthz_V2_AuthorizationResponse) -> Bool {
...
extension Envoy_Config_Filter_Http_ExtAuthz_V2_ExtAuthzPerRoute: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Envoy_Config_Filter_Http_ExtAuthz_V2_CheckSettings?
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_ExtAuthz_V2_ExtAuthzPerRoute, rhs: Envoy_Config_Filter_Http_ExtAuthz_V2_ExtAuthzPerRoute) -> Bool {
...
extension Envoy_Config_Filter_Http_ExtAuthz_V2_CheckSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_ExtAuthz_V2_CheckSettings, rhs: Envoy_Config_Filter_Http_ExtAuthz_V2_CheckSettings) -> Bool {
