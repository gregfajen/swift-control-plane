...
public struct Envoy_Config_Filter_Http_Tap_V2alpha_Tap {
...
fileprivate let _protobuf_package = "envoy.config.filter.http.tap.v2alpha"

extension Envoy_Config_Filter_Http_Tap_V2alpha_Tap: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_Tap_V2alpha_Tap, rhs: Envoy_Config_Filter_Http_Tap_V2alpha_Tap) -> Bool {
