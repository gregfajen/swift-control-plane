...
public struct Envoy_Config_Filter_Http_AwsRequestSigning_V2alpha_AwsRequestSigning {
...
fileprivate let _protobuf_package = "envoy.config.filter.http.aws_request_signing.v2alpha"

extension Envoy_Config_Filter_Http_AwsRequestSigning_V2alpha_AwsRequestSigning: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.hostRewrite) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_AwsRequestSigning_V2alpha_AwsRequestSigning, rhs: Envoy_Config_Filter_Http_AwsRequestSigning_V2alpha_AwsRequestSigning) -> Bool {
