...
public struct Envoy_Config_Filter_Http_Buffer_V2_Buffer {
...
public struct Envoy_Config_Filter_Http_Buffer_V2_BufferPerRoute {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var override: Envoy_Config_Filter_Http_Buffer_V2_BufferPerRoute.OneOf_Override? = nil
  ...
  public var buffer: Envoy_Config_Filter_Http_Buffer_V2_Buffer {
    get {
      if case .buffer(let v)? = override {return v}
      return Envoy_Config_Filter_Http_Buffer_V2_Buffer()
    }
  ...
  public enum OneOf_Override: Equatable {
    ...
    case disabled(Bool)
    /// Override the global configuration of the filter with this new config.
    case buffer(Envoy_Config_Filter_Http_Buffer_V2_Buffer)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Filter_Http_Buffer_V2_BufferPerRoute.OneOf_Override, rhs: Envoy_Config_Filter_Http_Buffer_V2_BufferPerRoute.OneOf_Override) -> Bool {
...
fileprivate let _protobuf_package = "envoy.config.filter.http.buffer.v2"

extension Envoy_Config_Filter_Http_Buffer_V2_Buffer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_Buffer_V2_Buffer, rhs: Envoy_Config_Filter_Http_Buffer_V2_Buffer) -> Bool {
...
extension Envoy_Config_Filter_Http_Buffer_V2_BufferPerRoute: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Envoy_Config_Filter_Http_Buffer_V2_Buffer?
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_Buffer_V2_BufferPerRoute, rhs: Envoy_Config_Filter_Http_Buffer_V2_BufferPerRoute) -> Bool {
