...
/// [#next-free-field: 6]
public struct Envoy_Config_Filter_Http_HealthCheck_V2_HealthCheck {
  ...
  ///    as if it were 12%.
  public var clusterMinHealthyPercentages: Dictionary<String,Envoy_Type_Percent> = [:]
...
fileprivate let _protobuf_package = "envoy.config.filter.http.health_check.v2"

extension Envoy_Config_Filter_Http_HealthCheck_V2_HealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._passThroughMode) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._cacheTime) }()
      case 4: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Type_Percent>.self, value: &self.clusterMinHealthyPercentages) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.clusterMinHealthyPercentages.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Type_Percent>.self, value: self.clusterMinHealthyPercentages, fieldNumber: 4)
    }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_HealthCheck_V2_HealthCheck, rhs: Envoy_Config_Filter_Http_HealthCheck_V2_HealthCheck) -> Bool {
