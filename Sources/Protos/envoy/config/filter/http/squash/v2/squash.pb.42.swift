...
/// [#next-free-field: 6]
public struct Envoy_Config_Filter_Http_Squash_V2_Squash {
...
fileprivate let _protobuf_package = "envoy.config.filter.http.squash.v2"

extension Envoy_Config_Filter_Http_Squash_V2_Squash: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._attachmentTemplate) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._requestTimeout) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._attachmentTimeout) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._attachmentPollPeriod) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Http_Squash_V2_Squash, rhs: Envoy_Config_Filter_Http_Squash_V2_Squash) -> Bool {
