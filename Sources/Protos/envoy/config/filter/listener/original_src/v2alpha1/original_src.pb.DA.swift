...
public struct Envoy_Config_Filter_Listener_OriginalSrc_V2alpha1_OriginalSrc {
...
fileprivate let _protobuf_package = "envoy.config.filter.listener.original_src.v2alpha1"

extension Envoy_Config_Filter_Listener_OriginalSrc_V2alpha1_OriginalSrc: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.bindPort) }()
      case 2: try { try decoder.decodeSingularUInt32Field(value: &self.mark) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Filter_Listener_OriginalSrc_V2alpha1_OriginalSrc, rhs: Envoy_Config_Filter_Listener_OriginalSrc_V2alpha1_OriginalSrc) -> Bool {
