...
public struct Envoy_Config_Core_V4alpha_Pipe {
...
/// [#next-free-field: 7]
public struct Envoy_Config_Core_V4alpha_SocketAddress {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var `protocol`: Envoy_Config_Core_V4alpha_SocketAddress.ProtocolEnum = .tcp
  ...
  public var portSpecifier: Envoy_Config_Core_V4alpha_SocketAddress.OneOf_PortSpecifier? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Core_V4alpha_SocketAddress.OneOf_PortSpecifier, rhs: Envoy_Config_Core_V4alpha_SocketAddress.OneOf_PortSpecifier) -> Bool {
      switch (lhs, rhs) {
      case (.portValue(let l), .portValue(let r)): return l == r
      case (.namedPort(let l), .namedPort(let r)): return l == r
...
extension Envoy_Config_Core_V4alpha_SocketAddress.ProtocolEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Core_V4alpha_SocketAddress.ProtocolEnum] = [
    .tcp,
    .udp,
  ]
}
...
public struct Envoy_Config_Core_V4alpha_TcpKeepalive {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Core_V4alpha_BindConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The address to bind to when creating a socket.
  public var sourceAddress: Envoy_Config_Core_V4alpha_SocketAddress {
    get {return _sourceAddress ?? Envoy_Config_Core_V4alpha_SocketAddress()}
  ...
  fileprivate var _sourceAddress: Envoy_Config_Core_V4alpha_SocketAddress? = nil
...
/// management servers.
public struct Envoy_Config_Core_V4alpha_Address {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var address: Envoy_Config_Core_V4alpha_Address.OneOf_Address? = nil

  public var socketAddress: Envoy_Config_Core_V4alpha_SocketAddress {
    get {
      if case .socketAddress(let v)? = address {return v}
      return Envoy_Config_Core_V4alpha_SocketAddress()
    }
    set {address = .socketAddress(newValue)}
  }

  public var pipe: Envoy_Config_Core_V4alpha_Pipe {
    get {
      if case .pipe(let v)? = address {return v}
      return Envoy_Config_Core_V4alpha_Pipe()
    }
  ...
  public enum OneOf_Address: Equatable {
    case socketAddress(Envoy_Config_Core_V4alpha_SocketAddress)
    case pipe(Envoy_Config_Core_V4alpha_Pipe)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Core_V4alpha_Address.OneOf_Address, rhs: Envoy_Config_Core_V4alpha_Address.OneOf_Address) -> Bool {
      switch (lhs, rhs) {
      case (.socketAddress(let l), .socketAddress(let r)): return l == r
      case (.pipe(let l), .pipe(let r)): return l == r
      default: return false
      }
    }
  #endif
...
public struct Envoy_Config_Core_V4alpha_CidrRange {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Envoy_Config_Core_V4alpha_Pipe: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularUInt32Field(value: &self.mode)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_Pipe, rhs: Envoy_Config_Core_V4alpha_Pipe) -> Bool {
...
extension Envoy_Config_Core_V4alpha_SocketAddress: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try decoder.decodeSingularStringField(value: &self.resolverName)
      case 6: try decoder.decodeSingularBoolField(value: &self.ipv4Compat)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .portValue(let v)?:
      try visitor.visitSingularUInt32Field(value: v, fieldNumber: 3)
    case .namedPort(let v)?:
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_SocketAddress, rhs: Envoy_Config_Core_V4alpha_SocketAddress) -> Bool {
...
extension Envoy_Config_Core_V4alpha_SocketAddress.ProtocolEnum: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "TCP"),
    1: .same(proto: "UDP"),
  ]
...
extension Envoy_Config_Core_V4alpha_TcpKeepalive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._keepaliveProbes)
      case 2: try decoder.decodeSingularMessageField(value: &self._keepaliveTime)
      case 3: try decoder.decodeSingularMessageField(value: &self._keepaliveInterval)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_TcpKeepalive, rhs: Envoy_Config_Core_V4alpha_TcpKeepalive) -> Bool {
...
extension Envoy_Config_Core_V4alpha_BindConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularMessageField(value: &self._freebind)
      case 3: try decoder.decodeRepeatedMessageField(value: &self.socketOptions)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_BindConfig, rhs: Envoy_Config_Core_V4alpha_BindConfig) -> Bool {
...
extension Envoy_Config_Core_V4alpha_Address: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1:
        var v: Envoy_Config_Core_V4alpha_SocketAddress?
      ...
      case 2:
        var v: Envoy_Config_Core_V4alpha_Pipe?
        if let current = self.address {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_Address, rhs: Envoy_Config_Core_V4alpha_Address) -> Bool {
    if lhs.address != rhs.address {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Envoy_Config_Core_V4alpha_CidrRange: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.addressPrefix)
      case 2: try decoder.decodeSingularMessageField(value: &self._prefixLen)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_CidrRange, rhs: Envoy_Config_Core_V4alpha_CidrRange) -> Bool {
