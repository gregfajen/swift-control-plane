...
public struct Envoy_Config_Core_V4alpha_KeepaliveSettings {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Core_V4alpha_Http2ProtocolOptions {
  ...
  public var connectionKeepalive: Envoy_Config_Core_V4alpha_KeepaliveSettings {
    get {return _storage._connectionKeepalive ?? Envoy_Config_Core_V4alpha_KeepaliveSettings()}
...
extension Envoy_Config_Core_V4alpha_KeepaliveSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_KeepaliveSettings, rhs: Envoy_Config_Core_V4alpha_KeepaliveSettings) -> Bool {
...
extension Envoy_Config_Core_V4alpha_Http2ProtocolOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _customSettingsParameters: [Envoy_Config_Core_V4alpha_Http2ProtocolOptions.SettingsParameter] = []
    var _connectionKeepalive: Envoy_Config_Core_V4alpha_KeepaliveSettings? = nil
