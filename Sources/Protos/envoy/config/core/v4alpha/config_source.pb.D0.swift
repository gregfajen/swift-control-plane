...
public enum Envoy_Config_Core_V4alpha_ApiVersion: SwiftProtobuf.Enum {
...
extension Envoy_Config_Core_V4alpha_ApiVersion: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Core_V4alpha_ApiVersion] = [
    .auto,
    .v2,
    .v3,
  ]
...
/// [#next-free-field: 9]
public struct Envoy_Config_Core_V4alpha_ApiConfigSource {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// API type (gRPC, REST, delta gRPC)
  public var apiType: Envoy_Config_Core_V4alpha_ApiConfigSource.ApiType = .deprecatedAndUnavailableDoNotUse

  /// API version for xDS transport protocol. This describes the xDS gRPC/REST
  /// endpoint and version of [Delta]DiscoveryRequest/Response used on the wire.
  public var transportApiVersion: Envoy_Config_Core_V4alpha_ApiVersion = .auto
  ...
  public var grpcServices: [Envoy_Config_Core_V4alpha_GrpcService] = []
  ...
  /// rate limited.
  public var rateLimitSettings: Envoy_Config_Core_V4alpha_RateLimitSettings {
    get {return _rateLimitSettings ?? Envoy_Config_Core_V4alpha_RateLimitSettings()}
  ...
  fileprivate var _rateLimitSettings: Envoy_Config_Core_V4alpha_RateLimitSettings? = nil
}

#if swift(>=4.2)

extension Envoy_Config_Core_V4alpha_ApiConfigSource.ApiType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Core_V4alpha_ApiConfigSource.ApiType] = [
...
public struct Envoy_Config_Core_V4alpha_AggregatedConfigSource {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Core_V4alpha_SelfConfigSource {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Core_V4alpha_RateLimitSettings {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// inotify for updates.
/// [#next-free-field: 7]
public struct Envoy_Config_Core_V4alpha_ConfigSource {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var configSourceSpecifier: Envoy_Config_Core_V4alpha_ConfigSource.OneOf_ConfigSourceSpecifier? = nil
  ...
  public var apiConfigSource: Envoy_Config_Core_V4alpha_ApiConfigSource {
    get {
      if case .apiConfigSource(let v)? = configSourceSpecifier {return v}
      return Envoy_Config_Core_V4alpha_ApiConfigSource()
    }
  ...
  public var ads: Envoy_Config_Core_V4alpha_AggregatedConfigSource {
    get {
      if case .ads(let v)? = configSourceSpecifier {return v}
      return Envoy_Config_Core_V4alpha_AggregatedConfigSource()
    }
  ...
  public var self_p: Envoy_Config_Core_V4alpha_SelfConfigSource {
    get {
      if case .self_p(let v)? = configSourceSpecifier {return v}
      return Envoy_Config_Core_V4alpha_SelfConfigSource()
    }
  ...
  public var resourceApiVersion: Envoy_Config_Core_V4alpha_ApiVersion = .auto
  ...
  public enum OneOf_ConfigSourceSpecifier: Equatable {
    ...
    case path(String)
    /// API configuration source.
    case apiConfigSource(Envoy_Config_Core_V4alpha_ApiConfigSource)
    /// When set, ADS will be used to fetch resources. The ADS API configuration
    /// source in the bootstrap configuration is used.
    case ads(Envoy_Config_Core_V4alpha_AggregatedConfigSource)
    /// [#not-implemented-hide:]
    /// When set, the client will access the resources from the same server it got the
    /// ConfigSource from, although not necessarily from the same stream. This is similar to the
    /// :ref:`ads<envoy_api_field.ConfigSource.ads>` field, except that the client may use a
    ...
    /// this field can implicitly mean to use the same stream in the case where the ConfigSource
    /// is provided via ADS and the specified data can also be obtained via ADS.]
    case self_p(Envoy_Config_Core_V4alpha_SelfConfigSource)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Core_V4alpha_ConfigSource.OneOf_ConfigSourceSpecifier, rhs: Envoy_Config_Core_V4alpha_ConfigSource.OneOf_ConfigSourceSpecifier) -> Bool {
      switch (lhs, rhs) {
      case (.path(let l), .path(let r)): return l == r
      case (.apiConfigSource(let l), .apiConfigSource(let r)): return l == r
      case (.ads(let l), .ads(let r)): return l == r
...
extension Envoy_Config_Core_V4alpha_ApiVersion: SwiftProtobuf._ProtoNameProviding {
...
extension Envoy_Config_Core_V4alpha_ApiConfigSource: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularEnumField(value: &self.apiType)
      case 2: try decoder.decodeRepeatedStringField(value: &self.clusterNames)
      case 3: try decoder.decodeSingularMessageField(value: &self._refreshDelay)
      case 4: try decoder.decodeRepeatedMessageField(value: &self.grpcServices)
      case 5: try decoder.decodeSingularMessageField(value: &self._requestTimeout)
      case 6: try decoder.decodeSingularMessageField(value: &self._rateLimitSettings)
      case 7: try decoder.decodeSingularBoolField(value: &self.setNodeOnFirstMessageOnly)
      case 8: try decoder.decodeSingularEnumField(value: &self.transportApiVersion)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_ApiConfigSource, rhs: Envoy_Config_Core_V4alpha_ApiConfigSource) -> Bool {
...
extension Envoy_Config_Core_V4alpha_ApiConfigSource.ApiType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Config_Core_V4alpha_AggregatedConfigSource: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_AggregatedConfigSource, rhs: Envoy_Config_Core_V4alpha_AggregatedConfigSource) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Core_V4alpha_SelfConfigSource: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_SelfConfigSource, rhs: Envoy_Config_Core_V4alpha_SelfConfigSource) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Core_V4alpha_RateLimitSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._maxTokens)
      case 2: try decoder.decodeSingularMessageField(value: &self._fillRate)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_RateLimitSettings, rhs: Envoy_Config_Core_V4alpha_RateLimitSettings) -> Bool {
...
extension Envoy_Config_Core_V4alpha_ConfigSource: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2:
        var v: Envoy_Config_Core_V4alpha_ApiConfigSource?
      ...
      case 3:
        var v: Envoy_Config_Core_V4alpha_AggregatedConfigSource?
        if let current = self.configSourceSpecifier {
          try decoder.handleConflictingOneOf()
      ...
      case 4: try decoder.decodeSingularMessageField(value: &self._initialFetchTimeout)
      case 5:
        var v: Envoy_Config_Core_V4alpha_SelfConfigSource?
        if let current = self.configSourceSpecifier {
          try decoder.handleConflictingOneOf()
      ...
      case 6: try decoder.decodeSingularEnumField(value: &self.resourceApiVersion)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_ConfigSource, rhs: Envoy_Config_Core_V4alpha_ConfigSource) -> Bool {
