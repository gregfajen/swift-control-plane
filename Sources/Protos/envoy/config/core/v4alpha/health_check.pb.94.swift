...
public struct Envoy_Config_Core_V4alpha_HealthCheck {
  ...
  public var noTrafficHealthyInterval: SwiftProtobuf.Google_Protobuf_Duration {
    get {return _storage._noTrafficHealthyInterval ?? SwiftProtobuf.Google_Protobuf_Duration()}
    set {_uniqueStorage()._noTrafficHealthyInterval = newValue}
  }
  /// Returns true if `noTrafficHealthyInterval` has been explicitly set.
  public var hasNoTrafficHealthyInterval: Bool {return _storage._noTrafficHealthyInterval != nil}
  /// Clears the value of `noTrafficHealthyInterval`. Subsequent reads from it will return its default value.
  public mutating func clearNoTrafficHealthyInterval() {_uniqueStorage()._noTrafficHealthyInterval = nil}
...
extension Envoy_Config_Core_V4alpha_HealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    24: .standard(proto: "no_traffic_healthy_interval"),
  ...
  fileprivate class _StorageClass {
    ...
    var _noTrafficHealthyInterval: SwiftProtobuf.Google_Protobuf_Duration? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _noTrafficHealthyInterval = source._noTrafficHealthyInterval
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 23: try { try decoder.decodeSingularMessageField(value: &_storage._transportSocketMatchCriteria) }()
        case 24: try { try decoder.decodeSingularMessageField(value: &_storage._noTrafficHealthyInterval) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._noTrafficHealthyInterval {
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_HealthCheck, rhs: Envoy_Config_Core_V4alpha_HealthCheck) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._noTrafficHealthyInterval != rhs_storage._noTrafficHealthyInterval {return false}
