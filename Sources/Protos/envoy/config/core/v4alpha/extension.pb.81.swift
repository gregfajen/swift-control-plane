...
public struct Envoy_Config_Core_V4alpha_ExtensionConfigSource {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Envoy_Config_Core_V4alpha_ExtensionConfigSource: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_ExtensionConfigSource, rhs: Envoy_Config_Core_V4alpha_ExtensionConfigSource) -> Bool {
