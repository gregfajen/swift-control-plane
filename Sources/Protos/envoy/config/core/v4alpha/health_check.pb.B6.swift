...
public enum Envoy_Config_Core_V4alpha_HealthStatus: SwiftProtobuf.Enum {
...
extension Envoy_Config_Core_V4alpha_HealthStatus: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Core_V4alpha_HealthStatus] = [
    .unknown,
    .healthy,
    .unhealthy,
    .draining,
...
/// [#next-free-field: 24]
public struct Envoy_Config_Core_V4alpha_HealthCheck {
  ...
  /// HTTP health check.
  public var httpHealthCheck: Envoy_Config_Core_V4alpha_HealthCheck.HttpHealthCheck {
    get {
      if case .httpHealthCheck(let v)? = _storage._healthChecker {return v}
      return Envoy_Config_Core_V4alpha_HealthCheck.HttpHealthCheck()
    }
    set {_uniqueStorage()._healthChecker = .httpHealthCheck(newValue)}
  }

  /// TCP health check.
  public var tcpHealthCheck: Envoy_Config_Core_V4alpha_HealthCheck.TcpHealthCheck {
    get {
      if case .tcpHealthCheck(let v)? = _storage._healthChecker {return v}
      return Envoy_Config_Core_V4alpha_HealthCheck.TcpHealthCheck()
    }
    set {_uniqueStorage()._healthChecker = .tcpHealthCheck(newValue)}
  }

  /// gRPC health check.
  public var grpcHealthCheck: Envoy_Config_Core_V4alpha_HealthCheck.GrpcHealthCheck {
    get {
      if case .grpcHealthCheck(let v)? = _storage._healthChecker {return v}
      return Envoy_Config_Core_V4alpha_HealthCheck.GrpcHealthCheck()
    }
    set {_uniqueStorage()._healthChecker = .grpcHealthCheck(newValue)}
  }

  /// Custom health check.
  public var customHealthCheck: Envoy_Config_Core_V4alpha_HealthCheck.CustomHealthCheck {
    get {
      if case .customHealthCheck(let v)? = _storage._healthChecker {return v}
      return Envoy_Config_Core_V4alpha_HealthCheck.CustomHealthCheck()
    }
  ...
  public var eventService: Envoy_Config_Core_V4alpha_EventServiceConfig {
    get {return _storage._eventService ?? Envoy_Config_Core_V4alpha_EventServiceConfig()}
  ...
  public var tlsOptions: Envoy_Config_Core_V4alpha_HealthCheck.TlsOptions {
    get {return _storage._tlsOptions ?? Envoy_Config_Core_V4alpha_HealthCheck.TlsOptions()}
  ...
  public var transportSocketMatchCriteria: SwiftProtobuf.Google_Protobuf_Struct {
    get {return _storage._transportSocketMatchCriteria ?? SwiftProtobuf.Google_Protobuf_Struct()}
    set {_uniqueStorage()._transportSocketMatchCriteria = newValue}
  }
  /// Returns true if `transportSocketMatchCriteria` has been explicitly set.
  public var hasTransportSocketMatchCriteria: Bool {return _storage._transportSocketMatchCriteria != nil}
  /// Clears the value of `transportSocketMatchCriteria`. Subsequent reads from it will return its default value.
  public mutating func clearTransportSocketMatchCriteria() {_uniqueStorage()._transportSocketMatchCriteria = nil}

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public enum OneOf_HealthChecker: Equatable {
    /// HTTP health check.
    case httpHealthCheck(Envoy_Config_Core_V4alpha_HealthCheck.HttpHealthCheck)
    /// TCP health check.
    case tcpHealthCheck(Envoy_Config_Core_V4alpha_HealthCheck.TcpHealthCheck)
    /// gRPC health check.
    case grpcHealthCheck(Envoy_Config_Core_V4alpha_HealthCheck.GrpcHealthCheck)
    /// Custom health check.
    case customHealthCheck(Envoy_Config_Core_V4alpha_HealthCheck.CustomHealthCheck)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Core_V4alpha_HealthCheck.OneOf_HealthChecker, rhs: Envoy_Config_Core_V4alpha_HealthCheck.OneOf_HealthChecker) -> Bool {
      switch (lhs, rhs) {
      case (.httpHealthCheck(let l), .httpHealthCheck(let r)): return l == r
      case (.tcpHealthCheck(let l), .tcpHealthCheck(let r)): return l == r
      case (.grpcHealthCheck(let l), .grpcHealthCheck(let r)): return l == r
      case (.customHealthCheck(let l), .customHealthCheck(let r)): return l == r
  ...
  public struct Payload {
    ...
    public var payload: Envoy_Config_Core_V4alpha_HealthCheck.Payload.OneOf_Payload? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Config_Core_V4alpha_HealthCheck.Payload.OneOf_Payload, rhs: Envoy_Config_Core_V4alpha_HealthCheck.Payload.OneOf_Payload) -> Bool {
        switch (lhs, rhs) {
  ...
  public struct HttpHealthCheck {
    ...
    public var send: Envoy_Config_Core_V4alpha_HealthCheck.Payload {
      get {return _send ?? Envoy_Config_Core_V4alpha_HealthCheck.Payload()}
      set {_send = newValue}
    }
    ...
    public var receive: Envoy_Config_Core_V4alpha_HealthCheck.Payload {
      get {return _receive ?? Envoy_Config_Core_V4alpha_HealthCheck.Payload()}
    ...
    public var expectedStatuses: [Envoy_Type_V3_Int64Range] = []

    /// Use specified application protocol for health checks.
    public var codecClientType: Envoy_Type_V3_CodecClientType = .http1

    /// An optional service name parameter which is used to validate the identity of
    /// the health checked cluster using a :ref:`StringMatcher
    /// <envoy_api_msg_type.matcher.v4alpha.StringMatcher>`. See the :ref:`architecture overview
    /// <arch_overview_health_checking_identity>` for more information.
    public var serviceNameMatcher: Envoy_Type_Matcher_V4alpha_StringMatcher {
      get {return _serviceNameMatcher ?? Envoy_Type_Matcher_V4alpha_StringMatcher()}
    ...
    fileprivate var _send: Envoy_Config_Core_V4alpha_HealthCheck.Payload? = nil
    fileprivate var _receive: Envoy_Config_Core_V4alpha_HealthCheck.Payload? = nil
    fileprivate var _serviceNameMatcher: Envoy_Type_Matcher_V4alpha_StringMatcher? = nil
  }
  ...
  public struct CustomHealthCheck {
    ...
    public var configType: Envoy_Config_Core_V4alpha_HealthCheck.CustomHealthCheck.OneOf_ConfigType? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Config_Core_V4alpha_HealthCheck.CustomHealthCheck.OneOf_ConfigType, rhs: Envoy_Config_Core_V4alpha_HealthCheck.CustomHealthCheck.OneOf_ConfigType) -> Bool {
        switch (lhs, rhs) {
...
extension Envoy_Config_Core_V4alpha_HealthStatus: SwiftProtobuf._ProtoNameProviding {
...
extension Envoy_Config_Core_V4alpha_HealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    23: .standard(proto: "transport_socket_match_criteria"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _healthChecker: Envoy_Config_Core_V4alpha_HealthCheck.OneOf_HealthChecker?
    ...
    var _eventService: Envoy_Config_Core_V4alpha_EventServiceConfig? = nil
    var _alwaysLogHealthCheckFailures: Bool = false
    var _tlsOptions: Envoy_Config_Core_V4alpha_HealthCheck.TlsOptions? = nil
    var _transportSocketMatchCriteria: SwiftProtobuf.Google_Protobuf_Struct? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _transportSocketMatchCriteria = source._transportSocketMatchCriteria
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularMessageField(value: &_storage._timeout)
        case 2: try decoder.decodeSingularMessageField(value: &_storage._interval)
        case 3: try decoder.decodeSingularMessageField(value: &_storage._intervalJitter)
        case 4: try decoder.decodeSingularMessageField(value: &_storage._unhealthyThreshold)
        case 5: try decoder.decodeSingularMessageField(value: &_storage._healthyThreshold)
        case 6: try decoder.decodeSingularMessageField(value: &_storage._altPort)
        case 7: try decoder.decodeSingularMessageField(value: &_storage._reuseConnection)
        case 8:
          var v: Envoy_Config_Core_V4alpha_HealthCheck.HttpHealthCheck?
        ...
        case 9:
          var v: Envoy_Config_Core_V4alpha_HealthCheck.TcpHealthCheck?
          if let current = _storage._healthChecker {
            try decoder.handleConflictingOneOf()
        ...
        case 11:
          var v: Envoy_Config_Core_V4alpha_HealthCheck.GrpcHealthCheck?
          if let current = _storage._healthChecker {
            try decoder.handleConflictingOneOf()
        ...
        case 12: try decoder.decodeSingularMessageField(value: &_storage._noTrafficInterval)
        case 13:
          var v: Envoy_Config_Core_V4alpha_HealthCheck.CustomHealthCheck?
          if let current = _storage._healthChecker {
            try decoder.handleConflictingOneOf()
        ...
        case 14: try decoder.decodeSingularMessageField(value: &_storage._unhealthyInterval)
        case 15: try decoder.decodeSingularMessageField(value: &_storage._unhealthyEdgeInterval)
        case 16: try decoder.decodeSingularMessageField(value: &_storage._healthyEdgeInterval)
        case 17: try decoder.decodeSingularStringField(value: &_storage._eventLogPath)
        case 18: try decoder.decodeSingularUInt32Field(value: &_storage._intervalJitterPercent)
        case 19: try decoder.decodeSingularBoolField(value: &_storage._alwaysLogHealthCheckFailures)
        case 20: try decoder.decodeSingularMessageField(value: &_storage._initialJitter)
        case 21: try decoder.decodeSingularMessageField(value: &_storage._tlsOptions)
        case 22: try decoder.decodeSingularMessageField(value: &_storage._eventService)
        case 23: try decoder.decodeSingularMessageField(value: &_storage._transportSocketMatchCriteria)
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .httpHealthCheck(let v)?:
        try visitor.visitSingularMessageField(value: v, fieldNumber: 8)
      case .tcpHealthCheck(let v)?:
        try visitor.visitSingularMessageField(value: v, fieldNumber: 9)
      case .grpcHealthCheck(let v)?:
      ...
      if let v = _storage._transportSocketMatchCriteria {
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_HealthCheck, rhs: Envoy_Config_Core_V4alpha_HealthCheck) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._transportSocketMatchCriteria != rhs_storage._transportSocketMatchCriteria {return false}
        return true
      }
...
extension Envoy_Config_Core_V4alpha_HealthCheck.Payload: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V4alpha_HealthCheck.protoMessageName + ".Payload"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "text"),
    2: .same(proto: "binary"),
  ]
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_HealthCheck.Payload, rhs: Envoy_Config_Core_V4alpha_HealthCheck.Payload) -> Bool {
...
extension Envoy_Config_Core_V4alpha_HealthCheck.HttpHealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V4alpha_HealthCheck.protoMessageName + ".HttpHealthCheck"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "host"),
    2: .same(proto: "path"),
    3: .same(proto: "send"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeSingularMessageField(value: &self._send)
      case 4: try decoder.decodeSingularMessageField(value: &self._receive)
      ...
      case 9: try decoder.decodeRepeatedMessageField(value: &self.expectedStatuses)
      case 10: try decoder.decodeSingularEnumField(value: &self.codecClientType)
      case 11: try decoder.decodeSingularMessageField(value: &self._serviceNameMatcher)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_HealthCheck.HttpHealthCheck, rhs: Envoy_Config_Core_V4alpha_HealthCheck.HttpHealthCheck) -> Bool {
...
extension Envoy_Config_Core_V4alpha_HealthCheck.TcpHealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V4alpha_HealthCheck.protoMessageName + ".TcpHealthCheck"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "send"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._send)
      case 2: try decoder.decodeRepeatedMessageField(value: &self.receive)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_HealthCheck.TcpHealthCheck, rhs: Envoy_Config_Core_V4alpha_HealthCheck.TcpHealthCheck) -> Bool {
    if lhs._send != rhs._send {return false}
...
extension Envoy_Config_Core_V4alpha_HealthCheck.RedisHealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V4alpha_HealthCheck.protoMessageName + ".RedisHealthCheck"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "key"),
  ]
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_HealthCheck.RedisHealthCheck, rhs: Envoy_Config_Core_V4alpha_HealthCheck.RedisHealthCheck) -> Bool {
...
extension Envoy_Config_Core_V4alpha_HealthCheck.GrpcHealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V4alpha_HealthCheck.protoMessageName + ".GrpcHealthCheck"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_HealthCheck.GrpcHealthCheck, rhs: Envoy_Config_Core_V4alpha_HealthCheck.GrpcHealthCheck) -> Bool {
...
extension Envoy_Config_Core_V4alpha_HealthCheck.CustomHealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V4alpha_HealthCheck.protoMessageName + ".CustomHealthCheck"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_HealthCheck.CustomHealthCheck, rhs: Envoy_Config_Core_V4alpha_HealthCheck.CustomHealthCheck) -> Bool {
...
extension Envoy_Config_Core_V4alpha_HealthCheck.TlsOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V4alpha_HealthCheck.protoMessageName + ".TlsOptions"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedStringField(value: &self.alpnProtocols)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_HealthCheck.TlsOptions, rhs: Envoy_Config_Core_V4alpha_HealthCheck.TlsOptions) -> Bool {
