...
public struct Envoy_Config_Core_V4alpha_EnvoyInternalAddress {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var addressNameSpecifier: Envoy_Config_Core_V4alpha_EnvoyInternalAddress.OneOf_AddressNameSpecifier? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Core_V4alpha_EnvoyInternalAddress.OneOf_AddressNameSpecifier, rhs: Envoy_Config_Core_V4alpha_EnvoyInternalAddress.OneOf_AddressNameSpecifier) -> Bool {
...
public struct Envoy_Config_Core_V4alpha_Address {
  ...
  public var envoyInternalAddress: Envoy_Config_Core_V4alpha_EnvoyInternalAddress {
    get {
      if case .envoyInternalAddress(let v)? = address {return v}
      return Envoy_Config_Core_V4alpha_EnvoyInternalAddress()
    }
  ...
  public enum OneOf_Address: Equatable {
    ...
    /// [#not-implemented-hide:]
    case envoyInternalAddress(Envoy_Config_Core_V4alpha_EnvoyInternalAddress)
...
extension Envoy_Config_Core_V4alpha_EnvoyInternalAddress: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Core_V4alpha_EnvoyInternalAddress, rhs: Envoy_Config_Core_V4alpha_EnvoyInternalAddress) -> Bool {
...
extension Envoy_Config_Core_V4alpha_Address: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try {
        var v: Envoy_Config_Core_V4alpha_EnvoyInternalAddress?
        if let current = self.address {
          try decoder.handleConflictingOneOf()
