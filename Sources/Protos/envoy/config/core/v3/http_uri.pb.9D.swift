...
public struct Envoy_Config_Core_V3_HttpUri {
  ...
  public var httpUpstreamType: Envoy_Config_Core_V3_HttpUri.OneOf_HTTPUpstreamType? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Core_V3_HttpUri.OneOf_HTTPUpstreamType, rhs: Envoy_Config_Core_V3_HttpUri.OneOf_HTTPUpstreamType) -> Bool {
      switch (lhs, rhs) {
...
extension Envoy_Config_Core_V3_HttpUri: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Core_V3_HttpUri, rhs: Envoy_Config_Core_V3_HttpUri) -> Bool {
