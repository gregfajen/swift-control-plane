...
public enum Envoy_Config_Core_V3_HealthStatus: SwiftProtobuf.Enum {
...
extension Envoy_Config_Core_V3_HealthStatus: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Core_V3_HealthStatus] = [
    .unknown,
    .healthy,
    .unhealthy,
    .draining,
...
/// [#next-free-field: 24]
public struct Envoy_Config_Core_V3_HealthCheck {
  ...
  /// HTTP health check.
  public var httpHealthCheck: Envoy_Config_Core_V3_HealthCheck.HttpHealthCheck {
    get {
      if case .httpHealthCheck(let v)? = _storage._healthChecker {return v}
      return Envoy_Config_Core_V3_HealthCheck.HttpHealthCheck()
    }
    set {_uniqueStorage()._healthChecker = .httpHealthCheck(newValue)}
  }

  /// TCP health check.
  public var tcpHealthCheck: Envoy_Config_Core_V3_HealthCheck.TcpHealthCheck {
    get {
      if case .tcpHealthCheck(let v)? = _storage._healthChecker {return v}
      return Envoy_Config_Core_V3_HealthCheck.TcpHealthCheck()
    }
    set {_uniqueStorage()._healthChecker = .tcpHealthCheck(newValue)}
  }

  /// gRPC health check.
  public var grpcHealthCheck: Envoy_Config_Core_V3_HealthCheck.GrpcHealthCheck {
    get {
      if case .grpcHealthCheck(let v)? = _storage._healthChecker {return v}
      return Envoy_Config_Core_V3_HealthCheck.GrpcHealthCheck()
    }
    set {_uniqueStorage()._healthChecker = .grpcHealthCheck(newValue)}
  }

  /// Custom health check.
  public var customHealthCheck: Envoy_Config_Core_V3_HealthCheck.CustomHealthCheck {
    get {
      if case .customHealthCheck(let v)? = _storage._healthChecker {return v}
      return Envoy_Config_Core_V3_HealthCheck.CustomHealthCheck()
    }
  ...
  public var eventService: Envoy_Config_Core_V3_EventServiceConfig {
    get {return _storage._eventService ?? Envoy_Config_Core_V3_EventServiceConfig()}
  ...
  public var tlsOptions: Envoy_Config_Core_V3_HealthCheck.TlsOptions {
    get {return _storage._tlsOptions ?? Envoy_Config_Core_V3_HealthCheck.TlsOptions()}
  ...
  public enum OneOf_HealthChecker: Equatable {
    /// HTTP health check.
    case httpHealthCheck(Envoy_Config_Core_V3_HealthCheck.HttpHealthCheck)
    /// TCP health check.
    case tcpHealthCheck(Envoy_Config_Core_V3_HealthCheck.TcpHealthCheck)
    /// gRPC health check.
    case grpcHealthCheck(Envoy_Config_Core_V3_HealthCheck.GrpcHealthCheck)
    /// Custom health check.
    case customHealthCheck(Envoy_Config_Core_V3_HealthCheck.CustomHealthCheck)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Core_V3_HealthCheck.OneOf_HealthChecker, rhs: Envoy_Config_Core_V3_HealthCheck.OneOf_HealthChecker) -> Bool {
      switch (lhs, rhs) {
  ...
  public struct Payload {
    ...
    public var payload: Envoy_Config_Core_V3_HealthCheck.Payload.OneOf_Payload? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Config_Core_V3_HealthCheck.Payload.OneOf_Payload, rhs: Envoy_Config_Core_V3_HealthCheck.Payload.OneOf_Payload) -> Bool {
        switch (lhs, rhs) {
  ...
  public struct HttpHealthCheck {
    ...
    public var send: Envoy_Config_Core_V3_HealthCheck.Payload {
      get {return _send ?? Envoy_Config_Core_V3_HealthCheck.Payload()}
      set {_send = newValue}
    }
    ...
    public var receive: Envoy_Config_Core_V3_HealthCheck.Payload {
      get {return _receive ?? Envoy_Config_Core_V3_HealthCheck.Payload()}
    ...
    public var serviceNameMatcher: Envoy_Type_Matcher_V3_StringMatcher {
      get {return _serviceNameMatcher ?? Envoy_Type_Matcher_V3_StringMatcher()}
    ...
    fileprivate var _send: Envoy_Config_Core_V3_HealthCheck.Payload? = nil
    fileprivate var _receive: Envoy_Config_Core_V3_HealthCheck.Payload? = nil
    fileprivate var _serviceNameMatcher: Envoy_Type_Matcher_V3_StringMatcher? = nil
  }
  ...
  public struct CustomHealthCheck {
    ...
    public var configType: Envoy_Config_Core_V3_HealthCheck.CustomHealthCheck.OneOf_ConfigType? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Config_Core_V3_HealthCheck.CustomHealthCheck.OneOf_ConfigType, rhs: Envoy_Config_Core_V3_HealthCheck.CustomHealthCheck.OneOf_ConfigType) -> Bool {
        switch (lhs, rhs) {
...
extension Envoy_Config_Core_V3_HealthStatus: SwiftProtobuf._ProtoNameProviding {
...
extension Envoy_Config_Core_V3_HealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _healthChecker: Envoy_Config_Core_V3_HealthCheck.OneOf_HealthChecker?
    ...
    var _eventService: Envoy_Config_Core_V3_EventServiceConfig? = nil
    var _alwaysLogHealthCheckFailures: Bool = false
    var _tlsOptions: Envoy_Config_Core_V3_HealthCheck.TlsOptions? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 8:
          var v: Envoy_Config_Core_V3_HealthCheck.HttpHealthCheck?
        ...
        case 9:
          var v: Envoy_Config_Core_V3_HealthCheck.TcpHealthCheck?
          if let current = _storage._healthChecker {
            try decoder.handleConflictingOneOf()
        ...
        case 11:
          var v: Envoy_Config_Core_V3_HealthCheck.GrpcHealthCheck?
          if let current = _storage._healthChecker {
            try decoder.handleConflictingOneOf()
        ...
        case 13:
          var v: Envoy_Config_Core_V3_HealthCheck.CustomHealthCheck?
          if let current = _storage._healthChecker {
            try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Config_Core_V3_HealthCheck, rhs: Envoy_Config_Core_V3_HealthCheck) -> Bool {
...
extension Envoy_Config_Core_V3_HealthCheck.Payload: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V3_HealthCheck.protoMessageName + ".Payload"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "text"),
    2: .same(proto: "binary"),
  ]
  ...
  public static func ==(lhs: Envoy_Config_Core_V3_HealthCheck.Payload, rhs: Envoy_Config_Core_V3_HealthCheck.Payload) -> Bool {
...
extension Envoy_Config_Core_V3_HealthCheck.HttpHealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V3_HealthCheck.protoMessageName + ".HttpHealthCheck"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "host"),
    2: .same(proto: "path"),
    3: .same(proto: "send"),
  ...
  public static func ==(lhs: Envoy_Config_Core_V3_HealthCheck.HttpHealthCheck, rhs: Envoy_Config_Core_V3_HealthCheck.HttpHealthCheck) -> Bool {
...
extension Envoy_Config_Core_V3_HealthCheck.TcpHealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V3_HealthCheck.protoMessageName + ".TcpHealthCheck"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "send"),
  ...
  public static func ==(lhs: Envoy_Config_Core_V3_HealthCheck.TcpHealthCheck, rhs: Envoy_Config_Core_V3_HealthCheck.TcpHealthCheck) -> Bool {
    if lhs._send != rhs._send {return false}
...
extension Envoy_Config_Core_V3_HealthCheck.RedisHealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V3_HealthCheck.protoMessageName + ".RedisHealthCheck"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "key"),
  ]
  ...
  public static func ==(lhs: Envoy_Config_Core_V3_HealthCheck.RedisHealthCheck, rhs: Envoy_Config_Core_V3_HealthCheck.RedisHealthCheck) -> Bool {
...
extension Envoy_Config_Core_V3_HealthCheck.GrpcHealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V3_HealthCheck.protoMessageName + ".GrpcHealthCheck"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Core_V3_HealthCheck.GrpcHealthCheck, rhs: Envoy_Config_Core_V3_HealthCheck.GrpcHealthCheck) -> Bool {
...
extension Envoy_Config_Core_V3_HealthCheck.CustomHealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V3_HealthCheck.protoMessageName + ".CustomHealthCheck"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  public static func ==(lhs: Envoy_Config_Core_V3_HealthCheck.CustomHealthCheck, rhs: Envoy_Config_Core_V3_HealthCheck.CustomHealthCheck) -> Bool {
...
extension Envoy_Config_Core_V3_HealthCheck.TlsOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V3_HealthCheck.protoMessageName + ".TlsOptions"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Core_V3_HealthCheck.TlsOptions, rhs: Envoy_Config_Core_V3_HealthCheck.TlsOptions) -> Bool {
