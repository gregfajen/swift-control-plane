...
public struct Envoy_Config_Core_V3_GrpcService {
  ...
  public struct GoogleGrpc {
    ...
    public var channelArgs: Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs {
      get {return _channelArgs ?? Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs()}
    ...
    public struct ChannelArgs {
      ...
      public var args: Dictionary<String,Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs.Value> = [:]
      ...
      public struct Value {
        ...
        public var valueSpecifier: Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs.Value.OneOf_ValueSpecifier? = nil
        ...
        #if !swift(>=4.1)
          public static func ==(lhs: Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs.Value.OneOf_ValueSpecifier, rhs: Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs.Value.OneOf_ValueSpecifier) -> Bool {
            // The use of inline closures is to circumvent an issue where the compiler
            // allocates stack space for every case branch when no optimizations are
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch (lhs, rhs) {
    ...
    fileprivate var _channelArgs: Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs? = nil
  }
...
extension Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V3_GrpcService.GoogleGrpc.protoMessageName + ".ChannelArgs"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "args"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs.Value>.self, value: &self.args) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.args.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs.Value>.self, value: self.args, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs, rhs: Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs) -> Bool {
...
extension Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs.Value: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs.protoMessageName + ".Value"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs.Value, rhs: Envoy_Config_Core_V3_GrpcService.GoogleGrpc.ChannelArgs.Value) -> Bool {
