...
public struct Envoy_Config_Core_V3_EventServiceConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var configSourceSpecifier: Envoy_Config_Core_V3_EventServiceConfig.OneOf_ConfigSourceSpecifier? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Core_V3_EventServiceConfig.OneOf_ConfigSourceSpecifier, rhs: Envoy_Config_Core_V3_EventServiceConfig.OneOf_ConfigSourceSpecifier) -> Bool {
      switch (lhs, rhs) {
...
extension Envoy_Config_Core_V3_EventServiceConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Core_V3_EventServiceConfig, rhs: Envoy_Config_Core_V3_EventServiceConfig) -> Bool {
