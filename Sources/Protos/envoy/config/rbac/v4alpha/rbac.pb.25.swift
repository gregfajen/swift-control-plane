...
public struct Envoy_Config_Rbac_V4alpha_Permission {
  ...
  public enum OneOf_Rule: Equatable {
    ...
    public static func ==(lhs: Envoy_Config_Rbac_V4alpha_Permission.OneOf_Rule, rhs: Envoy_Config_Rbac_V4alpha_Permission.OneOf_Rule) -> Bool {
      switch (lhs, rhs) {
      case (.andRules(let l), .andRules(let r)): return l == r
      case (.orRules(let l), .orRules(let r)): return l == r
      case (.any(let l), .any(let r)): return l == r
      case (.header(let l), .header(let r)): return l == r
      case (.urlPath(let l), .urlPath(let r)): return l == r
      case (.destinationIp(let l), .destinationIp(let r)): return l == r
      case (.destinationPort(let l), .destinationPort(let r)): return l == r
      case (.metadata(let l), .metadata(let r)): return l == r
      case (.notRule(let l), .notRule(let r)): return l == r
      case (.requestedServerName(let l), .requestedServerName(let r)): return l == r
...
public struct Envoy_Config_Rbac_V4alpha_Principal {
  ...
  public enum OneOf_Identifier: Equatable {
    ...
    public static func ==(lhs: Envoy_Config_Rbac_V4alpha_Principal.OneOf_Identifier, rhs: Envoy_Config_Rbac_V4alpha_Principal.OneOf_Identifier) -> Bool {
      switch (lhs, rhs) {
      case (.andIds(let l), .andIds(let r)): return l == r
      case (.orIds(let l), .orIds(let r)): return l == r
      case (.any(let l), .any(let r)): return l == r
      case (.authenticated(let l), .authenticated(let r)): return l == r
      case (.directRemoteIp(let l), .directRemoteIp(let r)): return l == r
      case (.remoteIp(let l), .remoteIp(let r)): return l == r
      case (.header(let l), .header(let r)): return l == r
      case (.urlPath(let l), .urlPath(let r)): return l == r
      case (.metadata(let l), .metadata(let r)): return l == r
      case (.notID(let l), .notID(let r)): return l == r
      default: return false
      }
    }
  #endif
...
extension Envoy_Config_Rbac_V4alpha_RBAC: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Config_Rbac_V4alpha_Policy>.self, value: &self.policies)
      default: break
      }
    }
  }
...
extension Envoy_Config_Rbac_V4alpha_Policy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeRepeatedMessageField(value: &self.principals)
...
extension Envoy_Config_Rbac_V4alpha_Permission: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .destinationIp(let v)?:
        try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
      case .destinationPort(let v)?:
        try visitor.visitSingularUInt32Field(value: v, fieldNumber: 6)
      case .metadata(let v)?:
        try visitor.visitSingularMessageField(value: v, fieldNumber: 7)
      case .notRule(let v)?:
        try visitor.visitSingularMessageField(value: v, fieldNumber: 8)
      case .requestedServerName(let v)?:
...
extension Envoy_Config_Rbac_V4alpha_Principal.Authenticated: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 2: try decoder.decodeSingularMessageField(value: &self._principalName)
      default: break
      }
    }
  }
