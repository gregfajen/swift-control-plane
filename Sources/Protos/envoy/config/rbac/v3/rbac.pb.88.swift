...
public struct Envoy_Config_Rbac_V3_Policy {
  ...
  public var checkedCondition: Google_Api_Expr_V1alpha1_CheckedExpr {
    get {return _checkedCondition ?? Google_Api_Expr_V1alpha1_CheckedExpr()}
    set {_checkedCondition = newValue}
  }
  /// Returns true if `checkedCondition` has been explicitly set.
  public var hasCheckedCondition: Bool {return self._checkedCondition != nil}
  /// Clears the value of `checkedCondition`. Subsequent reads from it will return its default value.
  public mutating func clearCheckedCondition() {self._checkedCondition = nil}
  ...
  fileprivate var _checkedCondition: Google_Api_Expr_V1alpha1_CheckedExpr? = nil
}
...
extension Envoy_Config_Rbac_V3_RBAC: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Config_Rbac_V3_Policy>.self, value: &self.policies) }()
      default: break
      }
    }
  }
...
extension Envoy_Config_Rbac_V3_Policy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularMessageField(value: &self._checkedCondition) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._checkedCondition {
  ...
  public static func ==(lhs: Envoy_Config_Rbac_V3_Policy, rhs: Envoy_Config_Rbac_V3_Policy) -> Bool {
    ...
    if lhs._checkedCondition != rhs._checkedCondition {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
