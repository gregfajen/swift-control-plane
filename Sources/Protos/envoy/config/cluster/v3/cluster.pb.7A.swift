...
public struct Envoy_Config_Cluster_V3_ClusterCollection {
...
public struct Envoy_Config_Cluster_V3_Cluster {
  ...
  public var maglevLbConfig: Envoy_Config_Cluster_V3_Cluster.MaglevLbConfig {
    get {
      if case .maglevLbConfig(let v)? = _storage._lbConfig {return v}
      return Envoy_Config_Cluster_V3_Cluster.MaglevLbConfig()
    }
  ...
  public var upstreamConfig: Envoy_Config_Core_V3_TypedExtensionConfig {
    get {return _storage._upstreamConfig ?? Envoy_Config_Core_V3_TypedExtensionConfig()}
  ...
  public var trackClusterStats: Envoy_Config_Cluster_V3_TrackClusterStats {
    get {return _storage._trackClusterStats ?? Envoy_Config_Cluster_V3_TrackClusterStats()}
  ...
  public var prefetchPolicy: Envoy_Config_Cluster_V3_Cluster.PrefetchPolicy {
    get {return _storage._prefetchPolicy ?? Envoy_Config_Cluster_V3_Cluster.PrefetchPolicy()}
  ...
  public enum OneOf_LbConfig: Equatable {
    ...
    /// Optional configuration for the Maglev load balancing policy.
    case maglevLbConfig(Envoy_Config_Cluster_V3_Cluster.MaglevLbConfig)
    /// Optional configuration for the Original Destination load balancing policy.
  ...
  public struct EdsClusterConfig {
    ...
    public var edsConfig: Envoy_Config_Core_V3_ConfigSource {
      get {return _storage._edsConfig ?? Envoy_Config_Core_V3_ConfigSource()}
    ...
    public var edsResourceLocator: Udpa_Core_V1_ResourceLocator {
      get {return _storage._edsResourceLocator ?? Udpa_Core_V1_ResourceLocator()}
      set {_uniqueStorage()._edsResourceLocator = newValue}
    }
    /// Returns true if `edsResourceLocator` has been explicitly set.
    public var hasEdsResourceLocator: Bool {return _storage._edsResourceLocator != nil}
    /// Clears the value of `edsResourceLocator`. Subsequent reads from it will return its default value.
    public mutating func clearEdsResourceLocator() {_uniqueStorage()._edsResourceLocator = nil}
  ...
  public struct LeastRequestLbConfig {
    ...
    public var activeRequestBias: Envoy_Config_Core_V3_RuntimeDouble {
      get {return _activeRequestBias ?? Envoy_Config_Core_V3_RuntimeDouble()}
    ...
    fileprivate var _activeRequestBias: Envoy_Config_Core_V3_RuntimeDouble? = nil
  }
...
public struct Envoy_Config_Cluster_V3_TrackClusterStats {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Envoy_Config_Cluster_V3_ClusterCollection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V3_ClusterCollection, rhs: Envoy_Config_Cluster_V3_ClusterCollection) -> Bool {
...
extension Envoy_Config_Cluster_V3_Cluster: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _upstreamConfig: Envoy_Config_Core_V3_TypedExtensionConfig? = nil
    var _trackClusterStats: Envoy_Config_Cluster_V3_TrackClusterStats? = nil
    var _prefetchPolicy: Envoy_Config_Cluster_V3_Cluster.PrefetchPolicy? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 52: try {
          var v: Envoy_Config_Cluster_V3_Cluster.MaglevLbConfig?
          if let current = _storage._lbConfig {
            try decoder.handleConflictingOneOf()
...
extension Envoy_Config_Cluster_V3_Cluster.EdsClusterConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _edsConfig: Envoy_Config_Core_V3_ConfigSource? = nil
    var _serviceName: String = String()
    var _edsResourceLocator: Udpa_Core_V1_ResourceLocator? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _edsResourceLocator = source._edsResourceLocator
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularStringField(value: &_storage._serviceName) }()
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._edsResourceLocator) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._edsResourceLocator {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V3_Cluster.EdsClusterConfig, rhs: Envoy_Config_Cluster_V3_Cluster.EdsClusterConfig) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._edsResourceLocator != rhs_storage._edsResourceLocator {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Envoy_Config_Cluster_V3_Cluster.MaglevLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V3_Cluster.protoMessageName + ".MaglevLbConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V3_Cluster.MaglevLbConfig, rhs: Envoy_Config_Cluster_V3_Cluster.MaglevLbConfig) -> Bool {
...
extension Envoy_Config_Cluster_V3_Cluster.PrefetchPolicy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V3_Cluster.protoMessageName + ".PrefetchPolicy"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V3_Cluster.PrefetchPolicy, rhs: Envoy_Config_Cluster_V3_Cluster.PrefetchPolicy) -> Bool {
...
extension Envoy_Config_Cluster_V3_TrackClusterStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V3_TrackClusterStats, rhs: Envoy_Config_Cluster_V3_TrackClusterStats) -> Bool {
