...
public struct Envoy_Config_Cluster_V4alpha_ClusterCollection {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var entries: Udpa_Core_V1_CollectionEntry {
    get {return _entries ?? Udpa_Core_V1_CollectionEntry()}
  ...
  fileprivate var _entries: Udpa_Core_V1_CollectionEntry? = nil
}

/// Configuration for a single upstream cluster.
/// [#next-free-field: 53]
public struct Envoy_Config_Cluster_V4alpha_Cluster {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var transportSocketMatches: [Envoy_Config_Cluster_V4alpha_Cluster.TransportSocketMatch] {
  ...
  public var type: Envoy_Config_Cluster_V4alpha_Cluster.DiscoveryType {
    get {
  ...
  public var clusterType: Envoy_Config_Cluster_V4alpha_Cluster.CustomClusterType {
    get {
      if case .clusterType(let v)? = _storage._clusterDiscoveryType {return v}
      return Envoy_Config_Cluster_V4alpha_Cluster.CustomClusterType()
    }
    set {_uniqueStorage()._clusterDiscoveryType = .clusterType(newValue)}
  }

  /// Configuration to use for EDS updates for the Cluster.
  public var edsClusterConfig: Envoy_Config_Cluster_V4alpha_Cluster.EdsClusterConfig {
    get {return _storage._edsClusterConfig ?? Envoy_Config_Cluster_V4alpha_Cluster.EdsClusterConfig()}
  ...
  public var lbPolicy: Envoy_Config_Cluster_V4alpha_Cluster.LbPolicy {
  ...
  public var healthChecks: [Envoy_Config_Core_V4alpha_HealthCheck] {
  ...
  public var circuitBreakers: Envoy_Config_Cluster_V4alpha_CircuitBreakers {
    get {return _storage._circuitBreakers ?? Envoy_Config_Cluster_V4alpha_CircuitBreakers()}
  ...
  public var upstreamHTTPProtocolOptions: Envoy_Config_Core_V4alpha_UpstreamHttpProtocolOptions {
    get {return _storage._upstreamHTTPProtocolOptions ?? Envoy_Config_Core_V4alpha_UpstreamHttpProtocolOptions()}
  ...
  /// ignored.
  public var dnsFailureRefreshRate: Envoy_Config_Cluster_V4alpha_Cluster.RefreshRate {
    get {return _storage._dnsFailureRefreshRate ?? Envoy_Config_Cluster_V4alpha_Cluster.RefreshRate()}
  ...
  public var dnsLookupFamily: Envoy_Config_Cluster_V4alpha_Cluster.DnsLookupFamily {
  ...
  public var dnsResolvers: [Envoy_Config_Core_V4alpha_Address] {
  ...
  public var outlierDetection: Envoy_Config_Cluster_V4alpha_OutlierDetection {
    get {return _storage._outlierDetection ?? Envoy_Config_Cluster_V4alpha_OutlierDetection()}
  ...
  public var upstreamBindConfig: Envoy_Config_Core_V4alpha_BindConfig {
    get {return _storage._upstreamBindConfig ?? Envoy_Config_Core_V4alpha_BindConfig()}
  ...
  public var lbSubsetConfig: Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig {
    get {return _storage._lbSubsetConfig ?? Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig()}
  ...
  public var ringHashLbConfig: Envoy_Config_Cluster_V4alpha_Cluster.RingHashLbConfig {
    get {
      if case .ringHashLbConfig(let v)? = _storage._lbConfig {return v}
      return Envoy_Config_Cluster_V4alpha_Cluster.RingHashLbConfig()
    }
    set {_uniqueStorage()._lbConfig = .ringHashLbConfig(newValue)}
  }

  /// Optional configuration for the Maglev load balancing policy.
  public var maglevLbConfig: Envoy_Config_Cluster_V4alpha_Cluster.MaglevLbConfig {
    get {
      if case .maglevLbConfig(let v)? = _storage._lbConfig {return v}
      return Envoy_Config_Cluster_V4alpha_Cluster.MaglevLbConfig()
    }
    set {_uniqueStorage()._lbConfig = .maglevLbConfig(newValue)}
  }

  /// Optional configuration for the Original Destination load balancing policy.
  public var originalDstLbConfig: Envoy_Config_Cluster_V4alpha_Cluster.OriginalDstLbConfig {
    get {
      if case .originalDstLbConfig(let v)? = _storage._lbConfig {return v}
      return Envoy_Config_Cluster_V4alpha_Cluster.OriginalDstLbConfig()
    }
    set {_uniqueStorage()._lbConfig = .originalDstLbConfig(newValue)}
  }

  /// Optional configuration for the LeastRequest load balancing policy.
  public var leastRequestLbConfig: Envoy_Config_Cluster_V4alpha_Cluster.LeastRequestLbConfig {
    get {
      if case .leastRequestLbConfig(let v)? = _storage._lbConfig {return v}
      return Envoy_Config_Cluster_V4alpha_Cluster.LeastRequestLbConfig()
    }
    set {_uniqueStorage()._lbConfig = .leastRequestLbConfig(newValue)}
  }

  /// Common configuration for all load balancer implementations.
  public var commonLbConfig: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig {
    get {return _storage._commonLbConfig ?? Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig()}
  ...
  public var transportSocket: Envoy_Config_Core_V4alpha_TransportSocket {
    get {return _storage._transportSocket ?? Envoy_Config_Core_V4alpha_TransportSocket()}
  ...
  public var protocolSelection: Envoy_Config_Cluster_V4alpha_Cluster.ClusterProtocolSelection {
    get {return _storage._protocolSelection}
    set {_uniqueStorage()._protocolSelection = newValue}
  }

  /// Optional options for upstream connections.
  public var upstreamConnectionOptions: Envoy_Config_Cluster_V4alpha_UpstreamConnectionOptions {
    get {return _storage._upstreamConnectionOptions ?? Envoy_Config_Cluster_V4alpha_UpstreamConnectionOptions()}
  ...
  public var filters: [Envoy_Config_Cluster_V4alpha_Filter] {
  ...
  public var loadBalancingPolicy: Envoy_Config_Cluster_V4alpha_LoadBalancingPolicy {
    get {return _storage._loadBalancingPolicy ?? Envoy_Config_Cluster_V4alpha_LoadBalancingPolicy()}
  ...
  public var lrsServer: Envoy_Config_Core_V4alpha_ConfigSource {
    get {return _storage._lrsServer ?? Envoy_Config_Core_V4alpha_ConfigSource()}
  ...
  public var upstreamConfig: Envoy_Config_Core_V4alpha_TypedExtensionConfig {
    get {return _storage._upstreamConfig ?? Envoy_Config_Core_V4alpha_TypedExtensionConfig()}
    set {_uniqueStorage()._upstreamConfig = newValue}
  }
  /// Returns true if `upstreamConfig` has been explicitly set.
  public var hasUpstreamConfig: Bool {return _storage._upstreamConfig != nil}
  /// Clears the value of `upstreamConfig`. Subsequent reads from it will return its default value.
  public mutating func clearUpstreamConfig() {_uniqueStorage()._upstreamConfig = nil}

  /// Configuration to track optional cluster stats.
  public var trackClusterStats: Envoy_Config_Cluster_V4alpha_TrackClusterStats {
    get {return _storage._trackClusterStats ?? Envoy_Config_Cluster_V4alpha_TrackClusterStats()}
    set {_uniqueStorage()._trackClusterStats = newValue}
  }
  /// Returns true if `trackClusterStats` has been explicitly set.
  public var hasTrackClusterStats: Bool {return _storage._trackClusterStats != nil}
  /// Clears the value of `trackClusterStats`. Subsequent reads from it will return its default value.
  public mutating func clearTrackClusterStats() {_uniqueStorage()._trackClusterStats = nil}

  /// [#not-implemented-hide:]
  /// Prefetch configuration for this cluster.
  public var prefetchPolicy: Envoy_Config_Cluster_V4alpha_Cluster.PrefetchPolicy {
    get {return _storage._prefetchPolicy ?? Envoy_Config_Cluster_V4alpha_Cluster.PrefetchPolicy()}
    set {_uniqueStorage()._prefetchPolicy = newValue}
  }
  /// Returns true if `prefetchPolicy` has been explicitly set.
  public var hasPrefetchPolicy: Bool {return _storage._prefetchPolicy != nil}
  /// Clears the value of `prefetchPolicy`. Subsequent reads from it will return its default value.
  public mutating func clearPrefetchPolicy() {_uniqueStorage()._prefetchPolicy = nil}

  /// If `connection_pool_per_downstream_connection` is true, the cluster will use a separate
  /// connection pool for every downstream connection
  public var connectionPoolPerDownstreamConnection: Bool {
    get {return _storage._connectionPoolPerDownstreamConnection}
    set {_uniqueStorage()._connectionPoolPerDownstreamConnection = newValue}
  }
  ...
  public enum OneOf_ClusterDiscoveryType: Equatable {
    /// The :ref:`service discovery type <arch_overview_service_discovery_types>`
    /// to use for resolving the cluster.
    case type(Envoy_Config_Cluster_V4alpha_Cluster.DiscoveryType)
    /// The custom cluster type.
    case clusterType(Envoy_Config_Cluster_V4alpha_Cluster.CustomClusterType)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.OneOf_ClusterDiscoveryType, rhs: Envoy_Config_Cluster_V4alpha_Cluster.OneOf_ClusterDiscoveryType) -> Bool {
      ...
      case (.clusterType, .clusterType): return {
        guard case .clusterType(let l) = lhs, case .clusterType(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
  ...
  public enum OneOf_LbConfig: Equatable {
    /// Optional configuration for the Ring Hash load balancing policy.
    case ringHashLbConfig(Envoy_Config_Cluster_V4alpha_Cluster.RingHashLbConfig)
    /// Optional configuration for the Maglev load balancing policy.
    case maglevLbConfig(Envoy_Config_Cluster_V4alpha_Cluster.MaglevLbConfig)
    /// Optional configuration for the Original Destination load balancing policy.
    case originalDstLbConfig(Envoy_Config_Cluster_V4alpha_Cluster.OriginalDstLbConfig)
    /// Optional configuration for the LeastRequest load balancing policy.
    case leastRequestLbConfig(Envoy_Config_Cluster_V4alpha_Cluster.LeastRequestLbConfig)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.OneOf_LbConfig, rhs: Envoy_Config_Cluster_V4alpha_Cluster.OneOf_LbConfig) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.ringHashLbConfig, .ringHashLbConfig): return {
        guard case .ringHashLbConfig(let l) = lhs, case .ringHashLbConfig(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.maglevLbConfig, .maglevLbConfig): return {
        guard case .maglevLbConfig(let l) = lhs, case .maglevLbConfig(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.originalDstLbConfig, .originalDstLbConfig): return {
        guard case .originalDstLbConfig(let l) = lhs, case .originalDstLbConfig(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.leastRequestLbConfig, .leastRequestLbConfig): return {
        guard case .leastRequestLbConfig(let l) = lhs, case .leastRequestLbConfig(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
  ...
  public struct EdsClusterConfig {
    ...
    public var edsConfig: Envoy_Config_Core_V4alpha_ConfigSource {
      get {return _storage._edsConfig ?? Envoy_Config_Core_V4alpha_ConfigSource()}
      set {_uniqueStorage()._edsConfig = newValue}
    }
    /// Returns true if `edsConfig` has been explicitly set.
    public var hasEdsConfig: Bool {return _storage._edsConfig != nil}
    /// Clears the value of `edsConfig`. Subsequent reads from it will return its default value.
    public mutating func clearEdsConfig() {_uniqueStorage()._edsConfig = nil}

    public var nameSpecifier: OneOf_NameSpecifier? {
      get {return _storage._nameSpecifier}
      set {_uniqueStorage()._nameSpecifier = newValue}
    }
    ...
    public var serviceName: String {
      get {
        if case .serviceName(let v)? = _storage._nameSpecifier {return v}
        return String()
      }
      set {_uniqueStorage()._nameSpecifier = .serviceName(newValue)}
    }

    /// Resource locator for EDS. This is mutually exclusive to *service_name*.
    /// [#not-implemented-hide:]
    public var edsResourceLocator: Udpa_Core_V1_ResourceLocator {
      get {
        if case .edsResourceLocator(let v)? = _storage._nameSpecifier {return v}
        return Udpa_Core_V1_ResourceLocator()
      }
      set {_uniqueStorage()._nameSpecifier = .edsResourceLocator(newValue)}
    }
    ...
    public enum OneOf_NameSpecifier: Equatable {
      ...
      /// Resource locator for EDS. This is mutually exclusive to *service_name*.
      /// [#not-implemented-hide:]
      case edsResourceLocator(Udpa_Core_V1_ResourceLocator)

    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.EdsClusterConfig.OneOf_NameSpecifier, rhs: Envoy_Config_Cluster_V4alpha_Cluster.EdsClusterConfig.OneOf_NameSpecifier) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
        case (.serviceName, .serviceName): return {
          guard case .serviceName(let l) = lhs, case .serviceName(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.edsResourceLocator, .edsResourceLocator): return {
          guard case .edsResourceLocator(let l) = lhs, case .edsResourceLocator(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        default: return false
        }
  ...
  public struct LbSubsetConfig {
    ...
    public var fallbackPolicy: Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig.LbSubsetFallbackPolicy = .noFallback
    ...
    public var subsetSelectors: [Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig.LbSubsetSelector] = []
    ...
    public struct LbSubsetSelector {
      ...
      public var singleHostPerSubset: Bool = false

      /// The behavior used when no endpoint subset matches the selected route's
      /// metadata.
      public var fallbackPolicy: Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig.LbSubsetSelector.LbSubsetSelectorFallbackPolicy = .notDefined
  ...
  public struct LeastRequestLbConfig {
    ...
    public var activeRequestBias: Envoy_Config_Core_V4alpha_RuntimeDouble {
      get {return _activeRequestBias ?? Envoy_Config_Core_V4alpha_RuntimeDouble()}
      set {_activeRequestBias = newValue}
    }
    /// Returns true if `activeRequestBias` has been explicitly set.
    public var hasActiveRequestBias: Bool {return self._activeRequestBias != nil}
    /// Clears the value of `activeRequestBias`. Subsequent reads from it will return its default value.
    public mutating func clearActiveRequestBias() {self._activeRequestBias = nil}
    ...
    fileprivate var _activeRequestBias: Envoy_Config_Core_V4alpha_RuntimeDouble? = nil
  }
  ...
  public struct RingHashLbConfig {
    ...
    public var hashFunction: Envoy_Config_Cluster_V4alpha_Cluster.RingHashLbConfig.HashFunction = .xxHash
  ...
  public struct MaglevLbConfig {
    ...
    public var tableSize: SwiftProtobuf.Google_Protobuf_UInt64Value {
      get {return _tableSize ?? SwiftProtobuf.Google_Protobuf_UInt64Value()}
      set {_tableSize = newValue}
    }
    /// Returns true if `tableSize` has been explicitly set.
    public var hasTableSize: Bool {return self._tableSize != nil}
    /// Clears the value of `tableSize`. Subsequent reads from it will return its default value.
    public mutating func clearTableSize() {self._tableSize = nil}

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public init() {}

    fileprivate var _tableSize: SwiftProtobuf.Google_Protobuf_UInt64Value? = nil
  }
  ...
  public struct CommonLbConfig {
    ...
    public var localityConfigSpecifier: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.OneOf_LocalityConfigSpecifier? = nil

    public var zoneAwareLbConfig: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.ZoneAwareLbConfig {
      get {
        if case .zoneAwareLbConfig(let v)? = localityConfigSpecifier {return v}
        return Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.ZoneAwareLbConfig()
      }
      set {localityConfigSpecifier = .zoneAwareLbConfig(newValue)}
    }

    public var localityWeightedLbConfig: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.LocalityWeightedLbConfig {
      get {
        if case .localityWeightedLbConfig(let v)? = localityConfigSpecifier {return v}
        return Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.LocalityWeightedLbConfig()
      }
    ...
    public var consistentHashingLbConfig: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.ConsistentHashingLbConfig {
      get {return _consistentHashingLbConfig ?? Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.ConsistentHashingLbConfig()}
    ...
    public enum OneOf_LocalityConfigSpecifier: Equatable {
      case zoneAwareLbConfig(Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.ZoneAwareLbConfig)
      case localityWeightedLbConfig(Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.LocalityWeightedLbConfig)

    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.OneOf_LocalityConfigSpecifier, rhs: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.OneOf_LocalityConfigSpecifier) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
        case (.zoneAwareLbConfig, .zoneAwareLbConfig): return {
          guard case .zoneAwareLbConfig(let l) = lhs, case .zoneAwareLbConfig(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.localityWeightedLbConfig, .localityWeightedLbConfig): return {
          guard case .localityWeightedLbConfig(let l) = lhs, case .localityWeightedLbConfig(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        default: return false
        }
    ...
    public struct ConsistentHashingLbConfig {
      ...
      public var hashBalanceFactor: SwiftProtobuf.Google_Protobuf_UInt32Value {
        get {return _hashBalanceFactor ?? SwiftProtobuf.Google_Protobuf_UInt32Value()}
        set {_hashBalanceFactor = newValue}
      }
      /// Returns true if `hashBalanceFactor` has been explicitly set.
      public var hasHashBalanceFactor: Bool {return self._hashBalanceFactor != nil}
      /// Clears the value of `hashBalanceFactor`. Subsequent reads from it will return its default value.
      public mutating func clearHashBalanceFactor() {self._hashBalanceFactor = nil}

      public var unknownFields = SwiftProtobuf.UnknownStorage()

      public init() {}

      fileprivate var _hashBalanceFactor: SwiftProtobuf.Google_Protobuf_UInt32Value? = nil
    }
    ...
    fileprivate var _consistentHashingLbConfig: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.ConsistentHashingLbConfig? = nil
  }
  ...
  public struct PrefetchPolicy {
    ...
    public var perUpstreamPrefetchRatio: SwiftProtobuf.Google_Protobuf_DoubleValue {
      get {return _perUpstreamPrefetchRatio ?? SwiftProtobuf.Google_Protobuf_DoubleValue()}
      set {_perUpstreamPrefetchRatio = newValue}
    }
    /// Returns true if `perUpstreamPrefetchRatio` has been explicitly set.
    public var hasPerUpstreamPrefetchRatio: Bool {return self._perUpstreamPrefetchRatio != nil}
    /// Clears the value of `perUpstreamPrefetchRatio`. Subsequent reads from it will return its default value.
    public mutating func clearPerUpstreamPrefetchRatio() {self._perUpstreamPrefetchRatio = nil}
    ...
    public var predictivePrefetchRatio: SwiftProtobuf.Google_Protobuf_DoubleValue {
      get {return _predictivePrefetchRatio ?? SwiftProtobuf.Google_Protobuf_DoubleValue()}
      set {_predictivePrefetchRatio = newValue}
    }
    /// Returns true if `predictivePrefetchRatio` has been explicitly set.
    public var hasPredictivePrefetchRatio: Bool {return self._predictivePrefetchRatio != nil}
    /// Clears the value of `predictivePrefetchRatio`. Subsequent reads from it will return its default value.
    public mutating func clearPredictivePrefetchRatio() {self._predictivePrefetchRatio = nil}

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public init() {}

    fileprivate var _perUpstreamPrefetchRatio: SwiftProtobuf.Google_Protobuf_DoubleValue? = nil
    fileprivate var _predictivePrefetchRatio: SwiftProtobuf.Google_Protobuf_DoubleValue? = nil
  }
...
extension Envoy_Config_Cluster_V4alpha_Cluster.DiscoveryType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Cluster_V4alpha_Cluster.DiscoveryType] = [
    .static,
    .strictDns,
    .logicalDns,
    .eds,
...
extension Envoy_Config_Cluster_V4alpha_Cluster.LbPolicy: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Cluster_V4alpha_Cluster.LbPolicy] = [
    .roundRobin,
    .leastRequest,
    .ringHash,
    .random,
...
extension Envoy_Config_Cluster_V4alpha_Cluster.DnsLookupFamily: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Cluster_V4alpha_Cluster.DnsLookupFamily] = [
    .auto,
    .v4Only,
    .v6Only,
  ]
...
extension Envoy_Config_Cluster_V4alpha_Cluster.ClusterProtocolSelection: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Cluster_V4alpha_Cluster.ClusterProtocolSelection] = [
    .useConfiguredProtocol,
    .useDownstreamProtocol,
  ]
}

extension Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig.LbSubsetFallbackPolicy: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig.LbSubsetFallbackPolicy] = [
    .noFallback,
    .anyEndpoint,
    .defaultSubset,
  ]
...
extension Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig.LbSubsetSelector.LbSubsetSelectorFallbackPolicy: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig.LbSubsetSelector.LbSubsetSelectorFallbackPolicy] = [
    .notDefined,
    .noFallback,
    .anyEndpoint,
    .defaultSubset,
...
extension Envoy_Config_Cluster_V4alpha_Cluster.RingHashLbConfig.HashFunction: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Cluster_V4alpha_Cluster.RingHashLbConfig.HashFunction] = [
    .xxHash,
    .murmurHash2,
  ]
}
...
public struct Envoy_Config_Cluster_V4alpha_LoadBalancingPolicy {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var policies: [Envoy_Config_Cluster_V4alpha_LoadBalancingPolicy.Policy] = []
...
public struct Envoy_Config_Cluster_V4alpha_UpstreamBindConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The address Envoy should bind to when establishing upstream connections.
  public var sourceAddress: Envoy_Config_Core_V4alpha_Address {
    get {return _sourceAddress ?? Envoy_Config_Core_V4alpha_Address()}
  ...
  fileprivate var _sourceAddress: Envoy_Config_Core_V4alpha_Address? = nil
}

public struct Envoy_Config_Cluster_V4alpha_UpstreamConnectionOptions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// If set then set SO_KEEPALIVE on the socket to enable TCP Keepalives.
  public var tcpKeepalive: Envoy_Config_Core_V4alpha_TcpKeepalive {
    get {return _tcpKeepalive ?? Envoy_Config_Core_V4alpha_TcpKeepalive()}
  ...
  fileprivate var _tcpKeepalive: Envoy_Config_Core_V4alpha_TcpKeepalive? = nil
}

public struct Envoy_Config_Cluster_V4alpha_TrackClusterStats {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var timeoutBudgets: Bool = false

  /// If request_response_sizes is true, then the :ref:`histograms
  /// <config_cluster_manager_cluster_stats_request_response_sizes>`  tracking header and body sizes
  /// of requests and responses will be published.
  public var requestResponseSizes: Bool = false
...
extension Envoy_Config_Cluster_V4alpha_ClusterCollection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ClusterCollection"
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_ClusterCollection, rhs: Envoy_Config_Cluster_V4alpha_ClusterCollection) -> Bool {
...
extension Envoy_Config_Cluster_V4alpha_Cluster: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    52: .standard(proto: "maglev_lb_config"),
    ...
    48: .standard(proto: "upstream_config"),
    49: .standard(proto: "track_cluster_stats"),
    50: .standard(proto: "prefetch_policy"),
    51: .standard(proto: "connection_pool_per_downstream_connection"),
  ]

  fileprivate class _StorageClass {
    var _transportSocketMatches: [Envoy_Config_Cluster_V4alpha_Cluster.TransportSocketMatch] = []
    var _name: String = String()
    var _altStatName: String = String()
    var _clusterDiscoveryType: Envoy_Config_Cluster_V4alpha_Cluster.OneOf_ClusterDiscoveryType?
    var _edsClusterConfig: Envoy_Config_Cluster_V4alpha_Cluster.EdsClusterConfig? = nil
    ...
    var _lbPolicy: Envoy_Config_Cluster_V4alpha_Cluster.LbPolicy = .roundRobin
    var _loadAssignment: Envoy_Config_Endpoint_V3_ClusterLoadAssignment? = nil
    var _healthChecks: [Envoy_Config_Core_V4alpha_HealthCheck] = []
    var _maxRequestsPerConnection: SwiftProtobuf.Google_Protobuf_UInt32Value? = nil
    var _circuitBreakers: Envoy_Config_Cluster_V4alpha_CircuitBreakers? = nil
    var _upstreamHTTPProtocolOptions: Envoy_Config_Core_V4alpha_UpstreamHttpProtocolOptions? = nil
    ...
    var _dnsFailureRefreshRate: Envoy_Config_Cluster_V4alpha_Cluster.RefreshRate? = nil
    var _respectDnsTtl: Bool = false
    var _dnsLookupFamily: Envoy_Config_Cluster_V4alpha_Cluster.DnsLookupFamily = .auto
    var _dnsResolvers: [Envoy_Config_Core_V4alpha_Address] = []
    var _useTcpForDnsLookups: Bool = false
    var _outlierDetection: Envoy_Config_Cluster_V4alpha_OutlierDetection? = nil
    var _cleanupInterval: SwiftProtobuf.Google_Protobuf_Duration? = nil
    var _upstreamBindConfig: Envoy_Config_Core_V4alpha_BindConfig? = nil
    var _lbSubsetConfig: Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig? = nil
    var _lbConfig: Envoy_Config_Cluster_V4alpha_Cluster.OneOf_LbConfig?
    var _commonLbConfig: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig? = nil
    var _transportSocket: Envoy_Config_Core_V4alpha_TransportSocket? = nil
    var _metadata: Envoy_Config_Core_V4alpha_Metadata? = nil
    var _protocolSelection: Envoy_Config_Cluster_V4alpha_Cluster.ClusterProtocolSelection = .useConfiguredProtocol
    var _upstreamConnectionOptions: Envoy_Config_Cluster_V4alpha_UpstreamConnectionOptions? = nil
    var _closeConnectionsOnHostHealthFailure: Bool = false
    var _ignoreHealthOnHostRemoval: Bool = false
    var _filters: [Envoy_Config_Cluster_V4alpha_Filter] = []
    var _loadBalancingPolicy: Envoy_Config_Cluster_V4alpha_LoadBalancingPolicy? = nil
    var _lrsServer: Envoy_Config_Core_V4alpha_ConfigSource? = nil
    var _upstreamConfig: Envoy_Config_Core_V4alpha_TypedExtensionConfig? = nil
    var _trackClusterStats: Envoy_Config_Cluster_V4alpha_TrackClusterStats? = nil
    var _prefetchPolicy: Envoy_Config_Cluster_V4alpha_Cluster.PrefetchPolicy? = nil
    var _connectionPoolPerDownstreamConnection: Bool = false
    ...
    init(copying source: _StorageClass) {
      ...
      _upstreamConfig = source._upstreamConfig
      _trackClusterStats = source._trackClusterStats
      _prefetchPolicy = source._prefetchPolicy
      _connectionPoolPerDownstreamConnection = source._connectionPoolPerDownstreamConnection
    }
  }
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try {
          ...
          var v: Envoy_Config_Cluster_V4alpha_Cluster.DiscoveryType?
          try decoder.decodeSingularEnumField(value: &v)
          if let v = v {_storage._clusterDiscoveryType = .type(v)}
        }()
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._edsClusterConfig) }()
        case 4: try { try decoder.decodeSingularMessageField(value: &_storage._connectTimeout) }()
        case 5: try { try decoder.decodeSingularMessageField(value: &_storage._perConnectionBufferLimitBytes) }()
        case 6: try { try decoder.decodeSingularEnumField(value: &_storage._lbPolicy) }()
        case 8: try { try decoder.decodeRepeatedMessageField(value: &_storage._healthChecks) }()
        case 9: try { try decoder.decodeSingularMessageField(value: &_storage._maxRequestsPerConnection) }()
        case 10: try { try decoder.decodeSingularMessageField(value: &_storage._circuitBreakers) }()
        case 13: try { try decoder.decodeSingularMessageField(value: &_storage._httpProtocolOptions) }()
        case 14: try { try decoder.decodeSingularMessageField(value: &_storage._http2ProtocolOptions) }()
        case 16: try { try decoder.decodeSingularMessageField(value: &_storage._dnsRefreshRate) }()
        case 17: try { try decoder.decodeSingularEnumField(value: &_storage._dnsLookupFamily) }()
        case 18: try { try decoder.decodeRepeatedMessageField(value: &_storage._dnsResolvers) }()
        case 19: try { try decoder.decodeSingularMessageField(value: &_storage._outlierDetection) }()
        case 20: try { try decoder.decodeSingularMessageField(value: &_storage._cleanupInterval) }()
        case 21: try { try decoder.decodeSingularMessageField(value: &_storage._upstreamBindConfig) }()
        case 22: try { try decoder.decodeSingularMessageField(value: &_storage._lbSubsetConfig) }()
        case 23: try {
          var v: Envoy_Config_Cluster_V4alpha_Cluster.RingHashLbConfig?
        ...
        case 24: try { try decoder.decodeSingularMessageField(value: &_storage._transportSocket) }()
        case 25: try { try decoder.decodeSingularMessageField(value: &_storage._metadata) }()
        case 26: try { try decoder.decodeSingularEnumField(value: &_storage._protocolSelection) }()
        case 27: try { try decoder.decodeSingularMessageField(value: &_storage._commonLbConfig) }()
        case 28: try { try decoder.decodeSingularStringField(value: &_storage._altStatName) }()
        case 29: try { try decoder.decodeSingularMessageField(value: &_storage._commonHTTPProtocolOptions) }()
        case 30: try { try decoder.decodeSingularMessageField(value: &_storage._upstreamConnectionOptions) }()
        case 31: try { try decoder.decodeSingularBoolField(value: &_storage._closeConnectionsOnHostHealthFailure) }()
        case 32: try { try decoder.decodeSingularBoolField(value: &_storage._ignoreHealthOnHostRemoval) }()
        case 33: try { try decoder.decodeSingularMessageField(value: &_storage._loadAssignment) }()
        case 34: try {
          var v: Envoy_Config_Cluster_V4alpha_Cluster.OriginalDstLbConfig?
          if let current = _storage._lbConfig {
            try decoder.handleConflictingOneOf()
        ...
        case 36: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.Google_Protobuf_Any>.self, value: &_storage._typedExtensionProtocolOptions) }()
        case 37: try {
          var v: Envoy_Config_Cluster_V4alpha_Cluster.LeastRequestLbConfig?
          if let current = _storage._lbConfig {
            try decoder.handleConflictingOneOf()
        ...
        case 38: try {
          var v: Envoy_Config_Cluster_V4alpha_Cluster.CustomClusterType?
        ...
        case 39: try { try decoder.decodeSingularBoolField(value: &_storage._respectDnsTtl) }()
        case 40: try { try decoder.decodeRepeatedMessageField(value: &_storage._filters) }()
        case 41: try { try decoder.decodeSingularMessageField(value: &_storage._loadBalancingPolicy) }()
        case 42: try { try decoder.decodeSingularMessageField(value: &_storage._lrsServer) }()
        case 43: try { try decoder.decodeRepeatedMessageField(value: &_storage._transportSocketMatches) }()
        case 44: try { try decoder.decodeSingularMessageField(value: &_storage._dnsFailureRefreshRate) }()
        case 45: try { try decoder.decodeSingularBoolField(value: &_storage._useTcpForDnsLookups) }()
        case 46: try { try decoder.decodeSingularMessageField(value: &_storage._upstreamHTTPProtocolOptions) }()
        case 48: try { try decoder.decodeSingularMessageField(value: &_storage._upstreamConfig) }()
        case 49: try { try decoder.decodeSingularMessageField(value: &_storage._trackClusterStats) }()
        case 50: try { try decoder.decodeSingularMessageField(value: &_storage._prefetchPolicy) }()
        case 51: try { try decoder.decodeSingularBoolField(value: &_storage._connectionPoolPerDownstreamConnection) }()
        case 52: try {
          var v: Envoy_Config_Cluster_V4alpha_Cluster.MaglevLbConfig?
          if let current = _storage._lbConfig {
            try decoder.handleConflictingOneOf()
            if case .maglevLbConfig(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._lbConfig = .maglevLbConfig(v)}
        }()
        default: break
        }
      }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._upstreamConfig {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 48)
      }
      if let v = _storage._trackClusterStats {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 49)
      }
      if let v = _storage._prefetchPolicy {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 50)
      }
      if _storage._connectionPoolPerDownstreamConnection != false {
        try visitor.visitSingularBoolField(value: _storage._connectionPoolPerDownstreamConnection, fieldNumber: 51)
      }
      if case .maglevLbConfig(let v)? = _storage._lbConfig {
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster, rhs: Envoy_Config_Cluster_V4alpha_Cluster) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._upstreamConfig != rhs_storage._upstreamConfig {return false}
        if _storage._trackClusterStats != rhs_storage._trackClusterStats {return false}
        if _storage._prefetchPolicy != rhs_storage._prefetchPolicy {return false}
        if _storage._connectionPoolPerDownstreamConnection != rhs_storage._connectionPoolPerDownstreamConnection {return false}
        return true
      }
...
extension Envoy_Config_Cluster_V4alpha_Cluster.DiscoveryType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "STATIC"),
...
extension Envoy_Config_Cluster_V4alpha_Cluster.LbPolicy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Config_Cluster_V4alpha_Cluster.DnsLookupFamily: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "AUTO"),
...
extension Envoy_Config_Cluster_V4alpha_Cluster.ClusterProtocolSelection: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Config_Cluster_V4alpha_Cluster.TransportSocketMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.protoMessageName + ".TransportSocketMatch"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .same(proto: "match"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularMessageField(value: &self._transportSocket) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.TransportSocketMatch, rhs: Envoy_Config_Cluster_V4alpha_Cluster.TransportSocketMatch) -> Bool {
...
extension Envoy_Config_Cluster_V4alpha_Cluster.CustomClusterType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.protoMessageName + ".CustomClusterType"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.CustomClusterType, rhs: Envoy_Config_Cluster_V4alpha_Cluster.CustomClusterType) -> Bool {
    if lhs.name != rhs.name {return false}
...
extension Envoy_Config_Cluster_V4alpha_Cluster.EdsClusterConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.protoMessageName + ".EdsClusterConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "eds_config"),
    2: .standard(proto: "service_name"),
    3: .standard(proto: "eds_resource_locator"),
  ]

  fileprivate class _StorageClass {
    var _edsConfig: Envoy_Config_Core_V4alpha_ConfigSource? = nil
    var _nameSpecifier: Envoy_Config_Cluster_V4alpha_Cluster.EdsClusterConfig.OneOf_NameSpecifier?
    ...
    init(copying source: _StorageClass) {
      _edsConfig = source._edsConfig
      _nameSpecifier = source._nameSpecifier
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularMessageField(value: &_storage._edsConfig) }()
        case 2: try {
          if _storage._nameSpecifier != nil {try decoder.handleConflictingOneOf()}
          var v: String?
          try decoder.decodeSingularStringField(value: &v)
          if let v = v {_storage._nameSpecifier = .serviceName(v)}
        }()
        case 3: try {
          var v: Udpa_Core_V1_ResourceLocator?
          if let current = _storage._nameSpecifier {
            try decoder.handleConflictingOneOf()
            if case .edsResourceLocator(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._nameSpecifier = .edsResourceLocator(v)}
        }()
        default: break
        }
      }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      if let v = _storage._edsConfig {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
      }
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch _storage._nameSpecifier {
      case .serviceName?: try {
        guard case .serviceName(let v)? = _storage._nameSpecifier else { preconditionFailure() }
        try visitor.visitSingularStringField(value: v, fieldNumber: 2)
      }()
      case .edsResourceLocator?: try {
        guard case .edsResourceLocator(let v)? = _storage._nameSpecifier else { preconditionFailure() }
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      }()
      case nil: break
      }
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.EdsClusterConfig, rhs: Envoy_Config_Cluster_V4alpha_Cluster.EdsClusterConfig) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._edsConfig != rhs_storage._edsConfig {return false}
        if _storage._nameSpecifier != rhs_storage._nameSpecifier {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.protoMessageName + ".LbSubsetConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularEnumField(value: &self.fallbackPolicy) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._defaultSubset) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.subsetSelectors) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self.localityWeightAware) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self.scaleLocalityWeight) }()
      case 6: try { try decoder.decodeSingularBoolField(value: &self.panicModeAny) }()
      case 7: try { try decoder.decodeSingularBoolField(value: &self.listAsAny) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig, rhs: Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig) -> Bool {
...
extension Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig.LbSubsetFallbackPolicy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig.LbSubsetSelector: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig.protoMessageName + ".LbSubsetSelector"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "keys"),
    4: .standard(proto: "single_host_per_subset"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularEnumField(value: &self.fallbackPolicy) }()
      case 3: try { try decoder.decodeRepeatedStringField(value: &self.fallbackKeysSubset) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self.singleHostPerSubset) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.singleHostPerSubset != false {
      try visitor.visitSingularBoolField(value: self.singleHostPerSubset, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig.LbSubsetSelector, rhs: Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig.LbSubsetSelector) -> Bool {
    if lhs.keys != rhs.keys {return false}
    if lhs.singleHostPerSubset != rhs.singleHostPerSubset {return false}
    if lhs.fallbackPolicy != rhs.fallbackPolicy {return false}
...
extension Envoy_Config_Cluster_V4alpha_Cluster.LbSubsetConfig.LbSubsetSelector.LbSubsetSelectorFallbackPolicy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Config_Cluster_V4alpha_Cluster.LeastRequestLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.protoMessageName + ".LeastRequestLbConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "choice_count"),
    2: .standard(proto: "active_request_bias"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._choiceCount) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._activeRequestBias) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._activeRequestBias {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.LeastRequestLbConfig, rhs: Envoy_Config_Cluster_V4alpha_Cluster.LeastRequestLbConfig) -> Bool {
    if lhs._choiceCount != rhs._choiceCount {return false}
    if lhs._activeRequestBias != rhs._activeRequestBias {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Cluster_V4alpha_Cluster.RingHashLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.protoMessageName + ".RingHashLbConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._minimumRingSize) }()
      case 3: try { try decoder.decodeSingularEnumField(value: &self.hashFunction) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._maximumRingSize) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.RingHashLbConfig, rhs: Envoy_Config_Cluster_V4alpha_Cluster.RingHashLbConfig) -> Bool {
...
extension Envoy_Config_Cluster_V4alpha_Cluster.RingHashLbConfig.HashFunction: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Config_Cluster_V4alpha_Cluster.MaglevLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.protoMessageName + ".MaglevLbConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "table_size"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._tableSize) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._tableSize {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.MaglevLbConfig, rhs: Envoy_Config_Cluster_V4alpha_Cluster.MaglevLbConfig) -> Bool {
    if lhs._tableSize != rhs._tableSize {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Cluster_V4alpha_Cluster.OriginalDstLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.protoMessageName + ".OriginalDstLbConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.useHTTPHeader) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.OriginalDstLbConfig, rhs: Envoy_Config_Cluster_V4alpha_Cluster.OriginalDstLbConfig) -> Bool {
...
extension Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.protoMessageName + ".CommonLbConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._healthyPanicThreshold) }()
      case 2: try {
        var v: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.ZoneAwareLbConfig?
      ...
      case 3: try {
        var v: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.LocalityWeightedLbConfig?
        if let current = self.localityConfigSpecifier {
          try decoder.handleConflictingOneOf()
      ...
      case 4: try { try decoder.decodeSingularMessageField(value: &self._updateMergeWindow) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self.ignoreNewHostsUntilFirstHc) }()
      case 6: try { try decoder.decodeSingularBoolField(value: &self.closeConnectionsOnHostSetChange) }()
      case 7: try { try decoder.decodeSingularMessageField(value: &self._consistentHashingLbConfig) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .zoneAwareLbConfig?: try {
      guard case .zoneAwareLbConfig(let v)? = self.localityConfigSpecifier else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }()
    case .localityWeightedLbConfig?: try {
      guard case .localityWeightedLbConfig(let v)? = self.localityConfigSpecifier else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }()
    case nil: break
    }
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig, rhs: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig) -> Bool {
...
extension Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.ZoneAwareLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.protoMessageName + ".ZoneAwareLbConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._routingEnabled) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._minClusterSize) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.failTrafficOnPanic) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.ZoneAwareLbConfig, rhs: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.ZoneAwareLbConfig) -> Bool {
...
extension Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.LocalityWeightedLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.protoMessageName + ".LocalityWeightedLbConfig"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.LocalityWeightedLbConfig, rhs: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.LocalityWeightedLbConfig) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.ConsistentHashingLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.protoMessageName + ".ConsistentHashingLbConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "use_hostname_for_hashing"),
    2: .standard(proto: "hash_balance_factor"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.useHostnameForHashing) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._hashBalanceFactor) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._hashBalanceFactor {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.ConsistentHashingLbConfig, rhs: Envoy_Config_Cluster_V4alpha_Cluster.CommonLbConfig.ConsistentHashingLbConfig) -> Bool {
    if lhs.useHostnameForHashing != rhs.useHostnameForHashing {return false}
    if lhs._hashBalanceFactor != rhs._hashBalanceFactor {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Cluster_V4alpha_Cluster.RefreshRate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.protoMessageName + ".RefreshRate"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.RefreshRate, rhs: Envoy_Config_Cluster_V4alpha_Cluster.RefreshRate) -> Bool {
...
extension Envoy_Config_Cluster_V4alpha_Cluster.PrefetchPolicy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_Cluster.protoMessageName + ".PrefetchPolicy"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "per_upstream_prefetch_ratio"),
    2: .standard(proto: "predictive_prefetch_ratio"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._perUpstreamPrefetchRatio) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._predictivePrefetchRatio) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._perUpstreamPrefetchRatio {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }
    if let v = self._predictivePrefetchRatio {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_Cluster.PrefetchPolicy, rhs: Envoy_Config_Cluster_V4alpha_Cluster.PrefetchPolicy) -> Bool {
    if lhs._perUpstreamPrefetchRatio != rhs._perUpstreamPrefetchRatio {return false}
    if lhs._predictivePrefetchRatio != rhs._predictivePrefetchRatio {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Cluster_V4alpha_LoadBalancingPolicy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_LoadBalancingPolicy, rhs: Envoy_Config_Cluster_V4alpha_LoadBalancingPolicy) -> Bool {
...
extension Envoy_Config_Cluster_V4alpha_LoadBalancingPolicy.Policy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Cluster_V4alpha_LoadBalancingPolicy.protoMessageName + ".Policy"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_LoadBalancingPolicy.Policy, rhs: Envoy_Config_Cluster_V4alpha_LoadBalancingPolicy.Policy) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs._typedConfig != rhs._typedConfig {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Envoy_Config_Cluster_V4alpha_UpstreamBindConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_UpstreamBindConfig, rhs: Envoy_Config_Cluster_V4alpha_UpstreamBindConfig) -> Bool {
...
extension Envoy_Config_Cluster_V4alpha_UpstreamConnectionOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._tcpKeepalive) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_UpstreamConnectionOptions, rhs: Envoy_Config_Cluster_V4alpha_UpstreamConnectionOptions) -> Bool {
...
extension Envoy_Config_Cluster_V4alpha_TrackClusterStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TrackClusterStats"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "timeout_budgets"),
    2: .standard(proto: "request_response_sizes"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.timeoutBudgets) }()
      case 2: try { try decoder.decodeSingularBoolField(value: &self.requestResponseSizes) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.timeoutBudgets != false {
      try visitor.visitSingularBoolField(value: self.timeoutBudgets, fieldNumber: 1)
    }
    if self.requestResponseSizes != false {
      try visitor.visitSingularBoolField(value: self.requestResponseSizes, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Cluster_V4alpha_TrackClusterStats, rhs: Envoy_Config_Cluster_V4alpha_TrackClusterStats) -> Bool {
    if lhs.timeoutBudgets != rhs.timeoutBudgets {return false}
    if lhs.requestResponseSizes != rhs.requestResponseSizes {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
