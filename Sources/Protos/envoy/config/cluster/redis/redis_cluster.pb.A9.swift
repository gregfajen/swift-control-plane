...
/// [#next-free-field: 7]
public struct Envoy_Config_Cluster_Redis_RedisClusterConfig {
...
fileprivate let _protobuf_package = "envoy.config.cluster.redis"

extension Envoy_Config_Cluster_Redis_RedisClusterConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._clusterRefreshRate) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._clusterRefreshTimeout) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._redirectRefreshInterval) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._redirectRefreshThreshold) }()
      case 5: try { try decoder.decodeSingularUInt32Field(value: &self.failureRefreshThreshold) }()
      case 6: try { try decoder.decodeSingularUInt32Field(value: &self.hostDegradedRefreshThreshold) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Cluster_Redis_RedisClusterConfig, rhs: Envoy_Config_Cluster_Redis_RedisClusterConfig) -> Bool {
