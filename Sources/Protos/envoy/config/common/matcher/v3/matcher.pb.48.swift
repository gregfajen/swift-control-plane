...
/// [#next-free-field: 11]
public struct Envoy_Config_Common_Matcher_V3_MatchPredicate {
  ...
  /// matches.
  public var orMatch: Envoy_Config_Common_Matcher_V3_MatchPredicate.MatchSet {
    get {
      if case .orMatch(let v)? = _storage._rule {return v}
      return Envoy_Config_Common_Matcher_V3_MatchPredicate.MatchSet()
    }
  ...
  /// matches.
  public var andMatch: Envoy_Config_Common_Matcher_V3_MatchPredicate.MatchSet {
    get {
  ...
  public var notMatch: Envoy_Config_Common_Matcher_V3_MatchPredicate {
    get {
  ...
  public var httpRequestHeadersMatch: Envoy_Config_Common_Matcher_V3_HttpHeadersMatch {
    get {
  ...
  public var httpRequestTrailersMatch: Envoy_Config_Common_Matcher_V3_HttpHeadersMatch {
    get {
  ...
  public var httpResponseHeadersMatch: Envoy_Config_Common_Matcher_V3_HttpHeadersMatch {
    get {
  ...
  public var httpResponseTrailersMatch: Envoy_Config_Common_Matcher_V3_HttpHeadersMatch {
    get {
  ...
  public var httpRequestGenericBodyMatch: Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch {
    get {
  ...
  public var httpResponseGenericBodyMatch: Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch {
    get {
  ...
  public enum OneOf_Rule: Equatable {
    /// A set that describes a logical OR. If any member of the set matches, the match configuration
    /// matches.
    case orMatch(Envoy_Config_Common_Matcher_V3_MatchPredicate.MatchSet)
    /// A set that describes a logical AND. If all members of the set match, the match configuration
    /// matches.
    case andMatch(Envoy_Config_Common_Matcher_V3_MatchPredicate.MatchSet)
    /// A negation match. The match configuration will match if the negated match condition matches.
    case notMatch(Envoy_Config_Common_Matcher_V3_MatchPredicate)
    /// The match configuration will always match.
    case anyMatch(Bool)
    /// HTTP request headers match configuration.
    case httpRequestHeadersMatch(Envoy_Config_Common_Matcher_V3_HttpHeadersMatch)
    /// HTTP request trailers match configuration.
    case httpRequestTrailersMatch(Envoy_Config_Common_Matcher_V3_HttpHeadersMatch)
    /// HTTP response headers match configuration.
    case httpResponseHeadersMatch(Envoy_Config_Common_Matcher_V3_HttpHeadersMatch)
    /// HTTP response trailers match configuration.
    case httpResponseTrailersMatch(Envoy_Config_Common_Matcher_V3_HttpHeadersMatch)
    /// HTTP request generic body match configuration.
    case httpRequestGenericBodyMatch(Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch)
    /// HTTP response generic body match configuration.
    case httpResponseGenericBodyMatch(Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Common_Matcher_V3_MatchPredicate.OneOf_Rule, rhs: Envoy_Config_Common_Matcher_V3_MatchPredicate.OneOf_Rule) -> Bool {
  ...
  public struct MatchSet {
    ...
    public var rules: [Envoy_Config_Common_Matcher_V3_MatchPredicate] = []
...
public struct Envoy_Config_Common_Matcher_V3_HttpHeadersMatch {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var patterns: [Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch.GenericTextMatch] = []
  ...
  public struct GenericTextMatch {
    ...
    public var rule: Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch.GenericTextMatch.OneOf_Rule? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch.GenericTextMatch.OneOf_Rule, rhs: Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch.GenericTextMatch.OneOf_Rule) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
...
fileprivate let _protobuf_package = "envoy.config.common.matcher.v3"

extension Envoy_Config_Common_Matcher_V3_MatchPredicate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _rule: Envoy_Config_Common_Matcher_V3_MatchPredicate.OneOf_Rule?
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        switch fieldNumber {
        case 1: try {
          var v: Envoy_Config_Common_Matcher_V3_MatchPredicate.MatchSet?
        ...
        case 3: try {
          var v: Envoy_Config_Common_Matcher_V3_MatchPredicate?
          if let current = _storage._rule {
            try decoder.handleConflictingOneOf()
        ...
        case 5: try {
          var v: Envoy_Config_Common_Matcher_V3_HttpHeadersMatch?
          if let current = _storage._rule {
            try decoder.handleConflictingOneOf()
        ...
        case 9: try {
          var v: Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch?
          if let current = _storage._rule {
            try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Config_Common_Matcher_V3_MatchPredicate, rhs: Envoy_Config_Common_Matcher_V3_MatchPredicate) -> Bool {
...
extension Envoy_Config_Common_Matcher_V3_MatchPredicate.MatchSet: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Common_Matcher_V3_MatchPredicate.protoMessageName + ".MatchSet"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "rules"),
  ]
  ...
  public static func ==(lhs: Envoy_Config_Common_Matcher_V3_MatchPredicate.MatchSet, rhs: Envoy_Config_Common_Matcher_V3_MatchPredicate.MatchSet) -> Bool {
...
extension Envoy_Config_Common_Matcher_V3_HttpHeadersMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Common_Matcher_V3_HttpHeadersMatch, rhs: Envoy_Config_Common_Matcher_V3_HttpHeadersMatch) -> Bool {
...
extension Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch, rhs: Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch) -> Bool {
...
extension Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch.GenericTextMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch.protoMessageName + ".GenericTextMatch"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch.GenericTextMatch, rhs: Envoy_Config_Common_Matcher_V3_HttpGenericBodyMatch.GenericTextMatch) -> Bool {
