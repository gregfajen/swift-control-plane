...
/// [#next-free-field: 7]
public struct Envoy_Config_Common_DynamicForwardProxy_V2alpha_DnsCacheConfig {
  ...
  public var dnsLookupFamily: Envoy_Api_V2_Cluster.DnsLookupFamily = .auto
  ...
  public var dnsFailureRefreshRate: Envoy_Api_V2_Cluster.RefreshRate {
    get {return _dnsFailureRefreshRate ?? Envoy_Api_V2_Cluster.RefreshRate()}
  ...
  fileprivate var _dnsFailureRefreshRate: Envoy_Api_V2_Cluster.RefreshRate? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.config.common.dynamic_forward_proxy.v2alpha"

extension Envoy_Config_Common_DynamicForwardProxy_V2alpha_DnsCacheConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Common_DynamicForwardProxy_V2alpha_DnsCacheConfig, rhs: Envoy_Config_Common_DynamicForwardProxy_V2alpha_DnsCacheConfig) -> Bool {
