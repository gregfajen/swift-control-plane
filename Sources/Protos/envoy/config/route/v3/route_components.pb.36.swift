...
public struct Envoy_Config_Route_V3_Route {
  ...
  public var match: Envoy_Config_Route_V3_RouteMatch {
    get {return _storage._match ?? Envoy_Config_Route_V3_RouteMatch()}
  ...
  public var decorator: Envoy_Config_Route_V3_Decorator {
    get {return _storage._decorator ?? Envoy_Config_Route_V3_Decorator()}
  ...
  public var tracing: Envoy_Config_Route_V3_Tracing {
    get {return _storage._tracing ?? Envoy_Config_Route_V3_Tracing()}
...
public struct Envoy_Config_Route_V3_RouteAction {
  ...
  public var hostRewritePathRegex: Envoy_Type_Matcher_V3_RegexMatchAndSubstitute {
    get {
  ...
  public var maxStreamDuration: Envoy_Config_Route_V3_RouteAction.MaxStreamDuration {
    get {return _storage._maxStreamDuration ?? Envoy_Config_Route_V3_RouteAction.MaxStreamDuration()}
  ...
  public enum OneOf_HostRewriteSpecifier: Equatable {
    ...
    ///
    /// Would rewrite the host header to `envoyproxy.io` given the path `/envoyproxy.io/some/path`.
    case hostRewritePathRegex(Envoy_Type_Matcher_V3_RegexMatchAndSubstitute)
  ...
  public struct HashPolicy {
    ...
    public struct Header {
      ...
      public var regexRewrite: Envoy_Type_Matcher_V3_RegexMatchAndSubstitute {
        get {return _regexRewrite ?? Envoy_Type_Matcher_V3_RegexMatchAndSubstitute()}
      ...
      fileprivate var _regexRewrite: Envoy_Type_Matcher_V3_RegexMatchAndSubstitute? = nil
    }
...
public struct Envoy_Config_Route_V3_RetryPolicy {
  ...
  public var numRetries: SwiftProtobuf.Google_Protobuf_UInt32Value {
    get {return _storage._numRetries ?? SwiftProtobuf.Google_Protobuf_UInt32Value()}
    set {_uniqueStorage()._numRetries = newValue}
  }
  /// Returns true if `numRetries` has been explicitly set.
  public var hasNumRetries: Bool {return _storage._numRetries != nil}
  /// Clears the value of `numRetries`. Subsequent reads from it will return its default value.
  public mutating func clearNumRetries() {_uniqueStorage()._numRetries = nil}
  ...
  public var retryPriority: Envoy_Config_Route_V3_RetryPolicy.RetryPriority {
    get {return _storage._retryPriority ?? Envoy_Config_Route_V3_RetryPolicy.RetryPriority()}
  ...
  public var retryBackOff: Envoy_Config_Route_V3_RetryPolicy.RetryBackOff {
    get {return _storage._retryBackOff ?? Envoy_Config_Route_V3_RetryPolicy.RetryBackOff()}
  ...
  public var rateLimitedRetryBackOff: Envoy_Config_Route_V3_RetryPolicy.RateLimitedRetryBackOff {
    get {return _storage._rateLimitedRetryBackOff ?? Envoy_Config_Route_V3_RetryPolicy.RateLimitedRetryBackOff()}
  ...
  public struct ResetHeader {
    ...
    public var format: Envoy_Config_Route_V3_RetryPolicy.ResetHeaderFormat = .seconds
  ...
  public struct RateLimitedRetryBackOff {
    ...
    public var resetHeaders: [Envoy_Config_Route_V3_RetryPolicy.ResetHeader] = []
...
extension Envoy_Config_Route_V3_RetryPolicy.ResetHeaderFormat: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Route_V3_RetryPolicy.ResetHeaderFormat] = [
    .seconds,
    .unixTimestamp,
  ]
}
...
public struct Envoy_Config_Route_V3_RateLimit {
  ...
  public var limit: Envoy_Config_Route_V3_RateLimit.Override {
    get {return _limit ?? Envoy_Config_Route_V3_RateLimit.Override()}
    set {_limit = newValue}
  }
  ...
  public struct Action {
    ...
    public var dynamicMetadata: Envoy_Config_Route_V3_RateLimit.Action.DynamicMetaData {
      get {
        if case .dynamicMetadata(let v)? = actionSpecifier {return v}
        return Envoy_Config_Route_V3_RateLimit.Action.DynamicMetaData()
      }
      set {actionSpecifier = .dynamicMetadata(newValue)}
    }

    /// Rate limit on metadata.
    public var metadata: Envoy_Config_Route_V3_RateLimit.Action.MetaData {
      get {
        if case .metadata(let v)? = actionSpecifier {return v}
        return Envoy_Config_Route_V3_RateLimit.Action.MetaData()
      }
    ...
    public enum OneOf_ActionSpecifier: Equatable {
      ...
      /// .. attention::
      ///   This field has been deprecated in favor of the :ref:`metadata <envoy_api_field_config.route.v3.RateLimit.Action.metadata>` field
      case dynamicMetadata(Envoy_Config_Route_V3_RateLimit.Action.DynamicMetaData)
      /// Rate limit on metadata.
      case metadata(Envoy_Config_Route_V3_RateLimit.Action.MetaData)
    ...
    public struct MetaData {
      ...
      /// Source of metadata
      public var source: Envoy_Config_Route_V3_RateLimit.Action.MetaData.Source = .dynamic
  ...
  public struct Override {
    ...
    public var overrideSpecifier: Envoy_Config_Route_V3_RateLimit.Override.OneOf_OverrideSpecifier? = nil

    /// Limit override from dynamic metadata.
    public var dynamicMetadata: Envoy_Config_Route_V3_RateLimit.Override.DynamicMetadata {
      get {
        if case .dynamicMetadata(let v)? = overrideSpecifier {return v}
        return Envoy_Config_Route_V3_RateLimit.Override.DynamicMetadata()
      }
    ...
    public enum OneOf_OverrideSpecifier: Equatable {
      /// Limit override from dynamic metadata.
      case dynamicMetadata(Envoy_Config_Route_V3_RateLimit.Override.DynamicMetadata)

    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Config_Route_V3_RateLimit.Override.OneOf_OverrideSpecifier, rhs: Envoy_Config_Route_V3_RateLimit.Override.OneOf_OverrideSpecifier) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
  ...
  fileprivate var _limit: Envoy_Config_Route_V3_RateLimit.Override? = nil
}

#if swift(>=4.2)

extension Envoy_Config_Route_V3_RateLimit.Action.MetaData.Source: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Route_V3_RateLimit.Action.MetaData.Source] = [
    .dynamic,
    .routeEntry,
  ]
}
...
extension Envoy_Config_Route_V3_Route: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _name: String = String()
    var _match: Envoy_Config_Route_V3_RouteMatch? = nil
    var _action: Envoy_Config_Route_V3_Route.OneOf_Action?
    var _metadata: Envoy_Config_Core_V3_Metadata? = nil
    var _decorator: Envoy_Config_Route_V3_Decorator? = nil
    var _typedPerFilterConfig: Dictionary<String,SwiftProtobuf.Google_Protobuf_Any> = [:]
    var _requestHeadersToAdd: [Envoy_Config_Core_V3_HeaderValueOption] = []
    var _requestHeadersToRemove: [String] = []
    var _responseHeadersToAdd: [Envoy_Config_Core_V3_HeaderValueOption] = []
    var _responseHeadersToRemove: [String] = []
    var _tracing: Envoy_Config_Route_V3_Tracing? = nil
    var _perRequestBufferLimitBytes: SwiftProtobuf.Google_Protobuf_UInt32Value? = nil
...
extension Envoy_Config_Route_V3_RouteAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _hedgePolicy: Envoy_Config_Route_V3_HedgePolicy? = nil
    var _maxStreamDuration: Envoy_Config_Route_V3_RouteAction.MaxStreamDuration? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 35: try {
          var v: Envoy_Type_Matcher_V3_RegexMatchAndSubstitute?
          if let current = _storage._hostRewriteSpecifier {
            try decoder.handleConflictingOneOf()
...
extension Envoy_Config_Route_V3_RouteAction.MaxStreamDuration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Route_V3_RouteAction.protoMessageName + ".MaxStreamDuration"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Route_V3_RouteAction.MaxStreamDuration, rhs: Envoy_Config_Route_V3_RouteAction.MaxStreamDuration) -> Bool {
...
extension Envoy_Config_Route_V3_RetryPolicy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _numRetries: SwiftProtobuf.Google_Protobuf_UInt32Value? = nil
    var _perTryTimeout: SwiftProtobuf.Google_Protobuf_Duration? = nil
    var _retryPriority: Envoy_Config_Route_V3_RetryPolicy.RetryPriority? = nil
    var _retryHostPredicate: [Envoy_Config_Route_V3_RetryPolicy.RetryHostPredicate] = []
    var _hostSelectionRetryMaxAttempts: Int64 = 0
    var _retriableStatusCodes: [UInt32] = []
    var _retryBackOff: Envoy_Config_Route_V3_RetryPolicy.RetryBackOff? = nil
    var _rateLimitedRetryBackOff: Envoy_Config_Route_V3_RetryPolicy.RateLimitedRetryBackOff? = nil
    var _retriableHeaders: [Envoy_Config_Route_V3_HeaderMatcher] = []
    var _retriableRequestHeaders: [Envoy_Config_Route_V3_HeaderMatcher] = []
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._numRetries) }()
...
extension Envoy_Config_Route_V3_RetryPolicy.ResetHeaderFormat: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Config_Route_V3_RetryPolicy.ResetHeader: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Route_V3_RetryPolicy.protoMessageName + ".ResetHeader"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .same(proto: "format"),
  ]
  ...
  public static func ==(lhs: Envoy_Config_Route_V3_RetryPolicy.ResetHeader, rhs: Envoy_Config_Route_V3_RetryPolicy.ResetHeader) -> Bool {
    if lhs.name != rhs.name {return false}
...
extension Envoy_Config_Route_V3_RetryPolicy.RateLimitedRetryBackOff: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Route_V3_RetryPolicy.protoMessageName + ".RateLimitedRetryBackOff"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Route_V3_RetryPolicy.RateLimitedRetryBackOff, rhs: Envoy_Config_Route_V3_RetryPolicy.RateLimitedRetryBackOff) -> Bool {
...
extension Envoy_Config_Route_V3_RateLimit.Action: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    7: .standard(proto: "dynamic_metadata"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try {
        var v: Envoy_Config_Route_V3_RateLimit.Action.DynamicMetaData?
        if let current = self.actionSpecifier {
          try decoder.handleConflictingOneOf()
          if case .dynamicMetadata(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.actionSpecifier = .dynamicMetadata(v)}
      }()
      case 8: try {
        var v: Envoy_Config_Route_V3_RateLimit.Action.MetaData?
        if let current = self.actionSpecifier {
          try decoder.handleConflictingOneOf()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .dynamicMetadata?: try {
      guard case .dynamicMetadata(let v)? = self.actionSpecifier else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 7)
    }()
    case .metadata?: try {
...
extension Envoy_Config_Route_V3_RateLimit.Action.DynamicMetaData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Route_V3_RateLimit.Action.protoMessageName + ".DynamicMetaData"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Route_V3_RateLimit.Action.DynamicMetaData, rhs: Envoy_Config_Route_V3_RateLimit.Action.DynamicMetaData) -> Bool {
    if lhs.descriptorKey != rhs.descriptorKey {return false}
...
extension Envoy_Config_Route_V3_RateLimit.Action.MetaData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Route_V3_RateLimit.Action.protoMessageName + ".MetaData"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "descriptor_key"),
    2: .standard(proto: "metadata_key"),
    3: .standard(proto: "default_value"),
  ...
  public static func ==(lhs: Envoy_Config_Route_V3_RateLimit.Action.MetaData, rhs: Envoy_Config_Route_V3_RateLimit.Action.MetaData) -> Bool {
    if lhs.descriptorKey != rhs.descriptorKey {return false}
    if lhs._metadataKey != rhs._metadataKey {return false}
    if lhs.defaultValue != rhs.defaultValue {return false}
...
extension Envoy_Config_Route_V3_RateLimit.Action.MetaData.Source: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Config_Route_V3_RateLimit.Override: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Route_V3_RateLimit.protoMessageName + ".Override"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Envoy_Config_Route_V3_RateLimit.Override.DynamicMetadata?
  ...
  public static func ==(lhs: Envoy_Config_Route_V3_RateLimit.Override, rhs: Envoy_Config_Route_V3_RateLimit.Override) -> Bool {
...
extension Envoy_Config_Route_V3_RateLimit.Override.DynamicMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Route_V3_RateLimit.Override.protoMessageName + ".DynamicMetadata"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Route_V3_RateLimit.Override.DynamicMetadata, rhs: Envoy_Config_Route_V3_RateLimit.Override.DynamicMetadata) -> Bool {
    if lhs._metadataKey != rhs._metadataKey {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
