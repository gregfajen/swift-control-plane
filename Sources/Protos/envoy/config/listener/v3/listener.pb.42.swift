...
public struct Envoy_Config_Listener_V3_ListenerCollection {
...
public struct Envoy_Config_Listener_V3_Listener {
  ...
  public var defaultFilterChain: Envoy_Config_Listener_V3_FilterChain {
    get {return _storage._defaultFilterChain ?? Envoy_Config_Listener_V3_FilterChain()}
  ...
  /// [#not-implemented-hide:]
  public var udpWriterConfig: Envoy_Config_Core_V3_TypedExtensionConfig {
    get {return _storage._udpWriterConfig ?? Envoy_Config_Core_V3_TypedExtensionConfig()}
...
extension Envoy_Config_Listener_V3_ListenerCollection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Listener_V3_ListenerCollection, rhs: Envoy_Config_Listener_V3_ListenerCollection) -> Bool {
...
extension Envoy_Config_Listener_V3_Listener: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _defaultFilterChain: Envoy_Config_Listener_V3_FilterChain? = nil
    ...
    var _udpWriterConfig: Envoy_Config_Core_V3_TypedExtensionConfig? = nil
