...
public struct Envoy_Config_Listener_V4alpha_FilterChain {
  ...
  public var filterChainMatch: Envoy_Config_Listener_V4alpha_FilterChainMatch {
    get {return _storage._filterChainMatch ?? Envoy_Config_Listener_V4alpha_FilterChainMatch()}
  ...
  public var onDemandConfiguration: Envoy_Config_Listener_V4alpha_FilterChain.OnDemandConfiguration {
    get {return _storage._onDemandConfiguration ?? Envoy_Config_Listener_V4alpha_FilterChain.OnDemandConfiguration()}
...
extension Envoy_Config_Listener_V4alpha_FilterChain: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _filterChainMatch: Envoy_Config_Listener_V4alpha_FilterChainMatch? = nil
    var _filters: [Envoy_Config_Listener_V4alpha_Filter] = []
    ...
    var _onDemandConfiguration: Envoy_Config_Listener_V4alpha_FilterChain.OnDemandConfiguration? = nil
...
extension Envoy_Config_Listener_V4alpha_FilterChain.OnDemandConfiguration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Listener_V4alpha_FilterChain.protoMessageName + ".OnDemandConfiguration"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Listener_V4alpha_FilterChain.OnDemandConfiguration, rhs: Envoy_Config_Listener_V4alpha_FilterChain.OnDemandConfiguration) -> Bool {
