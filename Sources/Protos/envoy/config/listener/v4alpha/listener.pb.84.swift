...
public struct Envoy_Config_Listener_V4alpha_ListenerCollection {
...
/// [#next-free-field: 26]
public struct Envoy_Config_Listener_V4alpha_Listener {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var filterChains: [Envoy_Config_Listener_V4alpha_FilterChain] {
  ...
  public var defaultFilterChain: Envoy_Config_Listener_V4alpha_FilterChain {
    get {return _storage._defaultFilterChain ?? Envoy_Config_Listener_V4alpha_FilterChain()}
    set {_uniqueStorage()._defaultFilterChain = newValue}
  }
  /// Returns true if `defaultFilterChain` has been explicitly set.
  public var hasDefaultFilterChain: Bool {return _storage._defaultFilterChain != nil}
  /// Clears the value of `defaultFilterChain`. Subsequent reads from it will return its default value.
  public mutating func clearDefaultFilterChain() {_uniqueStorage()._defaultFilterChain = nil}
  ...
  /// [#not-implemented-hide:]
  public var deprecatedV1: Envoy_Config_Listener_V4alpha_Listener.DeprecatedV1 {
    get {return _storage._deprecatedV1 ?? Envoy_Config_Listener_V4alpha_Listener.DeprecatedV1()}
  ...
  public var drainType: Envoy_Config_Listener_V4alpha_Listener.DrainType {
  ...
  public var listenerFilters: [Envoy_Config_Listener_V4alpha_ListenerFilter] {
  ...
  public var trafficDirection: Envoy_Config_Core_V4alpha_TrafficDirection {
  ...
  public var udpListenerConfig: Envoy_Config_Listener_V4alpha_UdpListenerConfig {
    get {return _storage._udpListenerConfig ?? Envoy_Config_Listener_V4alpha_UdpListenerConfig()}
  ...
  public var apiListener: Envoy_Config_Listener_V4alpha_ApiListener {
    get {return _storage._apiListener ?? Envoy_Config_Listener_V4alpha_ApiListener()}
  ...
  /// worker threads.
  public var connectionBalanceConfig: Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig {
    get {return _storage._connectionBalanceConfig ?? Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig()}
  ...
  /// [#not-implemented-hide:]
  public var udpWriterConfig: Envoy_Config_Core_V4alpha_TypedExtensionConfig {
    get {return _storage._udpWriterConfig ?? Envoy_Config_Core_V4alpha_TypedExtensionConfig()}
    set {_uniqueStorage()._udpWriterConfig = newValue}
  }
  /// Returns true if `udpWriterConfig` has been explicitly set.
  public var hasUdpWriterConfig: Bool {return _storage._udpWriterConfig != nil}
  /// Clears the value of `udpWriterConfig`. Subsequent reads from it will return its default value.
  public mutating func clearUdpWriterConfig() {_uniqueStorage()._udpWriterConfig = nil}
  ...
  public var tcpBacklogSize: SwiftProtobuf.Google_Protobuf_UInt32Value {
    get {return _storage._tcpBacklogSize ?? SwiftProtobuf.Google_Protobuf_UInt32Value()}
    set {_uniqueStorage()._tcpBacklogSize = newValue}
  }
  /// Returns true if `tcpBacklogSize` has been explicitly set.
  public var hasTcpBacklogSize: Bool {return _storage._tcpBacklogSize != nil}
  /// Clears the value of `tcpBacklogSize`. Subsequent reads from it will return its default value.
  public mutating func clearTcpBacklogSize() {_uniqueStorage()._tcpBacklogSize = nil}
  ...
  public struct ConnectionBalanceConfig {
    ...
    public var balanceType: Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig.OneOf_BalanceType? = nil

    /// If specified, the listener will use the exact connection balancer.
    public var exactBalance: Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig.ExactBalance {
      get {
        if case .exactBalance(let v)? = balanceType {return v}
        return Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig.ExactBalance()
      }
    ...
    public enum OneOf_BalanceType: Equatable {
      /// If specified, the listener will use the exact connection balancer.
      case exactBalance(Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig.ExactBalance)

    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig.OneOf_BalanceType, rhs: Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig.OneOf_BalanceType) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
        case (.exactBalance, .exactBalance): return {
          guard case .exactBalance(let l) = lhs, case .exactBalance(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        }
      }
...
extension Envoy_Config_Listener_V4alpha_Listener.DrainType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Listener_V4alpha_Listener.DrainType] = [
    .default,
    .modifyOnly,
  ]
}
...
extension Envoy_Config_Listener_V4alpha_ListenerCollection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ListenerCollection"
  ...
  public static func ==(lhs: Envoy_Config_Listener_V4alpha_ListenerCollection, rhs: Envoy_Config_Listener_V4alpha_ListenerCollection) -> Bool {
...
extension Envoy_Config_Listener_V4alpha_Listener: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Listener"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .same(proto: "address"),
    3: .standard(proto: "filter_chains"),
    25: .standard(proto: "default_filter_chain"),
    ...
    23: .standard(proto: "udp_writer_config"),
    24: .standard(proto: "tcp_backlog_size"),
  ]

  fileprivate class _StorageClass {
    var _name: String = String()
    var _address: Envoy_Config_Core_V4alpha_Address? = nil
    var _filterChains: [Envoy_Config_Listener_V4alpha_FilterChain] = []
    var _defaultFilterChain: Envoy_Config_Listener_V4alpha_FilterChain? = nil
    ...
    var _deprecatedV1: Envoy_Config_Listener_V4alpha_Listener.DeprecatedV1? = nil
    var _drainType: Envoy_Config_Listener_V4alpha_Listener.DrainType = .default
    var _listenerFilters: [Envoy_Config_Listener_V4alpha_ListenerFilter] = []
    ...
    var _socketOptions: [Envoy_Config_Core_V4alpha_SocketOption] = []
    var _tcpFastOpenQueueLength: SwiftProtobuf.Google_Protobuf_UInt32Value? = nil
    var _trafficDirection: Envoy_Config_Core_V4alpha_TrafficDirection = .unspecified
    var _udpListenerConfig: Envoy_Config_Listener_V4alpha_UdpListenerConfig? = nil
    var _apiListener: Envoy_Config_Listener_V4alpha_ApiListener? = nil
    var _connectionBalanceConfig: Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig? = nil
    var _reusePort: Bool = false
    var _accessLog: [Envoy_Config_Accesslog_V4alpha_AccessLog] = []
    var _udpWriterConfig: Envoy_Config_Core_V4alpha_TypedExtensionConfig? = nil
    var _tcpBacklogSize: SwiftProtobuf.Google_Protobuf_UInt32Value? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _defaultFilterChain = source._defaultFilterChain
      ...
      _udpWriterConfig = source._udpWriterConfig
      _tcpBacklogSize = source._tcpBacklogSize
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try { try decoder.decodeRepeatedMessageField(value: &_storage._filterChains) }()
        ...
        case 7: try { try decoder.decodeSingularMessageField(value: &_storage._deprecatedV1) }()
        case 8: try { try decoder.decodeSingularEnumField(value: &_storage._drainType) }()
        case 9: try { try decoder.decodeRepeatedMessageField(value: &_storage._listenerFilters) }()
        case 10: try { try decoder.decodeSingularMessageField(value: &_storage._transparent) }()
        case 11: try { try decoder.decodeSingularMessageField(value: &_storage._freebind) }()
        case 12: try { try decoder.decodeSingularMessageField(value: &_storage._tcpFastOpenQueueLength) }()
        case 13: try { try decoder.decodeRepeatedMessageField(value: &_storage._socketOptions) }()
        case 15: try { try decoder.decodeSingularMessageField(value: &_storage._listenerFiltersTimeout) }()
        case 16: try { try decoder.decodeSingularEnumField(value: &_storage._trafficDirection) }()
        case 17: try { try decoder.decodeSingularBoolField(value: &_storage._continueOnListenerFiltersTimeout) }()
        case 18: try { try decoder.decodeSingularMessageField(value: &_storage._udpListenerConfig) }()
        case 19: try { try decoder.decodeSingularMessageField(value: &_storage._apiListener) }()
        case 20: try { try decoder.decodeSingularMessageField(value: &_storage._connectionBalanceConfig) }()
        case 21: try { try decoder.decodeSingularBoolField(value: &_storage._reusePort) }()
        case 22: try { try decoder.decodeRepeatedMessageField(value: &_storage._accessLog) }()
        case 23: try { try decoder.decodeSingularMessageField(value: &_storage._udpWriterConfig) }()
        case 24: try { try decoder.decodeSingularMessageField(value: &_storage._tcpBacklogSize) }()
        case 25: try { try decoder.decodeSingularMessageField(value: &_storage._defaultFilterChain) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._udpWriterConfig {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 23)
      }
      if let v = _storage._tcpBacklogSize {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 24)
      }
      if let v = _storage._defaultFilterChain {
  ...
  public static func ==(lhs: Envoy_Config_Listener_V4alpha_Listener, rhs: Envoy_Config_Listener_V4alpha_Listener) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._defaultFilterChain != rhs_storage._defaultFilterChain {return false}
        ...
        if _storage._udpWriterConfig != rhs_storage._udpWriterConfig {return false}
        if _storage._tcpBacklogSize != rhs_storage._tcpBacklogSize {return false}
        return true
      }
...
extension Envoy_Config_Listener_V4alpha_Listener.DrainType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Config_Listener_V4alpha_Listener.DeprecatedV1: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Listener_V4alpha_Listener.protoMessageName + ".DeprecatedV1"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._bindToPort) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Listener_V4alpha_Listener.DeprecatedV1, rhs: Envoy_Config_Listener_V4alpha_Listener.DeprecatedV1) -> Bool {
...
extension Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Listener_V4alpha_Listener.protoMessageName + ".ConnectionBalanceConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig.ExactBalance?
  ...
  public static func ==(lhs: Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig, rhs: Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig) -> Bool {
...
extension Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig.ExactBalance: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig.protoMessageName + ".ExactBalance"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig.ExactBalance, rhs: Envoy_Config_Listener_V4alpha_Listener.ConnectionBalanceConfig.ExactBalance) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
