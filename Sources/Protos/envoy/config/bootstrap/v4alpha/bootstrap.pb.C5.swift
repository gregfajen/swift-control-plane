...
/// [#next-free-field: 21]
public struct Envoy_Config_Bootstrap_V4alpha_Bootstrap {
  ...
  public var staticResources: Envoy_Config_Bootstrap_V4alpha_Bootstrap.StaticResources {
    get {return _storage._staticResources ?? Envoy_Config_Bootstrap_V4alpha_Bootstrap.StaticResources()}
  ...
  public var dynamicResources: Envoy_Config_Bootstrap_V4alpha_Bootstrap.DynamicResources {
    get {return _storage._dynamicResources ?? Envoy_Config_Bootstrap_V4alpha_Bootstrap.DynamicResources()}
  ...
  /// within the server.
  public var clusterManager: Envoy_Config_Bootstrap_V4alpha_ClusterManager {
    get {return _storage._clusterManager ?? Envoy_Config_Bootstrap_V4alpha_ClusterManager()}
  ...
  public var hdsConfig: Envoy_Config_Core_V4alpha_ApiConfigSource {
    get {return _storage._hdsConfig ?? Envoy_Config_Core_V4alpha_ApiConfigSource()}
  ...
  public var statsSinks: [Envoy_Config_Metrics_V4alpha_StatsSink] {
    get {return _storage._statsSinks}
    set {_uniqueStorage()._statsSinks = newValue}
  }

  /// Configuration for internal processing of stats.
  public var statsConfig: Envoy_Config_Metrics_V4alpha_StatsConfig {
    get {return _storage._statsConfig ?? Envoy_Config_Metrics_V4alpha_StatsConfig()}
  ...
  public var watchdog: Envoy_Config_Bootstrap_V4alpha_Watchdog {
    get {return _storage._watchdog ?? Envoy_Config_Bootstrap_V4alpha_Watchdog()}
  ...
  /// being used.
  public var layeredRuntime: Envoy_Config_Bootstrap_V4alpha_LayeredRuntime {
    get {return _storage._layeredRuntime ?? Envoy_Config_Bootstrap_V4alpha_LayeredRuntime()}
  ...
  public var admin: Envoy_Config_Bootstrap_V4alpha_Admin {
    get {return _storage._admin ?? Envoy_Config_Bootstrap_V4alpha_Admin()}
  ...
  public struct StaticResources {
    ...
    public var listeners: [Envoy_Config_Listener_V4alpha_Listener] = []
    ...
    /// IP or DNS-based).
    public var clusters: [Envoy_Config_Cluster_V4alpha_Cluster] = []

    /// These static secrets can be used by :ref:`SdsSecretConfig
    /// <envoy_api_msg_extensions.transport_sockets.tls.v4alpha.SdsSecretConfig>`
    public var secrets: [Envoy_Extensions_TransportSockets_Tls_V4alpha_Secret] = []
  ...
  public struct DynamicResources {
    ...
    public var ldsConfig: Envoy_Config_Core_V4alpha_ConfigSource {
      get {return _ldsConfig ?? Envoy_Config_Core_V4alpha_ConfigSource()}
      set {_ldsConfig = newValue}
    }
    /// Returns true if `ldsConfig` has been explicitly set.
    public var hasLdsConfig: Bool {return self._ldsConfig != nil}
    /// Clears the value of `ldsConfig`. Subsequent reads from it will return its default value.
    public mutating func clearLdsConfig() {self._ldsConfig = nil}

    /// All post-bootstrap :ref:`Cluster <envoy_api_msg_config.cluster.v4alpha.Cluster>` definitions are
    /// provided by a single :ref:`CDS <arch_overview_dynamic_config_cds>`
    /// configuration source.
    public var cdsConfig: Envoy_Config_Core_V4alpha_ConfigSource {
      get {return _cdsConfig ?? Envoy_Config_Core_V4alpha_ConfigSource()}
      set {_cdsConfig = newValue}
    }
    /// Returns true if `cdsConfig` has been explicitly set.
    public var hasCdsConfig: Bool {return self._cdsConfig != nil}
    /// Clears the value of `cdsConfig`. Subsequent reads from it will return its default value.
    public mutating func clearCdsConfig() {self._cdsConfig = nil}
    ...
    public var adsConfig: Envoy_Config_Core_V4alpha_ApiConfigSource {
      get {return _adsConfig ?? Envoy_Config_Core_V4alpha_ApiConfigSource()}
      set {_adsConfig = newValue}
    }
    /// Returns true if `adsConfig` has been explicitly set.
    public var hasAdsConfig: Bool {return self._adsConfig != nil}
    /// Clears the value of `adsConfig`. Subsequent reads from it will return its default value.
    public mutating func clearAdsConfig() {self._adsConfig = nil}

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public init() {}

    fileprivate var _ldsConfig: Envoy_Config_Core_V4alpha_ConfigSource? = nil
    fileprivate var _cdsConfig: Envoy_Config_Core_V4alpha_ConfigSource? = nil
    fileprivate var _adsConfig: Envoy_Config_Core_V4alpha_ApiConfigSource? = nil
  }
...
public struct Envoy_Config_Bootstrap_V4alpha_Admin {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var socketOptions: [Envoy_Config_Core_V4alpha_SocketOption] = []
...
public struct Envoy_Config_Bootstrap_V4alpha_ClusterManager {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var localClusterName: String = String()

  /// Optional global configuration for outlier detection.
  public var outlierDetection: Envoy_Config_Bootstrap_V4alpha_ClusterManager.OutlierDetection {
    get {return _outlierDetection ?? Envoy_Config_Bootstrap_V4alpha_ClusterManager.OutlierDetection()}
    set {_outlierDetection = newValue}
  }
  /// Returns true if `outlierDetection` has been explicitly set.
  public var hasOutlierDetection: Bool {return self._outlierDetection != nil}
  /// Clears the value of `outlierDetection`. Subsequent reads from it will return its default value.
  public mutating func clearOutlierDetection() {self._outlierDetection = nil}

  /// Optional configuration used to bind newly established upstream connections.
  /// This may be overridden on a per-cluster basis by upstream_bind_config in the cds_config.
  public var upstreamBindConfig: Envoy_Config_Core_V4alpha_BindConfig {
    get {return _upstreamBindConfig ?? Envoy_Config_Core_V4alpha_BindConfig()}
    set {_upstreamBindConfig = newValue}
  }
  /// Returns true if `upstreamBindConfig` has been explicitly set.
  public var hasUpstreamBindConfig: Bool {return self._upstreamBindConfig != nil}
  /// Clears the value of `upstreamBindConfig`. Subsequent reads from it will return its default value.
  public mutating func clearUpstreamBindConfig() {self._upstreamBindConfig = nil}

  /// A management server endpoint to stream load stats to via
  /// *StreamLoadStats*. This must have :ref:`api_type
  /// <envoy_api_field_config.core.v4alpha.ApiConfigSource.api_type>` :ref:`GRPC
  /// <envoy_api_enum_value_config.core.v4alpha.ApiConfigSource.ApiType.GRPC>`.
  public var loadStatsConfig: Envoy_Config_Core_V4alpha_ApiConfigSource {
    get {return _loadStatsConfig ?? Envoy_Config_Core_V4alpha_ApiConfigSource()}
    set {_loadStatsConfig = newValue}
  }
  /// Returns true if `loadStatsConfig` has been explicitly set.
  public var hasLoadStatsConfig: Bool {return self._loadStatsConfig != nil}
  /// Clears the value of `loadStatsConfig`. Subsequent reads from it will return its default value.
  public mutating func clearLoadStatsConfig() {self._loadStatsConfig = nil}
  ...
  public struct OutlierDetection {
    ...
    public var eventService: Envoy_Config_Core_V4alpha_EventServiceConfig {
      get {return _eventService ?? Envoy_Config_Core_V4alpha_EventServiceConfig()}
    ...
    fileprivate var _eventService: Envoy_Config_Core_V4alpha_EventServiceConfig? = nil
  }

  public init() {}

  fileprivate var _outlierDetection: Envoy_Config_Bootstrap_V4alpha_ClusterManager.OutlierDetection? = nil
  fileprivate var _upstreamBindConfig: Envoy_Config_Core_V4alpha_BindConfig? = nil
  fileprivate var _loadStatsConfig: Envoy_Config_Core_V4alpha_ApiConfigSource? = nil
}

/// Envoy process watchdog configuration. When configured, this monitors for
/// nonresponsive threads and kills the process after the configured thresholds.
/// See the :ref:`watchdog documentation <operations_performance_watchdog>` for more information.
public struct Envoy_Config_Bootstrap_V4alpha_Watchdog {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Bootstrap_V4alpha_Runtime {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// [#next-free-field: 6]
public struct Envoy_Config_Bootstrap_V4alpha_RuntimeLayer {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var layerSpecifier: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.OneOf_LayerSpecifier? = nil
  ...
  public var diskLayer: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.DiskLayer {
    get {
      if case .diskLayer(let v)? = layerSpecifier {return v}
      return Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.DiskLayer()
    }
    set {layerSpecifier = .diskLayer(newValue)}
  }

  public var adminLayer: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.AdminLayer {
    get {
      if case .adminLayer(let v)? = layerSpecifier {return v}
      return Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.AdminLayer()
    }
    set {layerSpecifier = .adminLayer(newValue)}
  }

  public var rtdsLayer: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.RtdsLayer {
    get {
      if case .rtdsLayer(let v)? = layerSpecifier {return v}
      return Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.RtdsLayer()
    }
  ...
  public enum OneOf_LayerSpecifier: Equatable {
    ...
    case diskLayer(Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.DiskLayer)
    case adminLayer(Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.AdminLayer)
    case rtdsLayer(Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.RtdsLayer)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.OneOf_LayerSpecifier, rhs: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.OneOf_LayerSpecifier) -> Bool {
      switch (lhs, rhs) {
      case (.staticLayer(let l), .staticLayer(let r)): return l == r
      case (.diskLayer(let l), .diskLayer(let r)): return l == r
      case (.adminLayer(let l), .adminLayer(let r)): return l == r
      case (.rtdsLayer(let l), .rtdsLayer(let r)): return l == r
  ...
  public struct RtdsLayer {
    ...
    public var rtdsConfig: Envoy_Config_Core_V4alpha_ConfigSource {
      get {return _rtdsConfig ?? Envoy_Config_Core_V4alpha_ConfigSource()}
    ...
    fileprivate var _rtdsConfig: Envoy_Config_Core_V4alpha_ConfigSource? = nil
  }
...
public struct Envoy_Config_Bootstrap_V4alpha_LayeredRuntime {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var layers: [Envoy_Config_Bootstrap_V4alpha_RuntimeLayer] = []
...
fileprivate let _protobuf_package = "envoy.config.bootstrap.v4alpha"

extension Envoy_Config_Bootstrap_V4alpha_Bootstrap: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _staticResources: Envoy_Config_Bootstrap_V4alpha_Bootstrap.StaticResources? = nil
    var _dynamicResources: Envoy_Config_Bootstrap_V4alpha_Bootstrap.DynamicResources? = nil
    var _clusterManager: Envoy_Config_Bootstrap_V4alpha_ClusterManager? = nil
    var _hdsConfig: Envoy_Config_Core_V4alpha_ApiConfigSource? = nil
    var _flagsPath: String = String()
    var _statsSinks: [Envoy_Config_Metrics_V4alpha_StatsSink] = []
    var _statsConfig: Envoy_Config_Metrics_V4alpha_StatsConfig? = nil
    var _statsFlushInterval: SwiftProtobuf.Google_Protobuf_Duration? = nil
    var _watchdog: Envoy_Config_Bootstrap_V4alpha_Watchdog? = nil
    var _layeredRuntime: Envoy_Config_Bootstrap_V4alpha_LayeredRuntime? = nil
    var _admin: Envoy_Config_Bootstrap_V4alpha_Admin? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try decoder.decodeSingularMessageField(value: &_storage._staticResources)
        case 3: try decoder.decodeSingularMessageField(value: &_storage._dynamicResources)
        case 4: try decoder.decodeSingularMessageField(value: &_storage._clusterManager)
        case 5: try decoder.decodeSingularStringField(value: &_storage._flagsPath)
        case 6: try decoder.decodeRepeatedMessageField(value: &_storage._statsSinks)
        case 7: try decoder.decodeSingularMessageField(value: &_storage._statsFlushInterval)
        case 8: try decoder.decodeSingularMessageField(value: &_storage._watchdog)
        case 12: try decoder.decodeSingularMessageField(value: &_storage._admin)
        case 13: try decoder.decodeSingularMessageField(value: &_storage._statsConfig)
        case 14: try decoder.decodeSingularMessageField(value: &_storage._hdsConfig)
        case 15: try decoder.decodeSingularMessageField(value: &_storage._overloadManager)
        case 16: try decoder.decodeSingularBoolField(value: &_storage._enableDispatcherStats)
        case 17: try decoder.decodeSingularMessageField(value: &_storage._layeredRuntime)
        case 18: try decoder.decodeSingularStringField(value: &_storage._headerPrefix)
        case 19: try decoder.decodeSingularMessageField(value: &_storage._statsServerVersionOverride)
        case 20: try decoder.decodeSingularBoolField(value: &_storage._useTcpForDnsLookups)
        default: break
        }
      }
    }
  ...
  public static func ==(lhs: Envoy_Config_Bootstrap_V4alpha_Bootstrap, rhs: Envoy_Config_Bootstrap_V4alpha_Bootstrap) -> Bool {
...
extension Envoy_Config_Bootstrap_V4alpha_Bootstrap.StaticResources: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Bootstrap_V4alpha_Bootstrap.protoMessageName + ".StaticResources"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedMessageField(value: &self.listeners)
      case 2: try decoder.decodeRepeatedMessageField(value: &self.clusters)
      case 3: try decoder.decodeRepeatedMessageField(value: &self.secrets)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Bootstrap_V4alpha_Bootstrap.StaticResources, rhs: Envoy_Config_Bootstrap_V4alpha_Bootstrap.StaticResources) -> Bool {
...
extension Envoy_Config_Bootstrap_V4alpha_Bootstrap.DynamicResources: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Bootstrap_V4alpha_Bootstrap.protoMessageName + ".DynamicResources"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._ldsConfig)
      case 2: try decoder.decodeSingularMessageField(value: &self._cdsConfig)
      case 3: try decoder.decodeSingularMessageField(value: &self._adsConfig)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._ldsConfig {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }
    if let v = self._cdsConfig {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }
    if let v = self._adsConfig {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Bootstrap_V4alpha_Bootstrap.DynamicResources, rhs: Envoy_Config_Bootstrap_V4alpha_Bootstrap.DynamicResources) -> Bool {
    if lhs._ldsConfig != rhs._ldsConfig {return false}
    if lhs._cdsConfig != rhs._cdsConfig {return false}
    if lhs._adsConfig != rhs._adsConfig {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Bootstrap_V4alpha_Admin: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.accessLogPath)
      case 2: try decoder.decodeSingularStringField(value: &self.profilePath)
      case 3: try decoder.decodeSingularMessageField(value: &self._address)
      case 4: try decoder.decodeRepeatedMessageField(value: &self.socketOptions)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Bootstrap_V4alpha_Admin, rhs: Envoy_Config_Bootstrap_V4alpha_Admin) -> Bool {
...
extension Envoy_Config_Bootstrap_V4alpha_ClusterManager: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.localClusterName)
      case 2: try decoder.decodeSingularMessageField(value: &self._outlierDetection)
      case 3: try decoder.decodeSingularMessageField(value: &self._upstreamBindConfig)
      case 4: try decoder.decodeSingularMessageField(value: &self._loadStatsConfig)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.localClusterName.isEmpty {
      try visitor.visitSingularStringField(value: self.localClusterName, fieldNumber: 1)
    }
    if let v = self._outlierDetection {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }
    if let v = self._upstreamBindConfig {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }
    if let v = self._loadStatsConfig {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Bootstrap_V4alpha_ClusterManager, rhs: Envoy_Config_Bootstrap_V4alpha_ClusterManager) -> Bool {
    if lhs.localClusterName != rhs.localClusterName {return false}
    if lhs._outlierDetection != rhs._outlierDetection {return false}
    if lhs._upstreamBindConfig != rhs._upstreamBindConfig {return false}
    if lhs._loadStatsConfig != rhs._loadStatsConfig {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Bootstrap_V4alpha_ClusterManager.OutlierDetection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Bootstrap_V4alpha_ClusterManager.protoMessageName + ".OutlierDetection"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.eventLogPath)
      case 2: try decoder.decodeSingularMessageField(value: &self._eventService)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Bootstrap_V4alpha_ClusterManager.OutlierDetection, rhs: Envoy_Config_Bootstrap_V4alpha_ClusterManager.OutlierDetection) -> Bool {
...
extension Envoy_Config_Bootstrap_V4alpha_Watchdog: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._missTimeout)
      case 2: try decoder.decodeSingularMessageField(value: &self._megamissTimeout)
      case 3: try decoder.decodeSingularMessageField(value: &self._killTimeout)
      case 4: try decoder.decodeSingularMessageField(value: &self._multikillTimeout)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Bootstrap_V4alpha_Watchdog, rhs: Envoy_Config_Bootstrap_V4alpha_Watchdog) -> Bool {
...
extension Envoy_Config_Bootstrap_V4alpha_Runtime: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.symlinkRoot)
      case 2: try decoder.decodeSingularStringField(value: &self.subdirectory)
      case 3: try decoder.decodeSingularStringField(value: &self.overrideSubdirectory)
      case 4: try decoder.decodeSingularMessageField(value: &self._base)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Bootstrap_V4alpha_Runtime, rhs: Envoy_Config_Bootstrap_V4alpha_Runtime) -> Bool {
...
extension Envoy_Config_Bootstrap_V4alpha_RuntimeLayer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3:
        var v: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.DiskLayer?
        if let current = self.layerSpecifier {
          try decoder.handleConflictingOneOf()
      ...
      case 4:
        var v: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.AdminLayer?
        if let current = self.layerSpecifier {
          try decoder.handleConflictingOneOf()
      ...
      case 5:
        var v: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.RtdsLayer?
        if let current = self.layerSpecifier {
          try decoder.handleConflictingOneOf()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .staticLayer(let v)?:
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    case .diskLayer(let v)?:
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    case .adminLayer(let v)?:
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    case .rtdsLayer(let v)?:
  ...
  public static func ==(lhs: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer, rhs: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer) -> Bool {
...
extension Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.DiskLayer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.protoMessageName + ".DiskLayer"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "symlink_root"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.symlinkRoot)
      case 2: try decoder.decodeSingularBoolField(value: &self.appendServiceCluster)
      case 3: try decoder.decodeSingularStringField(value: &self.subdirectory)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.DiskLayer, rhs: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.DiskLayer) -> Bool {
    if lhs.symlinkRoot != rhs.symlinkRoot {return false}
    if lhs.subdirectory != rhs.subdirectory {return false}
...
extension Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.AdminLayer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.protoMessageName + ".AdminLayer"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.AdminLayer, rhs: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.AdminLayer) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.RtdsLayer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.protoMessageName + ".RtdsLayer"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.name)
      case 2: try decoder.decodeSingularMessageField(value: &self._rtdsConfig)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.RtdsLayer, rhs: Envoy_Config_Bootstrap_V4alpha_RuntimeLayer.RtdsLayer) -> Bool {
    if lhs.name != rhs.name {return false}
...
extension Envoy_Config_Bootstrap_V4alpha_LayeredRuntime: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Bootstrap_V4alpha_LayeredRuntime, rhs: Envoy_Config_Bootstrap_V4alpha_LayeredRuntime) -> Bool {
