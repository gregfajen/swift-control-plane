...
public struct Envoy_Config_Accesslog_V4alpha_AccessLogFilter {
  ...
  /// Metadata Filter
  public var metadataFilter: Envoy_Config_Accesslog_V4alpha_MetadataFilter {
    get {
      if case .metadataFilter(let v)? = filterSpecifier {return v}
      return Envoy_Config_Accesslog_V4alpha_MetadataFilter()
    }
  ...
  public enum OneOf_FilterSpecifier: Equatable {
    ...
    /// Metadata Filter
    case metadataFilter(Envoy_Config_Accesslog_V4alpha_MetadataFilter)
...
public struct Envoy_Config_Accesslog_V4alpha_MetadataFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var matcher: Envoy_Type_Matcher_V4alpha_MetadataMatcher {
    get {return _matcher ?? Envoy_Type_Matcher_V4alpha_MetadataMatcher()}
  ...
  fileprivate var _matcher: Envoy_Type_Matcher_V4alpha_MetadataMatcher? = nil
...
extension Envoy_Config_Accesslog_V4alpha_AccessLogFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 12: try {
        var v: Envoy_Config_Accesslog_V4alpha_MetadataFilter?
        if let current = self.filterSpecifier {
          try decoder.handleConflictingOneOf()
...
extension Envoy_Config_Accesslog_V4alpha_MetadataFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Accesslog_V4alpha_MetadataFilter, rhs: Envoy_Config_Accesslog_V4alpha_MetadataFilter) -> Bool {
