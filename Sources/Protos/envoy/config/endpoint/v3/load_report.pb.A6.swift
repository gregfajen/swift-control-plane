...
/// [#next-free-field: 9]
public struct Envoy_Config_Endpoint_V3_UpstreamLocalityStats {
  ...
  public var loadMetricStats: [Envoy_Config_Endpoint_V3_EndpointLoadMetricStats] = []
  ...
  public var upstreamEndpointStats: [Envoy_Config_Endpoint_V3_UpstreamEndpointStats] = []
...
/// [#next-free-field: 8]
public struct Envoy_Config_Endpoint_V3_UpstreamEndpointStats {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Endpoint_V3_EndpointLoadMetricStats {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Next ID: 7
/// [#next-free-field: 7]
public struct Envoy_Config_Endpoint_V3_ClusterStats {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// Need at least one.
  public var upstreamLocalityStats: [Envoy_Config_Endpoint_V3_UpstreamLocalityStats] = []
  ...
  public var droppedRequests: [Envoy_Config_Endpoint_V3_ClusterStats.DroppedRequests] = []
...
extension Envoy_Config_Endpoint_V3_UpstreamLocalityStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularUInt64Field(value: &self.totalSuccessfulRequests)
      case 3: try decoder.decodeSingularUInt64Field(value: &self.totalRequestsInProgress)
      case 4: try decoder.decodeSingularUInt64Field(value: &self.totalErrorRequests)
      case 5: try decoder.decodeRepeatedMessageField(value: &self.loadMetricStats)
      case 6: try decoder.decodeSingularUInt32Field(value: &self.priority)
      case 7: try decoder.decodeRepeatedMessageField(value: &self.upstreamEndpointStats)
      case 8: try decoder.decodeSingularUInt64Field(value: &self.totalIssuedRequests)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Endpoint_V3_UpstreamLocalityStats, rhs: Envoy_Config_Endpoint_V3_UpstreamLocalityStats) -> Bool {
...
extension Envoy_Config_Endpoint_V3_UpstreamEndpointStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try decoder.decodeSingularUInt64Field(value: &self.totalIssuedRequests)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Endpoint_V3_UpstreamEndpointStats, rhs: Envoy_Config_Endpoint_V3_UpstreamEndpointStats) -> Bool {
...
extension Envoy_Config_Endpoint_V3_EndpointLoadMetricStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularUInt64Field(value: &self.numRequestsFinishedWithMetric)
      case 3: try decoder.decodeSingularDoubleField(value: &self.totalMetricValue)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Endpoint_V3_EndpointLoadMetricStats, rhs: Envoy_Config_Endpoint_V3_EndpointLoadMetricStats) -> Bool {
...
extension Envoy_Config_Endpoint_V3_ClusterStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeRepeatedMessageField(value: &self.upstreamLocalityStats)
      case 3: try decoder.decodeSingularUInt64Field(value: &self.totalDroppedRequests)
      case 4: try decoder.decodeSingularMessageField(value: &self._loadReportInterval)
      case 5: try decoder.decodeRepeatedMessageField(value: &self.droppedRequests)
      case 6: try decoder.decodeSingularStringField(value: &self.clusterServiceName)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Endpoint_V3_ClusterStats, rhs: Envoy_Config_Endpoint_V3_ClusterStats) -> Bool {
...
extension Envoy_Config_Endpoint_V3_ClusterStats.DroppedRequests: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Endpoint_V3_ClusterStats.protoMessageName + ".DroppedRequests"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularUInt64Field(value: &self.droppedCount)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Endpoint_V3_ClusterStats.DroppedRequests, rhs: Envoy_Config_Endpoint_V3_ClusterStats.DroppedRequests) -> Bool {
