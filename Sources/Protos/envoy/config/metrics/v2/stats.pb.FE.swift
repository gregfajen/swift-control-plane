...
public struct Envoy_Config_Metrics_V2_StatsSink {
  ...
  public var configType: Envoy_Config_Metrics_V2_StatsSink.OneOf_ConfigType? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Metrics_V2_StatsSink.OneOf_ConfigType, rhs: Envoy_Config_Metrics_V2_StatsSink.OneOf_ConfigType) -> Bool {
...
public struct Envoy_Config_Metrics_V2_StatsConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var statsTags: [Envoy_Config_Metrics_V2_TagSpecifier] = []
  ...
  public var statsMatcher: Envoy_Config_Metrics_V2_StatsMatcher {
    get {return _statsMatcher ?? Envoy_Config_Metrics_V2_StatsMatcher()}
  ...
  fileprivate var _statsMatcher: Envoy_Config_Metrics_V2_StatsMatcher? = nil
}

/// Configuration for disabling stat instantiation.
public struct Envoy_Config_Metrics_V2_StatsMatcher {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var statsMatcher: Envoy_Config_Metrics_V2_StatsMatcher.OneOf_StatsMatcher? = nil
  ...
  public var exclusionList: Envoy_Type_Matcher_ListStringMatcher {
    get {
      if case .exclusionList(let v)? = statsMatcher {return v}
      return Envoy_Type_Matcher_ListStringMatcher()
    }
  ...
  /// StringMatcher protos.
  public var inclusionList: Envoy_Type_Matcher_ListStringMatcher {
    get {
  ...
  public enum OneOf_StatsMatcher: Equatable {
    ...
    /// Exclusive match. All stats are enabled except for those matching one of the supplied
    /// StringMatcher protos.
    case exclusionList(Envoy_Type_Matcher_ListStringMatcher)
    /// Inclusive match. No stats are enabled except for those matching one of the supplied
    /// StringMatcher protos.
    case inclusionList(Envoy_Type_Matcher_ListStringMatcher)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Metrics_V2_StatsMatcher.OneOf_StatsMatcher, rhs: Envoy_Config_Metrics_V2_StatsMatcher.OneOf_StatsMatcher) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Envoy_Config_Metrics_V2_TagSpecifier {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var tagValue: Envoy_Config_Metrics_V2_TagSpecifier.OneOf_TagValue? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Metrics_V2_TagSpecifier.OneOf_TagValue, rhs: Envoy_Config_Metrics_V2_TagSpecifier.OneOf_TagValue) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Envoy_Config_Metrics_V2_StatsdSink {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var statsdSpecifier: Envoy_Config_Metrics_V2_StatsdSink.OneOf_StatsdSpecifier? = nil
  ...
  public enum OneOf_StatsdSpecifier: Equatable {
    ...
    /// compliant listener. If specified, statistics will be flushed to this
    /// address.
    case address(Envoy_Api_V2_Core_Address)
    /// The name of a cluster that is running a TCP `statsd
    /// <https://github.com/etsy/statsd>`_ compliant listener. If specified,
    /// Envoy will connect to this cluster to flush statistics.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Metrics_V2_StatsdSink.OneOf_StatsdSpecifier, rhs: Envoy_Config_Metrics_V2_StatsdSink.OneOf_StatsdSpecifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Envoy_Config_Metrics_V2_DogStatsdSink {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var dogStatsdSpecifier: Envoy_Config_Metrics_V2_DogStatsdSink.OneOf_DogStatsdSpecifier? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Metrics_V2_DogStatsdSink.OneOf_DogStatsdSpecifier, rhs: Envoy_Config_Metrics_V2_DogStatsdSink.OneOf_DogStatsdSpecifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Envoy_Config_Metrics_V2_HystrixSink {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "envoy.config.metrics.v2"

extension Envoy_Config_Metrics_V2_StatsSink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Metrics_V2_StatsSink, rhs: Envoy_Config_Metrics_V2_StatsSink) -> Bool {
...
extension Envoy_Config_Metrics_V2_StatsConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Metrics_V2_StatsConfig, rhs: Envoy_Config_Metrics_V2_StatsConfig) -> Bool {
...
extension Envoy_Config_Metrics_V2_StatsMatcher: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Envoy_Type_Matcher_ListStringMatcher?
  ...
  public static func ==(lhs: Envoy_Config_Metrics_V2_StatsMatcher, rhs: Envoy_Config_Metrics_V2_StatsMatcher) -> Bool {
...
extension Envoy_Config_Metrics_V2_TagSpecifier: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Metrics_V2_TagSpecifier, rhs: Envoy_Config_Metrics_V2_TagSpecifier) -> Bool {
...
extension Envoy_Config_Metrics_V2_StatsdSink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Envoy_Api_V2_Core_Address?
  ...
  public static func ==(lhs: Envoy_Config_Metrics_V2_StatsdSink, rhs: Envoy_Config_Metrics_V2_StatsdSink) -> Bool {
...
extension Envoy_Config_Metrics_V2_DogStatsdSink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Metrics_V2_DogStatsdSink, rhs: Envoy_Config_Metrics_V2_DogStatsdSink) -> Bool {
...
extension Envoy_Config_Metrics_V2_HystrixSink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Metrics_V2_HystrixSink, rhs: Envoy_Config_Metrics_V2_HystrixSink) -> Bool {
