...
public struct Envoy_Config_Metrics_V4alpha_StatsSink {
  ...
  public var configType: Envoy_Config_Metrics_V4alpha_StatsSink.OneOf_ConfigType? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Metrics_V4alpha_StatsSink.OneOf_ConfigType, rhs: Envoy_Config_Metrics_V4alpha_StatsSink.OneOf_ConfigType) -> Bool {
...
public struct Envoy_Config_Metrics_V4alpha_StatsConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var statsTags: [Envoy_Config_Metrics_V4alpha_TagSpecifier] = []
  ...
  public var statsMatcher: Envoy_Config_Metrics_V4alpha_StatsMatcher {
    get {return _statsMatcher ?? Envoy_Config_Metrics_V4alpha_StatsMatcher()}
  ...
  ///       3600000
  ///     ]
  public var histogramBucketSettings: [Envoy_Config_Metrics_V4alpha_HistogramBucketSettings] = []
  ...
  fileprivate var _statsMatcher: Envoy_Config_Metrics_V4alpha_StatsMatcher? = nil
}

/// Configuration for disabling stat instantiation.
public struct Envoy_Config_Metrics_V4alpha_StatsMatcher {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var statsMatcher: Envoy_Config_Metrics_V4alpha_StatsMatcher.OneOf_StatsMatcher? = nil
  ...
  public var exclusionList: Envoy_Type_Matcher_V4alpha_ListStringMatcher {
    get {
      if case .exclusionList(let v)? = statsMatcher {return v}
      return Envoy_Type_Matcher_V4alpha_ListStringMatcher()
    }
  ...
  /// StringMatcher protos.
  public var inclusionList: Envoy_Type_Matcher_V4alpha_ListStringMatcher {
    get {
  ...
  public enum OneOf_StatsMatcher: Equatable {
    ...
    /// Exclusive match. All stats are enabled except for those matching one of the supplied
    /// StringMatcher protos.
    case exclusionList(Envoy_Type_Matcher_V4alpha_ListStringMatcher)
    /// Inclusive match. No stats are enabled except for those matching one of the supplied
    /// StringMatcher protos.
    case inclusionList(Envoy_Type_Matcher_V4alpha_ListStringMatcher)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Metrics_V4alpha_StatsMatcher.OneOf_StatsMatcher, rhs: Envoy_Config_Metrics_V4alpha_StatsMatcher.OneOf_StatsMatcher) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.rejectAll, .rejectAll): return {
        guard case .rejectAll(let l) = lhs, case .rejectAll(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.exclusionList, .exclusionList): return {
        guard case .exclusionList(let l) = lhs, case .exclusionList(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.inclusionList, .inclusionList): return {
        guard case .inclusionList(let l) = lhs, case .inclusionList(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
public struct Envoy_Config_Metrics_V4alpha_TagSpecifier {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var tagValue: Envoy_Config_Metrics_V4alpha_TagSpecifier.OneOf_TagValue? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Metrics_V4alpha_TagSpecifier.OneOf_TagValue, rhs: Envoy_Config_Metrics_V4alpha_TagSpecifier.OneOf_TagValue) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      ...
      case (.fixedValue, .fixedValue): return {
        guard case .fixedValue(let l) = lhs, case .fixedValue(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
public struct Envoy_Config_Metrics_V4alpha_HistogramBucketSettings {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var match: Envoy_Type_Matcher_V4alpha_StringMatcher {
    get {return _match ?? Envoy_Type_Matcher_V4alpha_StringMatcher()}
    set {_match = newValue}
  }
  ...
  fileprivate var _match: Envoy_Type_Matcher_V4alpha_StringMatcher? = nil
}
...
public struct Envoy_Config_Metrics_V4alpha_StatsdSink {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var statsdSpecifier: Envoy_Config_Metrics_V4alpha_StatsdSink.OneOf_StatsdSpecifier? = nil
  ...
  public var address: Envoy_Config_Core_V4alpha_Address {
    get {
      ...
      return Envoy_Config_Core_V4alpha_Address()
    }
  ...
  public enum OneOf_StatsdSpecifier: Equatable {
    ...
    /// compliant listener. If specified, statistics will be flushed to this
    /// address.
    case address(Envoy_Config_Core_V4alpha_Address)
    /// The name of a cluster that is running a TCP `statsd
    /// <https://github.com/etsy/statsd>`_ compliant listener. If specified,
    /// Envoy will connect to this cluster to flush statistics.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Metrics_V4alpha_StatsdSink.OneOf_StatsdSpecifier, rhs: Envoy_Config_Metrics_V4alpha_StatsdSink.OneOf_StatsdSpecifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      ...
      case (.tcpClusterName, .tcpClusterName): return {
        guard case .tcpClusterName(let l) = lhs, case .tcpClusterName(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
public struct Envoy_Config_Metrics_V4alpha_DogStatsdSink {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var dogStatsdSpecifier: Envoy_Config_Metrics_V4alpha_DogStatsdSink.OneOf_DogStatsdSpecifier? = nil
  ...
  public var maxBytesPerDatagram: SwiftProtobuf.Google_Protobuf_UInt64Value {
    get {return _maxBytesPerDatagram ?? SwiftProtobuf.Google_Protobuf_UInt64Value()}
    set {_maxBytesPerDatagram = newValue}
  }
  /// Returns true if `maxBytesPerDatagram` has been explicitly set.
  public var hasMaxBytesPerDatagram: Bool {return self._maxBytesPerDatagram != nil}
  /// Clears the value of `maxBytesPerDatagram`. Subsequent reads from it will return its default value.
  public mutating func clearMaxBytesPerDatagram() {self._maxBytesPerDatagram = nil}
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Metrics_V4alpha_DogStatsdSink.OneOf_DogStatsdSpecifier, rhs: Envoy_Config_Metrics_V4alpha_DogStatsdSink.OneOf_DogStatsdSpecifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
  ...
  fileprivate var _maxBytesPerDatagram: SwiftProtobuf.Google_Protobuf_UInt64Value? = nil
}
...
public struct Envoy_Config_Metrics_V4alpha_HystrixSink {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "envoy.config.metrics.v4alpha"

extension Envoy_Config_Metrics_V4alpha_StatsSink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Metrics_V4alpha_StatsSink, rhs: Envoy_Config_Metrics_V4alpha_StatsSink) -> Bool {
...
extension Envoy_Config_Metrics_V4alpha_StatsConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    4: .standard(proto: "histogram_bucket_settings"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.statsTags) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._useAllDefaultTags) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._statsMatcher) }()
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.histogramBucketSettings) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.histogramBucketSettings.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.histogramBucketSettings, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Metrics_V4alpha_StatsConfig, rhs: Envoy_Config_Metrics_V4alpha_StatsConfig) -> Bool {
    ...
    if lhs.histogramBucketSettings != rhs.histogramBucketSettings {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Metrics_V4alpha_StatsMatcher: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Envoy_Type_Matcher_V4alpha_ListStringMatcher?
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .rejectAll?: try {
      guard case .rejectAll(let v)? = self.statsMatcher else { preconditionFailure() }
      try visitor.visitSingularBoolField(value: v, fieldNumber: 1)
    }()
    case .exclusionList?: try {
      guard case .exclusionList(let v)? = self.statsMatcher else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }()
    case .inclusionList?: try {
      guard case .inclusionList(let v)? = self.statsMatcher else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }()
    case nil: break
    }
  ...
  public static func ==(lhs: Envoy_Config_Metrics_V4alpha_StatsMatcher, rhs: Envoy_Config_Metrics_V4alpha_StatsMatcher) -> Bool {
...
extension Envoy_Config_Metrics_V4alpha_TagSpecifier: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .regex?: try {
      guard case .regex(let v)? = self.tagValue else { preconditionFailure() }
      try visitor.visitSingularStringField(value: v, fieldNumber: 2)
    }()
    case .fixedValue?: try {
      guard case .fixedValue(let v)? = self.tagValue else { preconditionFailure() }
  ...
  public static func ==(lhs: Envoy_Config_Metrics_V4alpha_TagSpecifier, rhs: Envoy_Config_Metrics_V4alpha_TagSpecifier) -> Bool {
...
extension Envoy_Config_Metrics_V4alpha_HistogramBucketSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".HistogramBucketSettings"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "match"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedDoubleField(value: &self.buckets) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.buckets.isEmpty {
      try visitor.visitPackedDoubleField(value: self.buckets, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Metrics_V4alpha_HistogramBucketSettings, rhs: Envoy_Config_Metrics_V4alpha_HistogramBucketSettings) -> Bool {
...
extension Envoy_Config_Metrics_V4alpha_StatsdSink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Envoy_Config_Core_V4alpha_Address?
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .address?: try {
      guard case .address(let v)? = self.statsdSpecifier else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }()
    case .tcpClusterName?: try {
      guard case .tcpClusterName(let v)? = self.statsdSpecifier else { preconditionFailure() }
      try visitor.visitSingularStringField(value: v, fieldNumber: 2)
    }()
    case nil: break
    }
  ...
  public static func ==(lhs: Envoy_Config_Metrics_V4alpha_StatsdSink, rhs: Envoy_Config_Metrics_V4alpha_StatsdSink) -> Bool {
...
extension Envoy_Config_Metrics_V4alpha_DogStatsdSink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DogStatsdSink"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "address"),
    3: .same(proto: "prefix"),
    4: .standard(proto: "max_bytes_per_datagram"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.prefix) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._maxBytesPerDatagram) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._maxBytesPerDatagram {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Metrics_V4alpha_DogStatsdSink, rhs: Envoy_Config_Metrics_V4alpha_DogStatsdSink) -> Bool {
    if lhs.dogStatsdSpecifier != rhs.dogStatsdSpecifier {return false}
    if lhs.prefix != rhs.prefix {return false}
    if lhs._maxBytesPerDatagram != rhs._maxBytesPerDatagram {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Metrics_V4alpha_HystrixSink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt64Field(value: &self.numBuckets) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Config_Metrics_V4alpha_HystrixSink, rhs: Envoy_Config_Metrics_V4alpha_HystrixSink) -> Bool {
