...
public struct Envoy_Config_Metrics_V3_StatsConfig {
  ...
  ///       3600000
  ///     ]
  public var histogramBucketSettings: [Envoy_Config_Metrics_V3_HistogramBucketSettings] = []
...
public struct Envoy_Config_Metrics_V3_HistogramBucketSettings {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var match: Envoy_Type_Matcher_V3_StringMatcher {
    get {return _match ?? Envoy_Type_Matcher_V3_StringMatcher()}
    set {_match = newValue}
  }
  ...
  fileprivate var _match: Envoy_Type_Matcher_V3_StringMatcher? = nil
}
...
extension Envoy_Config_Metrics_V3_HistogramBucketSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Metrics_V3_HistogramBucketSettings, rhs: Envoy_Config_Metrics_V3_HistogramBucketSettings) -> Bool {
