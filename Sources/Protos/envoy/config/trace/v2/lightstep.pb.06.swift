...
public struct Envoy_Config_Trace_V2_LightstepConfig {
  ...
  public var propagationModes: [Envoy_Config_Trace_V2_LightstepConfig.PropagationMode] = []
...
extension Envoy_Config_Trace_V2_LightstepConfig.PropagationMode: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Trace_V2_LightstepConfig.PropagationMode] = [
    .envoy,
    .lightstep,
    .b3,
    .traceContext,
...
extension Envoy_Config_Trace_V2_LightstepConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Trace_V2_LightstepConfig, rhs: Envoy_Config_Trace_V2_LightstepConfig) -> Bool {
...
extension Envoy_Config_Trace_V2_LightstepConfig.PropagationMode: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "ENVOY"),
