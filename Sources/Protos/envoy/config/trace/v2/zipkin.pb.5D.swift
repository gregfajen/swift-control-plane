...
/// [#next-free-field: 6]
public struct Envoy_Config_Trace_V2_ZipkinConfig {
  ...
  /// used.
  public var collectorEndpointVersion: Envoy_Config_Trace_V2_ZipkinConfig.CollectorEndpointVersion = .httpJsonV1
...
extension Envoy_Config_Trace_V2_ZipkinConfig.CollectorEndpointVersion: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Trace_V2_ZipkinConfig.CollectorEndpointVersion] = [
    .httpJsonV1,
    .httpJson,
    .httpProto,
    .grpc,
...
extension Envoy_Config_Trace_V2_ZipkinConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.collectorEndpointVersion != .httpJsonV1 {
      try visitor.visitSingularEnumField(value: self.collectorEndpointVersion, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Config_Trace_V2_ZipkinConfig, rhs: Envoy_Config_Trace_V2_ZipkinConfig) -> Bool {
...
extension Envoy_Config_Trace_V2_ZipkinConfig.CollectorEndpointVersion: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "HTTP_JSON_V1"),
