...
/// [#next-free-field: 6]
public struct Envoy_Config_Trace_V3_ZipkinConfig {
  ...
  /// used.
  public var collectorEndpointVersion: Envoy_Config_Trace_V3_ZipkinConfig.CollectorEndpointVersion = .deprecatedAndUnavailableDoNotUse
...
extension Envoy_Config_Trace_V3_ZipkinConfig.CollectorEndpointVersion: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Trace_V3_ZipkinConfig.CollectorEndpointVersion] = [
...
extension Envoy_Config_Trace_V3_ZipkinConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Trace_V3_ZipkinConfig, rhs: Envoy_Config_Trace_V3_ZipkinConfig) -> Bool {
...
extension Envoy_Config_Trace_V3_ZipkinConfig.CollectorEndpointVersion: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
