...
public struct Envoy_Config_Trace_V3_XRayConfig {
  ...
  public var daemonEndpoint: Envoy_Config_Core_V3_SocketAddress {
    get {return _daemonEndpoint ?? Envoy_Config_Core_V3_SocketAddress()}
  ...
  public var samplingRuleManifest: Envoy_Config_Core_V3_DataSource {
    get {return _samplingRuleManifest ?? Envoy_Config_Core_V3_DataSource()}
  ...
  public var segmentFields: Envoy_Config_Trace_V3_XRayConfig.SegmentFields {
    get {return _segmentFields ?? Envoy_Config_Trace_V3_XRayConfig.SegmentFields()}
  ...
  fileprivate var _daemonEndpoint: Envoy_Config_Core_V3_SocketAddress? = nil
  fileprivate var _samplingRuleManifest: Envoy_Config_Core_V3_DataSource? = nil
  fileprivate var _segmentFields: Envoy_Config_Trace_V3_XRayConfig.SegmentFields? = nil
}
...
extension Envoy_Config_Trace_V3_XRayConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Trace_V3_XRayConfig, rhs: Envoy_Config_Trace_V3_XRayConfig) -> Bool {
...
extension Envoy_Config_Trace_V3_XRayConfig.SegmentFields: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Trace_V3_XRayConfig.protoMessageName + ".SegmentFields"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "origin"),
    2: .same(proto: "aws"),
  ]
  ...
  public static func ==(lhs: Envoy_Config_Trace_V3_XRayConfig.SegmentFields, rhs: Envoy_Config_Trace_V3_XRayConfig.SegmentFields) -> Bool {
