...
public struct Envoy_Config_Trace_V3_Tracing {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Provides configuration for the HTTP tracer.
  public var http: Envoy_Config_Trace_V3_Tracing.Http {
    get {return _http ?? Envoy_Config_Trace_V3_Tracing.Http()}
    set {_http = newValue}
  }
  ...
  public struct Http {
    ...
    public var configType: Envoy_Config_Trace_V3_Tracing.Http.OneOf_ConfigType? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Config_Trace_V3_Tracing.Http.OneOf_ConfigType, rhs: Envoy_Config_Trace_V3_Tracing.Http.OneOf_ConfigType) -> Bool {
        switch (lhs, rhs) {
  ...
  fileprivate var _http: Envoy_Config_Trace_V3_Tracing.Http? = nil
}
...
extension Envoy_Config_Trace_V3_Tracing: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Trace_V3_Tracing, rhs: Envoy_Config_Trace_V3_Tracing) -> Bool {
...
extension Envoy_Config_Trace_V3_Tracing.Http: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Trace_V3_Tracing.protoMessageName + ".Http"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  public static func ==(lhs: Envoy_Config_Trace_V3_Tracing.Http, rhs: Envoy_Config_Trace_V3_Tracing.Http) -> Bool {
