...
/// Tap configuration.
public struct Envoy_Config_Tap_V4alpha_TapConfig {
  ...
  public var match: Envoy_Config_Common_Matcher_V4alpha_MatchPredicate {
    get {return _match ?? Envoy_Config_Common_Matcher_V4alpha_MatchPredicate()}
    set {_match = newValue}
  }
  ...
  public var outputConfig: Envoy_Config_Tap_V4alpha_OutputConfig {
    get {return _outputConfig ?? Envoy_Config_Tap_V4alpha_OutputConfig()}
  ...
  public var tapEnabled: Envoy_Config_Core_V4alpha_RuntimeFractionalPercent {
    get {return _tapEnabled ?? Envoy_Config_Core_V4alpha_RuntimeFractionalPercent()}
  ...
  fileprivate var _match: Envoy_Config_Common_Matcher_V4alpha_MatchPredicate? = nil
  fileprivate var _outputConfig: Envoy_Config_Tap_V4alpha_OutputConfig? = nil
  fileprivate var _tapEnabled: Envoy_Config_Core_V4alpha_RuntimeFractionalPercent? = nil
}

/// Tap match configuration. This is a recursive structure which allows complex nested match
/// configurations to be built using various logical operators.
/// [#next-free-field: 11]
public struct Envoy_Config_Tap_V4alpha_MatchPredicate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// matches.
  public var orMatch: Envoy_Config_Tap_V4alpha_MatchPredicate.MatchSet {
    get {
      if case .orMatch(let v)? = _storage._rule {return v}
      return Envoy_Config_Tap_V4alpha_MatchPredicate.MatchSet()
    }
  ...
  /// matches.
  public var andMatch: Envoy_Config_Tap_V4alpha_MatchPredicate.MatchSet {
    get {
  ...
  public var notMatch: Envoy_Config_Tap_V4alpha_MatchPredicate {
    get {
      if case .notMatch(let v)? = _storage._rule {return v}
      return Envoy_Config_Tap_V4alpha_MatchPredicate()
    }
  ...
  public var httpRequestHeadersMatch: Envoy_Config_Tap_V4alpha_HttpHeadersMatch {
    get {
      if case .httpRequestHeadersMatch(let v)? = _storage._rule {return v}
      return Envoy_Config_Tap_V4alpha_HttpHeadersMatch()
    }
    set {_uniqueStorage()._rule = .httpRequestHeadersMatch(newValue)}
  }

  /// HTTP request trailers match configuration.
  public var httpRequestTrailersMatch: Envoy_Config_Tap_V4alpha_HttpHeadersMatch {
    get {
  ...
  public var httpResponseHeadersMatch: Envoy_Config_Tap_V4alpha_HttpHeadersMatch {
    get {
  ...
  public var httpResponseTrailersMatch: Envoy_Config_Tap_V4alpha_HttpHeadersMatch {
    get {
  ...
  public var httpRequestGenericBodyMatch: Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch {
    get {
      if case .httpRequestGenericBodyMatch(let v)? = _storage._rule {return v}
      return Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch()
    }
    set {_uniqueStorage()._rule = .httpRequestGenericBodyMatch(newValue)}
  }

  /// HTTP response generic body match configuration.
  public var httpResponseGenericBodyMatch: Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch {
    get {
  ...
  public enum OneOf_Rule: Equatable {
    /// A set that describes a logical OR. If any member of the set matches, the match configuration
    /// matches.
    case orMatch(Envoy_Config_Tap_V4alpha_MatchPredicate.MatchSet)
    /// A set that describes a logical AND. If all members of the set match, the match configuration
    /// matches.
    case andMatch(Envoy_Config_Tap_V4alpha_MatchPredicate.MatchSet)
    /// A negation match. The match configuration will match if the negated match condition matches.
    case notMatch(Envoy_Config_Tap_V4alpha_MatchPredicate)
    /// The match configuration will always match.
    case anyMatch(Bool)
    /// HTTP request headers match configuration.
    case httpRequestHeadersMatch(Envoy_Config_Tap_V4alpha_HttpHeadersMatch)
    /// HTTP request trailers match configuration.
    case httpRequestTrailersMatch(Envoy_Config_Tap_V4alpha_HttpHeadersMatch)
    /// HTTP response headers match configuration.
    case httpResponseHeadersMatch(Envoy_Config_Tap_V4alpha_HttpHeadersMatch)
    /// HTTP response trailers match configuration.
    case httpResponseTrailersMatch(Envoy_Config_Tap_V4alpha_HttpHeadersMatch)
    /// HTTP request generic body match configuration.
    case httpRequestGenericBodyMatch(Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch)
    /// HTTP response generic body match configuration.
    case httpResponseGenericBodyMatch(Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Tap_V4alpha_MatchPredicate.OneOf_Rule, rhs: Envoy_Config_Tap_V4alpha_MatchPredicate.OneOf_Rule) -> Bool {
  ...
  public struct MatchSet {
    ...
    public var rules: [Envoy_Config_Tap_V4alpha_MatchPredicate] = []
...
public struct Envoy_Config_Tap_V4alpha_HttpHeadersMatch {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var patterns: [Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch.GenericTextMatch] = []
  ...
  public struct GenericTextMatch {
    ...
    public var rule: Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch.GenericTextMatch.OneOf_Rule? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch.GenericTextMatch.OneOf_Rule, rhs: Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch.GenericTextMatch.OneOf_Rule) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
...
public struct Envoy_Config_Tap_V4alpha_OutputConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var sinks: [Envoy_Config_Tap_V4alpha_OutputSink] = []
...
public struct Envoy_Config_Tap_V4alpha_OutputSink {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Sink output format.
  public var format: Envoy_Config_Tap_V4alpha_OutputSink.Format = .jsonBodyAsBytes

  public var outputSinkType: Envoy_Config_Tap_V4alpha_OutputSink.OneOf_OutputSinkType? = nil
  ...
  public var streamingAdmin: Envoy_Config_Tap_V4alpha_StreamingAdminSink {
    get {
      if case .streamingAdmin(let v)? = outputSinkType {return v}
      return Envoy_Config_Tap_V4alpha_StreamingAdminSink()
    }
    set {outputSinkType = .streamingAdmin(newValue)}
  }

  /// Tap output will be written to a file per tap sink.
  public var filePerTap: Envoy_Config_Tap_V4alpha_FilePerTapSink {
    get {
      if case .filePerTap(let v)? = outputSinkType {return v}
      return Envoy_Config_Tap_V4alpha_FilePerTapSink()
    }
  ...
  public var streamingGrpc: Envoy_Config_Tap_V4alpha_StreamingGrpcSink {
    get {
      if case .streamingGrpc(let v)? = outputSinkType {return v}
      return Envoy_Config_Tap_V4alpha_StreamingGrpcSink()
    }
  ...
  public enum OneOf_OutputSinkType: Equatable {
    ...
    ///   been configured to receive tap configuration from some other source (e.g., static
    ///   file, XDS, etc.) configuring the streaming admin output type will fail.
    case streamingAdmin(Envoy_Config_Tap_V4alpha_StreamingAdminSink)
    /// Tap output will be written to a file per tap sink.
    case filePerTap(Envoy_Config_Tap_V4alpha_FilePerTapSink)
    /// [#not-implemented-hide:]
    /// GrpcService to stream data to. The format argument must be PROTO_BINARY.
    /// [#comment: TODO(samflattery): remove cleanup in uber_per_filter.cc once implemented]
    case streamingGrpc(Envoy_Config_Tap_V4alpha_StreamingGrpcSink)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Config_Tap_V4alpha_OutputSink.OneOf_OutputSinkType, rhs: Envoy_Config_Tap_V4alpha_OutputSink.OneOf_OutputSinkType) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
extension Envoy_Config_Tap_V4alpha_OutputSink.Format: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Config_Tap_V4alpha_OutputSink.Format] = [
    .jsonBodyAsBytes,
    .jsonBodyAsString,
    .protoBinary,
...
public struct Envoy_Config_Tap_V4alpha_StreamingAdminSink {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Config_Tap_V4alpha_FilePerTapSink {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// server.
public struct Envoy_Config_Tap_V4alpha_StreamingGrpcSink {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var grpcService: Envoy_Config_Core_V4alpha_GrpcService {
    get {return _grpcService ?? Envoy_Config_Core_V4alpha_GrpcService()}
  ...
  fileprivate var _grpcService: Envoy_Config_Core_V4alpha_GrpcService? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.config.tap.v4alpha"

extension Envoy_Config_Tap_V4alpha_TapConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Tap_V4alpha_TapConfig, rhs: Envoy_Config_Tap_V4alpha_TapConfig) -> Bool {
...
extension Envoy_Config_Tap_V4alpha_MatchPredicate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _rule: Envoy_Config_Tap_V4alpha_MatchPredicate.OneOf_Rule?
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        switch fieldNumber {
        case 1: try {
          var v: Envoy_Config_Tap_V4alpha_MatchPredicate.MatchSet?
        ...
        case 3: try {
          var v: Envoy_Config_Tap_V4alpha_MatchPredicate?
          if let current = _storage._rule {
            try decoder.handleConflictingOneOf()
        ...
        case 5: try {
          var v: Envoy_Config_Tap_V4alpha_HttpHeadersMatch?
          if let current = _storage._rule {
            try decoder.handleConflictingOneOf()
        ...
        case 9: try {
          var v: Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch?
          if let current = _storage._rule {
            try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Config_Tap_V4alpha_MatchPredicate, rhs: Envoy_Config_Tap_V4alpha_MatchPredicate) -> Bool {
...
extension Envoy_Config_Tap_V4alpha_MatchPredicate.MatchSet: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Tap_V4alpha_MatchPredicate.protoMessageName + ".MatchSet"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "rules"),
  ]
  ...
  public static func ==(lhs: Envoy_Config_Tap_V4alpha_MatchPredicate.MatchSet, rhs: Envoy_Config_Tap_V4alpha_MatchPredicate.MatchSet) -> Bool {
...
extension Envoy_Config_Tap_V4alpha_HttpHeadersMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Tap_V4alpha_HttpHeadersMatch, rhs: Envoy_Config_Tap_V4alpha_HttpHeadersMatch) -> Bool {
...
extension Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch, rhs: Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch) -> Bool {
...
extension Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch.GenericTextMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch.protoMessageName + ".GenericTextMatch"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch.GenericTextMatch, rhs: Envoy_Config_Tap_V4alpha_HttpGenericBodyMatch.GenericTextMatch) -> Bool {
...
extension Envoy_Config_Tap_V4alpha_OutputConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Tap_V4alpha_OutputConfig, rhs: Envoy_Config_Tap_V4alpha_OutputConfig) -> Bool {
...
extension Envoy_Config_Tap_V4alpha_OutputSink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Envoy_Config_Tap_V4alpha_StreamingAdminSink?
      ...
      case 3: try {
        var v: Envoy_Config_Tap_V4alpha_FilePerTapSink?
        if let current = self.outputSinkType {
          try decoder.handleConflictingOneOf()
      ...
      case 4: try {
        var v: Envoy_Config_Tap_V4alpha_StreamingGrpcSink?
        if let current = self.outputSinkType {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Config_Tap_V4alpha_OutputSink, rhs: Envoy_Config_Tap_V4alpha_OutputSink) -> Bool {
...
extension Envoy_Config_Tap_V4alpha_OutputSink.Format: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Config_Tap_V4alpha_StreamingAdminSink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Tap_V4alpha_StreamingAdminSink, rhs: Envoy_Config_Tap_V4alpha_StreamingAdminSink) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Config_Tap_V4alpha_FilePerTapSink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Tap_V4alpha_FilePerTapSink, rhs: Envoy_Config_Tap_V4alpha_FilePerTapSink) -> Bool {
...
extension Envoy_Config_Tap_V4alpha_StreamingGrpcSink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Config_Tap_V4alpha_StreamingGrpcSink, rhs: Envoy_Config_Tap_V4alpha_StreamingGrpcSink) -> Bool {
