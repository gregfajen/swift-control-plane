...
public struct Envoy_Api_V2_Auth_GenericSecret {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Secret of generic type and is available to filters.
  public var secret: Envoy_Api_V2_Core_DataSource {
    get {return _secret ?? Envoy_Api_V2_Core_DataSource()}
  ...
  fileprivate var _secret: Envoy_Api_V2_Core_DataSource? = nil
}

public struct Envoy_Api_V2_Auth_SdsSecretConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var sdsConfig: Envoy_Api_V2_Core_ConfigSource {
    get {return _sdsConfig ?? Envoy_Api_V2_Core_ConfigSource()}
  ...
  fileprivate var _sdsConfig: Envoy_Api_V2_Core_ConfigSource? = nil
}

/// [#next-free-field: 6]
public struct Envoy_Api_V2_Auth_Secret {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var type: Envoy_Api_V2_Auth_Secret.OneOf_Type? = nil

  public var tlsCertificate: Envoy_Api_V2_Auth_TlsCertificate {
    get {
  ...
  public var genericSecret: Envoy_Api_V2_Auth_GenericSecret {
    get {
      if case .genericSecret(let v)? = type {return v}
      return Envoy_Api_V2_Auth_GenericSecret()
    }
  ...
  public enum OneOf_Type: Equatable {
    case tlsCertificate(Envoy_Api_V2_Auth_TlsCertificate)
    ...
    case genericSecret(Envoy_Api_V2_Auth_GenericSecret)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Api_V2_Auth_Secret.OneOf_Type, rhs: Envoy_Api_V2_Auth_Secret.OneOf_Type) -> Bool {
...
extension Envoy_Api_V2_Auth_GenericSecret: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Auth_GenericSecret, rhs: Envoy_Api_V2_Auth_GenericSecret) -> Bool {
...
extension Envoy_Api_V2_Auth_SdsSecretConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._sdsConfig) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Api_V2_Auth_SdsSecretConfig, rhs: Envoy_Api_V2_Auth_SdsSecretConfig) -> Bool {
...
extension Envoy_Api_V2_Auth_Secret: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try { try decoder.decodeSingularStringField(value: &self.name) }()
      case 2: try {
        var v: Envoy_Api_V2_Auth_TlsCertificate?
      ...
      case 5: try {
        var v: Envoy_Api_V2_Auth_GenericSecret?
        if let current = self.type {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Api_V2_Auth_Secret, rhs: Envoy_Api_V2_Auth_Secret) -> Bool {
    if lhs.name != rhs.name {return false}
