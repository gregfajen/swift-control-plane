...
public struct Envoy_Api_V2_Auth_TlsParameters {
  ...
  /// servers.
  public var tlsMinimumProtocolVersion: Envoy_Api_V2_Auth_TlsParameters.TlsProtocol = .tlsAuto

  /// Maximum TLS protocol version. By default, it's ``TLSv1_2`` for clients and ``TLSv1_3`` for
  /// servers.
  public var tlsMaximumProtocolVersion: Envoy_Api_V2_Auth_TlsParameters.TlsProtocol = .tlsAuto
...
extension Envoy_Api_V2_Auth_TlsParameters.TlsProtocol: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Api_V2_Auth_TlsParameters.TlsProtocol] = [
    .tlsAuto,
    .tlsv10,
    .tlsv11,
    .tlsv12,
...
public struct Envoy_Api_V2_Auth_PrivateKeyProvider {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var configType: Envoy_Api_V2_Auth_PrivateKeyProvider.OneOf_ConfigType? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Api_V2_Auth_PrivateKeyProvider.OneOf_ConfigType, rhs: Envoy_Api_V2_Auth_PrivateKeyProvider.OneOf_ConfigType) -> Bool {
...
/// [#next-free-field: 7]
public struct Envoy_Api_V2_Auth_TlsCertificate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The TLS certificate chain.
  public var certificateChain: Envoy_Api_V2_Core_DataSource {
    get {return _certificateChain ?? Envoy_Api_V2_Core_DataSource()}
  ...
  /// error.
  public var privateKeyProvider: Envoy_Api_V2_Auth_PrivateKeyProvider {
    get {return _privateKeyProvider ?? Envoy_Api_V2_Auth_PrivateKeyProvider()}
  ...
  public var password: Envoy_Api_V2_Core_DataSource {
    get {return _password ?? Envoy_Api_V2_Core_DataSource()}
  ...
  public var ocspStaple: Envoy_Api_V2_Core_DataSource {
    get {return _ocspStaple ?? Envoy_Api_V2_Core_DataSource()}
  ...
  /// [#not-implemented-hide:]
  public var signedCertificateTimestamp: [Envoy_Api_V2_Core_DataSource] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _certificateChain: Envoy_Api_V2_Core_DataSource? = nil
  fileprivate var _privateKey: Envoy_Api_V2_Core_DataSource? = nil
  fileprivate var _privateKeyProvider: Envoy_Api_V2_Auth_PrivateKeyProvider? = nil
  fileprivate var _password: Envoy_Api_V2_Core_DataSource? = nil
  fileprivate var _ocspStaple: Envoy_Api_V2_Core_DataSource? = nil
}

public struct Envoy_Api_V2_Auth_TlsSessionTicketKeys {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var keys: [Envoy_Api_V2_Core_DataSource] = []
...
/// [#next-free-field: 11]
public struct Envoy_Api_V2_Auth_CertificateValidationContext {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// system CA locations.
  public var trustedCa: Envoy_Api_V2_Core_DataSource {
    get {return _trustedCa ?? Envoy_Api_V2_Core_DataSource()}
  ...
  public var verifySubjectAltName: [String] = []
  ...
  ///   therefore this option must be used together with :ref:`trusted_ca
  ///   <envoy_api_field_auth.CertificateValidationContext.trusted_ca>`.
  public var matchSubjectAltNames: [Envoy_Type_Matcher_StringMatcher] = []
  ...
  public var crl: Envoy_Api_V2_Core_DataSource {
    get {return _crl ?? Envoy_Api_V2_Core_DataSource()}
    set {_crl = newValue}
  }
  ...
  public var trustChainVerification: Envoy_Api_V2_Auth_CertificateValidationContext.TrustChainVerification = .verifyTrustChain
  ...
  fileprivate var _trustedCa: Envoy_Api_V2_Core_DataSource? = nil
  ...
  fileprivate var _crl: Envoy_Api_V2_Core_DataSource? = nil
}

#if swift(>=4.2)

extension Envoy_Api_V2_Auth_CertificateValidationContext.TrustChainVerification: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Api_V2_Auth_CertificateValidationContext.TrustChainVerification] = [
    .verifyTrustChain,
    .acceptUntrusted,
  ]
}
...
extension Envoy_Api_V2_Auth_TlsParameters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Auth_TlsParameters, rhs: Envoy_Api_V2_Auth_TlsParameters) -> Bool {
...
extension Envoy_Api_V2_Auth_TlsParameters.TlsProtocol: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Api_V2_Auth_PrivateKeyProvider: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Auth_PrivateKeyProvider, rhs: Envoy_Api_V2_Auth_PrivateKeyProvider) -> Bool {
...
extension Envoy_Api_V2_Auth_TlsCertificate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Auth_TlsCertificate, rhs: Envoy_Api_V2_Auth_TlsCertificate) -> Bool {
...
extension Envoy_Api_V2_Auth_TlsSessionTicketKeys: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Auth_TlsSessionTicketKeys, rhs: Envoy_Api_V2_Auth_TlsSessionTicketKeys) -> Bool {
...
extension Envoy_Api_V2_Auth_CertificateValidationContext: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    4: .standard(proto: "verify_subject_alt_name"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeRepeatedStringField(value: &self.verifySubjectAltName) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._requireOcspStaple) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.verifySubjectAltName.isEmpty {
      try visitor.visitRepeatedStringField(value: self.verifySubjectAltName, fieldNumber: 4)
    }
  ...
  public static func ==(lhs: Envoy_Api_V2_Auth_CertificateValidationContext, rhs: Envoy_Api_V2_Auth_CertificateValidationContext) -> Bool {
    ...
    if lhs.verifySubjectAltName != rhs.verifySubjectAltName {return false}
...
extension Envoy_Api_V2_Auth_CertificateValidationContext.TrustChainVerification: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
