...
public struct Envoy_Api_V2_Cluster_CircuitBreakers {
  ...
  /// are used.
  public var thresholds: [Envoy_Api_V2_Cluster_CircuitBreakers.Thresholds] = []
  ...
  public struct Thresholds {
    ...
    public var priority: Envoy_Api_V2_Core_RoutingPriority = .default
    ...
    ///    breaker.
    public var retryBudget: Envoy_Api_V2_Cluster_CircuitBreakers.Thresholds.RetryBudget {
      get {return _retryBudget ?? Envoy_Api_V2_Cluster_CircuitBreakers.Thresholds.RetryBudget()}
    ...
    public struct RetryBudget {
      ...
      public var budgetPercent: Envoy_Type_Percent {
        get {return _budgetPercent ?? Envoy_Type_Percent()}
      ...
      fileprivate var _budgetPercent: Envoy_Type_Percent? = nil
    ...
    fileprivate var _retryBudget: Envoy_Api_V2_Cluster_CircuitBreakers.Thresholds.RetryBudget? = nil
...
fileprivate let _protobuf_package = "envoy.api.v2.cluster"

extension Envoy_Api_V2_Cluster_CircuitBreakers: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster_CircuitBreakers, rhs: Envoy_Api_V2_Cluster_CircuitBreakers) -> Bool {
...
extension Envoy_Api_V2_Cluster_CircuitBreakers.Thresholds: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster_CircuitBreakers.protoMessageName + ".Thresholds"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster_CircuitBreakers.Thresholds, rhs: Envoy_Api_V2_Cluster_CircuitBreakers.Thresholds) -> Bool {
...
extension Envoy_Api_V2_Cluster_CircuitBreakers.Thresholds.RetryBudget: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster_CircuitBreakers.Thresholds.protoMessageName + ".RetryBudget"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster_CircuitBreakers.Thresholds.RetryBudget, rhs: Envoy_Api_V2_Cluster_CircuitBreakers.Thresholds.RetryBudget) -> Bool {
