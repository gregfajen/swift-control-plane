...
/// [#next-free-field: 23]
public struct Envoy_Api_V2_Listener {
  ...
  public var filterChains: [Envoy_Api_V2_Listener_FilterChain] {
  ...
  public var useOriginalDst: SwiftProtobuf.Google_Protobuf_BoolValue {
    get {return _storage._useOriginalDst ?? SwiftProtobuf.Google_Protobuf_BoolValue()}
    set {_uniqueStorage()._useOriginalDst = newValue}
  }
  /// Returns true if `useOriginalDst` has been explicitly set.
  public var hasUseOriginalDst: Bool {return _storage._useOriginalDst != nil}
  /// Clears the value of `useOriginalDst`. Subsequent reads from it will return its default value.
  public mutating func clearUseOriginalDst() {_uniqueStorage()._useOriginalDst = nil}
  ...
  public var deprecatedV1: Envoy_Api_V2_Listener.DeprecatedV1 {
    get {return _storage._deprecatedV1 ?? Envoy_Api_V2_Listener.DeprecatedV1()}
  ...
  public var drainType: Envoy_Api_V2_Listener.DrainType {
  ...
  public var listenerFilters: [Envoy_Api_V2_Listener_ListenerFilter] {
  ...
  public var trafficDirection: Envoy_Api_V2_Core_TrafficDirection {
  ...
  public var udpListenerConfig: Envoy_Api_V2_Listener_UdpListenerConfig {
    get {return _storage._udpListenerConfig ?? Envoy_Api_V2_Listener_UdpListenerConfig()}
  ...
  public var apiListener: Envoy_Config_Listener_V2_ApiListener {
    get {return _storage._apiListener ?? Envoy_Config_Listener_V2_ApiListener()}
  ...
  /// worker threads.
  public var connectionBalanceConfig: Envoy_Api_V2_Listener.ConnectionBalanceConfig {
    get {return _storage._connectionBalanceConfig ?? Envoy_Api_V2_Listener.ConnectionBalanceConfig()}
  ...
  public struct ConnectionBalanceConfig {
    ...
    public var balanceType: Envoy_Api_V2_Listener.ConnectionBalanceConfig.OneOf_BalanceType? = nil

    /// If specified, the listener will use the exact connection balancer.
    public var exactBalance: Envoy_Api_V2_Listener.ConnectionBalanceConfig.ExactBalance {
      get {
        if case .exactBalance(let v)? = balanceType {return v}
        return Envoy_Api_V2_Listener.ConnectionBalanceConfig.ExactBalance()
      }
    ...
    public enum OneOf_BalanceType: Equatable {
      /// If specified, the listener will use the exact connection balancer.
      case exactBalance(Envoy_Api_V2_Listener.ConnectionBalanceConfig.ExactBalance)

    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Api_V2_Listener.ConnectionBalanceConfig.OneOf_BalanceType, rhs: Envoy_Api_V2_Listener.ConnectionBalanceConfig.OneOf_BalanceType) -> Bool {
...
extension Envoy_Api_V2_Listener.DrainType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Api_V2_Listener.DrainType] = [
    .default,
    .modifyOnly,
  ]
}
...
extension Envoy_Api_V2_Listener: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Listener"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .same(proto: "address"),
    3: .standard(proto: "filter_chains"),
    4: .standard(proto: "use_original_dst"),
  ...
  fileprivate class _StorageClass {
    ...
    var _filterChains: [Envoy_Api_V2_Listener_FilterChain] = []
    var _useOriginalDst: SwiftProtobuf.Google_Protobuf_BoolValue? = nil
    ...
    var _deprecatedV1: Envoy_Api_V2_Listener.DeprecatedV1? = nil
    var _drainType: Envoy_Api_V2_Listener.DrainType = .default
    var _listenerFilters: [Envoy_Api_V2_Listener_ListenerFilter] = []
    ...
    var _socketOptions: [Envoy_Api_V2_Core_SocketOption] = []
    var _tcpFastOpenQueueLength: SwiftProtobuf.Google_Protobuf_UInt32Value? = nil
    var _trafficDirection: Envoy_Api_V2_Core_TrafficDirection = .unspecified
    var _udpListenerConfig: Envoy_Api_V2_Listener_UdpListenerConfig? = nil
    var _apiListener: Envoy_Config_Listener_V2_ApiListener? = nil
    var _connectionBalanceConfig: Envoy_Api_V2_Listener.ConnectionBalanceConfig? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _useOriginalDst = source._useOriginalDst
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try { try decoder.decodeSingularMessageField(value: &_storage._useOriginalDst) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._useOriginalDst {
  ...
  public static func ==(lhs: Envoy_Api_V2_Listener, rhs: Envoy_Api_V2_Listener) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._useOriginalDst != rhs_storage._useOriginalDst {return false}
...
extension Envoy_Api_V2_Listener.DrainType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Api_V2_Listener.DeprecatedV1: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Listener.protoMessageName + ".DeprecatedV1"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Api_V2_Listener.DeprecatedV1, rhs: Envoy_Api_V2_Listener.DeprecatedV1) -> Bool {
...
extension Envoy_Api_V2_Listener.ConnectionBalanceConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Listener.protoMessageName + ".ConnectionBalanceConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Envoy_Api_V2_Listener.ConnectionBalanceConfig.ExactBalance?
  ...
  public static func ==(lhs: Envoy_Api_V2_Listener.ConnectionBalanceConfig, rhs: Envoy_Api_V2_Listener.ConnectionBalanceConfig) -> Bool {
...
extension Envoy_Api_V2_Listener.ConnectionBalanceConfig.ExactBalance: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Listener.ConnectionBalanceConfig.protoMessageName + ".ExactBalance"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Envoy_Api_V2_Listener.ConnectionBalanceConfig.ExactBalance, rhs: Envoy_Api_V2_Listener.ConnectionBalanceConfig.ExactBalance) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
