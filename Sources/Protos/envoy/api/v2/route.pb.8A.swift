...
/// [#next-free-field: 11]
public struct Envoy_Api_V2_RouteConfiguration {
  ...
  public var virtualHosts: [Envoy_Api_V2_Route_VirtualHost] {
  ...
  /// taking precedence.
  public var vhds: Envoy_Api_V2_Vhds {
    get {return _storage._vhds ?? Envoy_Api_V2_Vhds()}
...
public struct Envoy_Api_V2_Vhds {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Envoy_Api_V2_RouteConfiguration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _virtualHosts: [Envoy_Api_V2_Route_VirtualHost] = []
    var _vhds: Envoy_Api_V2_Vhds? = nil
  ...
  public static func ==(lhs: Envoy_Api_V2_RouteConfiguration, rhs: Envoy_Api_V2_RouteConfiguration) -> Bool {
...
extension Envoy_Api_V2_Vhds: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Vhds, rhs: Envoy_Api_V2_Vhds) -> Bool {
