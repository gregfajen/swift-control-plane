...
/// Next id: 4
public struct Envoy_Api_V2_Listener_QuicProtocolOptions {
...
extension Envoy_Api_V2_Listener_QuicProtocolOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Listener_QuicProtocolOptions, rhs: Envoy_Api_V2_Listener_QuicProtocolOptions) -> Bool {
