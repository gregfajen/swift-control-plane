...
public struct Envoy_Api_V2_Listener_Filter {
  ...
  public var configType: Envoy_Api_V2_Listener_Filter.OneOf_ConfigType? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Api_V2_Listener_Filter.OneOf_ConfigType, rhs: Envoy_Api_V2_Listener_Filter.OneOf_ConfigType) -> Bool {
...
/// [#next-free-field: 13]
public struct Envoy_Api_V2_Listener_FilterChainMatch {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var prefixRanges: [Envoy_Api_V2_Core_CidrRange] = []
  ...
  public var sourceType: Envoy_Api_V2_Listener_FilterChainMatch.ConnectionSourceType = .any

  /// The criteria is satisfied if the source IP address of the downstream
  /// connection is contained in at least one of the specified subnets. If the
  /// parameter is not specified or the list is empty, the source IP address is
  /// ignored.
  public var sourcePrefixRanges: [Envoy_Api_V2_Core_CidrRange] = []
...
extension Envoy_Api_V2_Listener_FilterChainMatch.ConnectionSourceType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Api_V2_Listener_FilterChainMatch.ConnectionSourceType] = [
    .any,
    .local,
    .external,
  ]
...
/// [#next-free-field: 8]
public struct Envoy_Api_V2_Listener_FilterChain {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The criteria to use when matching a connection to this filter chain.
  public var filterChainMatch: Envoy_Api_V2_Listener_FilterChainMatch {
    get {return _storage._filterChainMatch ?? Envoy_Api_V2_Listener_FilterChainMatch()}
  ...
  public var tlsContext: Envoy_Api_V2_Auth_DownstreamTlsContext {
    get {return _storage._tlsContext ?? Envoy_Api_V2_Auth_DownstreamTlsContext()}
  ...
  public var filters: [Envoy_Api_V2_Listener_Filter] {
...
///
/// [#next-free-field: 6]
public struct Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// matches.
  public var orMatch: Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate.MatchSet {
    get {
      if case .orMatch(let v)? = _storage._rule {return v}
      return Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate.MatchSet()
    }
  ...
  /// matches.
  public var andMatch: Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate.MatchSet {
    get {
  ...
  public var notMatch: Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate {
    get {
      if case .notMatch(let v)? = _storage._rule {return v}
      return Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate()
    }
  ...
  public var destinationPortRange: Envoy_Type_Int32Range {
    get {
      if case .destinationPortRange(let v)? = _storage._rule {return v}
      return Envoy_Type_Int32Range()
    }
  ...
  public enum OneOf_Rule: Equatable {
    /// A set that describes a logical OR. If any member of the set matches, the match configuration
    /// matches.
    case orMatch(Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate.MatchSet)
    /// A set that describes a logical AND. If all members of the set match, the match configuration
    /// matches.
    case andMatch(Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate.MatchSet)
    /// A negation match. The match configuration will match if the negated match condition matches.
    case notMatch(Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate)
    /// The match configuration will always match.
    case anyMatch(Bool)
    /// Match destination port. Particularly, the match evaluation must use the recovered local port if
    /// the owning listener filter is after :ref:`an original_dst listener filter <config_listener_filters_original_dst>`.
    case destinationPortRange(Envoy_Type_Int32Range)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate.OneOf_Rule, rhs: Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate.OneOf_Rule) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
  ...
  public struct MatchSet {
    ...
    public var rules: [Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate] = []
...
public struct Envoy_Api_V2_Listener_ListenerFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var configType: Envoy_Api_V2_Listener_ListenerFilter.OneOf_ConfigType? = nil
  ...
  public var filterDisabled: Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate {
    get {return _filterDisabled ?? Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate()}
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Api_V2_Listener_ListenerFilter.OneOf_ConfigType, rhs: Envoy_Api_V2_Listener_ListenerFilter.OneOf_ConfigType) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
  ...
  fileprivate var _filterDisabled: Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate? = nil
}
...
extension Envoy_Api_V2_Listener_Filter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Listener_Filter, rhs: Envoy_Api_V2_Listener_Filter) -> Bool {
...
extension Envoy_Api_V2_Listener_FilterChainMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Listener_FilterChainMatch, rhs: Envoy_Api_V2_Listener_FilterChainMatch) -> Bool {
...
extension Envoy_Api_V2_Listener_FilterChainMatch.ConnectionSourceType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "ANY"),
    1: .same(proto: "LOCAL"),
...
extension Envoy_Api_V2_Listener_FilterChain: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".FilterChain"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "filter_chain_match"),
    2: .standard(proto: "tls_context"),
  ...
  fileprivate class _StorageClass {
    var _filterChainMatch: Envoy_Api_V2_Listener_FilterChainMatch? = nil
    var _tlsContext: Envoy_Api_V2_Auth_DownstreamTlsContext? = nil
    var _filters: [Envoy_Api_V2_Listener_Filter] = []
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._tlsContext) }()
  ...
  public static func ==(lhs: Envoy_Api_V2_Listener_FilterChain, rhs: Envoy_Api_V2_Listener_FilterChain) -> Bool {
...
extension Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _rule: Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate.OneOf_Rule?
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        switch fieldNumber {
        case 1: try {
          var v: Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate.MatchSet?
        ...
        case 3: try {
          var v: Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate?
          if let current = _storage._rule {
            try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate, rhs: Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate.MatchSet: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate.protoMessageName + ".MatchSet"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "rules"),
  ]
  ...
  public static func ==(lhs: Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate.MatchSet, rhs: Envoy_Api_V2_Listener_ListenerFilterChainMatchPredicate.MatchSet) -> Bool {
...
extension Envoy_Api_V2_Listener_ListenerFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Listener_ListenerFilter, rhs: Envoy_Api_V2_Listener_ListenerFilter) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.configType != rhs.configType {return false}
