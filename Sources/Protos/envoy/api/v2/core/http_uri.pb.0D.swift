...
public struct Envoy_Api_V2_Core_HttpUri {
  ...
  public var httpUpstreamType: Envoy_Api_V2_Core_HttpUri.OneOf_HTTPUpstreamType? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Api_V2_Core_HttpUri.OneOf_HTTPUpstreamType, rhs: Envoy_Api_V2_Core_HttpUri.OneOf_HTTPUpstreamType) -> Bool {
...
extension Envoy_Api_V2_Core_HttpUri: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_HttpUri, rhs: Envoy_Api_V2_Core_HttpUri) -> Bool {
