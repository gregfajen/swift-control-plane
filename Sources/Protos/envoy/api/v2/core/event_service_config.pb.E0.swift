...
public struct Envoy_Api_V2_Core_EventServiceConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var configSourceSpecifier: Envoy_Api_V2_Core_EventServiceConfig.OneOf_ConfigSourceSpecifier? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Api_V2_Core_EventServiceConfig.OneOf_ConfigSourceSpecifier, rhs: Envoy_Api_V2_Core_EventServiceConfig.OneOf_ConfigSourceSpecifier) -> Bool {
...
extension Envoy_Api_V2_Core_EventServiceConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_EventServiceConfig, rhs: Envoy_Api_V2_Core_EventServiceConfig) -> Bool {
