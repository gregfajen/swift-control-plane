...
public struct Envoy_Api_V2_Core_TcpProtocolOptions {
...
public struct Envoy_Api_V2_Core_UpstreamHttpProtocolOptions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// [#next-free-field: 6]
public struct Envoy_Api_V2_Core_HttpProtocolOptions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var headersWithUnderscoresAction: Envoy_Api_V2_Core_HttpProtocolOptions.HeadersWithUnderscoresAction = .allow
...
extension Envoy_Api_V2_Core_HttpProtocolOptions.HeadersWithUnderscoresAction: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Api_V2_Core_HttpProtocolOptions.HeadersWithUnderscoresAction] = [
    .allow,
    .rejectRequest,
    .dropHeader,
  ]
...
/// [#next-free-field: 6]
public struct Envoy_Api_V2_Core_Http1ProtocolOptions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// are lower cased.
  public var headerKeyFormat: Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat {
    get {return _headerKeyFormat ?? Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat()}
  ...
  public struct HeaderKeyFormat {
    ...
    public var headerFormat: Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat.OneOf_HeaderFormat? = nil
    ...
    public var properCaseWords: Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat.ProperCaseWords {
      get {
        if case .properCaseWords(let v)? = headerFormat {return v}
        return Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat.ProperCaseWords()
      }
    ...
    public enum OneOf_HeaderFormat: Equatable {
      ...
      /// Note that while this results in most headers following conventional casing, certain headers
      /// are not covered. For example, the "TE" header will be formatted as "Te".
      case properCaseWords(Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat.ProperCaseWords)

    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat.OneOf_HeaderFormat, rhs: Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat.OneOf_HeaderFormat) -> Bool {
  ...
  fileprivate var _headerKeyFormat: Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat? = nil
}

/// [#next-free-field: 14]
public struct Envoy_Api_V2_Core_Http2ProtocolOptions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var customSettingsParameters: [Envoy_Api_V2_Core_Http2ProtocolOptions.SettingsParameter] = []
...
/// [#not-implemented-hide:]
public struct Envoy_Api_V2_Core_GrpcProtocolOptions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var http2ProtocolOptions: Envoy_Api_V2_Core_Http2ProtocolOptions {
    get {return _http2ProtocolOptions ?? Envoy_Api_V2_Core_Http2ProtocolOptions()}
  ...
  fileprivate var _http2ProtocolOptions: Envoy_Api_V2_Core_Http2ProtocolOptions? = nil
}
...
extension Envoy_Api_V2_Core_TcpProtocolOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_TcpProtocolOptions, rhs: Envoy_Api_V2_Core_TcpProtocolOptions) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Api_V2_Core_UpstreamHttpProtocolOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_UpstreamHttpProtocolOptions, rhs: Envoy_Api_V2_Core_UpstreamHttpProtocolOptions) -> Bool {
...
extension Envoy_Api_V2_Core_HttpProtocolOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_HttpProtocolOptions, rhs: Envoy_Api_V2_Core_HttpProtocolOptions) -> Bool {
...
extension Envoy_Api_V2_Core_HttpProtocolOptions.HeadersWithUnderscoresAction: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "ALLOW"),
...
extension Envoy_Api_V2_Core_Http1ProtocolOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_Http1ProtocolOptions, rhs: Envoy_Api_V2_Core_Http1ProtocolOptions) -> Bool {
...
extension Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Core_Http1ProtocolOptions.protoMessageName + ".HeaderKeyFormat"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat.ProperCaseWords?
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat, rhs: Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat) -> Bool {
...
extension Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat.ProperCaseWords: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat.protoMessageName + ".ProperCaseWords"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat.ProperCaseWords, rhs: Envoy_Api_V2_Core_Http1ProtocolOptions.HeaderKeyFormat.ProperCaseWords) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Api_V2_Core_Http2ProtocolOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._hpackTableSize) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._maxConcurrentStreams) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._initialStreamWindowSize) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._initialConnectionWindowSize) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self.allowConnect) }()
      case 6: try { try decoder.decodeSingularBoolField(value: &self.allowMetadata) }()
      case 7: try { try decoder.decodeSingularMessageField(value: &self._maxOutboundFrames) }()
      case 8: try { try decoder.decodeSingularMessageField(value: &self._maxOutboundControlFrames) }()
      case 9: try { try decoder.decodeSingularMessageField(value: &self._maxConsecutiveInboundFramesWithEmptyPayload) }()
      case 10: try { try decoder.decodeSingularMessageField(value: &self._maxInboundPriorityFramesPerStream) }()
      case 11: try { try decoder.decodeSingularMessageField(value: &self._maxInboundWindowUpdateFramesPerDataFrameSent) }()
      case 12: try { try decoder.decodeSingularBoolField(value: &self.streamErrorOnInvalidHTTPMessaging) }()
      case 13: try { try decoder.decodeRepeatedMessageField(value: &self.customSettingsParameters) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_Http2ProtocolOptions, rhs: Envoy_Api_V2_Core_Http2ProtocolOptions) -> Bool {
...
extension Envoy_Api_V2_Core_Http2ProtocolOptions.SettingsParameter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Core_Http2ProtocolOptions.protoMessageName + ".SettingsParameter"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_Http2ProtocolOptions.SettingsParameter, rhs: Envoy_Api_V2_Core_Http2ProtocolOptions.SettingsParameter) -> Bool {
...
extension Envoy_Api_V2_Core_GrpcProtocolOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_GrpcProtocolOptions, rhs: Envoy_Api_V2_Core_GrpcProtocolOptions) -> Bool {
