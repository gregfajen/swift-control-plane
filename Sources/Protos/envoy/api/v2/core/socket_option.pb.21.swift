...
/// [#next-free-field: 7]
public struct Envoy_Api_V2_Core_SocketOption {
  ...
  public var value: Envoy_Api_V2_Core_SocketOption.OneOf_Value? = nil
  ...
  public var state: Envoy_Api_V2_Core_SocketOption.SocketState = .statePrebind
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Api_V2_Core_SocketOption.OneOf_Value, rhs: Envoy_Api_V2_Core_SocketOption.OneOf_Value) -> Bool {
...
extension Envoy_Api_V2_Core_SocketOption.SocketState: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Api_V2_Core_SocketOption.SocketState] = [
    .statePrebind,
    .stateBound,
    .stateListening,
  ]
...
extension Envoy_Api_V2_Core_SocketOption: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_SocketOption, rhs: Envoy_Api_V2_Core_SocketOption) -> Bool {
...
extension Envoy_Api_V2_Core_SocketOption.SocketState: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
