...
public struct Envoy_Api_V2_Core_Pipe {
...
/// [#next-free-field: 7]
public struct Envoy_Api_V2_Core_SocketAddress {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var `protocol`: Envoy_Api_V2_Core_SocketAddress.ProtocolEnum = .tcp
  ...
  public var portSpecifier: Envoy_Api_V2_Core_SocketAddress.OneOf_PortSpecifier? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Api_V2_Core_SocketAddress.OneOf_PortSpecifier, rhs: Envoy_Api_V2_Core_SocketAddress.OneOf_PortSpecifier) -> Bool {
...
extension Envoy_Api_V2_Core_SocketAddress.ProtocolEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Api_V2_Core_SocketAddress.ProtocolEnum] = [
    .tcp,
    .udp,
  ]
}
...
public struct Envoy_Api_V2_Core_TcpKeepalive {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Api_V2_Core_BindConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The address to bind to when creating a socket.
  public var sourceAddress: Envoy_Api_V2_Core_SocketAddress {
    get {return _sourceAddress ?? Envoy_Api_V2_Core_SocketAddress()}
  ...
  fileprivate var _sourceAddress: Envoy_Api_V2_Core_SocketAddress? = nil
...
/// management servers.
public struct Envoy_Api_V2_Core_Address {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var address: Envoy_Api_V2_Core_Address.OneOf_Address? = nil

  public var socketAddress: Envoy_Api_V2_Core_SocketAddress {
    get {
  ...
  public var pipe: Envoy_Api_V2_Core_Pipe {
    get {
  ...
  public enum OneOf_Address: Equatable {
    case socketAddress(Envoy_Api_V2_Core_SocketAddress)
    case pipe(Envoy_Api_V2_Core_Pipe)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Api_V2_Core_Address.OneOf_Address, rhs: Envoy_Api_V2_Core_Address.OneOf_Address) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Envoy_Api_V2_Core_CidrRange {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Envoy_Api_V2_Core_Pipe: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_Pipe, rhs: Envoy_Api_V2_Core_Pipe) -> Bool {
...
extension Envoy_Api_V2_Core_SocketAddress: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_SocketAddress, rhs: Envoy_Api_V2_Core_SocketAddress) -> Bool {
...
extension Envoy_Api_V2_Core_SocketAddress.ProtocolEnum: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "TCP"),
    1: .same(proto: "UDP"),
  ]
...
extension Envoy_Api_V2_Core_TcpKeepalive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_TcpKeepalive, rhs: Envoy_Api_V2_Core_TcpKeepalive) -> Bool {
...
extension Envoy_Api_V2_Core_BindConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_BindConfig, rhs: Envoy_Api_V2_Core_BindConfig) -> Bool {
...
extension Envoy_Api_V2_Core_Address: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Envoy_Api_V2_Core_SocketAddress?
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_Address, rhs: Envoy_Api_V2_Core_Address) -> Bool {
    if lhs.address != rhs.address {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Envoy_Api_V2_Core_CidrRange: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_Core_CidrRange, rhs: Envoy_Api_V2_Core_CidrRange) -> Bool {
