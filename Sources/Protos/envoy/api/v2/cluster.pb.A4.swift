...
/// [#next-free-field: 48]
public struct Envoy_Api_V2_Cluster {
  ...
  public var transportSocketMatches: [Envoy_Api_V2_Cluster.TransportSocketMatch] {
  ...
  public var type: Envoy_Api_V2_Cluster.DiscoveryType {
    get {
  ...
  public var clusterType: Envoy_Api_V2_Cluster.CustomClusterType {
    get {
      if case .clusterType(let v)? = _storage._clusterDiscoveryType {return v}
      return Envoy_Api_V2_Cluster.CustomClusterType()
    }
    set {_uniqueStorage()._clusterDiscoveryType = .clusterType(newValue)}
  }

  /// Configuration to use for EDS updates for the Cluster.
  public var edsClusterConfig: Envoy_Api_V2_Cluster.EdsClusterConfig {
    get {return _storage._edsClusterConfig ?? Envoy_Api_V2_Cluster.EdsClusterConfig()}
  ...
  public var lbPolicy: Envoy_Api_V2_Cluster.LbPolicy {
  ...
  public var hosts: [Envoy_Api_V2_Core_Address] {
  ...
  public var loadAssignment: Envoy_Api_V2_ClusterLoadAssignment {
    get {return _storage._loadAssignment ?? Envoy_Api_V2_ClusterLoadAssignment()}
  ...
  public var circuitBreakers: Envoy_Api_V2_Cluster_CircuitBreakers {
    get {return _storage._circuitBreakers ?? Envoy_Api_V2_Cluster_CircuitBreakers()}
  ...
  public var tlsContext: Envoy_Api_V2_Auth_UpstreamTlsContext {
    get {return _storage._tlsContext ?? Envoy_Api_V2_Auth_UpstreamTlsContext()}
    set {_uniqueStorage()._tlsContext = newValue}
  }
  /// Returns true if `tlsContext` has been explicitly set.
  public var hasTlsContext: Bool {return _storage._tlsContext != nil}
  /// Clears the value of `tlsContext`. Subsequent reads from it will return its default value.
  public mutating func clearTlsContext() {_uniqueStorage()._tlsContext = nil}

  /// HTTP protocol options that are applied only to upstream HTTP connections.
  /// These options apply to all HTTP versions.
  public var upstreamHTTPProtocolOptions: Envoy_Api_V2_Core_UpstreamHttpProtocolOptions {
    get {return _storage._upstreamHTTPProtocolOptions ?? Envoy_Api_V2_Core_UpstreamHttpProtocolOptions()}
  ...
  /// specific options.
  public var extensionProtocolOptions: Dictionary<String,SwiftProtobuf.Google_Protobuf_Struct> {
    get {return _storage._extensionProtocolOptions}
    set {_uniqueStorage()._extensionProtocolOptions = newValue}
  }
  ...
  /// ignored.
  public var dnsFailureRefreshRate: Envoy_Api_V2_Cluster.RefreshRate {
    get {return _storage._dnsFailureRefreshRate ?? Envoy_Api_V2_Cluster.RefreshRate()}
  ...
  public var dnsLookupFamily: Envoy_Api_V2_Cluster.DnsLookupFamily {
  ...
  public var dnsResolvers: [Envoy_Api_V2_Core_Address] {
  ...
  public var outlierDetection: Envoy_Api_V2_Cluster_OutlierDetection {
    get {return _storage._outlierDetection ?? Envoy_Api_V2_Cluster_OutlierDetection()}
  ...
  public var lbSubsetConfig: Envoy_Api_V2_Cluster.LbSubsetConfig {
    get {return _storage._lbSubsetConfig ?? Envoy_Api_V2_Cluster.LbSubsetConfig()}
  ...
  public var ringHashLbConfig: Envoy_Api_V2_Cluster.RingHashLbConfig {
    get {
      if case .ringHashLbConfig(let v)? = _storage._lbConfig {return v}
      return Envoy_Api_V2_Cluster.RingHashLbConfig()
    }
    set {_uniqueStorage()._lbConfig = .ringHashLbConfig(newValue)}
  }

  /// Optional configuration for the Original Destination load balancing policy.
  public var originalDstLbConfig: Envoy_Api_V2_Cluster.OriginalDstLbConfig {
    get {
      if case .originalDstLbConfig(let v)? = _storage._lbConfig {return v}
      return Envoy_Api_V2_Cluster.OriginalDstLbConfig()
    }
    set {_uniqueStorage()._lbConfig = .originalDstLbConfig(newValue)}
  }

  /// Optional configuration for the LeastRequest load balancing policy.
  public var leastRequestLbConfig: Envoy_Api_V2_Cluster.LeastRequestLbConfig {
    get {
      if case .leastRequestLbConfig(let v)? = _storage._lbConfig {return v}
      return Envoy_Api_V2_Cluster.LeastRequestLbConfig()
    }
    set {_uniqueStorage()._lbConfig = .leastRequestLbConfig(newValue)}
  }

  /// Common configuration for all load balancer implementations.
  public var commonLbConfig: Envoy_Api_V2_Cluster.CommonLbConfig {
    get {return _storage._commonLbConfig ?? Envoy_Api_V2_Cluster.CommonLbConfig()}
  ...
  public var transportSocket: Envoy_Api_V2_Core_TransportSocket {
    get {return _storage._transportSocket ?? Envoy_Api_V2_Core_TransportSocket()}
  ...
  public var protocolSelection: Envoy_Api_V2_Cluster.ClusterProtocolSelection {
    get {return _storage._protocolSelection}
    set {_uniqueStorage()._protocolSelection = newValue}
  }

  /// Optional options for upstream connections.
  public var upstreamConnectionOptions: Envoy_Api_V2_UpstreamConnectionOptions {
    get {return _storage._upstreamConnectionOptions ?? Envoy_Api_V2_UpstreamConnectionOptions()}
  ...
  public var drainConnectionsOnHostRemoval: Bool {
    get {return _storage._drainConnectionsOnHostRemoval}
    set {_uniqueStorage()._drainConnectionsOnHostRemoval = newValue}
  }

  /// An (optional) network filter chain, listed in the order the filters should be applied.
  /// The chain will be applied to all outgoing connections that Envoy makes to the upstream
  /// servers of this cluster.
  public var filters: [Envoy_Api_V2_Cluster_Filter] {
  ...
  public var loadBalancingPolicy: Envoy_Api_V2_LoadBalancingPolicy {
    get {return _storage._loadBalancingPolicy ?? Envoy_Api_V2_LoadBalancingPolicy()}
  ...
  public var lrsServer: Envoy_Api_V2_Core_ConfigSource {
    get {return _storage._lrsServer ?? Envoy_Api_V2_Core_ConfigSource()}
  ...
  public enum OneOf_ClusterDiscoveryType: Equatable {
    /// The :ref:`service discovery type <arch_overview_service_discovery_types>`
    /// to use for resolving the cluster.
    case type(Envoy_Api_V2_Cluster.DiscoveryType)
    /// The custom cluster type.
    case clusterType(Envoy_Api_V2_Cluster.CustomClusterType)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Api_V2_Cluster.OneOf_ClusterDiscoveryType, rhs: Envoy_Api_V2_Cluster.OneOf_ClusterDiscoveryType) -> Bool {
  ...
  public enum OneOf_LbConfig: Equatable {
    /// Optional configuration for the Ring Hash load balancing policy.
    case ringHashLbConfig(Envoy_Api_V2_Cluster.RingHashLbConfig)
    /// Optional configuration for the Original Destination load balancing policy.
    case originalDstLbConfig(Envoy_Api_V2_Cluster.OriginalDstLbConfig)
    /// Optional configuration for the LeastRequest load balancing policy.
    case leastRequestLbConfig(Envoy_Api_V2_Cluster.LeastRequestLbConfig)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Api_V2_Cluster.OneOf_LbConfig, rhs: Envoy_Api_V2_Cluster.OneOf_LbConfig) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
  ...
  public struct TransportSocketMatch {
    ...
    public var transportSocket: Envoy_Api_V2_Core_TransportSocket {
      get {return _transportSocket ?? Envoy_Api_V2_Core_TransportSocket()}
    ...
    fileprivate var _transportSocket: Envoy_Api_V2_Core_TransportSocket? = nil
  }
  ...
  public struct EdsClusterConfig {
    ...
    public var edsConfig: Envoy_Api_V2_Core_ConfigSource {
      get {return _edsConfig ?? Envoy_Api_V2_Core_ConfigSource()}
    ...
    fileprivate var _edsConfig: Envoy_Api_V2_Core_ConfigSource? = nil
  }
  ...
  public struct LbSubsetConfig {
    ...
    public var fallbackPolicy: Envoy_Api_V2_Cluster.LbSubsetConfig.LbSubsetFallbackPolicy = .noFallback
    ...
    public var subsetSelectors: [Envoy_Api_V2_Cluster.LbSubsetConfig.LbSubsetSelector] = []
    ...
    public struct LbSubsetSelector {
      ...
      /// The behavior used when no endpoint subset matches the selected route's
      /// metadata.
      public var fallbackPolicy: Envoy_Api_V2_Cluster.LbSubsetConfig.LbSubsetSelector.LbSubsetSelectorFallbackPolicy = .notDefined
  ...
  public struct RingHashLbConfig {
    ...
    public var hashFunction: Envoy_Api_V2_Cluster.RingHashLbConfig.HashFunction = .xxHash
  ...
  public struct CommonLbConfig {
    ...
    public var healthyPanicThreshold: Envoy_Type_Percent {
      get {return _healthyPanicThreshold ?? Envoy_Type_Percent()}
    ...
    public var localityConfigSpecifier: Envoy_Api_V2_Cluster.CommonLbConfig.OneOf_LocalityConfigSpecifier? = nil

    public var zoneAwareLbConfig: Envoy_Api_V2_Cluster.CommonLbConfig.ZoneAwareLbConfig {
      get {
        if case .zoneAwareLbConfig(let v)? = localityConfigSpecifier {return v}
        return Envoy_Api_V2_Cluster.CommonLbConfig.ZoneAwareLbConfig()
      }
      set {localityConfigSpecifier = .zoneAwareLbConfig(newValue)}
    }

    public var localityWeightedLbConfig: Envoy_Api_V2_Cluster.CommonLbConfig.LocalityWeightedLbConfig {
      get {
        if case .localityWeightedLbConfig(let v)? = localityConfigSpecifier {return v}
        return Envoy_Api_V2_Cluster.CommonLbConfig.LocalityWeightedLbConfig()
      }
    ...
    public var consistentHashingLbConfig: Envoy_Api_V2_Cluster.CommonLbConfig.ConsistentHashingLbConfig {
      get {return _consistentHashingLbConfig ?? Envoy_Api_V2_Cluster.CommonLbConfig.ConsistentHashingLbConfig()}
    ...
    public enum OneOf_LocalityConfigSpecifier: Equatable {
      case zoneAwareLbConfig(Envoy_Api_V2_Cluster.CommonLbConfig.ZoneAwareLbConfig)
      case localityWeightedLbConfig(Envoy_Api_V2_Cluster.CommonLbConfig.LocalityWeightedLbConfig)

    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Api_V2_Cluster.CommonLbConfig.OneOf_LocalityConfigSpecifier, rhs: Envoy_Api_V2_Cluster.CommonLbConfig.OneOf_LocalityConfigSpecifier) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
    ...
    public struct ZoneAwareLbConfig {
      ...
      public var routingEnabled: Envoy_Type_Percent {
        get {return _routingEnabled ?? Envoy_Type_Percent()}
      ...
      fileprivate var _routingEnabled: Envoy_Type_Percent? = nil
    ...
    fileprivate var _healthyPanicThreshold: Envoy_Type_Percent? = nil
    fileprivate var _updateMergeWindow: SwiftProtobuf.Google_Protobuf_Duration? = nil
    fileprivate var _consistentHashingLbConfig: Envoy_Api_V2_Cluster.CommonLbConfig.ConsistentHashingLbConfig? = nil
  }
...
extension Envoy_Api_V2_Cluster.DiscoveryType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Api_V2_Cluster.DiscoveryType] = [
    .static,
    .strictDns,
    .logicalDns,
    .eds,
...
extension Envoy_Api_V2_Cluster.LbPolicy: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Api_V2_Cluster.LbPolicy] = [
    .roundRobin,
    .leastRequest,
    .ringHash,
    .random,
...
extension Envoy_Api_V2_Cluster.DnsLookupFamily: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Api_V2_Cluster.DnsLookupFamily] = [
    .auto,
    .v4Only,
    .v6Only,
  ]
...
extension Envoy_Api_V2_Cluster.ClusterProtocolSelection: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Api_V2_Cluster.ClusterProtocolSelection] = [
    .useConfiguredProtocol,
    .useDownstreamProtocol,
  ]
}

extension Envoy_Api_V2_Cluster.LbSubsetConfig.LbSubsetFallbackPolicy: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Api_V2_Cluster.LbSubsetConfig.LbSubsetFallbackPolicy] = [
    .noFallback,
    .anyEndpoint,
    .defaultSubset,
  ]
...
extension Envoy_Api_V2_Cluster.LbSubsetConfig.LbSubsetSelector.LbSubsetSelectorFallbackPolicy: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Api_V2_Cluster.LbSubsetConfig.LbSubsetSelector.LbSubsetSelectorFallbackPolicy] = [
    .notDefined,
    .noFallback,
    .anyEndpoint,
    .defaultSubset,
...
extension Envoy_Api_V2_Cluster.RingHashLbConfig.HashFunction: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Api_V2_Cluster.RingHashLbConfig.HashFunction] = [
    .xxHash,
    .murmurHash2,
  ]
}
...
public struct Envoy_Api_V2_LoadBalancingPolicy {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var policies: [Envoy_Api_V2_LoadBalancingPolicy.Policy] = []
...
public struct Envoy_Api_V2_UpstreamBindConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The address Envoy should bind to when establishing upstream connections.
  public var sourceAddress: Envoy_Api_V2_Core_Address {
    get {return _sourceAddress ?? Envoy_Api_V2_Core_Address()}
  ...
  fileprivate var _sourceAddress: Envoy_Api_V2_Core_Address? = nil
}

public struct Envoy_Api_V2_UpstreamConnectionOptions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// If set then set SO_KEEPALIVE on the socket to enable TCP Keepalives.
  public var tcpKeepalive: Envoy_Api_V2_Core_TcpKeepalive {
    get {return _tcpKeepalive ?? Envoy_Api_V2_Core_TcpKeepalive()}
  ...
  fileprivate var _tcpKeepalive: Envoy_Api_V2_Core_TcpKeepalive? = nil
}
...
extension Envoy_Api_V2_Cluster: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    35: .standard(proto: "extension_protocol_options"),
    ...
    32: .standard(proto: "drain_connections_on_host_removal"),
  ...
  fileprivate class _StorageClass {
    var _transportSocketMatches: [Envoy_Api_V2_Cluster.TransportSocketMatch] = []
    var _name: String = String()
    var _altStatName: String = String()
    var _clusterDiscoveryType: Envoy_Api_V2_Cluster.OneOf_ClusterDiscoveryType?
    var _edsClusterConfig: Envoy_Api_V2_Cluster.EdsClusterConfig? = nil
    ...
    var _lbPolicy: Envoy_Api_V2_Cluster.LbPolicy = .roundRobin
    var _hosts: [Envoy_Api_V2_Core_Address] = []
    var _loadAssignment: Envoy_Api_V2_ClusterLoadAssignment? = nil
    var _healthChecks: [Envoy_Api_V2_Core_HealthCheck] = []
    var _maxRequestsPerConnection: SwiftProtobuf.Google_Protobuf_UInt32Value? = nil
    var _circuitBreakers: Envoy_Api_V2_Cluster_CircuitBreakers? = nil
    var _tlsContext: Envoy_Api_V2_Auth_UpstreamTlsContext? = nil
    var _upstreamHTTPProtocolOptions: Envoy_Api_V2_Core_UpstreamHttpProtocolOptions? = nil
    ...
    var _extensionProtocolOptions: Dictionary<String,SwiftProtobuf.Google_Protobuf_Struct> = [:]
    ...
    var _dnsFailureRefreshRate: Envoy_Api_V2_Cluster.RefreshRate? = nil
    var _respectDnsTtl: Bool = false
    var _dnsLookupFamily: Envoy_Api_V2_Cluster.DnsLookupFamily = .auto
    var _dnsResolvers: [Envoy_Api_V2_Core_Address] = []
    var _useTcpForDnsLookups: Bool = false
    var _outlierDetection: Envoy_Api_V2_Cluster_OutlierDetection? = nil
    var _cleanupInterval: SwiftProtobuf.Google_Protobuf_Duration? = nil
    var _upstreamBindConfig: Envoy_Api_V2_Core_BindConfig? = nil
    var _lbSubsetConfig: Envoy_Api_V2_Cluster.LbSubsetConfig? = nil
    var _lbConfig: Envoy_Api_V2_Cluster.OneOf_LbConfig?
    var _commonLbConfig: Envoy_Api_V2_Cluster.CommonLbConfig? = nil
    var _transportSocket: Envoy_Api_V2_Core_TransportSocket? = nil
    var _metadata: Envoy_Api_V2_Core_Metadata? = nil
    var _protocolSelection: Envoy_Api_V2_Cluster.ClusterProtocolSelection = .useConfiguredProtocol
    var _upstreamConnectionOptions: Envoy_Api_V2_UpstreamConnectionOptions? = nil
    var _closeConnectionsOnHostHealthFailure: Bool = false
    var _drainConnectionsOnHostRemoval: Bool = false
    var _filters: [Envoy_Api_V2_Cluster_Filter] = []
    var _loadBalancingPolicy: Envoy_Api_V2_LoadBalancingPolicy? = nil
    var _lrsServer: Envoy_Api_V2_Core_ConfigSource? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _tlsContext = source._tlsContext
      ...
      _extensionProtocolOptions = source._extensionProtocolOptions
      ...
      _drainConnectionsOnHostRemoval = source._drainConnectionsOnHostRemoval
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try {
          ...
          var v: Envoy_Api_V2_Cluster.DiscoveryType?
        ...
        case 7: try { try decoder.decodeRepeatedMessageField(value: &_storage._hosts) }()
        ...
        case 11: try { try decoder.decodeSingularMessageField(value: &_storage._tlsContext) }()
        ...
        case 23: try {
          var v: Envoy_Api_V2_Cluster.RingHashLbConfig?
        ...
        case 32: try { try decoder.decodeSingularBoolField(value: &_storage._drainConnectionsOnHostRemoval) }()
        case 33: try { try decoder.decodeSingularMessageField(value: &_storage._loadAssignment) }()
        case 34: try {
          var v: Envoy_Api_V2_Cluster.OriginalDstLbConfig?
          if let current = _storage._lbConfig {
            try decoder.handleConflictingOneOf()
        ...
        case 35: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.Google_Protobuf_Struct>.self, value: &_storage._extensionProtocolOptions) }()
        ...
        case 37: try {
          var v: Envoy_Api_V2_Cluster.LeastRequestLbConfig?
          if let current = _storage._lbConfig {
            try decoder.handleConflictingOneOf()
        ...
        case 38: try {
          var v: Envoy_Api_V2_Cluster.CustomClusterType?
        ...
        case 47: try { try decoder.decodeSingularBoolField(value: &_storage._trackTimeoutBudgets) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._hosts.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._hosts, fieldNumber: 7)
      }
      ...
      if _storage._drainConnectionsOnHostRemoval != false {
        try visitor.visitSingularBoolField(value: _storage._drainConnectionsOnHostRemoval, fieldNumber: 32)
      }
      ...
      if !_storage._extensionProtocolOptions.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.Google_Protobuf_Struct>.self, value: _storage._extensionProtocolOptions, fieldNumber: 35)
      }
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster, rhs: Envoy_Api_V2_Cluster) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._tlsContext != rhs_storage._tlsContext {return false}
        ...
        if _storage._extensionProtocolOptions != rhs_storage._extensionProtocolOptions {return false}
        ...
        if _storage._drainConnectionsOnHostRemoval != rhs_storage._drainConnectionsOnHostRemoval {return false}
...
extension Envoy_Api_V2_Cluster.DiscoveryType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "STATIC"),
...
extension Envoy_Api_V2_Cluster.LbPolicy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "ROUND_ROBIN"),
    1: .same(proto: "LEAST_REQUEST"),
    2: .same(proto: "RING_HASH"),
    3: .same(proto: "RANDOM"),
    4: .same(proto: "ORIGINAL_DST_LB"),
    5: .same(proto: "MAGLEV"),
...
extension Envoy_Api_V2_Cluster.DnsLookupFamily: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "AUTO"),
...
extension Envoy_Api_V2_Cluster.ClusterProtocolSelection: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Api_V2_Cluster.TransportSocketMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster.protoMessageName + ".TransportSocketMatch"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .same(proto: "match"),
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster.TransportSocketMatch, rhs: Envoy_Api_V2_Cluster.TransportSocketMatch) -> Bool {
...
extension Envoy_Api_V2_Cluster.CustomClusterType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster.protoMessageName + ".CustomClusterType"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster.CustomClusterType, rhs: Envoy_Api_V2_Cluster.CustomClusterType) -> Bool {
    if lhs.name != rhs.name {return false}
...
extension Envoy_Api_V2_Cluster.EdsClusterConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster.protoMessageName + ".EdsClusterConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._edsConfig) }()
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster.EdsClusterConfig, rhs: Envoy_Api_V2_Cluster.EdsClusterConfig) -> Bool {
...
extension Envoy_Api_V2_Cluster.LbSubsetConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster.protoMessageName + ".LbSubsetConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster.LbSubsetConfig, rhs: Envoy_Api_V2_Cluster.LbSubsetConfig) -> Bool {
...
extension Envoy_Api_V2_Cluster.LbSubsetConfig.LbSubsetFallbackPolicy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Api_V2_Cluster.LbSubsetConfig.LbSubsetSelector: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster.LbSubsetConfig.protoMessageName + ".LbSubsetSelector"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "keys"),
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster.LbSubsetConfig.LbSubsetSelector, rhs: Envoy_Api_V2_Cluster.LbSubsetConfig.LbSubsetSelector) -> Bool {
...
extension Envoy_Api_V2_Cluster.LbSubsetConfig.LbSubsetSelector.LbSubsetSelectorFallbackPolicy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Api_V2_Cluster.LeastRequestLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster.protoMessageName + ".LeastRequestLbConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster.LeastRequestLbConfig, rhs: Envoy_Api_V2_Cluster.LeastRequestLbConfig) -> Bool {
...
extension Envoy_Api_V2_Cluster.RingHashLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster.protoMessageName + ".RingHashLbConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster.RingHashLbConfig, rhs: Envoy_Api_V2_Cluster.RingHashLbConfig) -> Bool {
...
extension Envoy_Api_V2_Cluster.RingHashLbConfig.HashFunction: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Api_V2_Cluster.OriginalDstLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster.protoMessageName + ".OriginalDstLbConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster.OriginalDstLbConfig, rhs: Envoy_Api_V2_Cluster.OriginalDstLbConfig) -> Bool {
...
extension Envoy_Api_V2_Cluster.CommonLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster.protoMessageName + ".CommonLbConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Envoy_Api_V2_Cluster.CommonLbConfig.ZoneAwareLbConfig?
      ...
      case 3: try {
        var v: Envoy_Api_V2_Cluster.CommonLbConfig.LocalityWeightedLbConfig?
        if let current = self.localityConfigSpecifier {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster.CommonLbConfig, rhs: Envoy_Api_V2_Cluster.CommonLbConfig) -> Bool {
...
extension Envoy_Api_V2_Cluster.CommonLbConfig.ZoneAwareLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster.CommonLbConfig.protoMessageName + ".ZoneAwareLbConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster.CommonLbConfig.ZoneAwareLbConfig, rhs: Envoy_Api_V2_Cluster.CommonLbConfig.ZoneAwareLbConfig) -> Bool {
...
extension Envoy_Api_V2_Cluster.CommonLbConfig.LocalityWeightedLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster.CommonLbConfig.protoMessageName + ".LocalityWeightedLbConfig"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster.CommonLbConfig.LocalityWeightedLbConfig, rhs: Envoy_Api_V2_Cluster.CommonLbConfig.LocalityWeightedLbConfig) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Api_V2_Cluster.CommonLbConfig.ConsistentHashingLbConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster.CommonLbConfig.protoMessageName + ".ConsistentHashingLbConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster.CommonLbConfig.ConsistentHashingLbConfig, rhs: Envoy_Api_V2_Cluster.CommonLbConfig.ConsistentHashingLbConfig) -> Bool {
...
extension Envoy_Api_V2_Cluster.RefreshRate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_Cluster.protoMessageName + ".RefreshRate"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Api_V2_Cluster.RefreshRate, rhs: Envoy_Api_V2_Cluster.RefreshRate) -> Bool {
...
extension Envoy_Api_V2_LoadBalancingPolicy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_LoadBalancingPolicy, rhs: Envoy_Api_V2_LoadBalancingPolicy) -> Bool {
...
extension Envoy_Api_V2_LoadBalancingPolicy.Policy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Api_V2_LoadBalancingPolicy.protoMessageName + ".Policy"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .same(proto: "config"),
  ...
  public static func ==(lhs: Envoy_Api_V2_LoadBalancingPolicy.Policy, rhs: Envoy_Api_V2_LoadBalancingPolicy.Policy) -> Bool {
    if lhs.name != rhs.name {return false}
...
extension Envoy_Api_V2_UpstreamBindConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_UpstreamBindConfig, rhs: Envoy_Api_V2_UpstreamBindConfig) -> Bool {
...
extension Envoy_Api_V2_UpstreamConnectionOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Api_V2_UpstreamConnectionOptions, rhs: Envoy_Api_V2_UpstreamConnectionOptions) -> Bool {
