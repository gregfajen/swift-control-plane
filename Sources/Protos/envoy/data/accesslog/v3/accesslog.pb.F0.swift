...
public struct Envoy_Data_Accesslog_V3_HTTPAccessLogEntry {
  ...
  public var protocolVersion: Envoy_Data_Accesslog_V3_HTTPAccessLogEntry.HTTPVersion = .protocolUnspecified

  /// Description of the incoming HTTP request.
  public var request: Envoy_Data_Accesslog_V3_HTTPRequestProperties {
    get {return _request ?? Envoy_Data_Accesslog_V3_HTTPRequestProperties()}
  ...
  public var response: Envoy_Data_Accesslog_V3_HTTPResponseProperties {
    get {return _response ?? Envoy_Data_Accesslog_V3_HTTPResponseProperties()}
  ...
  fileprivate var _commonProperties: Envoy_Data_Accesslog_V3_AccessLogCommon? = nil
  fileprivate var _request: Envoy_Data_Accesslog_V3_HTTPRequestProperties? = nil
  fileprivate var _response: Envoy_Data_Accesslog_V3_HTTPResponseProperties? = nil
}
    ...
    public struct SubjectAltName {
      ...
      public enum OneOf_San: Equatable {
        ...
        public static func ==(lhs: Envoy_Data_Accesslog_V3_TLSProperties.CertificateProperties.SubjectAltName.OneOf_San, rhs: Envoy_Data_Accesslog_V3_TLSProperties.CertificateProperties.SubjectAltName.OneOf_San) -> Bool {
          ...
          case (.dns(let l), .dns(let r)): return l == r
...
extension Envoy_Data_Accesslog_V3_TCPAccessLogEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._commonProperties)
      case 2: try decoder.decodeSingularMessageField(value: &self._connectionProperties)
      default: break
      }
    }
  }
...
extension Envoy_Data_Accesslog_V3_HTTPAccessLogEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._commonProperties)
      case 2: try decoder.decodeSingularEnumField(value: &self.protocolVersion)
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.protocolVersion != .protocolUnspecified {
      try visitor.visitSingularEnumField(value: self.protocolVersion, fieldNumber: 2)
    }
...
extension Envoy_Data_Accesslog_V3_ConnectionProperties: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularUInt64Field(value: &self.receivedBytes)
      case 2: try decoder.decodeSingularUInt64Field(value: &self.sentBytes)
      default: break
      }
    }
  }
...
extension Envoy_Data_Accesslog_V3_AccessLogCommon: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularDoubleField(value: &_storage._sampleRate)
        case 2: try decoder.decodeSingularMessageField(value: &_storage._downstreamRemoteAddress)
        case 3: try decoder.decodeSingularMessageField(value: &_storage._downstreamLocalAddress)
        case 4: try decoder.decodeSingularMessageField(value: &_storage._tlsProperties)
        case 5: try decoder.decodeSingularMessageField(value: &_storage._startTime)
        case 6: try decoder.decodeSingularMessageField(value: &_storage._timeToLastRxByte)
        case 7: try decoder.decodeSingularMessageField(value: &_storage._timeToFirstUpstreamTxByte)
        case 8: try decoder.decodeSingularMessageField(value: &_storage._timeToLastUpstreamTxByte)
        case 9: try decoder.decodeSingularMessageField(value: &_storage._timeToFirstUpstreamRxByte)
        case 10: try decoder.decodeSingularMessageField(value: &_storage._timeToLastUpstreamRxByte)
        case 11: try decoder.decodeSingularMessageField(value: &_storage._timeToFirstDownstreamTxByte)
        case 12: try decoder.decodeSingularMessageField(value: &_storage._timeToLastDownstreamTxByte)
        case 13: try decoder.decodeSingularMessageField(value: &_storage._upstreamRemoteAddress)
        case 14: try decoder.decodeSingularMessageField(value: &_storage._upstreamLocalAddress)
        case 15: try decoder.decodeSingularStringField(value: &_storage._upstreamCluster)
        case 16: try decoder.decodeSingularMessageField(value: &_storage._responseFlags)
        case 17: try decoder.decodeSingularMessageField(value: &_storage._metadata)
        case 18: try decoder.decodeSingularStringField(value: &_storage._upstreamTransportFailureReason)
        case 19: try decoder.decodeSingularStringField(value: &_storage._routeName)
        case 20: try decoder.decodeSingularMessageField(value: &_storage._downstreamDirectRemoteAddress)
        case 21: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.Google_Protobuf_Any>.self, value: &_storage._filterStateObjects)
        default: break
        }
      }
    }
...
extension Envoy_Data_Accesslog_V3_ResponseFlags: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularBoolField(value: &_storage._failedLocalHealthcheck)
        case 2: try decoder.decodeSingularBoolField(value: &_storage._noHealthyUpstream)
        case 3: try decoder.decodeSingularBoolField(value: &_storage._upstreamRequestTimeout)
        case 4: try decoder.decodeSingularBoolField(value: &_storage._localReset)
        case 5: try decoder.decodeSingularBoolField(value: &_storage._upstreamRemoteReset)
        case 6: try decoder.decodeSingularBoolField(value: &_storage._upstreamConnectionFailure)
        case 7: try decoder.decodeSingularBoolField(value: &_storage._upstreamConnectionTermination)
        case 8: try decoder.decodeSingularBoolField(value: &_storage._upstreamOverflow)
        case 9: try decoder.decodeSingularBoolField(value: &_storage._noRouteFound)
        case 10: try decoder.decodeSingularBoolField(value: &_storage._delayInjected)
        case 11: try decoder.decodeSingularBoolField(value: &_storage._faultInjected)
        case 12: try decoder.decodeSingularBoolField(value: &_storage._rateLimited)
        case 13: try decoder.decodeSingularMessageField(value: &_storage._unauthorizedDetails)
        case 14: try decoder.decodeSingularBoolField(value: &_storage._rateLimitServiceError)
        case 15: try decoder.decodeSingularBoolField(value: &_storage._downstreamConnectionTermination)
        case 16: try decoder.decodeSingularBoolField(value: &_storage._upstreamRetryLimitExceeded)
        case 17: try decoder.decodeSingularBoolField(value: &_storage._streamIdleTimeout)
        case 18: try decoder.decodeSingularBoolField(value: &_storage._invalidEnvoyRequestHeaders)
        case 19: try decoder.decodeSingularBoolField(value: &_storage._downstreamProtocolError)
        case 20: try decoder.decodeSingularBoolField(value: &_storage._upstreamMaxStreamDurationReached)
        case 21: try decoder.decodeSingularBoolField(value: &_storage._responseFromCacheFilter)
        default: break
        }
      }
    }
...
extension Envoy_Data_Accesslog_V3_TLSProperties: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularEnumField(value: &self.tlsVersion)
      case 2: try decoder.decodeSingularMessageField(value: &self._tlsCipherSuite)
      case 3: try decoder.decodeSingularStringField(value: &self.tlsSniHostname)
      case 4: try decoder.decodeSingularMessageField(value: &self._localCertificateProperties)
      case 5: try decoder.decodeSingularMessageField(value: &self._peerCertificateProperties)
      case 6: try decoder.decodeSingularStringField(value: &self.tlsSessionID)
      default: break
      }
    }
  }
...
extension Envoy_Data_Accesslog_V3_TLSProperties.CertificateProperties: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedMessageField(value: &self.subjectAltName)
...
extension Envoy_Data_Accesslog_V3_HTTPRequestProperties: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularEnumField(value: &self.requestMethod)
      ...
      case 4: try decoder.decodeSingularMessageField(value: &self._port)
      ...
      case 7: try decoder.decodeSingularStringField(value: &self.referer)
      case 8: try decoder.decodeSingularStringField(value: &self.forwardedFor)
      case 9: try decoder.decodeSingularStringField(value: &self.requestID)
      case 10: try decoder.decodeSingularStringField(value: &self.originalPath)
      case 11: try decoder.decodeSingularUInt64Field(value: &self.requestHeadersBytes)
      case 12: try decoder.decodeSingularUInt64Field(value: &self.requestBodyBytes)
      case 13: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.ProtobufString>.self, value: &self.requestHeaders)
      default: break
      }
    }
  }
...
extension Envoy_Data_Accesslog_V3_HTTPResponseProperties: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._responseCode)
      case 2: try decoder.decodeSingularUInt64Field(value: &self.responseHeadersBytes)
      case 3: try decoder.decodeSingularUInt64Field(value: &self.responseBodyBytes)
      case 4: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.ProtobufString>.self, value: &self.responseHeaders)
      case 5: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.ProtobufString>.self, value: &self.responseTrailers)
      case 6: try decoder.decodeSingularStringField(value: &self.responseCodeDetails)
      default: break
      }
    }
  }
