...
public struct Envoy_Data_Accesslog_V2_TCPAccessLogEntry {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Common properties shared by all Envoy access logs.
  public var commonProperties: Envoy_Data_Accesslog_V2_AccessLogCommon {
    get {return _commonProperties ?? Envoy_Data_Accesslog_V2_AccessLogCommon()}
  ...
  public var connectionProperties: Envoy_Data_Accesslog_V2_ConnectionProperties {
    get {return _connectionProperties ?? Envoy_Data_Accesslog_V2_ConnectionProperties()}
  ...
  fileprivate var _commonProperties: Envoy_Data_Accesslog_V2_AccessLogCommon? = nil
  fileprivate var _connectionProperties: Envoy_Data_Accesslog_V2_ConnectionProperties? = nil
}

public struct Envoy_Data_Accesslog_V2_HTTPAccessLogEntry {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// Common properties shared by all Envoy access logs.
  public var commonProperties: Envoy_Data_Accesslog_V2_AccessLogCommon {
    get {return _storage._commonProperties ?? Envoy_Data_Accesslog_V2_AccessLogCommon()}
  ...
  public var protocolVersion: Envoy_Data_Accesslog_V2_HTTPAccessLogEntry.HTTPVersion {
    get {return _storage._protocolVersion}
    set {_uniqueStorage()._protocolVersion = newValue}
  }

  /// Description of the incoming HTTP request.
  public var request: Envoy_Data_Accesslog_V2_HTTPRequestProperties {
    get {return _storage._request ?? Envoy_Data_Accesslog_V2_HTTPRequestProperties()}
  ...
  public var response: Envoy_Data_Accesslog_V2_HTTPResponseProperties {
    get {return _storage._response ?? Envoy_Data_Accesslog_V2_HTTPResponseProperties()}
...
extension Envoy_Data_Accesslog_V2_HTTPAccessLogEntry.HTTPVersion: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Data_Accesslog_V2_HTTPAccessLogEntry.HTTPVersion] = [
    .protocolUnspecified,
    .http10,
    .http11,
    .http2,
...
public struct Envoy_Data_Accesslog_V2_ConnectionProperties {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// [#next-free-field: 22]
public struct Envoy_Data_Accesslog_V2_AccessLogCommon {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var downstreamRemoteAddress: Envoy_Api_V2_Core_Address {
    get {return _storage._downstreamRemoteAddress ?? Envoy_Api_V2_Core_Address()}
  ...
  public var downstreamLocalAddress: Envoy_Api_V2_Core_Address {
    get {return _storage._downstreamLocalAddress ?? Envoy_Api_V2_Core_Address()}
  ...
  public var tlsProperties: Envoy_Data_Accesslog_V2_TLSProperties {
    get {return _storage._tlsProperties ?? Envoy_Data_Accesslog_V2_TLSProperties()}
  ...
  /// retries.
  public var upstreamRemoteAddress: Envoy_Api_V2_Core_Address {
    get {return _storage._upstreamRemoteAddress ?? Envoy_Api_V2_Core_Address()}
  ...
  public var upstreamLocalAddress: Envoy_Api_V2_Core_Address {
    get {return _storage._upstreamLocalAddress ?? Envoy_Api_V2_Core_Address()}
  ...
  public var responseFlags: Envoy_Data_Accesslog_V2_ResponseFlags {
    get {return _storage._responseFlags ?? Envoy_Data_Accesslog_V2_ResponseFlags()}
  ...
  public var downstreamDirectRemoteAddress: Envoy_Api_V2_Core_Address {
    get {return _storage._downstreamDirectRemoteAddress ?? Envoy_Api_V2_Core_Address()}
...
/// Flags indicating occurrences during request/response processing.
/// [#next-free-field: 20]
public struct Envoy_Data_Accesslog_V2_ResponseFlags {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var unauthorizedDetails: Envoy_Data_Accesslog_V2_ResponseFlags.Unauthorized {
    get {return _storage._unauthorizedDetails ?? Envoy_Data_Accesslog_V2_ResponseFlags.Unauthorized()}
  ...
  public struct Unauthorized {
    ...
    public var reason: Envoy_Data_Accesslog_V2_ResponseFlags.Unauthorized.Reason = .unspecified
...
extension Envoy_Data_Accesslog_V2_ResponseFlags.Unauthorized.Reason: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Data_Accesslog_V2_ResponseFlags.Unauthorized.Reason] = [
    .unspecified,
    .externalService,
  ]
}
...
/// [#next-free-field: 7]
public struct Envoy_Data_Accesslog_V2_TLSProperties {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Version of TLS that was negotiated.
  public var tlsVersion: Envoy_Data_Accesslog_V2_TLSProperties.TLSVersion = .versionUnspecified
  ...
  public var localCertificateProperties: Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties {
    get {return _localCertificateProperties ?? Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties()}
  ...
  public var peerCertificateProperties: Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties {
    get {return _peerCertificateProperties ?? Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties()}
  ...
  public struct CertificateProperties {
    ...
    public var subjectAltName: [Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties.SubjectAltName] = []
    ...
    public struct SubjectAltName {
      ...
      public var san: Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties.SubjectAltName.OneOf_San? = nil
      ...
      #if !swift(>=4.1)
        public static func ==(lhs: Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties.SubjectAltName.OneOf_San, rhs: Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties.SubjectAltName.OneOf_San) -> Bool {
  ...
  fileprivate var _localCertificateProperties: Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties? = nil
  fileprivate var _peerCertificateProperties: Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties? = nil
}

#if swift(>=4.2)

extension Envoy_Data_Accesslog_V2_TLSProperties.TLSVersion: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Data_Accesslog_V2_TLSProperties.TLSVersion] = [
    .versionUnspecified,
    .tlsv1,
    .tlsv11,
    .tlsv12,
...
/// [#next-free-field: 14]
public struct Envoy_Data_Accesslog_V2_HTTPRequestProperties {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The request method (RFC 7231/2616).
  public var requestMethod: Envoy_Api_V2_Core_RequestMethod = .methodUnspecified
...
/// [#next-free-field: 7]
public struct Envoy_Data_Accesslog_V2_HTTPResponseProperties {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "envoy.data.accesslog.v2"

extension Envoy_Data_Accesslog_V2_TCPAccessLogEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Data_Accesslog_V2_TCPAccessLogEntry, rhs: Envoy_Data_Accesslog_V2_TCPAccessLogEntry) -> Bool {
...
extension Envoy_Data_Accesslog_V2_HTTPAccessLogEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _commonProperties: Envoy_Data_Accesslog_V2_AccessLogCommon? = nil
    var _protocolVersion: Envoy_Data_Accesslog_V2_HTTPAccessLogEntry.HTTPVersion = .protocolUnspecified
    var _request: Envoy_Data_Accesslog_V2_HTTPRequestProperties? = nil
    var _response: Envoy_Data_Accesslog_V2_HTTPResponseProperties? = nil
  ...
  public static func ==(lhs: Envoy_Data_Accesslog_V2_HTTPAccessLogEntry, rhs: Envoy_Data_Accesslog_V2_HTTPAccessLogEntry) -> Bool {
...
extension Envoy_Data_Accesslog_V2_HTTPAccessLogEntry.HTTPVersion: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Data_Accesslog_V2_ConnectionProperties: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Data_Accesslog_V2_ConnectionProperties, rhs: Envoy_Data_Accesslog_V2_ConnectionProperties) -> Bool {
...
extension Envoy_Data_Accesslog_V2_AccessLogCommon: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _downstreamRemoteAddress: Envoy_Api_V2_Core_Address? = nil
    var _downstreamLocalAddress: Envoy_Api_V2_Core_Address? = nil
    var _tlsProperties: Envoy_Data_Accesslog_V2_TLSProperties? = nil
    ...
    var _upstreamRemoteAddress: Envoy_Api_V2_Core_Address? = nil
    var _upstreamLocalAddress: Envoy_Api_V2_Core_Address? = nil
    var _upstreamCluster: String = String()
    var _responseFlags: Envoy_Data_Accesslog_V2_ResponseFlags? = nil
    ...
    var _downstreamDirectRemoteAddress: Envoy_Api_V2_Core_Address? = nil
  ...
  public static func ==(lhs: Envoy_Data_Accesslog_V2_AccessLogCommon, rhs: Envoy_Data_Accesslog_V2_AccessLogCommon) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Envoy_Data_Accesslog_V2_ResponseFlags: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _unauthorizedDetails: Envoy_Data_Accesslog_V2_ResponseFlags.Unauthorized? = nil
  ...
  public static func ==(lhs: Envoy_Data_Accesslog_V2_ResponseFlags, rhs: Envoy_Data_Accesslog_V2_ResponseFlags) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Envoy_Data_Accesslog_V2_ResponseFlags.Unauthorized: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Data_Accesslog_V2_ResponseFlags.protoMessageName + ".Unauthorized"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "reason"),
  ]
  ...
  public static func ==(lhs: Envoy_Data_Accesslog_V2_ResponseFlags.Unauthorized, rhs: Envoy_Data_Accesslog_V2_ResponseFlags.Unauthorized) -> Bool {
...
extension Envoy_Data_Accesslog_V2_ResponseFlags.Unauthorized.Reason: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Data_Accesslog_V2_TLSProperties: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Data_Accesslog_V2_TLSProperties, rhs: Envoy_Data_Accesslog_V2_TLSProperties) -> Bool {
...
extension Envoy_Data_Accesslog_V2_TLSProperties.TLSVersion: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Data_Accesslog_V2_TLSProperties.protoMessageName + ".CertificateProperties"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties, rhs: Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties) -> Bool {
...
extension Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties.SubjectAltName: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties.protoMessageName + ".SubjectAltName"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "uri"),
    2: .same(proto: "dns"),
  ]
  ...
  public static func ==(lhs: Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties.SubjectAltName, rhs: Envoy_Data_Accesslog_V2_TLSProperties.CertificateProperties.SubjectAltName) -> Bool {
...
extension Envoy_Data_Accesslog_V2_HTTPRequestProperties: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Data_Accesslog_V2_HTTPRequestProperties, rhs: Envoy_Data_Accesslog_V2_HTTPRequestProperties) -> Bool {
...
extension Envoy_Data_Accesslog_V2_HTTPResponseProperties: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Data_Accesslog_V2_HTTPResponseProperties, rhs: Envoy_Data_Accesslog_V2_HTTPResponseProperties) -> Bool {
