...
public enum Envoy_Data_Cluster_V3_OutlierEjectionType: SwiftProtobuf.Enum {
...
extension Envoy_Data_Cluster_V3_OutlierEjectionType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Data_Cluster_V3_OutlierEjectionType] = [
    .consecutive5Xx,
...
public enum Envoy_Data_Cluster_V3_Action: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Envoy_Data_Cluster_V3_Action: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Data_Cluster_V3_Action] = [
    .eject,
    .uneject,
  ]
}
...
/// [#next-free-field: 12]
public struct Envoy_Data_Cluster_V3_OutlierDetectionEvent {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// In case of eject represents type of ejection that took place.
  public var type: Envoy_Data_Cluster_V3_OutlierEjectionType = .consecutive5Xx
  ...
  public var action: Envoy_Data_Cluster_V3_Action = .eject
  ...
  public var event: Envoy_Data_Cluster_V3_OutlierDetectionEvent.OneOf_Event? = nil

  public var ejectSuccessRateEvent: Envoy_Data_Cluster_V3_OutlierEjectSuccessRate {
    get {
      if case .ejectSuccessRateEvent(let v)? = event {return v}
      return Envoy_Data_Cluster_V3_OutlierEjectSuccessRate()
    }
    set {event = .ejectSuccessRateEvent(newValue)}
  }

  public var ejectConsecutiveEvent: Envoy_Data_Cluster_V3_OutlierEjectConsecutive {
    get {
      if case .ejectConsecutiveEvent(let v)? = event {return v}
      return Envoy_Data_Cluster_V3_OutlierEjectConsecutive()
    }
    set {event = .ejectConsecutiveEvent(newValue)}
  }

  public var ejectFailurePercentageEvent: Envoy_Data_Cluster_V3_OutlierEjectFailurePercentage {
    get {
      if case .ejectFailurePercentageEvent(let v)? = event {return v}
      return Envoy_Data_Cluster_V3_OutlierEjectFailurePercentage()
    }
  ...
  public enum OneOf_Event: Equatable {
    case ejectSuccessRateEvent(Envoy_Data_Cluster_V3_OutlierEjectSuccessRate)
    case ejectConsecutiveEvent(Envoy_Data_Cluster_V3_OutlierEjectConsecutive)
    case ejectFailurePercentageEvent(Envoy_Data_Cluster_V3_OutlierEjectFailurePercentage)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Data_Cluster_V3_OutlierDetectionEvent.OneOf_Event, rhs: Envoy_Data_Cluster_V3_OutlierDetectionEvent.OneOf_Event) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.ejectSuccessRateEvent, .ejectSuccessRateEvent): return {
        guard case .ejectSuccessRateEvent(let l) = lhs, case .ejectSuccessRateEvent(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.ejectConsecutiveEvent, .ejectConsecutiveEvent): return {
        guard case .ejectConsecutiveEvent(let l) = lhs, case .ejectConsecutiveEvent(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.ejectFailurePercentageEvent, .ejectFailurePercentageEvent): return {
        guard case .ejectFailurePercentageEvent(let l) = lhs, case .ejectFailurePercentageEvent(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
public struct Envoy_Data_Cluster_V3_OutlierEjectSuccessRate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Data_Cluster_V3_OutlierEjectConsecutive {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Data_Cluster_V3_OutlierEjectFailurePercentage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "envoy.data.cluster.v3"

extension Envoy_Data_Cluster_V3_OutlierEjectionType: SwiftProtobuf._ProtoNameProviding {
...
extension Envoy_Data_Cluster_V3_Action: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "EJECT"),
...
extension Envoy_Data_Cluster_V3_OutlierDetectionEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularMessageField(value: &self._secsSinceLastAction) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.clusterName) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.upstreamURL) }()
      case 6: try { try decoder.decodeSingularEnumField(value: &self.action) }()
      case 7: try { try decoder.decodeSingularUInt32Field(value: &self.numEjections) }()
      case 8: try { try decoder.decodeSingularBoolField(value: &self.enforced) }()
      case 9: try {
        var v: Envoy_Data_Cluster_V3_OutlierEjectSuccessRate?
      ...
      case 10: try {
        var v: Envoy_Data_Cluster_V3_OutlierEjectConsecutive?
        if let current = self.event {
          try decoder.handleConflictingOneOf()
      ...
      case 11: try {
        var v: Envoy_Data_Cluster_V3_OutlierEjectFailurePercentage?
        if let current = self.event {
          try decoder.handleConflictingOneOf()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // enabled. https://github.com/apple/swift-protobuf/issues/1034
    switch self.event {
    case .ejectSuccessRateEvent?: try {
      guard case .ejectSuccessRateEvent(let v)? = self.event else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 9)
    }()
    case .ejectConsecutiveEvent?: try {
      guard case .ejectConsecutiveEvent(let v)? = self.event else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 10)
    }()
    case .ejectFailurePercentageEvent?: try {
      guard case .ejectFailurePercentageEvent(let v)? = self.event else { preconditionFailure() }
  ...
  public static func ==(lhs: Envoy_Data_Cluster_V3_OutlierDetectionEvent, rhs: Envoy_Data_Cluster_V3_OutlierDetectionEvent) -> Bool {
...
extension Envoy_Data_Cluster_V3_OutlierEjectSuccessRate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.hostSuccessRate) }()
      case 2: try { try decoder.decodeSingularUInt32Field(value: &self.clusterAverageSuccessRate) }()
      case 3: try { try decoder.decodeSingularUInt32Field(value: &self.clusterSuccessRateEjectionThreshold) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Data_Cluster_V3_OutlierEjectSuccessRate, rhs: Envoy_Data_Cluster_V3_OutlierEjectSuccessRate) -> Bool {
...
extension Envoy_Data_Cluster_V3_OutlierEjectConsecutive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Data_Cluster_V3_OutlierEjectConsecutive, rhs: Envoy_Data_Cluster_V3_OutlierEjectConsecutive) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Data_Cluster_V3_OutlierEjectFailurePercentage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Data_Cluster_V3_OutlierEjectFailurePercentage, rhs: Envoy_Data_Cluster_V3_OutlierEjectFailurePercentage) -> Bool {
    if lhs.hostSuccessRate != rhs.hostSuccessRate {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
