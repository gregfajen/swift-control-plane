...
public struct Envoy_Data_Dns_V3_DnsTable {
  ...
  public struct DnsServiceProtocol {
    ...
    public var protocolConfig: Envoy_Data_Dns_V3_DnsTable.DnsServiceProtocol.OneOf_ProtocolConfig? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Data_Dns_V3_DnsTable.DnsServiceProtocol.OneOf_ProtocolConfig, rhs: Envoy_Data_Dns_V3_DnsTable.DnsServiceProtocol.OneOf_ProtocolConfig) -> Bool {
  ...
  public struct DnsServiceTarget {
    ...
    public var endpointType: Envoy_Data_Dns_V3_DnsTable.DnsServiceTarget.OneOf_EndpointType? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Data_Dns_V3_DnsTable.DnsServiceTarget.OneOf_EndpointType, rhs: Envoy_Data_Dns_V3_DnsTable.DnsServiceTarget.OneOf_EndpointType) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
  ...
  public struct DnsService {
    ...
    public var `protocol`: Envoy_Data_Dns_V3_DnsTable.DnsServiceProtocol {
      get {return _protocol ?? Envoy_Data_Dns_V3_DnsTable.DnsServiceProtocol()}
    ...
    public var targets: [Envoy_Data_Dns_V3_DnsTable.DnsServiceTarget] = []

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public init() {}

    fileprivate var _protocol: Envoy_Data_Dns_V3_DnsTable.DnsServiceProtocol? = nil
  ...
  public struct DnsServiceList {
    ...
    public var services: [Envoy_Data_Dns_V3_DnsTable.DnsService] = []
  ...
  public struct DnsEndpoint {
    ...
    public var serviceList: Envoy_Data_Dns_V3_DnsTable.DnsServiceList {
      get {
        if case .serviceList(let v)? = endpointConfig {return v}
        return Envoy_Data_Dns_V3_DnsTable.DnsServiceList()
      }
    ...
    public enum OneOf_EndpointConfig: Equatable {
      ...
      case clusterName(String)
      /// Define a DNS Service List for the specified endpoint
      case serviceList(Envoy_Data_Dns_V3_DnsTable.DnsServiceList)
...
extension Envoy_Data_Dns_V3_DnsTable.DnsServiceProtocol: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Data_Dns_V3_DnsTable.protoMessageName + ".DnsServiceProtocol"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "number"),
    2: .same(proto: "name"),
  ]
  ...
  public static func ==(lhs: Envoy_Data_Dns_V3_DnsTable.DnsServiceProtocol, rhs: Envoy_Data_Dns_V3_DnsTable.DnsServiceProtocol) -> Bool {
...
extension Envoy_Data_Dns_V3_DnsTable.DnsServiceTarget: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Data_Dns_V3_DnsTable.protoMessageName + ".DnsServiceTarget"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Data_Dns_V3_DnsTable.DnsServiceTarget, rhs: Envoy_Data_Dns_V3_DnsTable.DnsServiceTarget) -> Bool {
...
extension Envoy_Data_Dns_V3_DnsTable.DnsService: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Data_Dns_V3_DnsTable.protoMessageName + ".DnsService"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Data_Dns_V3_DnsTable.DnsService, rhs: Envoy_Data_Dns_V3_DnsTable.DnsService) -> Bool {
...
extension Envoy_Data_Dns_V3_DnsTable.DnsServiceList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Data_Dns_V3_DnsTable.protoMessageName + ".DnsServiceList"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Data_Dns_V3_DnsTable.DnsServiceList, rhs: Envoy_Data_Dns_V3_DnsTable.DnsServiceList) -> Bool {
...
extension Envoy_Data_Dns_V3_DnsTable.DnsEndpoint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try {
        var v: Envoy_Data_Dns_V3_DnsTable.DnsServiceList?
        if let current = self.endpointConfig {
          try decoder.handleConflictingOneOf()
