...
public struct Envoy_Service_LoadStats_V3_LoadStatsRequest {
  ...
  public var clusterStats: [Envoy_Config_Endpoint_V3_ClusterStats] = []
...
public struct Envoy_Service_LoadStats_V3_LoadStatsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "envoy.service.load_stats.v3"

extension Envoy_Service_LoadStats_V3_LoadStatsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeRepeatedMessageField(value: &self.clusterStats)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Service_LoadStats_V3_LoadStatsRequest, rhs: Envoy_Service_LoadStats_V3_LoadStatsRequest) -> Bool {
...
extension Envoy_Service_LoadStats_V3_LoadStatsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedStringField(value: &self.clusters)
      case 2: try decoder.decodeSingularMessageField(value: &self._loadReportingInterval)
      case 3: try decoder.decodeSingularBoolField(value: &self.reportEndpointGranularity)
      case 4: try decoder.decodeSingularBoolField(value: &self.sendAllClusters)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Service_LoadStats_V3_LoadStatsResponse, rhs: Envoy_Service_LoadStats_V3_LoadStatsResponse) -> Bool {
