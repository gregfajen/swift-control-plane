...
public struct Envoy_Service_LoadStats_V4alpha_LoadStatsRequest {
...
public struct Envoy_Service_LoadStats_V4alpha_LoadStatsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "envoy.service.load_stats.v4alpha"

extension Envoy_Service_LoadStats_V4alpha_LoadStatsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Service_LoadStats_V4alpha_LoadStatsRequest, rhs: Envoy_Service_LoadStats_V4alpha_LoadStatsRequest) -> Bool {
...
extension Envoy_Service_LoadStats_V4alpha_LoadStatsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Service_LoadStats_V4alpha_LoadStatsResponse, rhs: Envoy_Service_LoadStats_V4alpha_LoadStatsResponse) -> Bool {
