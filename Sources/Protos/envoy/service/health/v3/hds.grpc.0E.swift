...
public protocol Envoy_Service_Health_V3_HealthDiscoveryServiceClientProtocol: GRPCClient {
  func streamHealthCheck(
    callOptions: CallOptions?,
    handler: @escaping (Envoy_Service_Health_V3_HealthCheckSpecifier) -> Void
  ) -> BidirectionalStreamingCall<Envoy_Service_Health_V3_HealthCheckRequestOrEndpointHealthResponse, Envoy_Service_Health_V3_HealthCheckSpecifier>

  func fetchHealthCheck(
    _ request: Envoy_Service_Health_V3_HealthCheckRequestOrEndpointHealthResponse,
    callOptions: CallOptions?
  ) -> UnaryCall<Envoy_Service_Health_V3_HealthCheckRequestOrEndpointHealthResponse, Envoy_Service_Health_V3_HealthCheckSpecifier>

}

extension Envoy_Service_Health_V3_HealthDiscoveryServiceClientProtocol {
  ...
  public func streamHealthCheck(
    ...
    return self.makeBidirectionalStreamingCall(
      path: "/envoy.service.health.v3.HealthDiscoveryService/StreamHealthCheck",
  ...
  public func fetchHealthCheck(
    ...
    return self.makeUnaryCall(
      path: "/envoy.service.health.v3.HealthDiscoveryService/FetchHealthCheck",
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
...
public final class Envoy_Service_Health_V3_HealthDiscoveryServiceClient: Envoy_Service_Health_V3_HealthDiscoveryServiceClientProtocol {
...
extension Envoy_Service_Health_V3_HealthDiscoveryServiceProvider {
  public var serviceName: Substring { return "envoy.service.health.v3.HealthDiscoveryService" }
