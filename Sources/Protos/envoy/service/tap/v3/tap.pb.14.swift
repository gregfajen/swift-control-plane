...
public struct Envoy_Service_Tap_V3_StreamTapsRequest {
  ...
  public var identifier: Envoy_Service_Tap_V3_StreamTapsRequest.Identifier {
    get {return _storage._identifier ?? Envoy_Service_Tap_V3_StreamTapsRequest.Identifier()}
  ...
  public var trace: Envoy_Data_Tap_V3_TraceWrapper {
    get {return _storage._trace ?? Envoy_Data_Tap_V3_TraceWrapper()}
...
public struct Envoy_Service_Tap_V3_StreamTapsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "envoy.service.tap.v3"

extension Envoy_Service_Tap_V3_StreamTapsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _identifier: Envoy_Service_Tap_V3_StreamTapsRequest.Identifier? = nil
    var _traceID: UInt64 = 0
    var _trace: Envoy_Data_Tap_V3_TraceWrapper? = nil
  ...
  public static func ==(lhs: Envoy_Service_Tap_V3_StreamTapsRequest, rhs: Envoy_Service_Tap_V3_StreamTapsRequest) -> Bool {
...
extension Envoy_Service_Tap_V3_StreamTapsRequest.Identifier: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Service_Tap_V3_StreamTapsRequest.protoMessageName + ".Identifier"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "node"),
  ...
  public static func ==(lhs: Envoy_Service_Tap_V3_StreamTapsRequest.Identifier, rhs: Envoy_Service_Tap_V3_StreamTapsRequest.Identifier) -> Bool {
...
extension Envoy_Service_Tap_V3_StreamTapsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Service_Tap_V3_StreamTapsResponse, rhs: Envoy_Service_Tap_V3_StreamTapsResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
