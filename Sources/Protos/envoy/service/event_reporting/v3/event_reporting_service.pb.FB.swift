...
public struct Envoy_Service_EventReporting_V3_StreamEventsRequest {
  ...
  public var identifier: Envoy_Service_EventReporting_V3_StreamEventsRequest.Identifier {
    get {return _identifier ?? Envoy_Service_EventReporting_V3_StreamEventsRequest.Identifier()}
  ...
  fileprivate var _identifier: Envoy_Service_EventReporting_V3_StreamEventsRequest.Identifier? = nil
}
...
/// wants to process.
public struct Envoy_Service_EventReporting_V3_StreamEventsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "envoy.service.event_reporting.v3"

extension Envoy_Service_EventReporting_V3_StreamEventsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Service_EventReporting_V3_StreamEventsRequest, rhs: Envoy_Service_EventReporting_V3_StreamEventsRequest) -> Bool {
...
extension Envoy_Service_EventReporting_V3_StreamEventsRequest.Identifier: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Service_EventReporting_V3_StreamEventsRequest.protoMessageName + ".Identifier"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "node"),
  ]
  ...
  public static func ==(lhs: Envoy_Service_EventReporting_V3_StreamEventsRequest.Identifier, rhs: Envoy_Service_EventReporting_V3_StreamEventsRequest.Identifier) -> Bool {
...
extension Envoy_Service_EventReporting_V3_StreamEventsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Service_EventReporting_V3_StreamEventsResponse, rhs: Envoy_Service_EventReporting_V3_StreamEventsResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
