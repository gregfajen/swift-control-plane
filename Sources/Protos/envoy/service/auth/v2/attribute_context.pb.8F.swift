...
/// [#next-free-field: 12]
public struct Envoy_Service_Auth_V2_AttributeContext {
  ...
  /// last hop.
  public var source: Envoy_Service_Auth_V2_AttributeContext.Peer {
    get {return _storage._source ?? Envoy_Service_Auth_V2_AttributeContext.Peer()}
  ...
  /// the last hop.
  public var destination: Envoy_Service_Auth_V2_AttributeContext.Peer {
    get {return _storage._destination ?? Envoy_Service_Auth_V2_AttributeContext.Peer()}
  ...
  public var request: Envoy_Service_Auth_V2_AttributeContext.Request {
    get {return _storage._request ?? Envoy_Service_Auth_V2_AttributeContext.Request()}
  ...
  public var metadataContext: Envoy_Api_V2_Core_Metadata {
    get {return _storage._metadataContext ?? Envoy_Api_V2_Core_Metadata()}
  ...
  public struct Request {
    ...
    public var http: Envoy_Service_Auth_V2_AttributeContext.HttpRequest {
      get {return _http ?? Envoy_Service_Auth_V2_AttributeContext.HttpRequest()}
      set {_http = newValue}
    }
    ...
    fileprivate var _http: Envoy_Service_Auth_V2_AttributeContext.HttpRequest? = nil
  }
...
fileprivate let _protobuf_package = "envoy.service.auth.v2"

extension Envoy_Service_Auth_V2_AttributeContext: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _source: Envoy_Service_Auth_V2_AttributeContext.Peer? = nil
    var _destination: Envoy_Service_Auth_V2_AttributeContext.Peer? = nil
    var _request: Envoy_Service_Auth_V2_AttributeContext.Request? = nil
    var _contextExtensions: Dictionary<String,String> = [:]
    var _metadataContext: Envoy_Api_V2_Core_Metadata? = nil
  ...
  public static func ==(lhs: Envoy_Service_Auth_V2_AttributeContext, rhs: Envoy_Service_Auth_V2_AttributeContext) -> Bool {
...
extension Envoy_Service_Auth_V2_AttributeContext.Peer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Service_Auth_V2_AttributeContext.protoMessageName + ".Peer"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Service_Auth_V2_AttributeContext.Peer, rhs: Envoy_Service_Auth_V2_AttributeContext.Peer) -> Bool {
...
extension Envoy_Service_Auth_V2_AttributeContext.Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Service_Auth_V2_AttributeContext.protoMessageName + ".Request"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "time"),
    2: .same(proto: "http"),
  ]
  ...
  public static func ==(lhs: Envoy_Service_Auth_V2_AttributeContext.Request, rhs: Envoy_Service_Auth_V2_AttributeContext.Request) -> Bool {
...
extension Envoy_Service_Auth_V2_AttributeContext.HttpRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Service_Auth_V2_AttributeContext.protoMessageName + ".HttpRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "method"),
  ...
  public static func ==(lhs: Envoy_Service_Auth_V2_AttributeContext.HttpRequest, rhs: Envoy_Service_Auth_V2_AttributeContext.HttpRequest) -> Bool {
