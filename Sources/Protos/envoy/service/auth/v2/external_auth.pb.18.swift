...
public struct Envoy_Service_Auth_V2_CheckRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The request attributes.
  public var attributes: Envoy_Service_Auth_V2_AttributeContext {
    get {return _attributes ?? Envoy_Service_Auth_V2_AttributeContext()}
  ...
  fileprivate var _attributes: Envoy_Service_Auth_V2_AttributeContext? = nil
}

/// HTTP attributes for a denied response.
public struct Envoy_Service_Auth_V2_DeniedHttpResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var status: Envoy_Type_HttpStatus {
    get {return _status ?? Envoy_Type_HttpStatus()}
  ...
  public var headers: [Envoy_Api_V2_Core_HeaderValueOption] = []
  ...
  fileprivate var _status: Envoy_Type_HttpStatus? = nil
}

/// HTTP attributes for an ok response.
public struct Envoy_Service_Auth_V2_OkHttpResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Service_Auth_V2_CheckResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var httpResponse: Envoy_Service_Auth_V2_CheckResponse.OneOf_HTTPResponse? = nil

  /// Supplies http attributes for a denied response.
  public var deniedResponse: Envoy_Service_Auth_V2_DeniedHttpResponse {
    get {
      if case .deniedResponse(let v)? = httpResponse {return v}
      return Envoy_Service_Auth_V2_DeniedHttpResponse()
    }
    set {httpResponse = .deniedResponse(newValue)}
  }

  /// Supplies http attributes for an ok response.
  public var okResponse: Envoy_Service_Auth_V2_OkHttpResponse {
    get {
      if case .okResponse(let v)? = httpResponse {return v}
      return Envoy_Service_Auth_V2_OkHttpResponse()
    }
  ...
  public enum OneOf_HTTPResponse: Equatable {
    /// Supplies http attributes for a denied response.
    case deniedResponse(Envoy_Service_Auth_V2_DeniedHttpResponse)
    /// Supplies http attributes for an ok response.
    case okResponse(Envoy_Service_Auth_V2_OkHttpResponse)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Service_Auth_V2_CheckResponse.OneOf_HTTPResponse, rhs: Envoy_Service_Auth_V2_CheckResponse.OneOf_HTTPResponse) -> Bool {
...
extension Envoy_Service_Auth_V2_CheckRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Service_Auth_V2_CheckRequest, rhs: Envoy_Service_Auth_V2_CheckRequest) -> Bool {
...
extension Envoy_Service_Auth_V2_DeniedHttpResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Service_Auth_V2_DeniedHttpResponse, rhs: Envoy_Service_Auth_V2_DeniedHttpResponse) -> Bool {
...
extension Envoy_Service_Auth_V2_OkHttpResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Service_Auth_V2_OkHttpResponse, rhs: Envoy_Service_Auth_V2_OkHttpResponse) -> Bool {
    if lhs.headers != rhs.headers {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Envoy_Service_Auth_V2_CheckResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try { try decoder.decodeSingularMessageField(value: &self._status) }()
      case 2: try {
        var v: Envoy_Service_Auth_V2_DeniedHttpResponse?
      ...
      case 3: try {
        var v: Envoy_Service_Auth_V2_OkHttpResponse?
        if let current = self.httpResponse {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Service_Auth_V2_CheckResponse, rhs: Envoy_Service_Auth_V2_CheckResponse) -> Bool {
    if lhs._status != rhs._status {return false}
