...
public struct Envoy_Service_Ratelimit_V3_RateLimitResponse {
  ...
  public struct DescriptorStatus {
    ...
    public var durationUntilReset: SwiftProtobuf.Google_Protobuf_Duration {
      get {return _durationUntilReset ?? SwiftProtobuf.Google_Protobuf_Duration()}
      set {_durationUntilReset = newValue}
    }
    /// Returns true if `durationUntilReset` has been explicitly set.
    public var hasDurationUntilReset: Bool {return self._durationUntilReset != nil}
    /// Clears the value of `durationUntilReset`. Subsequent reads from it will return its default value.
    public mutating func clearDurationUntilReset() {self._durationUntilReset = nil}
    ...
    fileprivate var _durationUntilReset: SwiftProtobuf.Google_Protobuf_Duration? = nil
  }
...
extension Envoy_Service_Ratelimit_V3_RateLimitResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.responseHeadersToAdd) }()
...
extension Envoy_Service_Ratelimit_V3_RateLimitResponse.DescriptorStatus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    4: .standard(proto: "duration_until_reset"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularMessageField(value: &self._durationUntilReset) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._durationUntilReset {
  ...
  public static func ==(lhs: Envoy_Service_Ratelimit_V3_RateLimitResponse.DescriptorStatus, rhs: Envoy_Service_Ratelimit_V3_RateLimitResponse.DescriptorStatus) -> Bool {
    ...
    if lhs._durationUntilReset != rhs._durationUntilReset {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
