...
public protocol Envoy_Service_Accesslog_V3_AccessLogServiceClientProtocol: GRPCClient {
  func streamAccessLogs(
    callOptions: CallOptions?
  ) -> ClientStreamingCall<Envoy_Service_Accesslog_V3_StreamAccessLogsMessage, Envoy_Service_Accesslog_V3_StreamAccessLogsResponse>

}

extension Envoy_Service_Accesslog_V3_AccessLogServiceClientProtocol {
  ...
  public func streamAccessLogs(
    ...
    return self.makeClientStreamingCall(
      path: "/envoy.service.accesslog.v3.AccessLogService/StreamAccessLogs",
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
}

public final class Envoy_Service_Accesslog_V3_AccessLogServiceClient: Envoy_Service_Accesslog_V3_AccessLogServiceClientProtocol {
...
extension Envoy_Service_Accesslog_V3_AccessLogServiceProvider {
  public var serviceName: Substring { return "envoy.service.accesslog.v3.AccessLogService" }
