...
public enum Envoy_Service_Status_V3_ConfigStatus: SwiftProtobuf.Enum {
...
extension Envoy_Service_Status_V3_ConfigStatus: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Service_Status_V3_ConfigStatus] = [
    .unknown,
    .synced,
    .notSent,
    .stale,
...
public enum Envoy_Service_Status_V3_ClientConfigStatus: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Envoy_Service_Status_V3_ClientConfigStatus: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Service_Status_V3_ClientConfigStatus] = [
    .clientUnknown,
    .clientRequested,
    .clientAcked,
    .clientNacked,
...
public struct Envoy_Service_Status_V3_ClientStatusRequest {
  ...
  public var nodeMatchers: [Envoy_Type_Matcher_V3_NodeMatcher] = []
...
/// [#next-free-field: 8]
public struct Envoy_Service_Status_V3_PerXdsConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var status: Envoy_Service_Status_V3_ConfigStatus = .unknown
  ...
  public var clientStatus: Envoy_Service_Status_V3_ClientConfigStatus = .clientUnknown

  public var perXdsConfig: Envoy_Service_Status_V3_PerXdsConfig.OneOf_PerXdsConfig? = nil

  public var listenerConfig: Envoy_Admin_V3_ListenersConfigDump {
    get {
  ...
  public var clusterConfig: Envoy_Admin_V3_ClustersConfigDump {
    get {
  ...
  public var routeConfig: Envoy_Admin_V3_RoutesConfigDump {
    get {
  ...
  public var scopedRouteConfig: Envoy_Admin_V3_ScopedRoutesConfigDump {
    get {
  ...
  public var endpointConfig: Envoy_Admin_V3_EndpointsConfigDump {
    get {
  ...
  public enum OneOf_PerXdsConfig: Equatable {
    case listenerConfig(Envoy_Admin_V3_ListenersConfigDump)
    case clusterConfig(Envoy_Admin_V3_ClustersConfigDump)
    case routeConfig(Envoy_Admin_V3_RoutesConfigDump)
    case scopedRouteConfig(Envoy_Admin_V3_ScopedRoutesConfigDump)
    case endpointConfig(Envoy_Admin_V3_EndpointsConfigDump)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Service_Status_V3_PerXdsConfig.OneOf_PerXdsConfig, rhs: Envoy_Service_Status_V3_PerXdsConfig.OneOf_PerXdsConfig) -> Bool {
...
public struct Envoy_Service_Status_V3_ClientConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var xdsConfig: [Envoy_Service_Status_V3_PerXdsConfig] = []
...
public struct Envoy_Service_Status_V3_ClientStatusResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Client configs for the clients specified in the ClientStatusRequest.
  public var config: [Envoy_Service_Status_V3_ClientConfig] = []
...
fileprivate let _protobuf_package = "envoy.service.status.v3"

extension Envoy_Service_Status_V3_ConfigStatus: SwiftProtobuf._ProtoNameProviding {
...
extension Envoy_Service_Status_V3_ClientConfigStatus: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Service_Status_V3_ClientStatusRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Service_Status_V3_ClientStatusRequest, rhs: Envoy_Service_Status_V3_ClientStatusRequest) -> Bool {
...
extension Envoy_Service_Status_V3_PerXdsConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Envoy_Admin_V3_ListenersConfigDump?
      ...
      case 3: try {
        var v: Envoy_Admin_V3_ClustersConfigDump?
        if let current = self.perXdsConfig {
          try decoder.handleConflictingOneOf()
      ...
      case 4: try {
        var v: Envoy_Admin_V3_RoutesConfigDump?
        if let current = self.perXdsConfig {
          try decoder.handleConflictingOneOf()
      ...
      case 5: try {
        var v: Envoy_Admin_V3_ScopedRoutesConfigDump?
        if let current = self.perXdsConfig {
          try decoder.handleConflictingOneOf()
      ...
      case 6: try {
        var v: Envoy_Admin_V3_EndpointsConfigDump?
        if let current = self.perXdsConfig {
          try decoder.handleConflictingOneOf()
      ...
      case 7: try { try decoder.decodeSingularEnumField(value: &self.clientStatus) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.clientStatus != .clientUnknown {
      try visitor.visitSingularEnumField(value: self.clientStatus, fieldNumber: 7)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Service_Status_V3_PerXdsConfig, rhs: Envoy_Service_Status_V3_PerXdsConfig) -> Bool {
...
extension Envoy_Service_Status_V3_ClientConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Service_Status_V3_ClientConfig, rhs: Envoy_Service_Status_V3_ClientConfig) -> Bool {
    if lhs._node != rhs._node {return false}
...
extension Envoy_Service_Status_V3_ClientStatusResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Service_Status_V3_ClientStatusResponse, rhs: Envoy_Service_Status_V3_ClientStatusResponse) -> Bool {
