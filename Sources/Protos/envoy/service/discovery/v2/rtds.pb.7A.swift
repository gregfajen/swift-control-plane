...
public struct Envoy_Service_Discovery_V2_RtdsDummy {
...
public struct Envoy_Service_Discovery_V2_Runtime {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Envoy_Service_Discovery_V2_RtdsDummy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Service_Discovery_V2_RtdsDummy, rhs: Envoy_Service_Discovery_V2_RtdsDummy) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Service_Discovery_V2_Runtime: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Service_Discovery_V2_Runtime, rhs: Envoy_Service_Discovery_V2_Runtime) -> Bool {
