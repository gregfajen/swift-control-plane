...
public struct Envoy_Service_Discovery_V3_Resource {
  ...
  public var udpaResourceName: Udpa_Core_V1_ResourceName {
    get {return _udpaResourceName ?? Udpa_Core_V1_ResourceName()}
    set {_udpaResourceName = newValue}
  }
  /// Returns true if `udpaResourceName` has been explicitly set.
  public var hasUdpaResourceName: Bool {return self._udpaResourceName != nil}
  /// Clears the value of `udpaResourceName`. Subsequent reads from it will return its default value.
  public mutating func clearUdpaResourceName() {self._udpaResourceName = nil}
  ...
  fileprivate var _udpaResourceName: Udpa_Core_V1_ResourceName? = nil
...
extension Envoy_Service_Discovery_V3_Resource: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularMessageField(value: &self._udpaResourceName) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._udpaResourceName {
  ...
  public static func ==(lhs: Envoy_Service_Discovery_V3_Resource, rhs: Envoy_Service_Discovery_V3_Resource) -> Bool {
    ...
    if lhs._udpaResourceName != rhs._udpaResourceName {return false}
