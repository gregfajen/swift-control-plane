...
public struct Envoy_Type_Matcher_DoubleMatcher {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var matchPattern: Envoy_Type_Matcher_DoubleMatcher.OneOf_MatchPattern? = nil

  /// If specified, the input double value must be in the range specified here.
  /// Note: The range is using half-open interval semantics [start, end).
  public var range: Envoy_Type_DoubleRange {
    get {
      if case .range(let v)? = matchPattern {return v}
      return Envoy_Type_DoubleRange()
    }
  ...
  public enum OneOf_MatchPattern: Equatable {
    /// If specified, the input double value must be in the range specified here.
    /// Note: The range is using half-open interval semantics [start, end).
    case range(Envoy_Type_DoubleRange)
    /// If specified, the input double value must be equal to the value specified here.
    case exact(Double)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Type_Matcher_DoubleMatcher.OneOf_MatchPattern, rhs: Envoy_Type_Matcher_DoubleMatcher.OneOf_MatchPattern) -> Bool {
...
extension Envoy_Type_Matcher_DoubleMatcher: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Type_Matcher_DoubleMatcher, rhs: Envoy_Type_Matcher_DoubleMatcher) -> Bool {
