...
public struct Envoy_Type_Matcher_NodeMatcher {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Specifies match criteria on the node id.
  public var nodeID: Envoy_Type_Matcher_StringMatcher {
    get {return _nodeID ?? Envoy_Type_Matcher_StringMatcher()}
  ...
  public var nodeMetadatas: [Envoy_Type_Matcher_StructMatcher] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _nodeID: Envoy_Type_Matcher_StringMatcher? = nil
}
...
extension Envoy_Type_Matcher_NodeMatcher: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Type_Matcher_NodeMatcher, rhs: Envoy_Type_Matcher_NodeMatcher) -> Bool {
