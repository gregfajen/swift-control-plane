...
/// [#next-free-field: 8]
public struct Envoy_Type_Matcher_V4alpha_StringMatcher {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var matchPattern: Envoy_Type_Matcher_V4alpha_StringMatcher.OneOf_MatchPattern? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Type_Matcher_V4alpha_StringMatcher.OneOf_MatchPattern, rhs: Envoy_Type_Matcher_V4alpha_StringMatcher.OneOf_MatchPattern) -> Bool {
...
public struct Envoy_Type_Matcher_V4alpha_ListStringMatcher {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var patterns: [Envoy_Type_Matcher_V4alpha_StringMatcher] = []
...
extension Envoy_Type_Matcher_V4alpha_StringMatcher: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Type_Matcher_V4alpha_StringMatcher, rhs: Envoy_Type_Matcher_V4alpha_StringMatcher) -> Bool {
...
extension Envoy_Type_Matcher_V4alpha_ListStringMatcher: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Type_Matcher_V4alpha_ListStringMatcher, rhs: Envoy_Type_Matcher_V4alpha_ListStringMatcher) -> Bool {
