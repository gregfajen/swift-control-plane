...
public struct Envoy_Type_Matcher_V4alpha_StructMatcher {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The path to retrieve the Value from the Struct.
  public var path: [Envoy_Type_Matcher_V4alpha_StructMatcher.PathSegment] = []
  ...
  public struct PathSegment {
    ...
    public var segment: Envoy_Type_Matcher_V4alpha_StructMatcher.PathSegment.OneOf_Segment? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Type_Matcher_V4alpha_StructMatcher.PathSegment.OneOf_Segment, rhs: Envoy_Type_Matcher_V4alpha_StructMatcher.PathSegment.OneOf_Segment) -> Bool {
        switch (lhs, rhs) {
...
extension Envoy_Type_Matcher_V4alpha_StructMatcher: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Type_Matcher_V4alpha_StructMatcher, rhs: Envoy_Type_Matcher_V4alpha_StructMatcher) -> Bool {
...
extension Envoy_Type_Matcher_V4alpha_StructMatcher.PathSegment: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Type_Matcher_V4alpha_StructMatcher.protoMessageName + ".PathSegment"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "key"),
  ]
  ...
  public static func ==(lhs: Envoy_Type_Matcher_V4alpha_StructMatcher.PathSegment, rhs: Envoy_Type_Matcher_V4alpha_StructMatcher.PathSegment) -> Bool {
