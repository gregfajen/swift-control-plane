...
public struct Envoy_Type_Matcher_V3_DoubleMatcher {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var matchPattern: Envoy_Type_Matcher_V3_DoubleMatcher.OneOf_MatchPattern? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Type_Matcher_V3_DoubleMatcher.OneOf_MatchPattern, rhs: Envoy_Type_Matcher_V3_DoubleMatcher.OneOf_MatchPattern) -> Bool {
...
extension Envoy_Type_Matcher_V3_DoubleMatcher: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Type_Matcher_V3_DoubleMatcher, rhs: Envoy_Type_Matcher_V3_DoubleMatcher) -> Bool {
