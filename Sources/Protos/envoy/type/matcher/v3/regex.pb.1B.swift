...
public struct Envoy_Type_Matcher_V3_RegexMatcher {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var engineType: Envoy_Type_Matcher_V3_RegexMatcher.OneOf_EngineType? = nil

  /// Google's RE2 regex engine.
  public var googleRe2: Envoy_Type_Matcher_V3_RegexMatcher.GoogleRE2 {
    get {
      if case .googleRe2(let v)? = engineType {return v}
      return Envoy_Type_Matcher_V3_RegexMatcher.GoogleRE2()
    }
  ...
  public enum OneOf_EngineType: Equatable {
    /// Google's RE2 regex engine.
    case googleRe2(Envoy_Type_Matcher_V3_RegexMatcher.GoogleRE2)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Type_Matcher_V3_RegexMatcher.OneOf_EngineType, rhs: Envoy_Type_Matcher_V3_RegexMatcher.OneOf_EngineType) -> Bool {
...
public struct Envoy_Type_Matcher_V3_RegexMatchAndSubstitute {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var pattern: Envoy_Type_Matcher_V3_RegexMatcher {
    get {return _pattern ?? Envoy_Type_Matcher_V3_RegexMatcher()}
  ...
  fileprivate var _pattern: Envoy_Type_Matcher_V3_RegexMatcher? = nil
}
...
extension Envoy_Type_Matcher_V3_RegexMatcher: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Envoy_Type_Matcher_V3_RegexMatcher.GoogleRE2?
  ...
  public static func ==(lhs: Envoy_Type_Matcher_V3_RegexMatcher, rhs: Envoy_Type_Matcher_V3_RegexMatcher) -> Bool {
...
extension Envoy_Type_Matcher_V3_RegexMatcher.GoogleRE2: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Type_Matcher_V3_RegexMatcher.protoMessageName + ".GoogleRE2"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Type_Matcher_V3_RegexMatcher.GoogleRE2, rhs: Envoy_Type_Matcher_V3_RegexMatcher.GoogleRE2) -> Bool {
...
extension Envoy_Type_Matcher_V3_RegexMatchAndSubstitute: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Type_Matcher_V3_RegexMatchAndSubstitute, rhs: Envoy_Type_Matcher_V3_RegexMatchAndSubstitute) -> Bool {
