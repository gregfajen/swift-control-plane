...
public struct Envoy_Type_SemanticVersion {
...
extension Envoy_Type_SemanticVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.majorNumber) }()
      case 2: try { try decoder.decodeSingularUInt32Field(value: &self.minorNumber) }()
  ...
  public static func ==(lhs: Envoy_Type_SemanticVersion, rhs: Envoy_Type_SemanticVersion) -> Bool {
