...
public struct Envoy_Type_Percent {
...
public struct Envoy_Type_FractionalPercent {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var denominator: Envoy_Type_FractionalPercent.DenominatorType = .hundred
...
extension Envoy_Type_FractionalPercent.DenominatorType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Type_FractionalPercent.DenominatorType] = [
    .hundred,
    .tenThousand,
    .million,
  ]
...
extension Envoy_Type_Percent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Type_Percent, rhs: Envoy_Type_Percent) -> Bool {
...
extension Envoy_Type_FractionalPercent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Type_FractionalPercent, rhs: Envoy_Type_FractionalPercent) -> Bool {
...
extension Envoy_Type_FractionalPercent.DenominatorType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
