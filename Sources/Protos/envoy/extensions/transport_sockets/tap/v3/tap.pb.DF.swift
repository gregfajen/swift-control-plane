...
public struct Envoy_Extensions_TransportSockets_Tap_V3_Tap {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Common configuration for the tap transport socket.
  public var commonConfig: Envoy_Extensions_Common_Tap_V3_CommonExtensionConfig {
    get {return _commonConfig ?? Envoy_Extensions_Common_Tap_V3_CommonExtensionConfig()}
  ...
  fileprivate var _commonConfig: Envoy_Extensions_Common_Tap_V3_CommonExtensionConfig? = nil
  fileprivate var _transportSocket: Envoy_Config_Core_V3_TransportSocket? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.extensions.transport_sockets.tap.v3"

extension Envoy_Extensions_TransportSockets_Tap_V3_Tap: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_TransportSockets_Tap_V3_Tap, rhs: Envoy_Extensions_TransportSockets_Tap_V3_Tap) -> Bool {
