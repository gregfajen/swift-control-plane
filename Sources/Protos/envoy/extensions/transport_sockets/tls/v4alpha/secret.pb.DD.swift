...
public struct Envoy_Extensions_TransportSockets_Tls_V4alpha_SdsSecretConfig {
  ...
  public var sdsResourceLocator: Udpa_Core_V1_ResourceLocator {
    get {
      if case .sdsResourceLocator(let v)? = _storage._nameSpecifier {return v}
      return Udpa_Core_V1_ResourceLocator()
    }
    set {_uniqueStorage()._nameSpecifier = .sdsResourceLocator(newValue)}
  }

  public var sdsConfig: Envoy_Config_Core_V4alpha_ConfigSource {
    get {return _storage._sdsConfig ?? Envoy_Config_Core_V4alpha_ConfigSource()}
  ...
  public enum OneOf_NameSpecifier: Equatable {
    ...
    /// Resource locator for SDS. This is mutually exclusive to *name*.
    /// [#not-implemented-hide:]
    case sdsResourceLocator(Udpa_Core_V1_ResourceLocator)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_SdsSecretConfig.OneOf_NameSpecifier, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_SdsSecretConfig.OneOf_NameSpecifier) -> Bool {
      ...
      case (.sdsResourceLocator, .sdsResourceLocator): return {
        guard case .sdsResourceLocator(let l) = lhs, case .sdsResourceLocator(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_SdsSecretConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _nameSpecifier: Envoy_Extensions_TransportSockets_Tls_V4alpha_SdsSecretConfig.OneOf_NameSpecifier?
    var _sdsConfig: Envoy_Config_Core_V4alpha_ConfigSource? = nil
      ...
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try {
          ...
          if let current = _storage._nameSpecifier {
            ...
            if case .sdsResourceLocator(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._nameSpecifier = .sdsResourceLocator(v)}
        }()
        default: break
        }
      }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if case .sdsResourceLocator(let v)? = _storage._nameSpecifier {
