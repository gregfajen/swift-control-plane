...
public struct Envoy_Extensions_TransportSockets_Tls_V4alpha_UpstreamTlsContext {
  ...
  ///   verification.
  public var commonTlsContext: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext {
    get {return _commonTlsContext ?? Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext()}
  ...
  fileprivate var _commonTlsContext: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext? = nil
  fileprivate var _maxSessionKeys: SwiftProtobuf.Google_Protobuf_UInt32Value? = nil
}

/// [#next-free-field: 9]
public struct Envoy_Extensions_TransportSockets_Tls_V4alpha_DownstreamTlsContext {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var sessionTicketKeysType: Envoy_Extensions_TransportSockets_Tls_V4alpha_DownstreamTlsContext.OneOf_SessionTicketKeysType? = nil
  ...
  public var sessionTicketKeysSdsSecretConfig: Envoy_Extensions_TransportSockets_Tls_V4alpha_SdsSecretConfig {
    get {
  ...
  public var ocspStaplePolicy: Envoy_Extensions_TransportSockets_Tls_V4alpha_DownstreamTlsContext.OcspStaplePolicy = .lenientStapling
  ...
  public enum OneOf_SessionTicketKeysType: Equatable {
    ...
    /// Config for fetching TLS session ticket keys via SDS API.
    case sessionTicketKeysSdsSecretConfig(Envoy_Extensions_TransportSockets_Tls_V4alpha_SdsSecretConfig)
    /// Config for controlling stateless TLS session resumption: setting this to true will cause the TLS
    /// server to not issue TLS session tickets for the purposes of stateless TLS session resumption.
    /// If set to false, the TLS server will issue TLS session tickets and encrypt/decrypt them using
    /// the keys specified through either :ref:`session_ticket_keys <envoy_api_field_extensions.transport_sockets.tls.v4alpha.DownstreamTlsContext.session_ticket_keys>`
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_DownstreamTlsContext.OneOf_SessionTicketKeysType, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_DownstreamTlsContext.OneOf_SessionTicketKeysType) -> Bool {
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_DownstreamTlsContext.OcspStaplePolicy: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Extensions_TransportSockets_Tls_V4alpha_DownstreamTlsContext.OcspStaplePolicy] = [
    .lenientStapling,
    .strictStapling,
    .mustStaple,
  ]
...
/// [#next-free-field: 14]
public struct Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// TLS protocol versions, cipher suites etc.
  public var tlsParams: Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsParameters {
    get {return _storage._tlsParams ?? Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsParameters()}
  ...
  public var tlsCertificates: [Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsCertificate] {
  ...
  public var tlsCertificateSdsSecretConfigs: [Envoy_Extensions_TransportSockets_Tls_V4alpha_SdsSecretConfig] {
  ...
  /// [#not-implemented-hide:]
  public var tlsCertificateCertificateProvider: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider {
    get {return _storage._tlsCertificateCertificateProvider ?? Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider()}
  ...
  /// [#not-implemented-hide:]
  public var tlsCertificateCertificateProviderInstance: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProviderInstance {
    get {return _storage._tlsCertificateCertificateProviderInstance ?? Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProviderInstance()}
  ...
  /// fetched/refreshed over the network asynchronously with respect to the TLS handshake.
  public var validationContextSdsSecretConfig: Envoy_Extensions_TransportSockets_Tls_V4alpha_SdsSecretConfig {
    get {
  ...
  public var combinedValidationContext: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CombinedCertificateValidationContext {
    get {
      if case .combinedValidationContext(let v)? = _storage._validationContextType {return v}
      return Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CombinedCertificateValidationContext()
    }
  ...
  /// [#not-implemented-hide:]
  public var validationContextCertificateProvider: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider {
    get {
      if case .validationContextCertificateProvider(let v)? = _storage._validationContextType {return v}
      return Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider()
    }
  ...
  /// [#not-implemented-hide:]
  public var validationContextCertificateProviderInstance: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProviderInstance {
    get {
      if case .validationContextCertificateProviderInstance(let v)? = _storage._validationContextType {return v}
      return Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProviderInstance()
    }
  ...
  /// behavior.
  public var customHandshaker: Envoy_Config_Core_V4alpha_TypedExtensionConfig {
    get {return _storage._customHandshaker ?? Envoy_Config_Core_V4alpha_TypedExtensionConfig()}
  ...
  public enum OneOf_ValidationContextType: Equatable {
    ...
    /// Config for fetching validation context via SDS API. Note SDS API allows certificates to be
    /// fetched/refreshed over the network asynchronously with respect to the TLS handshake.
    case validationContextSdsSecretConfig(Envoy_Extensions_TransportSockets_Tls_V4alpha_SdsSecretConfig)
    /// Combined certificate validation context holds a default CertificateValidationContext
    /// and SDS config. When SDS server returns dynamic CertificateValidationContext, both dynamic
    /// and default CertificateValidationContext are merged into a new CertificateValidationContext
    /// for validation. This merge is done by Message::MergeFrom(), so dynamic
    ...
    /// CertificateValidationContext, and concatenates repeated fields to default
    /// CertificateValidationContext, and logical OR is applied to boolean fields.
    case combinedValidationContext(Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CombinedCertificateValidationContext)
    /// Certificate provider for fetching validation context.
    /// [#not-implemented-hide:]
    case validationContextCertificateProvider(Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider)
    /// Certificate provider instance for fetching validation context.
    /// [#not-implemented-hide:]
    case validationContextCertificateProviderInstance(Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProviderInstance)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.OneOf_ValidationContextType, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.OneOf_ValidationContextType) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
  ...
  public struct CertificateProvider {
    ...
    public var config: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider.OneOf_Config? = nil

    public var typedConfig: Envoy_Config_Core_V4alpha_TypedExtensionConfig {
      get {
        if case .typedConfig(let v)? = config {return v}
        return Envoy_Config_Core_V4alpha_TypedExtensionConfig()
      }
    ...
    public enum OneOf_Config: Equatable {
      case typedConfig(Envoy_Config_Core_V4alpha_TypedExtensionConfig)

    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider.OneOf_Config, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider.OneOf_Config) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
  ...
  public struct CombinedCertificateValidationContext {
    ...
    /// How to validate peer certificates.
    public var defaultValidationContext: Envoy_Extensions_TransportSockets_Tls_V4alpha_CertificateValidationContext {
      get {return _defaultValidationContext ?? Envoy_Extensions_TransportSockets_Tls_V4alpha_CertificateValidationContext()}
    ...
    public var dynamicValidationContext: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CombinedCertificateValidationContext.OneOf_DynamicValidationContext? = nil
    ...
    public var validationContextSdsSecretConfig: Envoy_Extensions_TransportSockets_Tls_V4alpha_SdsSecretConfig {
      get {
        if case .validationContextSdsSecretConfig(let v)? = dynamicValidationContext {return v}
        return Envoy_Extensions_TransportSockets_Tls_V4alpha_SdsSecretConfig()
      }
      set {dynamicValidationContext = .validationContextSdsSecretConfig(newValue)}
    }
    ...
    public var validationContextCertificateProvider: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider {
      get {
        if case .validationContextCertificateProvider(let v)? = dynamicValidationContext {return v}
        return Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider()
      }
      set {dynamicValidationContext = .validationContextCertificateProvider(newValue)}
    }
    ...
    public var validationContextCertificateProviderInstance: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProviderInstance {
      get {
        if case .validationContextCertificateProviderInstance(let v)? = dynamicValidationContext {return v}
        return Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProviderInstance()
      }
      set {dynamicValidationContext = .validationContextCertificateProviderInstance(newValue)}
    }

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public enum OneOf_DynamicValidationContext: Equatable {
      /// Config for fetching validation context via SDS API. Note SDS API allows certificates to be
      /// fetched/refreshed over the network asynchronously with respect to the TLS handshake.
      /// Only one of validation_context_sds_secret_config, validation_context_certificate_provider,
      /// or validation_context_certificate_provider_instance may be used.
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CombinedCertificateValidationContext.OneOf_DynamicValidationContext, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CombinedCertificateValidationContext.OneOf_DynamicValidationContext) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
    ...
    fileprivate var _defaultValidationContext: Envoy_Extensions_TransportSockets_Tls_V4alpha_CertificateValidationContext? = nil
  }
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_UpstreamTlsContext: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_UpstreamTlsContext, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_UpstreamTlsContext) -> Bool {
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_DownstreamTlsContext: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_DownstreamTlsContext, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_DownstreamTlsContext) -> Bool {
    if lhs._commonTlsContext != rhs._commonTlsContext {return false}
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_DownstreamTlsContext.OcspStaplePolicy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _tlsParams: Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsParameters? = nil
    var _tlsCertificates: [Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsCertificate] = []
    var _tlsCertificateSdsSecretConfigs: [Envoy_Extensions_TransportSockets_Tls_V4alpha_SdsSecretConfig] = []
    var _tlsCertificateCertificateProvider: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider? = nil
    var _tlsCertificateCertificateProviderInstance: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProviderInstance? = nil
    var _validationContextType: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.OneOf_ValidationContextType?
    var _alpnProtocols: [String] = []
    var _customHandshaker: Envoy_Config_Core_V4alpha_TypedExtensionConfig? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 8: try {
          var v: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CombinedCertificateValidationContext?
          if let current = _storage._validationContextType {
            try decoder.handleConflictingOneOf()
        ...
        case 10: try {
          var v: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider?
          if let current = _storage._validationContextType {
            try decoder.handleConflictingOneOf()
        ...
        case 12: try {
          var v: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProviderInstance?
          if let current = _storage._validationContextType {
            try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext) -> Bool {
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.protoMessageName + ".CertificateProvider"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Envoy_Config_Core_V4alpha_TypedExtensionConfig?
  ...
  public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider) -> Bool {
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProviderInstance: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.protoMessageName + ".CertificateProviderInstance"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProviderInstance, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProviderInstance) -> Bool {
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CombinedCertificateValidationContext: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.protoMessageName + ".CombinedCertificateValidationContext"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Envoy_Extensions_TransportSockets_Tls_V4alpha_SdsSecretConfig?
        if let current = self.dynamicValidationContext {
          try decoder.handleConflictingOneOf()
          if case .validationContextSdsSecretConfig(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.dynamicValidationContext = .validationContextSdsSecretConfig(v)}
      }()
      case 3: try {
        var v: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProvider?
        if let current = self.dynamicValidationContext {
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.dynamicValidationContext = .validationContextCertificateProvider(v)}
      }()
      case 4: try {
        var v: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CertificateProviderInstance?
        if let current = self.dynamicValidationContext {
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.dynamicValidationContext = .validationContextCertificateProviderInstance(v)}
      }()
      default: break
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // allocates stack space for every case branch when no optimizations are
    // enabled. https://github.com/apple/swift-protobuf/issues/1034
    switch self.dynamicValidationContext {
    case .validationContextSdsSecretConfig?: try {
      guard case .validationContextSdsSecretConfig(let v)? = self.dynamicValidationContext else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }()
    case .validationContextCertificateProvider?: try {
      guard case .validationContextCertificateProvider(let v)? = self.dynamicValidationContext else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }()
    case .validationContextCertificateProviderInstance?: try {
      guard case .validationContextCertificateProviderInstance(let v)? = self.dynamicValidationContext else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }()
    case nil: break
    }
  ...
  public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CombinedCertificateValidationContext, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CommonTlsContext.CombinedCertificateValidationContext) -> Bool {
    if lhs._defaultValidationContext != rhs._defaultValidationContext {return false}
    if lhs.dynamicValidationContext != rhs.dynamicValidationContext {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
