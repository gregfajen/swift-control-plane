...
public struct Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsParameters {
  ...
  /// servers.
  public var tlsMinimumProtocolVersion: Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsParameters.TlsProtocol = .tlsAuto
  ...
  public var tlsMaximumProtocolVersion: Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsParameters.TlsProtocol = .tlsAuto
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsParameters.TlsProtocol: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsParameters.TlsProtocol] = [
    .tlsAuto,
    .tlsv10,
    .tlsv11,
    .tlsv12,
...
public struct Envoy_Extensions_TransportSockets_Tls_V4alpha_PrivateKeyProvider {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var configType: Envoy_Extensions_TransportSockets_Tls_V4alpha_PrivateKeyProvider.OneOf_ConfigType? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_PrivateKeyProvider.OneOf_ConfigType, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_PrivateKeyProvider.OneOf_ConfigType) -> Bool {
      switch (lhs, rhs) {
...
/// [#next-free-field: 7]
public struct Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsCertificate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The TLS certificate chain.
  public var certificateChain: Envoy_Config_Core_V4alpha_DataSource {
    get {return _certificateChain ?? Envoy_Config_Core_V4alpha_DataSource()}
  ...
  /// error.
  public var privateKeyProvider: Envoy_Extensions_TransportSockets_Tls_V4alpha_PrivateKeyProvider {
    get {return _privateKeyProvider ?? Envoy_Extensions_TransportSockets_Tls_V4alpha_PrivateKeyProvider()}
  ...
  public var password: Envoy_Config_Core_V4alpha_DataSource {
    get {return _password ?? Envoy_Config_Core_V4alpha_DataSource()}
  ...
  public var ocspStaple: Envoy_Config_Core_V4alpha_DataSource {
    get {return _ocspStaple ?? Envoy_Config_Core_V4alpha_DataSource()}
  ...
  /// [#not-implemented-hide:]
  public var signedCertificateTimestamp: [Envoy_Config_Core_V4alpha_DataSource] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _certificateChain: Envoy_Config_Core_V4alpha_DataSource? = nil
  fileprivate var _privateKey: Envoy_Config_Core_V4alpha_DataSource? = nil
  fileprivate var _privateKeyProvider: Envoy_Extensions_TransportSockets_Tls_V4alpha_PrivateKeyProvider? = nil
  fileprivate var _password: Envoy_Config_Core_V4alpha_DataSource? = nil
  fileprivate var _ocspStaple: Envoy_Config_Core_V4alpha_DataSource? = nil
}

public struct Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsSessionTicketKeys {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var keys: [Envoy_Config_Core_V4alpha_DataSource] = []
...
/// [#next-free-field: 11]
public struct Envoy_Extensions_TransportSockets_Tls_V4alpha_CertificateValidationContext {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// system CA locations.
  public var trustedCa: Envoy_Config_Core_V4alpha_DataSource {
    get {return _trustedCa ?? Envoy_Config_Core_V4alpha_DataSource()}
  ...
  public var matchSubjectAltNames: [Envoy_Type_Matcher_V4alpha_StringMatcher] = []

  /// [#not-implemented-hide:] Must present a signed time-stamped OCSP response.
  public var requireOcspStaple: SwiftProtobuf.Google_Protobuf_BoolValue {
    get {return _requireOcspStaple ?? SwiftProtobuf.Google_Protobuf_BoolValue()}
    set {_requireOcspStaple = newValue}
  }
  /// Returns true if `requireOcspStaple` has been explicitly set.
  public var hasRequireOcspStaple: Bool {return self._requireOcspStaple != nil}
  /// Clears the value of `requireOcspStaple`. Subsequent reads from it will return its default value.
  public mutating func clearRequireOcspStaple() {self._requireOcspStaple = nil}
  ...
  public var crl: Envoy_Config_Core_V4alpha_DataSource {
    get {return _crl ?? Envoy_Config_Core_V4alpha_DataSource()}
    set {_crl = newValue}
  }
  ...
  public var trustChainVerification: Envoy_Extensions_TransportSockets_Tls_V4alpha_CertificateValidationContext.TrustChainVerification = .verifyTrustChain
  ...
  fileprivate var _trustedCa: Envoy_Config_Core_V4alpha_DataSource? = nil
  fileprivate var _requireOcspStaple: SwiftProtobuf.Google_Protobuf_BoolValue? = nil
  fileprivate var _requireSignedCertificateTimestamp: SwiftProtobuf.Google_Protobuf_BoolValue? = nil
  fileprivate var _crl: Envoy_Config_Core_V4alpha_DataSource? = nil
}

#if swift(>=4.2)

extension Envoy_Extensions_TransportSockets_Tls_V4alpha_CertificateValidationContext.TrustChainVerification: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Extensions_TransportSockets_Tls_V4alpha_CertificateValidationContext.TrustChainVerification] = [
    .verifyTrustChain,
    .acceptUntrusted,
  ]
}
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsParameters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularEnumField(value: &self.tlsMinimumProtocolVersion)
      case 2: try decoder.decodeSingularEnumField(value: &self.tlsMaximumProtocolVersion)
      case 3: try decoder.decodeRepeatedStringField(value: &self.cipherSuites)
      case 4: try decoder.decodeRepeatedStringField(value: &self.ecdhCurves)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsParameters, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsParameters) -> Bool {
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsParameters.TlsProtocol: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_PrivateKeyProvider: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_PrivateKeyProvider, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_PrivateKeyProvider) -> Bool {
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsCertificate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._certificateChain)
      ...
      case 4: try decoder.decodeSingularMessageField(value: &self._ocspStaple)
      case 5: try decoder.decodeRepeatedMessageField(value: &self.signedCertificateTimestamp)
      case 6: try decoder.decodeSingularMessageField(value: &self._privateKeyProvider)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsCertificate, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsCertificate) -> Bool {
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsSessionTicketKeys: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsSessionTicketKeys, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_TlsSessionTicketKeys) -> Bool {
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_CertificateValidationContext: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    5: .standard(proto: "require_ocsp_staple"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._trustedCa)
      case 2: try decoder.decodeRepeatedStringField(value: &self.verifyCertificateHash)
      case 3: try decoder.decodeRepeatedStringField(value: &self.verifyCertificateSpki)
      case 5: try decoder.decodeSingularMessageField(value: &self._requireOcspStaple)
      case 6: try decoder.decodeSingularMessageField(value: &self._requireSignedCertificateTimestamp)
      case 7: try decoder.decodeSingularMessageField(value: &self._crl)
      case 8: try decoder.decodeSingularBoolField(value: &self.allowExpiredCertificate)
      case 9: try decoder.decodeRepeatedMessageField(value: &self.matchSubjectAltNames)
      case 10: try decoder.decodeSingularEnumField(value: &self.trustChainVerification)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._requireOcspStaple {
  ...
  public static func ==(lhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CertificateValidationContext, rhs: Envoy_Extensions_TransportSockets_Tls_V4alpha_CertificateValidationContext) -> Bool {
    ...
    if lhs._requireOcspStaple != rhs._requireOcspStaple {return false}
...
extension Envoy_Extensions_TransportSockets_Tls_V4alpha_CertificateValidationContext.TrustChainVerification: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
