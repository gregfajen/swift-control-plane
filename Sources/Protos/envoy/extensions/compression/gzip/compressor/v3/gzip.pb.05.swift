...
extension Envoy_Extensions_Compression_Gzip_Compressor_V3_Gzip: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularEnumField(value: &self.compressionLevel)
      case 3: try decoder.decodeSingularEnumField(value: &self.compressionStrategy)
      case 4: try decoder.decodeSingularMessageField(value: &self._windowBits)
      case 5: try decoder.decodeSingularMessageField(value: &self._chunkSize)
      default: break
      }
    }
  }
