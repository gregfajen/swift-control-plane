...
public struct Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig {
  ...
  /// to DNS requests.
  public var serverConfig: Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ServerContextConfig {
    get {return _serverConfig ?? Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ServerContextConfig()}
  ...
  public var clientConfig: Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ClientContextConfig {
    get {return _clientConfig ?? Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ClientContextConfig()}
  ...
  public struct ServerContextConfig {
    ...
    public var configSource: Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ServerContextConfig.OneOf_ConfigSource? = nil

    /// Load the configuration specified from the control plane
    public var inlineDnsTable: Envoy_Data_Dns_V3_DnsTable {
      get {
        if case .inlineDnsTable(let v)? = configSource {return v}
        return Envoy_Data_Dns_V3_DnsTable()
      }
    ...
    public var externalDnsTable: Envoy_Config_Core_V3_DataSource {
      get {
    ...
    public enum OneOf_ConfigSource: Equatable {
      /// Load the configuration specified from the control plane
      case inlineDnsTable(Envoy_Data_Dns_V3_DnsTable)
      /// Seed the filter configuration from an external path. This source
      /// is a yaml formatted file that contains the DnsTable driving Envoy's
      /// responses to DNS queries
      case externalDnsTable(Envoy_Config_Core_V3_DataSource)

    #if !swift(>=4.1)
      public static func ==(lhs: Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ServerContextConfig.OneOf_ConfigSource, rhs: Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ServerContextConfig.OneOf_ConfigSource) -> Bool {
        switch (lhs, rhs) {
        case (.inlineDnsTable(let l), .inlineDnsTable(let r)): return l == r
        case (.externalDnsTable(let l), .externalDnsTable(let r)): return l == r
  ...
  fileprivate var _serverConfig: Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ServerContextConfig? = nil
  fileprivate var _clientConfig: Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ClientContextConfig? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.extensions.filters.udp.dns_filter.v3alpha"

extension Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeSingularMessageField(value: &self._clientConfig)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig, rhs: Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig) -> Bool {
...
extension Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ServerContextConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.protoMessageName + ".ServerContextConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1:
        var v: Envoy_Data_Dns_V3_DnsTable?
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .inlineDnsTable(let v)?:
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    case .externalDnsTable(let v)?:
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    case nil: break
    }
    try unknownFields.traverse(visitor: &visitor)
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ServerContextConfig, rhs: Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ServerContextConfig) -> Bool {
...
extension Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ClientContextConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.protoMessageName + ".ClientContextConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._resolverTimeout)
      case 2: try decoder.decodeRepeatedStringField(value: &self.upstreamResolvers)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.upstreamResolvers.isEmpty {
      try visitor.visitRepeatedStringField(value: self.upstreamResolvers, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ClientContextConfig, rhs: Envoy_Extensions_Filters_Udp_DnsFilter_V3alpha_DnsFilterConfig.ClientContextConfig) -> Bool {
