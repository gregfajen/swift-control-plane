...
public struct Envoy_Extensions_Filters_Network_ZookeeperProxy_V3_ZooKeeperProxy {
...
fileprivate let _protobuf_package = "envoy.extensions.filters.network.zookeeper_proxy.v3"

extension Envoy_Extensions_Filters_Network_ZookeeperProxy_V3_ZooKeeperProxy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularStringField(value: &self.accessLog)
      case 3: try decoder.decodeSingularMessageField(value: &self._maxPacketBytes)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_ZookeeperProxy_V3_ZooKeeperProxy, rhs: Envoy_Extensions_Filters_Network_ZookeeperProxy_V3_ZooKeeperProxy) -> Bool {
