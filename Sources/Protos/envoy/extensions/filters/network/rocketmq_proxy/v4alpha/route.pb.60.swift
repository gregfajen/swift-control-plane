...
public struct Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteConfiguration {
  ...
  public var routes: [Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_Route] = []
...
public struct Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_Route {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Route matching parameters.
  public var match: Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteMatch {
    get {return _match ?? Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteMatch()}
    set {_match = newValue}
  }
  ...
  public var route: Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteAction {
    get {return _route ?? Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteAction()}
    set {_route = newValue}
  }
  ...
  fileprivate var _match: Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteMatch? = nil
  fileprivate var _route: Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteAction? = nil
}

public struct Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteMatch {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The name of the topic.
  public var topic: Envoy_Type_Matcher_V4alpha_StringMatcher {
    get {return _topic ?? Envoy_Type_Matcher_V4alpha_StringMatcher()}
    set {_topic = newValue}
  }
  ...
  fileprivate var _topic: Envoy_Type_Matcher_V4alpha_StringMatcher? = nil
}

public struct Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteAction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteConfiguration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteConfiguration, rhs: Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteConfiguration) -> Bool {
...
extension Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_Route: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_Route, rhs: Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_Route) -> Bool {
...
extension Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteMatch, rhs: Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteMatch) -> Bool {
...
extension Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._metadataMatch) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteAction, rhs: Envoy_Extensions_Filters_Network_RocketmqProxy_V4alpha_RouteAction) -> Bool {
