...
public struct Envoy_Extensions_Filters_Network_MysqlProxy_V3_MySQLProxy {
...
fileprivate let _protobuf_package = "envoy.extensions.filters.network.mysql_proxy.v3"

extension Envoy_Extensions_Filters_Network_MysqlProxy_V3_MySQLProxy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MySQLProxy"
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_MysqlProxy_V3_MySQLProxy, rhs: Envoy_Extensions_Filters_Network_MysqlProxy_V3_MySQLProxy) -> Bool {
