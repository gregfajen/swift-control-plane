...
public struct Envoy_Extensions_Filters_Network_KafkaBroker_V3_KafkaBroker {
...
fileprivate let _protobuf_package = "envoy.extensions.filters.network.kafka_broker.v3"

extension Envoy_Extensions_Filters_Network_KafkaBroker_V3_KafkaBroker: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_KafkaBroker_V3_KafkaBroker, rhs: Envoy_Extensions_Filters_Network_KafkaBroker_V3_KafkaBroker) -> Bool {
