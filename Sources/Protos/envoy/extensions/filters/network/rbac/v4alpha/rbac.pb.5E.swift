...
public struct Envoy_Extensions_Filters_Network_Rbac_V4alpha_RBAC {
  ...
  public var enforcementType: Envoy_Extensions_Filters_Network_Rbac_V4alpha_RBAC.EnforcementType = .oneTimeOnFirstByte
...
extension Envoy_Extensions_Filters_Network_Rbac_V4alpha_RBAC.EnforcementType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Extensions_Filters_Network_Rbac_V4alpha_RBAC.EnforcementType] = [
    .oneTimeOnFirstByte,
    .continuous,
  ]
}
...
fileprivate let _protobuf_package = "envoy.extensions.filters.network.rbac.v4alpha"

extension Envoy_Extensions_Filters_Network_Rbac_V4alpha_RBAC: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_Rbac_V4alpha_RBAC, rhs: Envoy_Extensions_Filters_Network_Rbac_V4alpha_RBAC) -> Bool {
...
extension Envoy_Extensions_Filters_Network_Rbac_V4alpha_RBAC.EnforcementType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
