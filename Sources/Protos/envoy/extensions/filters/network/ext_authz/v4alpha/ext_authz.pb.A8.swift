...
/// [#next-free-field: 7]
public struct Envoy_Extensions_Filters_Network_ExtAuthz_V4alpha_ExtAuthz {
...
fileprivate let _protobuf_package = "envoy.extensions.filters.network.ext_authz.v4alpha"

extension Envoy_Extensions_Filters_Network_ExtAuthz_V4alpha_ExtAuthz: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_ExtAuthz_V4alpha_ExtAuthz, rhs: Envoy_Extensions_Filters_Network_ExtAuthz_V4alpha_ExtAuthz) -> Bool {
