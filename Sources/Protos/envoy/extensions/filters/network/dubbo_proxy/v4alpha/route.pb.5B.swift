...
extension Envoy_Extensions_Filters_Network_DubboProxy_V4alpha_MethodMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufUInt32,Envoy_Extensions_Filters_Network_DubboProxy_V4alpha_MethodMatch.ParameterMatchSpecifier>.self, value: &self.paramsMatch) }()
      default: break
      }
    }
  }
