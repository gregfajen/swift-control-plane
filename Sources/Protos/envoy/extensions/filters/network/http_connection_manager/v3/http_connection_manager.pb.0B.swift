...
/// [#next-free-field: 42]
public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Supplies the type of codec that the connection manager should use.
  public var codecType: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.CodecType {
  ...
  public var rds: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_Rds {
    get {
      if case .rds(let v)? = _storage._routeSpecifier {return v}
      return Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_Rds()
    }
    set {_uniqueStorage()._routeSpecifier = .rds(newValue)}
  }

  /// The route table for the connection manager is static and is specified in this property.
  public var routeConfig: Envoy_Config_Route_V3_RouteConfiguration {
    get {
  ...
  public var scopedRoutes: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes {
    get {
      if case .scopedRoutes(let v)? = _storage._routeSpecifier {return v}
      return Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes()
    }
  ...
  public var httpFilters: [Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpFilter] {
  ...
  public var tracing: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.Tracing {
    get {return _storage._tracing ?? Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.Tracing()}
  ...
  /// server_name.
  public var serverHeaderTransformation: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.ServerHeaderTransformation {
  ...
  public var requestHeadersTimeout: SwiftProtobuf.Google_Protobuf_Duration {
    get {return _storage._requestHeadersTimeout ?? SwiftProtobuf.Google_Protobuf_Duration()}
    set {_uniqueStorage()._requestHeadersTimeout = newValue}
  }
  /// Returns true if `requestHeadersTimeout` has been explicitly set.
  public var hasRequestHeadersTimeout: Bool {return _storage._requestHeadersTimeout != nil}
  /// Clears the value of `requestHeadersTimeout`. Subsequent reads from it will return its default value.
  public mutating func clearRequestHeadersTimeout() {_uniqueStorage()._requestHeadersTimeout = nil}
  ...
  public var internalAddressConfig: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.InternalAddressConfig {
    get {return _storage._internalAddressConfig ?? Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.InternalAddressConfig()}
  ...
  /// header.
  public var forwardClientCertDetails: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.ForwardClientCertDetails {
  ...
  /// value.
  public var setCurrentClientCertDetails: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.SetCurrentClientCertDetails {
    get {return _storage._setCurrentClientCertDetails ?? Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.SetCurrentClientCertDetails()}
  ...
  public var upgradeConfigs: [Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.UpgradeConfig] {
  ...
  public var requestIDExtension: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_RequestIDExtension {
    get {return _storage._requestIDExtension ?? Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_RequestIDExtension()}
  ...
  public var localReplyConfig: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_LocalReplyConfig {
    get {return _storage._localReplyConfig ?? Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_LocalReplyConfig()}
    set {_uniqueStorage()._localReplyConfig = newValue}
  }
  /// Returns true if `localReplyConfig` has been explicitly set.
  public var hasLocalReplyConfig: Bool {return _storage._localReplyConfig != nil}
  /// Clears the value of `localReplyConfig`. Subsequent reads from it will return its default value.
  public mutating func clearLocalReplyConfig() {_uniqueStorage()._localReplyConfig = nil}
  ...
  public var streamErrorOnInvalidHTTPMessage: SwiftProtobuf.Google_Protobuf_BoolValue {
    get {return _storage._streamErrorOnInvalidHTTPMessage ?? SwiftProtobuf.Google_Protobuf_BoolValue()}
    set {_uniqueStorage()._streamErrorOnInvalidHTTPMessage = newValue}
  }
  /// Returns true if `streamErrorOnInvalidHTTPMessage` has been explicitly set.
  public var hasStreamErrorOnInvalidHTTPMessage: Bool {return _storage._streamErrorOnInvalidHTTPMessage != nil}
  /// Clears the value of `streamErrorOnInvalidHTTPMessage`. Subsequent reads from it will return its default value.
  public mutating func clearStreamErrorOnInvalidHTTPMessage() {_uniqueStorage()._streamErrorOnInvalidHTTPMessage = nil}

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public enum OneOf_RouteSpecifier: Equatable {
    /// The connection manager’s route table will be dynamically loaded via the RDS API.
    case rds(Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_Rds)
    /// The route table for the connection manager is static and is specified in this property.
    case routeConfig(Envoy_Config_Route_V3_RouteConfiguration)
    /// A route table will be dynamically assigned to each request based on request attributes
    /// (e.g., the value of a header). The "routing scopes" (i.e., route tables) and "scope keys" are
    /// specified in this message.
    case scopedRoutes(Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.OneOf_RouteSpecifier, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.OneOf_RouteSpecifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.rds, .rds): return {
        guard case .rds(let l) = lhs, case .rds(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      ...
      case (.scopedRoutes, .scopedRoutes): return {
        guard case .scopedRoutes(let l) = lhs, case .scopedRoutes(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
  ...
  public struct Tracing {
    ...
    ///   on OpenCensus side.
    public var provider: Envoy_Config_Trace_V3_Tracing.Http {
      get {return _provider ?? Envoy_Config_Trace_V3_Tracing.Http()}
    ...
    fileprivate var _provider: Envoy_Config_Trace_V3_Tracing.Http? = nil
  }
  ...
  public struct UpgradeConfig {
    ...
    public var filters: [Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpFilter] = []
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.CodecType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.CodecType] = [
    .auto,
    .http1,
    .http2,
    .http3,
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.ServerHeaderTransformation: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.ServerHeaderTransformation] = [
    .overwrite,
    .appendIfAbsent,
    .passThrough,
  ]
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.ForwardClientCertDetails: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.ForwardClientCertDetails] = [
    .sanitize,
    .forwardOnly,
    .appendForward,
    .sanitizeSet,
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.Tracing.OperationName: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.Tracing.OperationName] = [
    .ingress,
    .egress,
  ]
}
...
public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_LocalReplyConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var mappers: [Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ResponseMapper] = []
  ...
  ///    "path": "/foo"
  ///  }
  public var bodyFormat: Envoy_Config_Core_V3_SubstitutionFormatString {
    get {return _bodyFormat ?? Envoy_Config_Core_V3_SubstitutionFormatString()}
    set {_bodyFormat = newValue}
  }
  /// Returns true if `bodyFormat` has been explicitly set.
  public var hasBodyFormat: Bool {return self._bodyFormat != nil}
  /// Clears the value of `bodyFormat`. Subsequent reads from it will return its default value.
  public mutating func clearBodyFormat() {self._bodyFormat = nil}

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _bodyFormat: Envoy_Config_Core_V3_SubstitutionFormatString? = nil
}

/// The configuration to filter and change local response.
/// [#next-free-field: 6]
public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ResponseMapper {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var statusCode: SwiftProtobuf.Google_Protobuf_UInt32Value {
    get {return _statusCode ?? SwiftProtobuf.Google_Protobuf_UInt32Value()}
    set {_statusCode = newValue}
  }
  /// Returns true if `statusCode` has been explicitly set.
  public var hasStatusCode: Bool {return self._statusCode != nil}
  ...
  public var bodyFormatOverride: Envoy_Config_Core_V3_SubstitutionFormatString {
    get {return _bodyFormatOverride ?? Envoy_Config_Core_V3_SubstitutionFormatString()}
    set {_bodyFormatOverride = newValue}
  }
  /// Returns true if `bodyFormatOverride` has been explicitly set.
  public var hasBodyFormatOverride: Bool {return self._bodyFormatOverride != nil}
  /// Clears the value of `bodyFormatOverride`. Subsequent reads from it will return its default value.
  public mutating func clearBodyFormatOverride() {self._bodyFormatOverride = nil}
  ...
  public var headersToAdd: [Envoy_Config_Core_V3_HeaderValueOption] = []
  ...
  fileprivate var _statusCode: SwiftProtobuf.Google_Protobuf_UInt32Value? = nil
  fileprivate var _body: Envoy_Config_Core_V3_DataSource? = nil
  fileprivate var _bodyFormatOverride: Envoy_Config_Core_V3_SubstitutionFormatString? = nil
}

public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_Rds {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// configurations.
  public var routeConfigName: String {
    get {return _storage._routeConfigName}
    set {_uniqueStorage()._routeConfigName = newValue}
  }

  /// Resource locator for RDS. This is mutually exclusive to *route_config_name*.
  /// [#not-implemented-hide:]
  public var rdsResourceLocator: Udpa_Core_V1_ResourceLocator {
    get {return _storage._rdsResourceLocator ?? Udpa_Core_V1_ResourceLocator()}
    set {_uniqueStorage()._rdsResourceLocator = newValue}
  }
  /// Returns true if `rdsResourceLocator` has been explicitly set.
  public var hasRdsResourceLocator: Bool {return _storage._rdsResourceLocator != nil}
  /// Clears the value of `rdsResourceLocator`. Subsequent reads from it will return its default value.
  public mutating func clearRdsResourceLocator() {_uniqueStorage()._rdsResourceLocator = nil}
...
public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRouteConfigurationsList {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var scopedRouteConfigurations: [Envoy_Config_Route_V3_ScopedRouteConfiguration] = []
...
/// [#next-free-field: 6]
public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var scopeKeyBuilder: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder {
    get {return _storage._scopeKeyBuilder ?? Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder()}
    set {_uniqueStorage()._scopeKeyBuilder = newValue}
  }
  /// Returns true if `scopeKeyBuilder` has been explicitly set.
  public var hasScopeKeyBuilder: Bool {return _storage._scopeKeyBuilder != nil}
  /// Clears the value of `scopeKeyBuilder`. Subsequent reads from it will return its default value.
  public mutating func clearScopeKeyBuilder() {_uniqueStorage()._scopeKeyBuilder = nil}

  /// Configuration source specifier for RDS.
  /// This config source is used to subscribe to RouteConfiguration resources specified in
  /// ScopedRouteConfiguration messages.
  public var rdsConfigSource: Envoy_Config_Core_V3_ConfigSource {
    get {return _storage._rdsConfigSource ?? Envoy_Config_Core_V3_ConfigSource()}
    set {_uniqueStorage()._rdsConfigSource = newValue}
  }
  /// Returns true if `rdsConfigSource` has been explicitly set.
  public var hasRdsConfigSource: Bool {return _storage._rdsConfigSource != nil}
  /// Clears the value of `rdsConfigSource`. Subsequent reads from it will return its default value.
  public mutating func clearRdsConfigSource() {_uniqueStorage()._rdsConfigSource = nil}

  public var configSpecifier: OneOf_ConfigSpecifier? {
    get {return _storage._configSpecifier}
    set {_uniqueStorage()._configSpecifier = newValue}
  }
  ...
  /// in this message.
  public var scopedRouteConfigurationsList: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRouteConfigurationsList {
    get {
      if case .scopedRouteConfigurationsList(let v)? = _storage._configSpecifier {return v}
      return Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRouteConfigurationsList()
    }
    set {_uniqueStorage()._configSpecifier = .scopedRouteConfigurationsList(newValue)}
  }
  ...
  /// :ref:`ScopeKeyBuilder<envoy_api_msg_extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder>`
  /// in this message.
  public var scopedRds: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRds {
    get {
      if case .scopedRds(let v)? = _storage._configSpecifier {return v}
      return Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRds()
    }
    set {_uniqueStorage()._configSpecifier = .scopedRds(newValue)}
  }
  ...
  public enum OneOf_ConfigSpecifier: Equatable {
    ...
    /// :ref:`ScopeKeyBuilder<envoy_api_msg_extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder>`
    /// in this message.
    case scopedRouteConfigurationsList(Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRouteConfigurationsList)
    /// The set of routing scopes associated with the HCM will be dynamically loaded via the SRDS
    /// API. A scope is assigned to a request by matching a key constructed from the request's
    /// attributes according to the algorithm specified by the
    /// :ref:`ScopeKeyBuilder<envoy_api_msg_extensions.filters.network.http_connection_manager.v3.ScopedRoutes.ScopeKeyBuilder>`
    /// in this message.
    case scopedRds(Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRds)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.OneOf_ConfigSpecifier, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.OneOf_ConfigSpecifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.scopedRouteConfigurationsList, .scopedRouteConfigurationsList): return {
        guard case .scopedRouteConfigurationsList(let l) = lhs, case .scopedRouteConfigurationsList(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.scopedRds, .scopedRds): return {
        guard case .scopedRds(let l) = lhs, case .scopedRds(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
  ...
  public struct ScopeKeyBuilder {
    ...
    public var fragments: [Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder] = []
    ...
    public struct FragmentBuilder {
      ...
      public var type: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.OneOf_Type? = nil

      /// Specifies how a header field's value should be extracted.
      public var headerValueExtractor: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor {
        get {
          if case .headerValueExtractor(let v)? = type {return v}
          return Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor()
        }
      ...
      public enum OneOf_Type: Equatable {
        /// Specifies how a header field's value should be extracted.
        case headerValueExtractor(Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor)

      #if !swift(>=4.1)
        public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.OneOf_Type, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.OneOf_Type) -> Bool {
          // The use of inline closures is to circumvent an issue where the compiler
          // allocates stack space for every case branch when no optimizations are
          // enabled. https://github.com/apple/swift-protobuf/issues/1034
          switch (lhs, rhs) {
          case (.headerValueExtractor, .headerValueExtractor): return {
            guard case .headerValueExtractor(let l) = lhs, case .headerValueExtractor(let r) = rhs else { preconditionFailure() }
            return l == r
          }()
          }
        }
      ...
      public struct HeaderValueExtractor {
        ...
        public var extractType: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.OneOf_ExtractType? = nil
        ...
        public var element: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement {
          get {
            if case .element(let v)? = extractType {return v}
            return Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement()
          }
        ...
        public enum OneOf_ExtractType: Equatable {
          ...
          case index(UInt32)
          /// Specifies the key value pair to extract the value from.
          case element(Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement)

        #if !swift(>=4.1)
          public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.OneOf_ExtractType, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.OneOf_ExtractType) -> Bool {
            // The use of inline closures is to circumvent an issue where the compiler
            // allocates stack space for every case branch when no optimizations are
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch (lhs, rhs) {
...
public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRds {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Configuration source specifier for scoped RDS.
  public var scopedRdsConfigSource: Envoy_Config_Core_V3_ConfigSource {
    get {return _scopedRdsConfigSource ?? Envoy_Config_Core_V3_ConfigSource()}
  ...
  fileprivate var _scopedRdsConfigSource: Envoy_Config_Core_V3_ConfigSource? = nil
}

/// [#next-free-field: 6]
public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var configType: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpFilter.OneOf_ConfigType? = nil
  ...
  public var configDiscovery: Envoy_Config_Core_V3_ExtensionConfigSource {
    get {
      if case .configDiscovery(let v)? = configType {return v}
      return Envoy_Config_Core_V3_ExtensionConfigSource()
    }
    set {configType = .configDiscovery(newValue)}
  }
  ...
  public enum OneOf_ConfigType: Equatable {
    ...
    /// In case of a failure and without the default configuration, the HTTP listener responds with code 500.
    /// Extension configs delivered through this mechanism are not expected to require warming (see https://github.com/envoyproxy/envoy/issues/12061).
    case configDiscovery(Envoy_Config_Core_V3_ExtensionConfigSource)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpFilter.OneOf_ConfigType, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpFilter.OneOf_ConfigType) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      ...
      case (.configDiscovery, .configDiscovery): return {
        guard case .configDiscovery(let l) = lhs, case .configDiscovery(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_RequestIDExtension {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "envoy.extensions.filters.network.http_connection_manager.v3"

extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    41: .standard(proto: "request_headers_timeout"),
    ...
    38: .standard(proto: "local_reply_config"),
    39: .standard(proto: "strip_matching_host_port"),
    40: .standard(proto: "stream_error_on_invalid_http_message"),
  ]

  fileprivate class _StorageClass {
    var _codecType: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.CodecType = .auto
    var _statPrefix: String = String()
    var _routeSpecifier: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.OneOf_RouteSpecifier?
    var _httpFilters: [Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpFilter] = []
    var _addUserAgent: SwiftProtobuf.Google_Protobuf_BoolValue? = nil
    var _tracing: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.Tracing? = nil
    ...
    var _serverHeaderTransformation: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.ServerHeaderTransformation = .overwrite
    ...
    var _requestHeadersTimeout: SwiftProtobuf.Google_Protobuf_Duration? = nil
    ...
    var _internalAddressConfig: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.InternalAddressConfig? = nil
    ...
    var _forwardClientCertDetails: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.ForwardClientCertDetails = .sanitize
    var _setCurrentClientCertDetails: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.SetCurrentClientCertDetails? = nil
    var _proxy100Continue: Bool = false
    var _representIpv4RemoteAddressAsIpv4MappedIpv6: Bool = false
    var _upgradeConfigs: [Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.UpgradeConfig] = []
    var _normalizePath: SwiftProtobuf.Google_Protobuf_BoolValue? = nil
    var _mergeSlashes: Bool = false
    var _requestIDExtension: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_RequestIDExtension? = nil
    var _localReplyConfig: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_LocalReplyConfig? = nil
    var _stripMatchingHostPort: Bool = false
    var _streamErrorOnInvalidHTTPMessage: SwiftProtobuf.Google_Protobuf_BoolValue? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _requestHeadersTimeout = source._requestHeadersTimeout
      ...
      _localReplyConfig = source._localReplyConfig
      _stripMatchingHostPort = source._stripMatchingHostPort
      _streamErrorOnInvalidHTTPMessage = source._streamErrorOnInvalidHTTPMessage
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularEnumField(value: &_storage._codecType) }()
        case 2: try { try decoder.decodeSingularStringField(value: &_storage._statPrefix) }()
        case 3: try {
          var v: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_Rds?
        ...
        case 4: try {
          var v: Envoy_Config_Route_V3_RouteConfiguration?
          if let current = _storage._routeSpecifier {
            try decoder.handleConflictingOneOf()
        ...
        case 5: try { try decoder.decodeRepeatedMessageField(value: &_storage._httpFilters) }()
        case 6: try { try decoder.decodeSingularMessageField(value: &_storage._addUserAgent) }()
        case 7: try { try decoder.decodeSingularMessageField(value: &_storage._tracing) }()
        case 8: try { try decoder.decodeSingularMessageField(value: &_storage._httpProtocolOptions) }()
        case 9: try { try decoder.decodeSingularMessageField(value: &_storage._http2ProtocolOptions) }()
        case 10: try { try decoder.decodeSingularStringField(value: &_storage._serverName) }()
        case 12: try { try decoder.decodeSingularMessageField(value: &_storage._drainTimeout) }()
        case 13: try { try decoder.decodeRepeatedMessageField(value: &_storage._accessLog) }()
        case 14: try { try decoder.decodeSingularMessageField(value: &_storage._useRemoteAddress) }()
        case 15: try { try decoder.decodeSingularMessageField(value: &_storage._generateRequestID) }()
        case 16: try { try decoder.decodeSingularEnumField(value: &_storage._forwardClientCertDetails) }()
        case 17: try { try decoder.decodeSingularMessageField(value: &_storage._setCurrentClientCertDetails) }()
        case 18: try { try decoder.decodeSingularBoolField(value: &_storage._proxy100Continue) }()
        case 19: try { try decoder.decodeSingularUInt32Field(value: &_storage._xffNumTrustedHops) }()
        case 20: try { try decoder.decodeSingularBoolField(value: &_storage._representIpv4RemoteAddressAsIpv4MappedIpv6) }()
        case 21: try { try decoder.decodeSingularBoolField(value: &_storage._skipXffAppend) }()
        case 22: try { try decoder.decodeSingularStringField(value: &_storage._via) }()
        case 23: try { try decoder.decodeRepeatedMessageField(value: &_storage._upgradeConfigs) }()
        case 24: try { try decoder.decodeSingularMessageField(value: &_storage._streamIdleTimeout) }()
        case 25: try { try decoder.decodeSingularMessageField(value: &_storage._internalAddressConfig) }()
        case 26: try { try decoder.decodeSingularMessageField(value: &_storage._delayedCloseTimeout) }()
        case 28: try { try decoder.decodeSingularMessageField(value: &_storage._requestTimeout) }()
        case 29: try { try decoder.decodeSingularMessageField(value: &_storage._maxRequestHeadersKb) }()
        case 30: try { try decoder.decodeSingularMessageField(value: &_storage._normalizePath) }()
        case 31: try {
          var v: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes?
          if let current = _storage._routeSpecifier {
            try decoder.handleConflictingOneOf()
        ...
        case 32: try { try decoder.decodeSingularBoolField(value: &_storage._preserveExternalRequestID) }()
        case 33: try { try decoder.decodeSingularBoolField(value: &_storage._mergeSlashes) }()
        case 34: try { try decoder.decodeSingularEnumField(value: &_storage._serverHeaderTransformation) }()
        case 35: try { try decoder.decodeSingularMessageField(value: &_storage._commonHTTPProtocolOptions) }()
        case 36: try { try decoder.decodeSingularMessageField(value: &_storage._requestIDExtension) }()
        case 37: try { try decoder.decodeSingularBoolField(value: &_storage._alwaysSetRequestIDInResponse) }()
        case 38: try { try decoder.decodeSingularMessageField(value: &_storage._localReplyConfig) }()
        case 39: try { try decoder.decodeSingularBoolField(value: &_storage._stripMatchingHostPort) }()
        case 40: try { try decoder.decodeSingularMessageField(value: &_storage._streamErrorOnInvalidHTTPMessage) }()
        case 41: try { try decoder.decodeSingularMessageField(value: &_storage._requestHeadersTimeout) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .rds?: try {
        guard case .rds(let v)? = _storage._routeSpecifier else { preconditionFailure() }
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      }()
      case .routeConfig?: try {
        guard case .routeConfig(let v)? = _storage._routeSpecifier else { preconditionFailure() }
      ...
      if let v = _storage._localReplyConfig {
      ...
      if let v = _storage._streamErrorOnInvalidHTTPMessage {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 40)
      }
      if let v = _storage._requestHeadersTimeout {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._requestHeadersTimeout != rhs_storage._requestHeadersTimeout {return false}
        ...
        if _storage._localReplyConfig != rhs_storage._localReplyConfig {return false}
        if _storage._stripMatchingHostPort != rhs_storage._stripMatchingHostPort {return false}
        if _storage._streamErrorOnInvalidHTTPMessage != rhs_storage._streamErrorOnInvalidHTTPMessage {return false}
        return true
      }
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.CodecType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "AUTO"),
    1: .same(proto: "HTTP1"),
    2: .same(proto: "HTTP2"),
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.ServerHeaderTransformation: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.ForwardClientCertDetails: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.Tracing: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.protoMessageName + ".Tracing"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 3: try { try decoder.decodeSingularMessageField(value: &self._clientSampling) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._randomSampling) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._overallSampling) }()
      case 6: try { try decoder.decodeSingularBoolField(value: &self.verbose) }()
      case 7: try { try decoder.decodeSingularMessageField(value: &self._maxPathTagLength) }()
      case 8: try { try decoder.decodeRepeatedMessageField(value: &self.customTags) }()
      case 9: try { try decoder.decodeSingularMessageField(value: &self._provider) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.Tracing, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.Tracing) -> Bool {
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.Tracing.OperationName: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.InternalAddressConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.protoMessageName + ".InternalAddressConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.unixSockets) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.InternalAddressConfig, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.InternalAddressConfig) -> Bool {
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.SetCurrentClientCertDetails: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.protoMessageName + ".SetCurrentClientCertDetails"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularBoolField(value: &self.cert) }()
      case 4: try { try decoder.decodeSingularBoolField(value: &self.dns) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self.uri) }()
      case 6: try { try decoder.decodeSingularBoolField(value: &self.chain) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.SetCurrentClientCertDetails, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.SetCurrentClientCertDetails) -> Bool {
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.UpgradeConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.protoMessageName + ".UpgradeConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularMessageField(value: &self._enabled) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.UpgradeConfig, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpConnectionManager.UpgradeConfig) -> Bool {
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_LocalReplyConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".LocalReplyConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "mappers"),
    2: .standard(proto: "body_format"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.mappers) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._bodyFormat) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.mappers.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.mappers, fieldNumber: 1)
    }
    if let v = self._bodyFormat {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_LocalReplyConfig, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_LocalReplyConfig) -> Bool {
    if lhs.mappers != rhs.mappers {return false}
    if lhs._bodyFormat != rhs._bodyFormat {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ResponseMapper: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ResponseMapper"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "filter"),
    2: .standard(proto: "status_code"),
    3: .same(proto: "body"),
    4: .standard(proto: "body_format_override"),
    5: .standard(proto: "headers_to_add"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._statusCode) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._body) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._bodyFormatOverride) }()
      case 5: try { try decoder.decodeRepeatedMessageField(value: &self.headersToAdd) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._bodyFormatOverride {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }
    if !self.headersToAdd.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.headersToAdd, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ResponseMapper, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ResponseMapper) -> Bool {
    if lhs._filter != rhs._filter {return false}
    if lhs._statusCode != rhs._statusCode {return false}
    if lhs._body != rhs._body {return false}
    if lhs._bodyFormatOverride != rhs._bodyFormatOverride {return false}
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_Rds: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .standard(proto: "rds_resource_locator"),
  ]

  fileprivate class _StorageClass {
    var _configSource: Envoy_Config_Core_V3_ConfigSource? = nil
    var _routeConfigName: String = String()
    var _rdsResourceLocator: Udpa_Core_V1_ResourceLocator? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _routeConfigName = source._routeConfigName
      _rdsResourceLocator = source._rdsResourceLocator
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularStringField(value: &_storage._routeConfigName) }()
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._rdsResourceLocator) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._routeConfigName.isEmpty {
        try visitor.visitSingularStringField(value: _storage._routeConfigName, fieldNumber: 2)
      }
      if let v = _storage._rdsResourceLocator {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_Rds, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_Rds) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._configSource != rhs_storage._configSource {return false}
        if _storage._routeConfigName != rhs_storage._routeConfigName {return false}
        if _storage._rdsResourceLocator != rhs_storage._rdsResourceLocator {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRouteConfigurationsList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.scopedRouteConfigurations) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRouteConfigurationsList, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRouteConfigurationsList) -> Bool {
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _scopeKeyBuilder: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder? = nil
    var _rdsConfigSource: Envoy_Config_Core_V3_ConfigSource? = nil
    var _configSpecifier: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.OneOf_ConfigSpecifier?
    ...
    init(copying source: _StorageClass) {
      _name = source._name
      _scopeKeyBuilder = source._scopeKeyBuilder
      _rdsConfigSource = source._rdsConfigSource
      _configSpecifier = source._configSpecifier
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._scopeKeyBuilder) }()
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._rdsConfigSource) }()
        case 4: try {
          var v: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRouteConfigurationsList?
          if let current = _storage._configSpecifier {
            try decoder.handleConflictingOneOf()
            if case .scopedRouteConfigurationsList(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._configSpecifier = .scopedRouteConfigurationsList(v)}
        }()
        case 5: try {
          var v: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRds?
          if let current = _storage._configSpecifier {
            try decoder.handleConflictingOneOf()
            if case .scopedRds(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._configSpecifier = .scopedRds(v)}
        }()
        default: break
        }
      }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._scopeKeyBuilder {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
      }
      if let v = _storage._rdsConfigSource {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      }
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch _storage._configSpecifier {
      case .scopedRouteConfigurationsList?: try {
        guard case .scopedRouteConfigurationsList(let v)? = _storage._configSpecifier else { preconditionFailure() }
        try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
      }()
      case .scopedRds?: try {
        guard case .scopedRds(let v)? = _storage._configSpecifier else { preconditionFailure() }
        try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
      }()
      case nil: break
      }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._name != rhs_storage._name {return false}
        if _storage._scopeKeyBuilder != rhs_storage._scopeKeyBuilder {return false}
        if _storage._rdsConfigSource != rhs_storage._rdsConfigSource {return false}
        if _storage._configSpecifier != rhs_storage._configSpecifier {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.protoMessageName + ".ScopeKeyBuilder"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder) -> Bool {
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.protoMessageName + ".FragmentBuilder"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor?
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder) -> Bool {
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.protoMessageName + ".HeaderValueExtractor"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.elementSeparator) }()
      case 3: try {
      ...
      case 4: try {
        var v: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement?
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .index?: try {
      guard case .index(let v)? = self.extractType else { preconditionFailure() }
      try visitor.visitSingularUInt32Field(value: v, fieldNumber: 3)
    }()
    case .element?: try {
      guard case .element(let v)? = self.extractType else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }()
    case nil: break
    }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor) -> Bool {
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.protoMessageName + ".KvElement"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.separator) }()
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.HeaderValueExtractor.KvElement) -> Bool {
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRds: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._scopedRdsConfigSource) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRds, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_ScopedRds) -> Bool {
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".HttpFilter"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    4: .standard(proto: "typed_config"),
    5: .standard(proto: "config_discovery"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try {
        var v: Envoy_Config_Core_V3_ExtensionConfigSource?
        if let current = self.configType {
          try decoder.handleConflictingOneOf()
          if case .configDiscovery(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.configType = .configDiscovery(v)}
      }()
      default: break
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .configDiscovery?: try {
      guard case .configDiscovery(let v)? = self.configType else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
    }()
    case nil: break
    }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpFilter, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_HttpFilter) -> Bool {
    if lhs.name != rhs.name {return false}
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_RequestIDExtension: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_RequestIDExtension, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V3_RequestIDExtension) -> Bool {
