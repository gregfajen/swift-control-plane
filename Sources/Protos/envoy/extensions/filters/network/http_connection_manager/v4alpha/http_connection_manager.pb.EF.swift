...
public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_HttpConnectionManager {
  ...
  public var localReplyConfig: Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_LocalReplyConfig {
    get {return _storage._localReplyConfig ?? Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_LocalReplyConfig()}
...
public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_LocalReplyConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var mappers: [Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_ResponseMapper] = []
  ...
  ///    "path": "/foo"
  ///  }
  public var bodyFormat: Envoy_Config_Core_V4alpha_SubstitutionFormatString {
    get {return _bodyFormat ?? Envoy_Config_Core_V4alpha_SubstitutionFormatString()}
  ...
  fileprivate var _bodyFormat: Envoy_Config_Core_V4alpha_SubstitutionFormatString? = nil
}

/// The configuration to filter and change local response.
/// [#next-free-field: 6]
public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_ResponseMapper {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Filter to determine if this mapper should apply.
  public var filter: Envoy_Config_Accesslog_V4alpha_AccessLogFilter {
    get {return _filter ?? Envoy_Config_Accesslog_V4alpha_AccessLogFilter()}
  ...
  public var bodyFormatOverride: Envoy_Config_Core_V4alpha_SubstitutionFormatString {
    get {return _bodyFormatOverride ?? Envoy_Config_Core_V4alpha_SubstitutionFormatString()}
  ...
  public var headersToAdd: [Envoy_Config_Core_V4alpha_HeaderValueOption] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _filter: Envoy_Config_Accesslog_V4alpha_AccessLogFilter? = nil
  ...
  fileprivate var _bodyFormatOverride: Envoy_Config_Core_V4alpha_SubstitutionFormatString? = nil
}
...
public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_Rds {
  ...
  public var configSource: Envoy_Config_Core_V4alpha_ConfigSource {
    get {return _storage._configSource ?? Envoy_Config_Core_V4alpha_ConfigSource()}
  ...
  public var routeConfigName: String {
    get {
      if case .routeConfigName(let v)? = _storage._nameSpecifier {return v}
      return String()
    }
    set {_uniqueStorage()._nameSpecifier = .routeConfigName(newValue)}
  }
  ...
  public var rdsResourceLocator: Udpa_Core_V1_ResourceLocator {
    get {
      if case .rdsResourceLocator(let v)? = _storage._nameSpecifier {return v}
      return Udpa_Core_V1_ResourceLocator()
    }
    set {_uniqueStorage()._nameSpecifier = .rdsResourceLocator(newValue)}
  }
  ...
  public enum OneOf_NameSpecifier: Equatable {
    ...
    /// associated HTTP connection manager filters) to use different route
    /// configurations.
    case routeConfigName(String)
    /// Resource locator for RDS. This is mutually exclusive to *route_config_name*.
    /// [#not-implemented-hide:]
    case rdsResourceLocator(Udpa_Core_V1_ResourceLocator)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_Rds.OneOf_NameSpecifier, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_Rds.OneOf_NameSpecifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.routeConfigName, .routeConfigName): return {
        guard case .routeConfigName(let l) = lhs, case .routeConfigName(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.rdsResourceLocator, .rdsResourceLocator): return {
        guard case .rdsResourceLocator(let l) = lhs, case .rdsResourceLocator(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_ScopedRoutes {
  ...
  public var scopeKeyBuilder: Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_ScopedRoutes.ScopeKeyBuilder {
    get {return _storage._scopeKeyBuilder ?? Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_ScopedRoutes.ScopeKeyBuilder()}
  ...
  public var rdsConfigSource: Envoy_Config_Core_V4alpha_ConfigSource {
    get {return _storage._rdsConfigSource ?? Envoy_Config_Core_V4alpha_ConfigSource()}
...
public struct Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_HttpFilter {
  ...
  public var configDiscovery: Envoy_Config_Core_V4alpha_ExtensionConfigSource {
    get {
      if case .configDiscovery(let v)? = configType {return v}
      return Envoy_Config_Core_V4alpha_ExtensionConfigSource()
    }
  ...
  public enum OneOf_ConfigType: Equatable {
    ...
    /// In case of a failure and without the default configuration, the HTTP listener responds with code 500.
    /// Extension configs delivered through this mechanism are not expected to require warming (see https://github.com/envoyproxy/envoy/issues/12061).
    case configDiscovery(Envoy_Config_Core_V4alpha_ExtensionConfigSource)
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_HttpConnectionManager: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _localReplyConfig: Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_LocalReplyConfig? = nil
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_LocalReplyConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_LocalReplyConfig, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_LocalReplyConfig) -> Bool {
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_ResponseMapper: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_ResponseMapper, rhs: Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_ResponseMapper) -> Bool {
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_Rds: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _configSource: Envoy_Config_Core_V4alpha_ConfigSource? = nil
    var _nameSpecifier: Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_Rds.OneOf_NameSpecifier?
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try {
          ...
          if let v = v {_storage._nameSpecifier = .routeConfigName(v)}
        }()
        case 3: try {
          var v: Udpa_Core_V1_ResourceLocator?
          if let current = _storage._nameSpecifier {
            try decoder.handleConflictingOneOf()
            if case .rdsResourceLocator(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._nameSpecifier = .rdsResourceLocator(v)}
        }()
        default: break
        }
      }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .routeConfigName?: try {
        guard case .routeConfigName(let v)? = _storage._nameSpecifier else { preconditionFailure() }
        try visitor.visitSingularStringField(value: v, fieldNumber: 2)
      }()
      case .rdsResourceLocator?: try {
        guard case .rdsResourceLocator(let v)? = _storage._nameSpecifier else { preconditionFailure() }
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      }()
      case nil: break
      }
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_ScopedRoutes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _scopeKeyBuilder: Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_ScopedRoutes.ScopeKeyBuilder? = nil
    var _rdsConfigSource: Envoy_Config_Core_V4alpha_ConfigSource? = nil
    var _configSpecifier: Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_ScopedRoutes.OneOf_ConfigSpecifier?
...
extension Envoy_Extensions_Filters_Network_HttpConnectionManager_V4alpha_HttpFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try {
        var v: Envoy_Config_Core_V4alpha_ExtensionConfigSource?
        if let current = self.configType {
          try decoder.handleConflictingOneOf()
