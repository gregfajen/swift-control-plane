...
public enum Envoy_Extensions_Filters_Network_ThriftProxy_V3_TransportType: SwiftProtobuf.Enum {
...
extension Envoy_Extensions_Filters_Network_ThriftProxy_V3_TransportType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Extensions_Filters_Network_ThriftProxy_V3_TransportType] = [
    .autoTransport,
    .framed,
    .unframed,
    .header,
...
public enum Envoy_Extensions_Filters_Network_ThriftProxy_V3_ProtocolType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Envoy_Extensions_Filters_Network_ThriftProxy_V3_ProtocolType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Extensions_Filters_Network_ThriftProxy_V3_ProtocolType] = [
    .autoProtocol,
    .binary,
    .laxBinary,
    .compact,
...
/// [#next-free-field: 6]
public struct Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftProxy {
  ...
  public var transport: Envoy_Extensions_Filters_Network_ThriftProxy_V3_TransportType = .autoTransport
  ...
  public var `protocol`: Envoy_Extensions_Filters_Network_ThriftProxy_V3_ProtocolType = .autoProtocol

  /// The human readable prefix to use when emitting statistics.
  public var statPrefix: String = String()

  /// The route table for the connection manager is static and is specified in this property.
  public var routeConfig: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteConfiguration {
    get {return _routeConfig ?? Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteConfiguration()}
  ...
  public var thriftFilters: [Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftFilter] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _routeConfig: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteConfiguration? = nil
}

/// ThriftFilter configures a Thrift filter.
public struct Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var configType: Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftFilter.OneOf_ConfigType? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftFilter.OneOf_ConfigType, rhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftFilter.OneOf_ConfigType) -> Bool {
      switch (lhs, rhs) {
...
public struct Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftProtocolOptions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Envoy_Extensions_Filters_Network_ThriftProxy_V3_TransportType: SwiftProtobuf._ProtoNameProviding {
...
extension Envoy_Extensions_Filters_Network_ThriftProxy_V3_ProtocolType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftProxy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftProxy, rhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftProxy) -> Bool {
...
extension Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftFilter, rhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftFilter) -> Bool {
...
extension Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftProtocolOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftProtocolOptions, rhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_ThriftProtocolOptions) -> Bool {
    if lhs.transport != rhs.transport {return false}
    if lhs.`protocol` != rhs.`protocol` {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
