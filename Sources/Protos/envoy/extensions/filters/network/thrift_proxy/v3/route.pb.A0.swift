...
public struct Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteConfiguration {
  ...
  public var routes: [Envoy_Extensions_Filters_Network_ThriftProxy_V3_Route] = []
...
public struct Envoy_Extensions_Filters_Network_ThriftProxy_V3_Route {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Route matching parameters.
  public var match: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteMatch {
    get {return _match ?? Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteMatch()}
    set {_match = newValue}
  }
  ...
  public var route: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteAction {
    get {return _route ?? Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteAction()}
    set {_route = newValue}
  }
  ...
  fileprivate var _match: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteMatch? = nil
  fileprivate var _route: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteAction? = nil
}

public struct Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteMatch {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var matchSpecifier: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteMatch.OneOf_MatchSpecifier? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteMatch.OneOf_MatchSpecifier, rhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteMatch.OneOf_MatchSpecifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.methodName, .methodName): return {
        guard case .methodName(let l) = lhs, case .methodName(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
/// [#next-free-field: 7]
public struct Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteAction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var clusterSpecifier: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteAction.OneOf_ClusterSpecifier? = nil
  ...
  public var weightedClusters: Envoy_Extensions_Filters_Network_ThriftProxy_V3_WeightedCluster {
    get {
      if case .weightedClusters(let v)? = clusterSpecifier {return v}
      return Envoy_Extensions_Filters_Network_ThriftProxy_V3_WeightedCluster()
    }
  ...
  public enum OneOf_ClusterSpecifier: Equatable {
    ...
    /// request is routed to one of the upstream clusters based on weights
    /// assigned to each cluster.
    case weightedClusters(Envoy_Extensions_Filters_Network_ThriftProxy_V3_WeightedCluster)
    /// Envoy will determine the cluster to route to by reading the value of the
    /// Thrift header named by cluster_header from the request headers. If the
    /// header is not found or the referenced cluster does not exist Envoy will
    /// respond with an unknown method exception or an internal error exception,
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteAction.OneOf_ClusterSpecifier, rhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteAction.OneOf_ClusterSpecifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Envoy_Extensions_Filters_Network_ThriftProxy_V3_WeightedCluster {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Specifies one or more upstream clusters associated with the route.
  public var clusters: [Envoy_Extensions_Filters_Network_ThriftProxy_V3_WeightedCluster.ClusterWeight] = []
...
fileprivate let _protobuf_package = "envoy.extensions.filters.network.thrift_proxy.v3"

extension Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteConfiguration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteConfiguration, rhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteConfiguration) -> Bool {
...
extension Envoy_Extensions_Filters_Network_ThriftProxy_V3_Route: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_Route, rhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_Route) -> Bool {
...
extension Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteMatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .methodName?: try {
      guard case .methodName(let v)? = self.matchSpecifier else { preconditionFailure() }
      try visitor.visitSingularStringField(value: v, fieldNumber: 1)
    }()
    case .serviceName?: try {
      guard case .serviceName(let v)? = self.matchSpecifier else { preconditionFailure() }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteMatch, rhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteMatch) -> Bool {
...
extension Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Envoy_Extensions_Filters_Network_ThriftProxy_V3_WeightedCluster?
      ...
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.rateLimits) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self.stripServiceName) }()
      case 6: try {
        if self.clusterSpecifier != nil {try decoder.handleConflictingOneOf()}
        var v: String?
        try decoder.decodeSingularStringField(value: &v)
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteAction, rhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_RouteAction) -> Bool {
...
extension Envoy_Extensions_Filters_Network_ThriftProxy_V3_WeightedCluster: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_WeightedCluster, rhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_WeightedCluster) -> Bool {
...
extension Envoy_Extensions_Filters_Network_ThriftProxy_V3_WeightedCluster.ClusterWeight: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Network_ThriftProxy_V3_WeightedCluster.protoMessageName + ".ClusterWeight"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .same(proto: "weight"),
    3: .standard(proto: "metadata_match"),
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_WeightedCluster.ClusterWeight, rhs: Envoy_Extensions_Filters_Network_ThriftProxy_V3_WeightedCluster.ClusterWeight) -> Bool {
    if lhs.name != rhs.name {return false}
