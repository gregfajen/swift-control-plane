...
public struct Envoy_Extensions_Filters_Network_ClientSslAuth_V3_ClientSSLAuth {
  ...
  /// IP white list.
  public var ipWhiteList: [Envoy_Config_Core_V3_CidrRange] = []
...
fileprivate let _protobuf_package = "envoy.extensions.filters.network.client_ssl_auth.v3"

extension Envoy_Extensions_Filters_Network_ClientSslAuth_V3_ClientSSLAuth: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.authApiCluster)
      case 2: try decoder.decodeSingularStringField(value: &self.statPrefix)
      case 3: try decoder.decodeSingularMessageField(value: &self._refreshDelay)
      case 4: try decoder.decodeRepeatedMessageField(value: &self.ipWhiteList)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_ClientSslAuth_V3_ClientSSLAuth, rhs: Envoy_Extensions_Filters_Network_ClientSslAuth_V3_ClientSSLAuth) -> Bool {
