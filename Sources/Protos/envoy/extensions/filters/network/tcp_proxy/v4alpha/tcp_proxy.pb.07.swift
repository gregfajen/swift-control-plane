...
/// [#next-free-field: 14]
public struct Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy {
  ...
  public var clusterSpecifier: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.OneOf_ClusterSpecifier? = nil
  ...
  public var weightedClusters: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.WeightedCluster {
    get {
      if case .weightedClusters(let v)? = clusterSpecifier {return v}
      return Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.WeightedCluster()
    }
  ...
  public var tunnelingConfig: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.TunnelingConfig {
    get {return _tunnelingConfig ?? Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.TunnelingConfig()}
  ...
  public var maxDownstreamConnectionDuration: SwiftProtobuf.Google_Protobuf_Duration {
    get {return _maxDownstreamConnectionDuration ?? SwiftProtobuf.Google_Protobuf_Duration()}
    set {_maxDownstreamConnectionDuration = newValue}
  }
  /// Returns true if `maxDownstreamConnectionDuration` has been explicitly set.
  public var hasMaxDownstreamConnectionDuration: Bool {return self._maxDownstreamConnectionDuration != nil}
  /// Clears the value of `maxDownstreamConnectionDuration`. Subsequent reads from it will return its default value.
  public mutating func clearMaxDownstreamConnectionDuration() {self._maxDownstreamConnectionDuration = nil}
  ...
  public enum OneOf_ClusterSpecifier: Equatable {
    ...
    /// request is routed to one of the upstream clusters based on weights
    /// assigned to each cluster.
    case weightedClusters(Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.WeightedCluster)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.OneOf_ClusterSpecifier, rhs: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.OneOf_ClusterSpecifier) -> Bool {
  ...
  public struct WeightedCluster {
    ...
    public var clusters: [Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.WeightedCluster.ClusterWeight] = []
  ...
  fileprivate var _tunnelingConfig: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.TunnelingConfig? = nil
  fileprivate var _maxDownstreamConnectionDuration: SwiftProtobuf.Google_Protobuf_Duration? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.extensions.filters.network.tcp_proxy.v4alpha"

extension Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    13: .standard(proto: "max_downstream_connection_duration"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try {
        var v: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.WeightedCluster?
      ...
      case 13: try { try decoder.decodeSingularMessageField(value: &self._maxDownstreamConnectionDuration) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._maxDownstreamConnectionDuration {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 13)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy, rhs: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy) -> Bool {
    ...
    if lhs._maxDownstreamConnectionDuration != rhs._maxDownstreamConnectionDuration {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.WeightedCluster: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.protoMessageName + ".WeightedCluster"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.WeightedCluster, rhs: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.WeightedCluster) -> Bool {
...
extension Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.WeightedCluster.ClusterWeight: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.WeightedCluster.protoMessageName + ".ClusterWeight"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .same(proto: "weight"),
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.WeightedCluster.ClusterWeight, rhs: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.WeightedCluster.ClusterWeight) -> Bool {
...
extension Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.TunnelingConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.protoMessageName + ".TunnelingConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.TunnelingConfig, rhs: Envoy_Extensions_Filters_Network_TcpProxy_V4alpha_TcpProxy.TunnelingConfig) -> Bool {
