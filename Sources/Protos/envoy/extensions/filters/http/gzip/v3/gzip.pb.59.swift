...
extension Envoy_Extensions_Filters_Http_Gzip_V3_Gzip: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._memoryLevel)
      case 3: try decoder.decodeSingularEnumField(value: &self.compressionLevel)
      case 4: try decoder.decodeSingularEnumField(value: &self.compressionStrategy)
      case 9: try decoder.decodeSingularMessageField(value: &self._windowBits)
      case 10: try decoder.decodeSingularMessageField(value: &self._compressor)
      case 11: try decoder.decodeSingularMessageField(value: &self._chunkSize)
      default: break
      }
    }
  }
