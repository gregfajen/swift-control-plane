...
public struct Envoy_Extensions_Filters_Http_JwtAuthn_V3_RequirementRule {
  ...
  public var requires: Envoy_Extensions_Filters_Http_JwtAuthn_V3_JwtRequirement {
    get {return _requires ?? Envoy_Extensions_Filters_Http_JwtAuthn_V3_JwtRequirement()}
  ...
  fileprivate var _requires: Envoy_Extensions_Filters_Http_JwtAuthn_V3_JwtRequirement? = nil
}
...
extension Envoy_Extensions_Filters_Http_JwtAuthn_V3_FilterStateRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.name)
      case 3: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Extensions_Filters_Http_JwtAuthn_V3_JwtRequirement>.self, value: &self.requires)
      default: break
      }
    }
  }
...
extension Envoy_Extensions_Filters_Http_JwtAuthn_V3_JwtAuthentication: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Extensions_Filters_Http_JwtAuthn_V3_JwtProvider>.self, value: &self.providers)
