...
///
/// [#next-free-field: 10]
public struct Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtProvider {
  ...
  public var jwksSourceSpecifier: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtProvider.OneOf_JwksSourceSpecifier? = nil
  ...
  ///      cache_duration:
  ///        seconds: 300
  public var remoteJwks: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RemoteJwks {
    get {
      if case .remoteJwks(let v)? = jwksSourceSpecifier {return v}
      return Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RemoteJwks()
    }
  ...
  public var localJwks: Envoy_Config_Core_V4alpha_DataSource {
    get {
  ...
  public var fromHeaders: [Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtHeader] = []
  ...
  public enum OneOf_JwksSourceSpecifier: Equatable {
    ...
    ///      cache_duration:
    ///        seconds: 300
    case remoteJwks(Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RemoteJwks)
    /// JWKS is in local data source. It could be either in a local file or embedded in the
    /// inline_string.
    ///
    /// Example: local file
    ...
    ///    local_jwks:
    ///      inline_string: ACADADADADA
    case localJwks(Envoy_Config_Core_V4alpha_DataSource)

  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtProvider.OneOf_JwksSourceSpecifier, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtProvider.OneOf_JwksSourceSpecifier) -> Bool {
...
public struct Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RemoteJwks {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtHeader {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_ProviderWithAudiences {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///
/// [#next-free-field: 7]
public struct Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var requiresType: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement.OneOf_RequiresType? = nil
  ...
  /// Specify a required provider with audiences.
  public var providerAndAudiences: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_ProviderWithAudiences {
    get {
      if case .providerAndAudiences(let v)? = requiresType {return v}
      return Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_ProviderWithAudiences()
    }
  ...
  public var requiresAny: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementOrList {
    get {
      if case .requiresAny(let v)? = requiresType {return v}
      return Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementOrList()
    }
  ...
  public var requiresAll: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementAndList {
    get {
      if case .requiresAll(let v)? = requiresType {return v}
      return Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementAndList()
    }
  ...
  public enum OneOf_RequiresType: Equatable {
    ...
    /// Specify a required provider with audiences.
    case providerAndAudiences(Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_ProviderWithAudiences)
    /// Specify list of JwtRequirement. Their results are OR-ed.
    /// If any one of them passes, the result is passed.
    case requiresAny(Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementOrList)
    /// Specify list of JwtRequirement. Their results are AND-ed.
    /// All of them must pass, if one of them fails or missing, it fails.
    case requiresAll(Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementAndList)
    /// The requirement is always satisfied even if JWT is missing or the JWT
    /// verification fails. A typical usage is: this filter is used to only verify
    /// JWTs and pass the verified JWT payloads to another filter, the other filter
    /// will make decision. In this mode, all JWT tokens will be verified.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement.OneOf_RequiresType, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement.OneOf_RequiresType) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementOrList {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Specify a list of JwtRequirement.
  public var requirements: [Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement] = []
...
public struct Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementAndList {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// from "provider-A".
public struct Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RequirementRule {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var match: Envoy_Config_Route_V4alpha_RouteMatch {
    get {return _match ?? Envoy_Config_Route_V4alpha_RouteMatch()}
    set {_match = newValue}
  }
  ...
  public var requirementType: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RequirementRule.OneOf_RequirementType? = nil

  /// Specify a Jwt requirement. Please see detail comment in message JwtRequirement.
  public var requires: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement {
    get {
      if case .requires(let v)? = requirementType {return v}
      return Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement()
    }
  ...
  public enum OneOf_RequirementType: Equatable {
    /// Specify a Jwt requirement. Please see detail comment in message JwtRequirement.
    case requires(Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement)
    /// Use requirement_name to specify a Jwt requirement.
    /// This requirement_name MUST be specified at the
    /// :ref:`requirement_map <envoy_v3_api_field_extensions.filters.http.jwt_authn.v3.JwtAuthentication.requirement_map>`
    /// in `JwtAuthentication`.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RequirementRule.OneOf_RequirementType, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RequirementRule.OneOf_RequirementType) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
  ...
  fileprivate var _match: Envoy_Config_Route_V4alpha_RouteMatch? = nil
}
...
public struct Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_FilterStateRule {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var requires: Dictionary<String,Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement> = [:]
...
///
/// [#next-free-field: 6]
public struct Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtAuthentication {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  ///        local_jwks:
  ///          inline_string: jwks_string
  public var providers: Dictionary<String,Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtProvider> = [:]
  ...
  ///             - provider_name: provider1
  ///             - provider_name: provider2
  public var rules: [Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RequirementRule] = []

  /// This message specifies Jwt requirements based on stream_info.filterState.
  /// Other HTTP filters can use it to specify Jwt requirements dynamically.
  /// The *rules* field above is checked first, if it could not find any matches,
  /// check this one.
  public var filterStateRules: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_FilterStateRule {
    get {return _filterStateRules ?? Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_FilterStateRule()}
  ...
  public var requirementMap: Dictionary<String,Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement> = [:]

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _filterStateRules: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_FilterStateRule? = nil
}

/// Specify per-route config.
public struct Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_PerRouteConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var requirementSpecifier: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_PerRouteConfig.OneOf_RequirementSpecifier? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_PerRouteConfig.OneOf_RequirementSpecifier, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_PerRouteConfig.OneOf_RequirementSpecifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
fileprivate let _protobuf_package = "envoy.extensions.filters.http.jwt_authn.v4alpha"

extension Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtProvider: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try {
        var v: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RemoteJwks?
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtProvider, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtProvider) -> Bool {
...
extension Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RemoteJwks: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RemoteJwks, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RemoteJwks) -> Bool {
...
extension Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtHeader: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtHeader, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtHeader) -> Bool {
...
extension Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_ProviderWithAudiences: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_ProviderWithAudiences, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_ProviderWithAudiences) -> Bool {
...
extension Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_ProviderWithAudiences?
      ...
      case 3: try {
        var v: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementOrList?
        if let current = self.requiresType {
          try decoder.handleConflictingOneOf()
      ...
      case 4: try {
        var v: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementAndList?
        if let current = self.requiresType {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement) -> Bool {
...
extension Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementOrList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementOrList, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementOrList) -> Bool {
...
extension Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementAndList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementAndList, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirementAndList) -> Bool {
    if lhs.requirements != rhs.requirements {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RequirementRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement?
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RequirementRule, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_RequirementRule) -> Bool {
...
extension Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_FilterStateRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.name) }()
      case 3: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement>.self, value: &self.requires) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.requires.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement>.self, value: self.requires, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_FilterStateRule, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_FilterStateRule) -> Bool {
    if lhs.name != rhs.name {return false}
...
extension Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtAuthentication: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtProvider>.self, value: &self.providers) }()
      ...
      case 5: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement>.self, value: &self.requirementMap) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.providers.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtProvider>.self, value: self.providers, fieldNumber: 1)
    }
    ...
    if !self.requirementMap.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtRequirement>.self, value: self.requirementMap, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtAuthentication, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_JwtAuthentication) -> Bool {
...
extension Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_PerRouteConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_PerRouteConfig, rhs: Envoy_Extensions_Filters_Http_JwtAuthn_V4alpha_PerRouteConfig) -> Bool {
