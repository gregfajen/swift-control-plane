...
/// [#next-free-field: 6]
public struct Envoy_Extensions_Filters_Http_HealthCheck_V3_HealthCheck {
...
fileprivate let _protobuf_package = "envoy.extensions.filters.http.health_check.v3"

extension Envoy_Extensions_Filters_Http_HealthCheck_V3_HealthCheck: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Envoy_Type_V3_Percent>.self, value: &self.clusterMinHealthyPercentages) }()
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_HealthCheck_V3_HealthCheck, rhs: Envoy_Extensions_Filters_Http_HealthCheck_V3_HealthCheck) -> Bool {
