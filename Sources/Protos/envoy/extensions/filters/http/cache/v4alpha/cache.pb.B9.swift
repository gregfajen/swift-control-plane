...
public struct Envoy_Extensions_Filters_Http_Cache_V4alpha_CacheConfig {
  ...
  public var allowedVaryHeaders: [Envoy_Type_Matcher_V4alpha_StringMatcher] = []

  /// [#not-implemented-hide:]
  /// <TODO(toddmgreer) implement key customization>
  ///
  /// Modifies cache key creation by restricting which parts of the URL are included.
  public var keyCreatorParams: Envoy_Extensions_Filters_Http_Cache_V4alpha_CacheConfig.KeyCreatorParams {
    get {return _keyCreatorParams ?? Envoy_Extensions_Filters_Http_Cache_V4alpha_CacheConfig.KeyCreatorParams()}
  ...
  public struct KeyCreatorParams {
    ...
    public var queryParametersIncluded: [Envoy_Config_Route_V4alpha_QueryParameterMatcher] = []
    ...
    public var queryParametersExcluded: [Envoy_Config_Route_V4alpha_QueryParameterMatcher] = []
  ...
  fileprivate var _keyCreatorParams: Envoy_Extensions_Filters_Http_Cache_V4alpha_CacheConfig.KeyCreatorParams? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.extensions.filters.http.cache.v4alpha"

extension Envoy_Extensions_Filters_Http_Cache_V4alpha_CacheConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_Cache_V4alpha_CacheConfig, rhs: Envoy_Extensions_Filters_Http_Cache_V4alpha_CacheConfig) -> Bool {
...
extension Envoy_Extensions_Filters_Http_Cache_V4alpha_CacheConfig.KeyCreatorParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Extensions_Filters_Http_Cache_V4alpha_CacheConfig.protoMessageName + ".KeyCreatorParams"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_Cache_V4alpha_CacheConfig.KeyCreatorParams, rhs: Envoy_Extensions_Filters_Http_Cache_V4alpha_CacheConfig.KeyCreatorParams) -> Bool {
