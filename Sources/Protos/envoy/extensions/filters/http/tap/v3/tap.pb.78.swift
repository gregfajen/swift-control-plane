...
public struct Envoy_Extensions_Filters_Http_Tap_V3_Tap {
...
fileprivate let _protobuf_package = "envoy.extensions.filters.http.tap.v3"

extension Envoy_Extensions_Filters_Http_Tap_V3_Tap: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_Tap_V3_Tap, rhs: Envoy_Extensions_Filters_Http_Tap_V3_Tap) -> Bool {
