...
/// CSRF filter config.
public struct Envoy_Extensions_Filters_Http_Csrf_V3_CsrfPolicy {
  ...
  public var additionalOrigins: [Envoy_Type_Matcher_V3_StringMatcher] = []
...
fileprivate let _protobuf_package = "envoy.extensions.filters.http.csrf.v3"

extension Envoy_Extensions_Filters_Http_Csrf_V3_CsrfPolicy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_Csrf_V3_CsrfPolicy, rhs: Envoy_Extensions_Filters_Http_Csrf_V3_CsrfPolicy) -> Bool {
