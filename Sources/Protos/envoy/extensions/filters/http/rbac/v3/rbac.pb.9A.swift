...
/// RBAC filter config.
public struct Envoy_Extensions_Filters_Http_Rbac_V3_RBAC {
...
public struct Envoy_Extensions_Filters_Http_Rbac_V3_RBACPerRoute {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var rbac: Envoy_Extensions_Filters_Http_Rbac_V3_RBAC {
    get {return _rbac ?? Envoy_Extensions_Filters_Http_Rbac_V3_RBAC()}
    set {_rbac = newValue}
  }
  ...
  fileprivate var _rbac: Envoy_Extensions_Filters_Http_Rbac_V3_RBAC? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "envoy.extensions.filters.http.rbac.v3"

extension Envoy_Extensions_Filters_Http_Rbac_V3_RBAC: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_Rbac_V3_RBAC, rhs: Envoy_Extensions_Filters_Http_Rbac_V3_RBAC) -> Bool {
...
extension Envoy_Extensions_Filters_Http_Rbac_V3_RBACPerRoute: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 2: try decoder.decodeSingularMessageField(value: &self._rbac)
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_Rbac_V3_RBACPerRoute, rhs: Envoy_Extensions_Filters_Http_Rbac_V3_RBACPerRoute) -> Bool {
