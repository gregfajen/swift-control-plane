...
/// [#next-free-field: 7]
public struct Envoy_Extensions_Filters_Http_Router_V3_Router {
  ...
  public var upstreamLog: [Envoy_Config_Accesslog_V3_AccessLog] = []
...
fileprivate let _protobuf_package = "envoy.extensions.filters.http.router.v3"

extension Envoy_Extensions_Filters_Http_Router_V3_Router: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Filters_Http_Router_V3_Router, rhs: Envoy_Extensions_Filters_Http_Router_V3_Router) -> Bool {
