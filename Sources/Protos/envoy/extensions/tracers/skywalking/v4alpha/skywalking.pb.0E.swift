...
public struct Envoy_Extensions_Tracers_Skywalking_V4alpha_SkyWalkingConfig {
  ...
  public var grpcService: Envoy_Config_Core_V4alpha_GrpcService {
    get {return _storage._grpcService ?? Envoy_Config_Core_V4alpha_GrpcService()}
  ...
  public var clientConfig: Envoy_Extensions_Tracers_Skywalking_V4alpha_ClientConfig {
    get {return _storage._clientConfig ?? Envoy_Extensions_Tracers_Skywalking_V4alpha_ClientConfig()}
...
public struct Envoy_Extensions_Tracers_Skywalking_V4alpha_ClientConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var backendTokenSpecifier: Envoy_Extensions_Tracers_Skywalking_V4alpha_ClientConfig.OneOf_BackendTokenSpecifier? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Extensions_Tracers_Skywalking_V4alpha_ClientConfig.OneOf_BackendTokenSpecifier, rhs: Envoy_Extensions_Tracers_Skywalking_V4alpha_ClientConfig.OneOf_BackendTokenSpecifier) -> Bool {
...
fileprivate let _protobuf_package = "envoy.extensions.tracers.skywalking.v4alpha"

extension Envoy_Extensions_Tracers_Skywalking_V4alpha_SkyWalkingConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _grpcService: Envoy_Config_Core_V4alpha_GrpcService? = nil
    var _clientConfig: Envoy_Extensions_Tracers_Skywalking_V4alpha_ClientConfig? = nil
  ...
  public static func ==(lhs: Envoy_Extensions_Tracers_Skywalking_V4alpha_SkyWalkingConfig, rhs: Envoy_Extensions_Tracers_Skywalking_V4alpha_SkyWalkingConfig) -> Bool {
...
extension Envoy_Extensions_Tracers_Skywalking_V4alpha_ClientConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Extensions_Tracers_Skywalking_V4alpha_ClientConfig, rhs: Envoy_Extensions_Tracers_Skywalking_V4alpha_ClientConfig) -> Bool {
