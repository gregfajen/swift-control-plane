...
public struct Envoy_Admin_V4alpha_Listeners {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// List of listener statuses.
  public var listenerStatuses: [Envoy_Admin_V4alpha_ListenerStatus] = []
...
public struct Envoy_Admin_V4alpha_ListenerStatus {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var localAddress: Envoy_Config_Core_V4alpha_Address {
    get {return _localAddress ?? Envoy_Config_Core_V4alpha_Address()}
  ...
  fileprivate var _localAddress: Envoy_Config_Core_V4alpha_Address? = nil
}
...
extension Envoy_Admin_V4alpha_Listeners: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.listenerStatuses) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Admin_V4alpha_Listeners, rhs: Envoy_Admin_V4alpha_Listeners) -> Bool {
...
extension Envoy_Admin_V4alpha_ListenerStatus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Admin_V4alpha_ListenerStatus, rhs: Envoy_Admin_V4alpha_ListenerStatus) -> Bool {
