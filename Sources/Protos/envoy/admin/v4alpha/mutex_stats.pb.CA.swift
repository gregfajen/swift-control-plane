...
public struct Envoy_Admin_V4alpha_MutexStats {
...
extension Envoy_Admin_V4alpha_MutexStats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt64Field(value: &self.numContentions) }()
      case 2: try { try decoder.decodeSingularUInt64Field(value: &self.currentWaitCycles) }()
      case 3: try { try decoder.decodeSingularUInt64Field(value: &self.lifetimeWaitCycles) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Admin_V4alpha_MutexStats, rhs: Envoy_Admin_V4alpha_MutexStats) -> Bool {
