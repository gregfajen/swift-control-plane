...
public struct Envoy_Admin_V4alpha_ServerInfo {
  ...
  /// State of the server.
  public var state: Envoy_Admin_V4alpha_ServerInfo.State = .live
  ...
  public var commandLineOptions: Envoy_Admin_V4alpha_CommandLineOptions {
    get {return _commandLineOptions ?? Envoy_Admin_V4alpha_CommandLineOptions()}
  ...
  fileprivate var _commandLineOptions: Envoy_Admin_V4alpha_CommandLineOptions? = nil
}
...
extension Envoy_Admin_V4alpha_ServerInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeSingularMessageField(value: &self._uptimeCurrentEpoch)
      case 4: try decoder.decodeSingularMessageField(value: &self._uptimeAllEpochs)
      case 5: try decoder.decodeSingularStringField(value: &self.hotRestartVersion)
      case 6: try decoder.decodeSingularMessageField(value: &self._commandLineOptions)
      default: break
      }
    }
  }
...
extension Envoy_Admin_V4alpha_CommandLineOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularUInt64Field(value: &_storage._baseID)
        case 2: try decoder.decodeSingularUInt32Field(value: &_storage._concurrency)
        case 3: try decoder.decodeSingularStringField(value: &_storage._configPath)
        case 4: try decoder.decodeSingularStringField(value: &_storage._configYaml)
        case 5: try decoder.decodeSingularBoolField(value: &_storage._allowUnknownStaticFields)
        case 6: try decoder.decodeSingularStringField(value: &_storage._adminAddressPath)
        case 7: try decoder.decodeSingularEnumField(value: &_storage._localAddressIpVersion)
        case 8: try decoder.decodeSingularStringField(value: &_storage._logLevel)
        case 9: try decoder.decodeSingularStringField(value: &_storage._componentLogLevel)
        case 10: try decoder.decodeSingularStringField(value: &_storage._logFormat)
        case 11: try decoder.decodeSingularStringField(value: &_storage._logPath)
        case 13: try decoder.decodeSingularStringField(value: &_storage._serviceCluster)
        case 14: try decoder.decodeSingularStringField(value: &_storage._serviceNode)
        case 15: try decoder.decodeSingularStringField(value: &_storage._serviceZone)
        case 16: try decoder.decodeSingularMessageField(value: &_storage._fileFlushInterval)
        case 17: try decoder.decodeSingularMessageField(value: &_storage._drainTime)
        case 18: try decoder.decodeSingularMessageField(value: &_storage._parentShutdownTime)
        case 19: try decoder.decodeSingularEnumField(value: &_storage._mode)
        case 22: try decoder.decodeSingularBoolField(value: &_storage._disableHotRestart)
        case 23: try decoder.decodeSingularBoolField(value: &_storage._enableMutexTracing)
        case 24: try decoder.decodeSingularUInt32Field(value: &_storage._restartEpoch)
        case 25: try decoder.decodeSingularBoolField(value: &_storage._cpusetThreads)
        case 26: try decoder.decodeSingularBoolField(value: &_storage._rejectUnknownDynamicFields)
        case 27: try decoder.decodeSingularBoolField(value: &_storage._logFormatEscaped)
        case 28: try decoder.decodeRepeatedStringField(value: &_storage._disabledExtensions)
        case 29: try decoder.decodeSingularUInt32Field(value: &_storage._bootstrapVersion)
        case 30: try decoder.decodeSingularBoolField(value: &_storage._ignoreUnknownDynamicFields)
        default: break
        }
      }
    }
