...
/// [#next-free-field: 7]
public struct Envoy_Admin_V2alpha_Memory {
...
extension Envoy_Admin_V2alpha_Memory: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt64Field(value: &self.allocated) }()
      case 2: try { try decoder.decodeSingularUInt64Field(value: &self.heapSize) }()
      case 3: try { try decoder.decodeSingularUInt64Field(value: &self.pageheapUnmapped) }()
      case 4: try { try decoder.decodeSingularUInt64Field(value: &self.pageheapFree) }()
      case 5: try { try decoder.decodeSingularUInt64Field(value: &self.totalThreadCache) }()
      case 6: try { try decoder.decodeSingularUInt64Field(value: &self.totalPhysicalBytes) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Envoy_Admin_V2alpha_Memory, rhs: Envoy_Admin_V2alpha_Memory) -> Bool {
