...
public struct Envoy_Admin_V2alpha_Listeners {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// List of listener statuses.
  public var listenerStatuses: [Envoy_Admin_V2alpha_ListenerStatus] = []
...
public struct Envoy_Admin_V2alpha_ListenerStatus {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Envoy_Admin_V2alpha_Listeners: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Admin_V2alpha_Listeners, rhs: Envoy_Admin_V2alpha_Listeners) -> Bool {
...
extension Envoy_Admin_V2alpha_ListenerStatus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Admin_V2alpha_ListenerStatus, rhs: Envoy_Admin_V2alpha_ListenerStatus) -> Bool {
