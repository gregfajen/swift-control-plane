...
/// information.
public struct Envoy_Admin_V3_Certificates {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// List of certificates known to an Envoy.
  public var certificates: [Envoy_Admin_V3_Certificate] = []
...
public struct Envoy_Admin_V3_Certificate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Details of CA certificate.
  public var caCert: [Envoy_Admin_V3_CertificateDetails] = []

  /// Details of Certificate Chain
  public var certChain: [Envoy_Admin_V3_CertificateDetails] = []
...
/// [#next-free-field: 8]
public struct Envoy_Admin_V3_CertificateDetails {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var subjectAltNames: [Envoy_Admin_V3_SubjectAlternateName] = []
  ...
  public var ocspDetails: Envoy_Admin_V3_CertificateDetails.OcspDetails {
    get {return _ocspDetails ?? Envoy_Admin_V3_CertificateDetails.OcspDetails()}
  ...
  fileprivate var _ocspDetails: Envoy_Admin_V3_CertificateDetails.OcspDetails? = nil
}

public struct Envoy_Admin_V3_SubjectAlternateName {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Subject Alternate Name.
  public var name: Envoy_Admin_V3_SubjectAlternateName.OneOf_Name? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Envoy_Admin_V3_SubjectAlternateName.OneOf_Name, rhs: Envoy_Admin_V3_SubjectAlternateName.OneOf_Name) -> Bool {
...
extension Envoy_Admin_V3_Certificates: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Admin_V3_Certificates, rhs: Envoy_Admin_V3_Certificates) -> Bool {
...
extension Envoy_Admin_V3_Certificate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Admin_V3_Certificate, rhs: Envoy_Admin_V3_Certificate) -> Bool {
...
extension Envoy_Admin_V3_CertificateDetails: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Admin_V3_CertificateDetails, rhs: Envoy_Admin_V3_CertificateDetails) -> Bool {
...
extension Envoy_Admin_V3_CertificateDetails.OcspDetails: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Admin_V3_CertificateDetails.protoMessageName + ".OcspDetails"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Envoy_Admin_V3_CertificateDetails.OcspDetails, rhs: Envoy_Admin_V3_CertificateDetails.OcspDetails) -> Bool {
    if lhs._validFrom != rhs._validFrom {return false}
...
extension Envoy_Admin_V3_SubjectAlternateName: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Admin_V3_SubjectAlternateName, rhs: Envoy_Admin_V3_SubjectAlternateName) -> Bool {
