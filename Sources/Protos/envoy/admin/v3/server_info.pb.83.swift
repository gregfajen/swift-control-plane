...
/// [#next-free-field: 8]
public struct Envoy_Admin_V3_ServerInfo {
  ...
  /// State of the server.
  public var state: Envoy_Admin_V3_ServerInfo.State {
  ...
  public var commandLineOptions: Envoy_Admin_V3_CommandLineOptions {
    get {return _storage._commandLineOptions ?? Envoy_Admin_V3_CommandLineOptions()}
...
extension Envoy_Admin_V3_ServerInfo.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Admin_V3_ServerInfo.State] = [
    .live,
    .draining,
    .preInitializing,
    .initializing,
...
/// [#next-free-field: 37]
public struct Envoy_Admin_V3_CommandLineOptions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var localAddressIpVersion: Envoy_Admin_V3_CommandLineOptions.IpVersion {
  ...
  public var drainStrategy: Envoy_Admin_V3_CommandLineOptions.DrainStrategy {
  ...
  public var mode: Envoy_Admin_V3_CommandLineOptions.Mode {
...
extension Envoy_Admin_V3_CommandLineOptions.IpVersion: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Admin_V3_CommandLineOptions.IpVersion] = [
    .v4,
    .v6,
  ]
}

extension Envoy_Admin_V3_CommandLineOptions.Mode: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Admin_V3_CommandLineOptions.Mode] = [
    .serve,
    .validate,
    .initOnly,
  ]
...
extension Envoy_Admin_V3_CommandLineOptions.DrainStrategy: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Envoy_Admin_V3_CommandLineOptions.DrainStrategy] = [
    .gradual,
    .immediate,
  ]
}
...
extension Envoy_Admin_V3_ServerInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _state: Envoy_Admin_V3_ServerInfo.State = .live
    ...
    var _commandLineOptions: Envoy_Admin_V3_CommandLineOptions? = nil
  ...
  public static func ==(lhs: Envoy_Admin_V3_ServerInfo, rhs: Envoy_Admin_V3_ServerInfo) -> Bool {
...
extension Envoy_Admin_V3_ServerInfo.State: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "LIVE"),
...
extension Envoy_Admin_V3_CommandLineOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _localAddressIpVersion: Envoy_Admin_V3_CommandLineOptions.IpVersion = .v4
    ...
    var _drainStrategy: Envoy_Admin_V3_CommandLineOptions.DrainStrategy = .gradual
    var _parentShutdownTime: SwiftProtobuf.Google_Protobuf_Duration? = nil
    var _mode: Envoy_Admin_V3_CommandLineOptions.Mode = .serve
  ...
  public static func ==(lhs: Envoy_Admin_V3_CommandLineOptions, rhs: Envoy_Admin_V3_CommandLineOptions) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Envoy_Admin_V3_CommandLineOptions.IpVersion: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "v4"),
    1: .same(proto: "v6"),
  ]
...
extension Envoy_Admin_V3_CommandLineOptions.Mode: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "Serve"),
...
extension Envoy_Admin_V3_CommandLineOptions.DrainStrategy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
