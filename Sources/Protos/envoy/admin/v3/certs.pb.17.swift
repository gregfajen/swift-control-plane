...
public struct Envoy_Admin_V3_SubjectAlternateName {
  ...
  public enum OneOf_Name: Equatable {
    ...
    public static func ==(lhs: Envoy_Admin_V3_SubjectAlternateName.OneOf_Name, rhs: Envoy_Admin_V3_SubjectAlternateName.OneOf_Name) -> Bool {
      ...
      case (.ipAddress(let l), .ipAddress(let r)): return l == r
...
extension Envoy_Admin_V3_Certificate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedMessageField(value: &self.caCert)
      case 2: try decoder.decodeRepeatedMessageField(value: &self.certChain)
      default: break
      }
    }
  }
...
extension Envoy_Admin_V3_CertificateDetails: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularStringField(value: &self.serialNumber)
      case 3: try decoder.decodeRepeatedMessageField(value: &self.subjectAltNames)
      case 4: try decoder.decodeSingularUInt64Field(value: &self.daysUntilExpiration)
      case 5: try decoder.decodeSingularMessageField(value: &self._validFrom)
      case 6: try decoder.decodeSingularMessageField(value: &self._expirationTime)
      default: break
      }
    }
  }
