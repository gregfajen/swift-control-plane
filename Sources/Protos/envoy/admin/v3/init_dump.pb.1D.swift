...
public struct Envoy_Admin_V3_UnreadyTargetsDumps {
  ...
  public var unreadyTargetsDumps: [Envoy_Admin_V3_UnreadyTargetsDumps.UnreadyTargetsDump] = []
...
extension Envoy_Admin_V3_UnreadyTargetsDumps: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Envoy_Admin_V3_UnreadyTargetsDumps, rhs: Envoy_Admin_V3_UnreadyTargetsDumps) -> Bool {
...
extension Envoy_Admin_V3_UnreadyTargetsDumps.UnreadyTargetsDump: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Envoy_Admin_V3_UnreadyTargetsDumps.protoMessageName + ".UnreadyTargetsDump"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  public static func ==(lhs: Envoy_Admin_V3_UnreadyTargetsDumps.UnreadyTargetsDump, rhs: Envoy_Admin_V3_UnreadyTargetsDumps.UnreadyTargetsDump) -> Bool {
