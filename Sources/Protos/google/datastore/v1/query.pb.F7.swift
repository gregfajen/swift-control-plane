...
public struct Google_Datastore_V1_EntityResult {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The resulting entity.
  public var entity: Google_Datastore_V1_Entity {
...
extension Google_Datastore_V1_EntityResult.ResultType: CaseIterable {
  ...
  public static var allCases: [Google_Datastore_V1_EntityResult.ResultType] = [
    .unspecified,
    .full,
    .projection,
    .keyOnly,
...
public struct Google_Datastore_V1_Query {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The projection to return. Defaults to returning all properties.
  public var projection: [Google_Datastore_V1_Projection] = []

  /// The kinds to query (if empty, returns entities of all kinds).
  /// Currently at most 1 kind may be specified.
  public var kind: [Google_Datastore_V1_KindExpression] = []

  /// The filter to apply.
  public var filter: Google_Datastore_V1_Filter {
  ...
  public var order: [Google_Datastore_V1_PropertyOrder] = []

  /// The properties to make distinct. The query results will contain the first
  /// result for each distinct combination of values for the given properties
  /// (if empty, all results are returned).
  public var distinctOn: [Google_Datastore_V1_PropertyReference] = []
...
public struct Google_Datastore_V1_KindExpression {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Datastore_V1_PropertyReference {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Datastore_V1_Projection {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The property to project.
  public var property: Google_Datastore_V1_PropertyReference {
...
public struct Google_Datastore_V1_PropertyOrder {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var direction: Google_Datastore_V1_PropertyOrder.Direction = .unspecified
...
extension Google_Datastore_V1_PropertyOrder.Direction: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Datastore_V1_PropertyOrder.Direction] = [
    .unspecified,
    .ascending,
    .descending,
  ]
...
public struct Google_Datastore_V1_Filter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The type of filter.
  public var filterType: Google_Datastore_V1_Filter.OneOf_FilterType? = nil

  /// A composite filter.
  public var compositeFilter: Google_Datastore_V1_CompositeFilter {
    get {
  ...
  public var propertyFilter: Google_Datastore_V1_PropertyFilter {
    get {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Google_Datastore_V1_Filter.OneOf_FilterType, rhs: Google_Datastore_V1_Filter.OneOf_FilterType) -> Bool {
...
public struct Google_Datastore_V1_CompositeFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The operator for combining multiple filters.
  public var op: Google_Datastore_V1_CompositeFilter.Operator = .unspecified

  /// The list of filters to combine.
  /// Must contain at least one filter.
  public var filters: [Google_Datastore_V1_Filter] = []
...
extension Google_Datastore_V1_CompositeFilter.Operator: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Datastore_V1_CompositeFilter.Operator] = [
    .unspecified,
    .and,
  ]
}
...
public struct Google_Datastore_V1_PropertyFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var op: Google_Datastore_V1_PropertyFilter.Operator = .unspecified

  /// The value to compare the property to.
  public var value: Google_Datastore_V1_Value {
...
extension Google_Datastore_V1_PropertyFilter.Operator: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Datastore_V1_PropertyFilter.Operator] = [
    .unspecified,
    .lessThan,
    .lessThanOrEqual,
    .greaterThan,
...
public struct Google_Datastore_V1_GqlQuery {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var namedBindings: Dictionary<String,Google_Datastore_V1_GqlQueryParameter> = [:]
  ...
  public var positionalBindings: [Google_Datastore_V1_GqlQueryParameter] = []
...
public struct Google_Datastore_V1_GqlQueryParameter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The type of parameter.
  public var parameterType: Google_Datastore_V1_GqlQueryParameter.OneOf_ParameterType? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Google_Datastore_V1_GqlQueryParameter.OneOf_ParameterType, rhs: Google_Datastore_V1_GqlQueryParameter.OneOf_ParameterType) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Google_Datastore_V1_QueryResultBatch {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var entityResultType: Google_Datastore_V1_EntityResult.ResultType = .unspecified

  /// The results for this batch.
  public var entityResults: [Google_Datastore_V1_EntityResult] = []

  /// A cursor that points to the position after the last result in the batch.
  public var endCursor: Data = Data()

  /// The state of the query after the current batch.
  public var moreResults: Google_Datastore_V1_QueryResultBatch.MoreResultsType = .unspecified
...
extension Google_Datastore_V1_QueryResultBatch.MoreResultsType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Datastore_V1_QueryResultBatch.MoreResultsType] = [
    .unspecified,
    .notFinished,
...
extension Google_Datastore_V1_EntityResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_EntityResult, rhs: Google_Datastore_V1_EntityResult) -> Bool {
...
extension Google_Datastore_V1_Query: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_Query, rhs: Google_Datastore_V1_Query) -> Bool {
...
extension Google_Datastore_V1_KindExpression: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_KindExpression, rhs: Google_Datastore_V1_KindExpression) -> Bool {
...
extension Google_Datastore_V1_PropertyReference: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_PropertyReference, rhs: Google_Datastore_V1_PropertyReference) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Google_Datastore_V1_Projection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_Projection, rhs: Google_Datastore_V1_Projection) -> Bool {
...
extension Google_Datastore_V1_PropertyOrder: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_PropertyOrder, rhs: Google_Datastore_V1_PropertyOrder) -> Bool {
    if lhs._property != rhs._property {return false}
...
extension Google_Datastore_V1_Filter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_Filter, rhs: Google_Datastore_V1_Filter) -> Bool {
...
extension Google_Datastore_V1_CompositeFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_CompositeFilter, rhs: Google_Datastore_V1_CompositeFilter) -> Bool {
...
extension Google_Datastore_V1_PropertyFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_PropertyFilter, rhs: Google_Datastore_V1_PropertyFilter) -> Bool {
    if lhs._property != rhs._property {return false}
    if lhs.op != rhs.op {return false}
...
extension Google_Datastore_V1_GqlQuery: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_GqlQuery, rhs: Google_Datastore_V1_GqlQuery) -> Bool {
...
extension Google_Datastore_V1_GqlQueryParameter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_GqlQueryParameter, rhs: Google_Datastore_V1_GqlQueryParameter) -> Bool {
...
extension Google_Datastore_V1_QueryResultBatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_QueryResultBatch, rhs: Google_Datastore_V1_QueryResultBatch) -> Bool {
