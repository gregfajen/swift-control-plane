...
/// an active state.
public struct Google_Datastore_V1_PartitionId {
...
public struct Google_Datastore_V1_Key {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var path: [Google_Datastore_V1_Key.PathElement] = []
  ...
  public struct PathElement {
    ...
    /// The type of ID.
    public var idType: Google_Datastore_V1_Key.PathElement.OneOf_IDType? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Google_Datastore_V1_Key.PathElement.OneOf_IDType, rhs: Google_Datastore_V1_Key.PathElement.OneOf_IDType) -> Bool {
...
/// An array value.
public struct Google_Datastore_V1_ArrayValue {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var values: [Google_Datastore_V1_Value] = []
...
/// metadata.
public struct Google_Datastore_V1_Value {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Must have a value set.
  public var valueType: Google_Datastore_V1_Value.OneOf_ValueType? = nil
  ...
  /// A key value.
  public var keyValue: Google_Datastore_V1_Key {
    get {
  ...
  public var entityValue: Google_Datastore_V1_Entity {
    get {
  ...
  public var arrayValue: Google_Datastore_V1_ArrayValue {
    get {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Google_Datastore_V1_Value.OneOf_ValueType, rhs: Google_Datastore_V1_Value.OneOf_ValueType) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
/// message.
public struct Google_Datastore_V1_Entity {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// The name cannot be `""`.
  public var properties: Dictionary<String,Google_Datastore_V1_Value> = [:]
...
extension Google_Datastore_V1_PartitionId: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_PartitionId, rhs: Google_Datastore_V1_PartitionId) -> Bool {
...
extension Google_Datastore_V1_Key: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_Key, rhs: Google_Datastore_V1_Key) -> Bool {
...
extension Google_Datastore_V1_Key.PathElement: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Datastore_V1_Key.protoMessageName + ".PathElement"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "kind"),
    2: .same(proto: "id"),
    3: .same(proto: "name"),
  ...
  public static func ==(lhs: Google_Datastore_V1_Key.PathElement, rhs: Google_Datastore_V1_Key.PathElement) -> Bool {
...
extension Google_Datastore_V1_ArrayValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_ArrayValue, rhs: Google_Datastore_V1_ArrayValue) -> Bool {
...
extension Google_Datastore_V1_Value: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_Value, rhs: Google_Datastore_V1_Value) -> Bool {
...
extension Google_Datastore_V1_Entity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1_Entity, rhs: Google_Datastore_V1_Entity) -> Bool {
