...
/// an active state.
public struct Google_Datastore_V1beta3_PartitionId {
...
public struct Google_Datastore_V1beta3_Key {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var partitionID: Google_Datastore_V1beta3_PartitionId {
    get {return _partitionID ?? Google_Datastore_V1beta3_PartitionId()}
  ...
  public var path: [Google_Datastore_V1beta3_Key.PathElement] = []
  ...
  public struct PathElement {
    ...
    /// The type of ID.
    public var idType: Google_Datastore_V1beta3_Key.PathElement.OneOf_IDType? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Google_Datastore_V1beta3_Key.PathElement.OneOf_IDType, rhs: Google_Datastore_V1beta3_Key.PathElement.OneOf_IDType) -> Bool {
  ...
  fileprivate var _partitionID: Google_Datastore_V1beta3_PartitionId? = nil
}

/// An array value.
public struct Google_Datastore_V1beta3_ArrayValue {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var values: [Google_Datastore_V1beta3_Value] = []
...
/// metadata.
public struct Google_Datastore_V1beta3_Value {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Must have a value set.
  public var valueType: Google_Datastore_V1beta3_Value.OneOf_ValueType? = nil
  ...
  /// A key value.
  public var keyValue: Google_Datastore_V1beta3_Key {
    get {
  ...
  public var entityValue: Google_Datastore_V1beta3_Entity {
    get {
  ...
  public var arrayValue: Google_Datastore_V1beta3_ArrayValue {
    get {
      if case .arrayValue(let v)? = valueType {return v}
      return Google_Datastore_V1beta3_ArrayValue()
    }
    set {valueType = .arrayValue(newValue)}
  }

  /// The `meaning` field should only be populated for backwards compatibility.
  public var meaning: Int32 = 0

  /// If the value should be excluded from all indexes including those defined
  /// explicitly.
  public var excludeFromIndexes: Bool = false
  ...
  public enum OneOf_ValueType: Equatable {
    ...
    /// A key value.
    case keyValue(Google_Datastore_V1beta3_Key)
    /// A UTF-8 encoded string value.
    /// When `exclude_from_indexes` is false (it is indexed), may have at most
    /// 1500 bytes. Otherwise, may be set to at most 1,000,000 bytes.
    ...
    /// - May have a key with an incomplete key path.
    /// - May have a reserved/read-only key.
    case entityValue(Google_Datastore_V1beta3_Entity)
    /// An array value.
    /// Cannot contain another array value.
    /// A `Value` instance that sets field `array_value` must not set fields
    /// `meaning` or `exclude_from_indexes`.
    case arrayValue(Google_Datastore_V1beta3_ArrayValue)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Datastore_V1beta3_Value.OneOf_ValueType, rhs: Google_Datastore_V1beta3_Value.OneOf_ValueType) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      ...
      case (.keyValue, .keyValue): return {
        guard case .keyValue(let l) = lhs, case .keyValue(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      ...
      case (.blobValue, .blobValue): return {
        guard case .blobValue(let l) = lhs, case .blobValue(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      ...
      case (.entityValue, .entityValue): return {
        guard case .entityValue(let l) = lhs, case .entityValue(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
/// message.
public struct Google_Datastore_V1beta3_Entity {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// The name cannot be `""`.
  public var properties: Dictionary<String,Google_Datastore_V1beta3_Value> = [:]
...
extension Google_Datastore_V1beta3_PartitionId: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1beta3_PartitionId, rhs: Google_Datastore_V1beta3_PartitionId) -> Bool {
...
extension Google_Datastore_V1beta3_Key: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1beta3_Key, rhs: Google_Datastore_V1beta3_Key) -> Bool {
...
extension Google_Datastore_V1beta3_Key.PathElement: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Datastore_V1beta3_Key.protoMessageName + ".PathElement"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "kind"),
    2: .same(proto: "id"),
    3: .same(proto: "name"),
  ...
  public static func ==(lhs: Google_Datastore_V1beta3_Key.PathElement, rhs: Google_Datastore_V1beta3_Key.PathElement) -> Bool {
...
extension Google_Datastore_V1beta3_ArrayValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Datastore_V1beta3_ArrayValue, rhs: Google_Datastore_V1beta3_ArrayValue) -> Bool {
...
extension Google_Datastore_V1beta3_Value: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 9: try {
        var v: Google_Datastore_V1beta3_ArrayValue?
        if let current = self.valueType {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Datastore_V1beta3_Value, rhs: Google_Datastore_V1beta3_Value) -> Bool {
...
extension Google_Datastore_V1beta3_Entity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Datastore_V1beta3_Value>.self, value: &self.properties) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.properties.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Datastore_V1beta3_Value>.self, value: self.properties, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Datastore_V1beta3_Entity, rhs: Google_Datastore_V1beta3_Entity) -> Bool {
