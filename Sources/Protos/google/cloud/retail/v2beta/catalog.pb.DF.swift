...
public struct Google_Cloud_Retail_V2beta_ProductLevelConfig {
...
/// Next ID: 5.
public struct Google_Cloud_Retail_V2beta_Catalog {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var productLevelConfig: Google_Cloud_Retail_V2beta_ProductLevelConfig {
    get {return _productLevelConfig ?? Google_Cloud_Retail_V2beta_ProductLevelConfig()}
  ...
  fileprivate var _productLevelConfig: Google_Cloud_Retail_V2beta_ProductLevelConfig? = nil
}
...
extension Google_Cloud_Retail_V2beta_ProductLevelConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Retail_V2beta_ProductLevelConfig, rhs: Google_Cloud_Retail_V2beta_ProductLevelConfig) -> Bool {
...
extension Google_Cloud_Retail_V2beta_Catalog: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Retail_V2beta_Catalog, rhs: Google_Cloud_Retail_V2beta_Catalog) -> Bool {
