...
/// searched.
public struct Google_Cloud_Retail_V2beta_Product {
  ...
  public var priceInfo: Google_Cloud_Retail_V2beta_PriceInfo {
    get {return _storage._priceInfo ?? Google_Cloud_Retail_V2beta_PriceInfo()}
  ...
  public var availability: Google_Cloud_Retail_V2beta_Product.Availability {
  ...
  public var images: [Google_Cloud_Retail_V2beta_Image] {
...
extension Google_Cloud_Retail_V2beta_Product.Availability: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Retail_V2beta_Product.Availability] = [
    .unspecified,
    .inStock,
    .outOfStock,
    .preorder,
...
extension Google_Cloud_Retail_V2beta_Product: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _tags: [String] = []
    var _priceInfo: Google_Cloud_Retail_V2beta_PriceInfo? = nil
    var _availableTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _availability: Google_Cloud_Retail_V2beta_Product.Availability = .unspecified
    var _availableQuantity: SwiftProtobuf.Google_Protobuf_Int32Value? = nil
    var _uri: String = String()
    var _images: [Google_Cloud_Retail_V2beta_Image] = []
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 12: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Retail_V2beta_CustomAttribute>.self, value: &_storage._attributes) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._attributes.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Retail_V2beta_CustomAttribute>.self, value: _storage._attributes, fieldNumber: 12)
      }
  ...
  public static func ==(lhs: Google_Cloud_Retail_V2beta_Product, rhs: Google_Cloud_Retail_V2beta_Product) -> Bool {
...
extension Google_Cloud_Retail_V2beta_Product.Availability: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
