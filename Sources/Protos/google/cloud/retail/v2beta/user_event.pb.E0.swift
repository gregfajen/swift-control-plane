...
public struct Google_Cloud_Retail_V2beta_UserEvent {
  ...
  public var productDetails: [Google_Cloud_Retail_V2beta_ProductDetail] {
  ...
  /// search, and etc.
  public var attributes: Dictionary<String,Google_Cloud_Retail_V2beta_CustomAttribute> {
  ...
  public var purchaseTransaction: Google_Cloud_Retail_V2beta_PurchaseTransaction {
    get {return _storage._purchaseTransaction ?? Google_Cloud_Retail_V2beta_PurchaseTransaction()}
  ...
  /// User information.
  public var userInfo: Google_Cloud_Retail_V2beta_UserInfo {
    get {return _storage._userInfo ?? Google_Cloud_Retail_V2beta_UserInfo()}
...
public struct Google_Cloud_Retail_V2beta_ProductDetail {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// A transaction represents the entire purchase transaction.
public struct Google_Cloud_Retail_V2beta_PurchaseTransaction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Retail_V2beta_UserEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _productDetails: [Google_Cloud_Retail_V2beta_ProductDetail] = []
    var _attributes: Dictionary<String,Google_Cloud_Retail_V2beta_CustomAttribute> = [:]
    var _cartID: String = String()
    var _purchaseTransaction: Google_Cloud_Retail_V2beta_PurchaseTransaction? = nil
    var _searchQuery: String = String()
    var _pageCategories: [String] = []
    var _userInfo: Google_Cloud_Retail_V2beta_UserInfo? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 7: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Retail_V2beta_CustomAttribute>.self, value: &_storage._attributes) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._attributes.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Retail_V2beta_CustomAttribute>.self, value: _storage._attributes, fieldNumber: 7)
      }
  ...
  public static func ==(lhs: Google_Cloud_Retail_V2beta_UserEvent, rhs: Google_Cloud_Retail_V2beta_UserEvent) -> Bool {
...
extension Google_Cloud_Retail_V2beta_ProductDetail: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Retail_V2beta_ProductDetail, rhs: Google_Cloud_Retail_V2beta_ProductDetail) -> Bool {
...
extension Google_Cloud_Retail_V2beta_PurchaseTransaction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Retail_V2beta_PurchaseTransaction, rhs: Google_Cloud_Retail_V2beta_PurchaseTransaction) -> Bool {
