...
/// method.
public struct Google_Cloud_Retail_V2_ListCatalogsRequest {
...
/// [CatalogService.ListCatalogs][google.cloud.retail.v2.CatalogService.ListCatalogs]
/// method.
public struct Google_Cloud_Retail_V2_ListCatalogsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// All the customer's [Catalog][google.cloud.retail.v2.Catalog]s.
  public var catalogs: [Google_Cloud_Retail_V2_Catalog] = []
...
/// method.
public struct Google_Cloud_Retail_V2_UpdateCatalogRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var catalog: Google_Cloud_Retail_V2_Catalog {
    get {return _catalog ?? Google_Cloud_Retail_V2_Catalog()}
  ...
  fileprivate var _catalog: Google_Cloud_Retail_V2_Catalog? = nil
...
extension Google_Cloud_Retail_V2_ListCatalogsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Retail_V2_ListCatalogsRequest, rhs: Google_Cloud_Retail_V2_ListCatalogsRequest) -> Bool {
...
extension Google_Cloud_Retail_V2_ListCatalogsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Retail_V2_ListCatalogsResponse, rhs: Google_Cloud_Retail_V2_ListCatalogsResponse) -> Bool {
...
extension Google_Cloud_Retail_V2_UpdateCatalogRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Retail_V2_UpdateCatalogRequest, rhs: Google_Cloud_Retail_V2_UpdateCatalogRequest) -> Bool {
