...
public struct Google_Cloud_Retail_V2_PredictRequest {
...
public struct Google_Cloud_Retail_V2_PredictResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var results: [Google_Cloud_Retail_V2_PredictResponse.PredictionResult] = []
...
extension Google_Cloud_Retail_V2_PredictRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Retail_V2_PredictRequest, rhs: Google_Cloud_Retail_V2_PredictRequest) -> Bool {
...
extension Google_Cloud_Retail_V2_PredictResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Retail_V2_PredictResponse, rhs: Google_Cloud_Retail_V2_PredictResponse) -> Bool {
...
extension Google_Cloud_Retail_V2_PredictResponse.PredictionResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Retail_V2_PredictResponse.protoMessageName + ".PredictionResult"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
  ...
  public static func ==(lhs: Google_Cloud_Retail_V2_PredictResponse.PredictionResult, rhs: Google_Cloud_Retail_V2_PredictResponse.PredictionResult) -> Bool {
