...
public struct Google_Cloud_Dataproc_V1_ClusterOperationStatus {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Output only. A message containing the operation state.
  public var state: Google_Cloud_Dataproc_V1_ClusterOperationStatus.State = .unknown
...
extension Google_Cloud_Dataproc_V1_ClusterOperationStatus.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Dataproc_V1_ClusterOperationStatus.State] = [
    .unknown,
    .pending,
    .running,
    .done,
...
public struct Google_Cloud_Dataproc_V1_ClusterOperationMetadata {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var status: Google_Cloud_Dataproc_V1_ClusterOperationStatus {
    get {return _status ?? Google_Cloud_Dataproc_V1_ClusterOperationStatus()}
  ...
  public var statusHistory: [Google_Cloud_Dataproc_V1_ClusterOperationStatus] = []
  ...
  fileprivate var _status: Google_Cloud_Dataproc_V1_ClusterOperationStatus? = nil
}
...
extension Google_Cloud_Dataproc_V1_ClusterOperationStatus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dataproc_V1_ClusterOperationStatus, rhs: Google_Cloud_Dataproc_V1_ClusterOperationStatus) -> Bool {
...
extension Google_Cloud_Dataproc_V1_ClusterOperationStatus.State: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Dataproc_V1_ClusterOperationMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dataproc_V1_ClusterOperationMetadata, rhs: Google_Cloud_Dataproc_V1_ClusterOperationMetadata) -> Bool {
