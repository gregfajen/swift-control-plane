...
public struct Google_Cloud_Datacatalog_V1beta1_Schema {
  ...
  /// specified.
  public var columns: [Google_Cloud_Datacatalog_V1beta1_ColumnSchema] = []
...
/// other columns.
public struct Google_Cloud_Datacatalog_V1beta1_ColumnSchema {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var subcolumns: [Google_Cloud_Datacatalog_V1beta1_ColumnSchema] = []
...
extension Google_Cloud_Datacatalog_V1beta1_Schema: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Datacatalog_V1beta1_Schema, rhs: Google_Cloud_Datacatalog_V1beta1_Schema) -> Bool {
...
extension Google_Cloud_Datacatalog_V1beta1_ColumnSchema: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Datacatalog_V1beta1_ColumnSchema, rhs: Google_Cloud_Datacatalog_V1beta1_ColumnSchema) -> Bool {
