...
public struct Google_Cloud_Datacatalog_V1beta1_Tag {
  ...
  public var scope: Google_Cloud_Datacatalog_V1beta1_Tag.OneOf_Scope? = nil
  ...
  public var fields: Dictionary<String,Google_Cloud_Datacatalog_V1beta1_TagField> = [:]
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Datacatalog_V1beta1_Tag.OneOf_Scope, rhs: Google_Cloud_Datacatalog_V1beta1_Tag.OneOf_Scope) -> Bool {
...
public struct Google_Cloud_Datacatalog_V1beta1_TagField {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var kind: Google_Cloud_Datacatalog_V1beta1_TagField.OneOf_Kind? = nil
  ...
  public var enumValue: Google_Cloud_Datacatalog_V1beta1_TagField.EnumValue {
    get {
      if case .enumValue(let v)? = kind {return v}
      return Google_Cloud_Datacatalog_V1beta1_TagField.EnumValue()
    }
  ...
  public enum OneOf_Kind: Equatable {
    ...
    /// Holds the value for a tag field with enum type. This value must be
    /// one of the allowed values in the definition of this enum.
    case enumValue(Google_Cloud_Datacatalog_V1beta1_TagField.EnumValue)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Datacatalog_V1beta1_TagField.OneOf_Kind, rhs: Google_Cloud_Datacatalog_V1beta1_TagField.OneOf_Kind) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Google_Cloud_Datacatalog_V1beta1_TagTemplate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var fields: Dictionary<String,Google_Cloud_Datacatalog_V1beta1_TagTemplateField> = [:]
...
public struct Google_Cloud_Datacatalog_V1beta1_TagTemplateField {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var type: Google_Cloud_Datacatalog_V1beta1_FieldType {
    get {return _type ?? Google_Cloud_Datacatalog_V1beta1_FieldType()}
    set {_type = newValue}
  }
  ...
  fileprivate var _type: Google_Cloud_Datacatalog_V1beta1_FieldType? = nil
}

public struct Google_Cloud_Datacatalog_V1beta1_FieldType {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Required.
  public var typeDecl: Google_Cloud_Datacatalog_V1beta1_FieldType.OneOf_TypeDecl? = nil

  /// Represents primitive types - string, bool etc.
  public var primitiveType: Google_Cloud_Datacatalog_V1beta1_FieldType.PrimitiveType {
    get {
  ...
  public var enumType: Google_Cloud_Datacatalog_V1beta1_FieldType.EnumType {
    get {
      if case .enumType(let v)? = typeDecl {return v}
      return Google_Cloud_Datacatalog_V1beta1_FieldType.EnumType()
    }
  ...
  public enum OneOf_TypeDecl: Equatable {
    /// Represents primitive types - string, bool etc.
    case primitiveType(Google_Cloud_Datacatalog_V1beta1_FieldType.PrimitiveType)
    /// Represents an enum type.
    case enumType(Google_Cloud_Datacatalog_V1beta1_FieldType.EnumType)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Datacatalog_V1beta1_FieldType.OneOf_TypeDecl, rhs: Google_Cloud_Datacatalog_V1beta1_FieldType.OneOf_TypeDecl) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
  ...
  public struct EnumType {
    ...
    public var allowedValues: [Google_Cloud_Datacatalog_V1beta1_FieldType.EnumType.EnumValue] = []
...
extension Google_Cloud_Datacatalog_V1beta1_FieldType.PrimitiveType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Datacatalog_V1beta1_FieldType.PrimitiveType] = [
    .unspecified,
    .double,
    .string,
    .bool,
...
extension Google_Cloud_Datacatalog_V1beta1_Tag: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Datacatalog_V1beta1_TagField>.self, value: &self.fields) }()
      case 4: try {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.fields.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Datacatalog_V1beta1_TagField>.self, value: self.fields, fieldNumber: 3)
    }
  ...
  public static func ==(lhs: Google_Cloud_Datacatalog_V1beta1_Tag, rhs: Google_Cloud_Datacatalog_V1beta1_Tag) -> Bool {
...
extension Google_Cloud_Datacatalog_V1beta1_TagField: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try {
        var v: Google_Cloud_Datacatalog_V1beta1_TagField.EnumValue?
        if let current = self.kind {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Cloud_Datacatalog_V1beta1_TagField, rhs: Google_Cloud_Datacatalog_V1beta1_TagField) -> Bool {
...
extension Google_Cloud_Datacatalog_V1beta1_TagField.EnumValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Datacatalog_V1beta1_TagField.protoMessageName + ".EnumValue"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "display_name"),
  ]
  ...
  public static func ==(lhs: Google_Cloud_Datacatalog_V1beta1_TagField.EnumValue, rhs: Google_Cloud_Datacatalog_V1beta1_TagField.EnumValue) -> Bool {
    if lhs.displayName != rhs.displayName {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Google_Cloud_Datacatalog_V1beta1_TagTemplate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Datacatalog_V1beta1_TagTemplateField>.self, value: &self.fields) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.fields.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Datacatalog_V1beta1_TagTemplateField>.self, value: self.fields, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Datacatalog_V1beta1_TagTemplate, rhs: Google_Cloud_Datacatalog_V1beta1_TagTemplate) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.displayName != rhs.displayName {return false}
    if lhs.fields != rhs.fields {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Google_Cloud_Datacatalog_V1beta1_TagTemplateField: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Datacatalog_V1beta1_TagTemplateField, rhs: Google_Cloud_Datacatalog_V1beta1_TagTemplateField) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.displayName != rhs.displayName {return false}
...
extension Google_Cloud_Datacatalog_V1beta1_FieldType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try {
        ...
        var v: Google_Cloud_Datacatalog_V1beta1_FieldType.PrimitiveType?
        try decoder.decodeSingularEnumField(value: &v)
        if let v = v {self.typeDecl = .primitiveType(v)}
      }()
      case 2: try {
        var v: Google_Cloud_Datacatalog_V1beta1_FieldType.EnumType?
  ...
  public static func ==(lhs: Google_Cloud_Datacatalog_V1beta1_FieldType, rhs: Google_Cloud_Datacatalog_V1beta1_FieldType) -> Bool {
...
extension Google_Cloud_Datacatalog_V1beta1_FieldType.PrimitiveType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Datacatalog_V1beta1_FieldType.EnumType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Datacatalog_V1beta1_FieldType.protoMessageName + ".EnumType"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Datacatalog_V1beta1_FieldType.EnumType, rhs: Google_Cloud_Datacatalog_V1beta1_FieldType.EnumType) -> Bool {
...
extension Google_Cloud_Datacatalog_V1beta1_FieldType.EnumType.EnumValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Datacatalog_V1beta1_FieldType.EnumType.protoMessageName + ".EnumValue"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "display_name"),
  ]
  ...
  public static func ==(lhs: Google_Cloud_Datacatalog_V1beta1_FieldType.EnumType.EnumValue, rhs: Google_Cloud_Datacatalog_V1beta1_FieldType.EnumType.EnumValue) -> Bool {
    if lhs.displayName != rhs.displayName {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
