...
public struct Google_Cloud_Datacatalog_V1_GcsFilesetSpec {
  ...
  public var sampleGcsFileSpecs: [Google_Cloud_Datacatalog_V1_GcsFileSpec] = []
...
public struct Google_Cloud_Datacatalog_V1_GcsFileSpec {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var gcsTimestamps: Google_Cloud_Datacatalog_V1_SystemTimestamps {
    get {return _gcsTimestamps ?? Google_Cloud_Datacatalog_V1_SystemTimestamps()}
  ...
  fileprivate var _gcsTimestamps: Google_Cloud_Datacatalog_V1_SystemTimestamps? = nil
}
...
extension Google_Cloud_Datacatalog_V1_GcsFilesetSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Datacatalog_V1_GcsFilesetSpec, rhs: Google_Cloud_Datacatalog_V1_GcsFilesetSpec) -> Bool {
...
extension Google_Cloud_Datacatalog_V1_GcsFileSpec: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Datacatalog_V1_GcsFileSpec, rhs: Google_Cloud_Datacatalog_V1_GcsFileSpec) -> Bool {
