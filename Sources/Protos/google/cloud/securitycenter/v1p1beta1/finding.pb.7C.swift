...
public struct Google_Cloud_Securitycenter_V1p1beta1_Finding {
  ...
  /// writes the finding.
  public var severity: Google_Cloud_Securitycenter_V1p1beta1_Finding.Severity = .unspecified
...
extension Google_Cloud_Securitycenter_V1p1beta1_Finding.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Securitycenter_V1p1beta1_Finding.State] = [
    .unspecified,
    .active,
    .inactive,
  ]
...
extension Google_Cloud_Securitycenter_V1p1beta1_Finding.Severity: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Securitycenter_V1p1beta1_Finding.Severity] = [
    .unspecified,
    .critical,
    .high,
    .medium,
...
extension Google_Cloud_Securitycenter_V1p1beta1_Finding: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Securitycenter_V1p1beta1_Finding, rhs: Google_Cloud_Securitycenter_V1p1beta1_Finding) -> Bool {
...
extension Google_Cloud_Securitycenter_V1p1beta1_Finding.State: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Securitycenter_V1p1beta1_Finding.Severity: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
