...
public struct Google_Cloud_Securitycenter_V1_NotificationMessage {
  ...
  public var finding: Google_Cloud_Securitycenter_V1_Finding {
    get {
      ...
      return Google_Cloud_Securitycenter_V1_Finding()
    }
    set {_uniqueStorage()._event = .finding(newValue)}
  }

  /// The Cloud resource tied to this notification's Finding.
  public var resource: Google_Cloud_Securitycenter_V1_Resource {
    get {return _storage._resource ?? Google_Cloud_Securitycenter_V1_Resource()}
  ...
  public enum OneOf_Event: Equatable {
    /// If it's a Finding based notification config, this field will be
    /// populated.
    case finding(Google_Cloud_Securitycenter_V1_Finding)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Securitycenter_V1_NotificationMessage.OneOf_Event, rhs: Google_Cloud_Securitycenter_V1_NotificationMessage.OneOf_Event) -> Bool {
...
extension Google_Cloud_Securitycenter_V1_NotificationMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _event: Google_Cloud_Securitycenter_V1_NotificationMessage.OneOf_Event?
    var _resource: Google_Cloud_Securitycenter_V1_Resource? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try {
          var v: Google_Cloud_Securitycenter_V1_Finding?
  ...
  public static func ==(lhs: Google_Cloud_Securitycenter_V1_NotificationMessage, rhs: Google_Cloud_Securitycenter_V1_NotificationMessage) -> Bool {
