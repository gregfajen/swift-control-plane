...
public struct Google_Cloud_Bigquery_Storage_V1beta2_ProtoSchema {
...
/// Protobuf rows.
public struct Google_Cloud_Bigquery_Storage_V1beta2_ProtoRows {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Bigquery_Storage_V1beta2_ProtoSchema: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Bigquery_Storage_V1beta2_ProtoSchema, rhs: Google_Cloud_Bigquery_Storage_V1beta2_ProtoSchema) -> Bool {
...
extension Google_Cloud_Bigquery_Storage_V1beta2_ProtoRows: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Bigquery_Storage_V1beta2_ProtoRows, rhs: Google_Cloud_Bigquery_Storage_V1beta2_ProtoRows) -> Bool {
