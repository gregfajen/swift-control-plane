...
public enum Google_Cloud_Bigquery_Storage_V1beta2_DataFormat: SwiftProtobuf.Enum {
...
extension Google_Cloud_Bigquery_Storage_V1beta2_DataFormat: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Bigquery_Storage_V1beta2_DataFormat] = [
    .unspecified,
    .avro,
    .arrow,
  ]
...
public struct Google_Cloud_Bigquery_Storage_V1beta2_ReadSession {
  ...
  public var dataFormat: Google_Cloud_Bigquery_Storage_V1beta2_DataFormat = .unspecified

  /// The schema for the read. If read_options.selected_fields is set, the
  /// schema may be different from the table schema as it will only contain
  /// the selected fields.
  public var schema: Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.OneOf_Schema? = nil

  /// Output only. Avro schema.
  public var avroSchema: Google_Cloud_Bigquery_Storage_V1beta2_AvroSchema {
    get {
      if case .avroSchema(let v)? = schema {return v}
      return Google_Cloud_Bigquery_Storage_V1beta2_AvroSchema()
    }
    set {schema = .avroSchema(newValue)}
  }

  /// Output only. Arrow schema.
  public var arrowSchema: Google_Cloud_Bigquery_Storage_V1beta2_ArrowSchema {
    get {
      if case .arrowSchema(let v)? = schema {return v}
      return Google_Cloud_Bigquery_Storage_V1beta2_ArrowSchema()
    }
  ...
  public var tableModifiers: Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.TableModifiers {
    get {return _tableModifiers ?? Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.TableModifiers()}
  ...
  public var readOptions: Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.TableReadOptions {
    get {return _readOptions ?? Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.TableReadOptions()}
  ...
  public var streams: [Google_Cloud_Bigquery_Storage_V1beta2_ReadStream] = []
  ...
  public enum OneOf_Schema: Equatable {
    /// Output only. Avro schema.
    case avroSchema(Google_Cloud_Bigquery_Storage_V1beta2_AvroSchema)
    /// Output only. Arrow schema.
    case arrowSchema(Google_Cloud_Bigquery_Storage_V1beta2_ArrowSchema)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.OneOf_Schema, rhs: Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.OneOf_Schema) -> Bool {
  ...
  public struct TableReadOptions {
    ...
    public var arrowSerializationOptions: Google_Cloud_Bigquery_Storage_V1beta2_ArrowSerializationOptions {
      get {return _arrowSerializationOptions ?? Google_Cloud_Bigquery_Storage_V1beta2_ArrowSerializationOptions()}
      set {_arrowSerializationOptions = newValue}
    }
    /// Returns true if `arrowSerializationOptions` has been explicitly set.
    public var hasArrowSerializationOptions: Bool {return self._arrowSerializationOptions != nil}
    /// Clears the value of `arrowSerializationOptions`. Subsequent reads from it will return its default value.
    public mutating func clearArrowSerializationOptions() {self._arrowSerializationOptions = nil}

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public init() {}

    fileprivate var _arrowSerializationOptions: Google_Cloud_Bigquery_Storage_V1beta2_ArrowSerializationOptions? = nil
  }

  public init() {}

  fileprivate var _expireTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
  fileprivate var _tableModifiers: Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.TableModifiers? = nil
  fileprivate var _readOptions: Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.TableReadOptions? = nil
}

/// Information about a single stream that gets data out of the storage system.
/// Most of the information about `ReadStream` instances is aggregated, making
/// `ReadStream` lightweight.
public struct Google_Cloud_Bigquery_Storage_V1beta2_ReadStream {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Bigquery_Storage_V1beta2_WriteStream {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var type: Google_Cloud_Bigquery_Storage_V1beta2_WriteStream.TypeEnum = .unspecified
  ...
  public var tableSchema: Google_Cloud_Bigquery_Storage_V1beta2_TableSchema {
    get {return _tableSchema ?? Google_Cloud_Bigquery_Storage_V1beta2_TableSchema()}
  ...
  fileprivate var _tableSchema: Google_Cloud_Bigquery_Storage_V1beta2_TableSchema? = nil
}

#if swift(>=4.2)

extension Google_Cloud_Bigquery_Storage_V1beta2_WriteStream.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Bigquery_Storage_V1beta2_WriteStream.TypeEnum] = [
    .unspecified,
    .committed,
    .pending,
    .buffered,
...
extension Google_Cloud_Bigquery_Storage_V1beta2_DataFormat: SwiftProtobuf._ProtoNameProviding {
...
extension Google_Cloud_Bigquery_Storage_V1beta2_ReadSession: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try {
        var v: Google_Cloud_Bigquery_Storage_V1beta2_AvroSchema?
      ...
      case 5: try {
        var v: Google_Cloud_Bigquery_Storage_V1beta2_ArrowSchema?
        if let current = self.schema {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Cloud_Bigquery_Storage_V1beta2_ReadSession, rhs: Google_Cloud_Bigquery_Storage_V1beta2_ReadSession) -> Bool {
...
extension Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.TableModifiers: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.protoMessageName + ".TableModifiers"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.TableModifiers, rhs: Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.TableModifiers) -> Bool {
...
extension Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.TableReadOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.protoMessageName + ".TableReadOptions"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularMessageField(value: &self._arrowSerializationOptions) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._arrowSerializationOptions {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.TableReadOptions, rhs: Google_Cloud_Bigquery_Storage_V1beta2_ReadSession.TableReadOptions) -> Bool {
    if lhs.selectedFields != rhs.selectedFields {return false}
    if lhs.rowRestriction != rhs.rowRestriction {return false}
    if lhs._arrowSerializationOptions != rhs._arrowSerializationOptions {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Google_Cloud_Bigquery_Storage_V1beta2_ReadStream: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Bigquery_Storage_V1beta2_ReadStream, rhs: Google_Cloud_Bigquery_Storage_V1beta2_ReadStream) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Google_Cloud_Bigquery_Storage_V1beta2_WriteStream: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Bigquery_Storage_V1beta2_WriteStream, rhs: Google_Cloud_Bigquery_Storage_V1beta2_WriteStream) -> Bool {
    if lhs.name != rhs.name {return false}
...
extension Google_Cloud_Bigquery_Storage_V1beta2_WriteStream.TypeEnum: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
