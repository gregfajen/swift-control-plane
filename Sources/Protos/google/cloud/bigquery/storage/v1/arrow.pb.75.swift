...
public struct Google_Cloud_Bigquery_Storage_V1_ArrowSchema {
...
/// Arrow RecordBatch.
public struct Google_Cloud_Bigquery_Storage_V1_ArrowRecordBatch {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Bigquery_Storage_V1_ArrowSchema: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Bigquery_Storage_V1_ArrowSchema, rhs: Google_Cloud_Bigquery_Storage_V1_ArrowSchema) -> Bool {
...
extension Google_Cloud_Bigquery_Storage_V1_ArrowRecordBatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Bigquery_Storage_V1_ArrowRecordBatch, rhs: Google_Cloud_Bigquery_Storage_V1_ArrowRecordBatch) -> Bool {
