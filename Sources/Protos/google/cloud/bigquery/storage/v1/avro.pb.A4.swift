...
/// Avro schema.
public struct Google_Cloud_Bigquery_Storage_V1_AvroSchema {
...
/// Avro rows.
public struct Google_Cloud_Bigquery_Storage_V1_AvroRows {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Bigquery_Storage_V1_AvroSchema: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Bigquery_Storage_V1_AvroSchema, rhs: Google_Cloud_Bigquery_Storage_V1_AvroSchema) -> Bool {
...
extension Google_Cloud_Bigquery_Storage_V1_AvroRows: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Bigquery_Storage_V1_AvroRows, rhs: Google_Cloud_Bigquery_Storage_V1_AvroRows) -> Bool {
