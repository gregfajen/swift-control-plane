...
public struct Google_Cloud_Scheduler_V1_Job {
  ...
  /// Pub/Sub target.
  public var pubsubTarget: Google_Cloud_Scheduler_V1_PubsubTarget {
    get {
      if case .pubsubTarget(let v)? = _storage._target {return v}
      return Google_Cloud_Scheduler_V1_PubsubTarget()
    }
    set {_uniqueStorage()._target = .pubsubTarget(newValue)}
  }

  /// App Engine HTTP target.
  public var appEngineHTTPTarget: Google_Cloud_Scheduler_V1_AppEngineHttpTarget {
    get {
      if case .appEngineHTTPTarget(let v)? = _storage._target {return v}
      return Google_Cloud_Scheduler_V1_AppEngineHttpTarget()
    }
    set {_uniqueStorage()._target = .appEngineHTTPTarget(newValue)}
  }

  /// HTTP target.
  public var httpTarget: Google_Cloud_Scheduler_V1_HttpTarget {
    get {
      if case .httpTarget(let v)? = _storage._target {return v}
      return Google_Cloud_Scheduler_V1_HttpTarget()
    }
  ...
  public var state: Google_Cloud_Scheduler_V1_Job.State {
  ...
  public var retryConfig: Google_Cloud_Scheduler_V1_RetryConfig {
    get {return _storage._retryConfig ?? Google_Cloud_Scheduler_V1_RetryConfig()}
  ...
  public enum OneOf_Target: Equatable {
    /// Pub/Sub target.
    case pubsubTarget(Google_Cloud_Scheduler_V1_PubsubTarget)
    /// App Engine HTTP target.
    case appEngineHTTPTarget(Google_Cloud_Scheduler_V1_AppEngineHttpTarget)
    /// HTTP target.
    case httpTarget(Google_Cloud_Scheduler_V1_HttpTarget)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Scheduler_V1_Job.OneOf_Target, rhs: Google_Cloud_Scheduler_V1_Job.OneOf_Target) -> Bool {
...
extension Google_Cloud_Scheduler_V1_Job.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Scheduler_V1_Job.State] = [
    .unspecified,
    .enabled,
    .paused,
    .disabled,
...
public struct Google_Cloud_Scheduler_V1_RetryConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Scheduler_V1_Job: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _retryConfig: Google_Cloud_Scheduler_V1_RetryConfig? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try {
          var v: Google_Cloud_Scheduler_V1_PubsubTarget?
        ...
        case 5: try {
          var v: Google_Cloud_Scheduler_V1_AppEngineHttpTarget?
          if let current = _storage._target {
            try decoder.handleConflictingOneOf()
        ...
        case 6: try {
          var v: Google_Cloud_Scheduler_V1_HttpTarget?
          if let current = _storage._target {
            try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Cloud_Scheduler_V1_Job, rhs: Google_Cloud_Scheduler_V1_Job) -> Bool {
...
extension Google_Cloud_Scheduler_V1_Job.State: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Scheduler_V1_RetryConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Scheduler_V1_RetryConfig, rhs: Google_Cloud_Scheduler_V1_RetryConfig) -> Bool {
