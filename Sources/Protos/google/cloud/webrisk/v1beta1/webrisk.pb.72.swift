...
/// belong to.
public enum Google_Cloud_Webrisk_V1beta1_ThreatType: SwiftProtobuf.Enum {
...
extension Google_Cloud_Webrisk_V1beta1_ThreatType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Webrisk_V1beta1_ThreatType] = [
    .unspecified,
    .malware,
    .socialEngineering,
    .unwantedSoftware,
...
public enum Google_Cloud_Webrisk_V1beta1_CompressionType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Webrisk_V1beta1_CompressionType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Webrisk_V1beta1_CompressionType] = [
    .unspecified,
    .raw,
    .rice,
  ]
...
public struct Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The ThreatList to update.
  public var threatType: Google_Cloud_Webrisk_V1beta1_ThreatType = .unspecified
  ...
  public var constraints: Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffRequest.Constraints {
    get {return _constraints ?? Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffRequest.Constraints()}
  ...
  public struct Constraints {
    ...
    public var supportedCompressions: [Google_Cloud_Webrisk_V1beta1_CompressionType] = []
  ...
  fileprivate var _constraints: Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffRequest.Constraints? = nil
}

public struct Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var responseType: Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse.ResponseType = .unspecified

  /// A set of entries to add to a local threat type's list.
  public var additions: Google_Cloud_Webrisk_V1beta1_ThreatEntryAdditions {
    get {return _additions ?? Google_Cloud_Webrisk_V1beta1_ThreatEntryAdditions()}
  ...
  public var removals: Google_Cloud_Webrisk_V1beta1_ThreatEntryRemovals {
    get {return _removals ?? Google_Cloud_Webrisk_V1beta1_ThreatEntryRemovals()}
  ...
  public var checksum: Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse.Checksum {
    get {return _checksum ?? Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse.Checksum()}
  ...
  fileprivate var _additions: Google_Cloud_Webrisk_V1beta1_ThreatEntryAdditions? = nil
  fileprivate var _removals: Google_Cloud_Webrisk_V1beta1_ThreatEntryRemovals? = nil
  fileprivate var _checksum: Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse.Checksum? = nil
  fileprivate var _recommendedNextDiff: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
}

#if swift(>=4.2)

extension Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse.ResponseType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse.ResponseType] = [
    .unspecified,
    .diff,
    .reset,
  ]
...
public struct Google_Cloud_Webrisk_V1beta1_SearchUrisRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var threatTypes: [Google_Cloud_Webrisk_V1beta1_ThreatType] = []
...
public struct Google_Cloud_Webrisk_V1beta1_SearchUrisResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The threat list matches. This may be empty if the URI is on no list.
  public var threat: Google_Cloud_Webrisk_V1beta1_SearchUrisResponse.ThreatUri {
    get {return _threat ?? Google_Cloud_Webrisk_V1beta1_SearchUrisResponse.ThreatUri()}
  ...
  fileprivate var _threat: Google_Cloud_Webrisk_V1beta1_SearchUrisResponse.ThreatUri? = nil
}

/// Request to return full hashes matched by the provided hash prefixes.
public struct Google_Cloud_Webrisk_V1beta1_SearchHashesRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Webrisk_V1beta1_SearchHashesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var threats: [Google_Cloud_Webrisk_V1beta1_SearchHashesResponse.ThreatHash] = []
...
public struct Google_Cloud_Webrisk_V1beta1_ThreatEntryAdditions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var rawHashes: [Google_Cloud_Webrisk_V1beta1_RawHashes] = []

  /// The encoded 4-byte prefixes of SHA256-formatted entries, using a
  /// Golomb-Rice encoding. The hashes are converted to uint32, sorted in
  /// ascending order, then delta encoded and stored as encoded_data.
  public var riceHashes: Google_Cloud_Webrisk_V1beta1_RiceDeltaEncoding {
    get {return _riceHashes ?? Google_Cloud_Webrisk_V1beta1_RiceDeltaEncoding()}
  ...
  fileprivate var _riceHashes: Google_Cloud_Webrisk_V1beta1_RiceDeltaEncoding? = nil
}

/// Contains the set of entries to remove from a local database.
public struct Google_Cloud_Webrisk_V1beta1_ThreatEntryRemovals {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The raw removal indices for a local list.
  public var rawIndices: Google_Cloud_Webrisk_V1beta1_RawIndices {
    get {return _rawIndices ?? Google_Cloud_Webrisk_V1beta1_RawIndices()}
  ...
  public var riceIndices: Google_Cloud_Webrisk_V1beta1_RiceDeltaEncoding {
    get {return _riceIndices ?? Google_Cloud_Webrisk_V1beta1_RiceDeltaEncoding()}
  ...
  fileprivate var _rawIndices: Google_Cloud_Webrisk_V1beta1_RawIndices? = nil
  fileprivate var _riceIndices: Google_Cloud_Webrisk_V1beta1_RiceDeltaEncoding? = nil
}

/// A set of raw indices to remove from a local list.
public struct Google_Cloud_Webrisk_V1beta1_RawIndices {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// compression.
public struct Google_Cloud_Webrisk_V1beta1_RawHashes {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Webrisk_V1beta1_RiceDeltaEncoding {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "google.cloud.webrisk.v1beta1"

extension Google_Cloud_Webrisk_V1beta1_ThreatType: SwiftProtobuf._ProtoNameProviding {
...
extension Google_Cloud_Webrisk_V1beta1_CompressionType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffRequest, rhs: Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffRequest) -> Bool {
...
extension Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffRequest.Constraints: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffRequest.protoMessageName + ".Constraints"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffRequest.Constraints, rhs: Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffRequest.Constraints) -> Bool {
...
extension Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse, rhs: Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse) -> Bool {
...
extension Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse.ResponseType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse.Checksum: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse.protoMessageName + ".Checksum"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "sha256"),
  ]
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse.Checksum, rhs: Google_Cloud_Webrisk_V1beta1_ComputeThreatListDiffResponse.Checksum) -> Bool {
...
extension Google_Cloud_Webrisk_V1beta1_SearchUrisRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_SearchUrisRequest, rhs: Google_Cloud_Webrisk_V1beta1_SearchUrisRequest) -> Bool {
...
extension Google_Cloud_Webrisk_V1beta1_SearchUrisResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_SearchUrisResponse, rhs: Google_Cloud_Webrisk_V1beta1_SearchUrisResponse) -> Bool {
...
extension Google_Cloud_Webrisk_V1beta1_SearchUrisResponse.ThreatUri: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Webrisk_V1beta1_SearchUrisResponse.protoMessageName + ".ThreatUri"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_SearchUrisResponse.ThreatUri, rhs: Google_Cloud_Webrisk_V1beta1_SearchUrisResponse.ThreatUri) -> Bool {
    if lhs.threatTypes != rhs.threatTypes {return false}
...
extension Google_Cloud_Webrisk_V1beta1_SearchHashesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_SearchHashesRequest, rhs: Google_Cloud_Webrisk_V1beta1_SearchHashesRequest) -> Bool {
...
extension Google_Cloud_Webrisk_V1beta1_SearchHashesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_SearchHashesResponse, rhs: Google_Cloud_Webrisk_V1beta1_SearchHashesResponse) -> Bool {
...
extension Google_Cloud_Webrisk_V1beta1_SearchHashesResponse.ThreatHash: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Webrisk_V1beta1_SearchHashesResponse.protoMessageName + ".ThreatHash"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "threat_types"),
    2: .same(proto: "hash"),
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_SearchHashesResponse.ThreatHash, rhs: Google_Cloud_Webrisk_V1beta1_SearchHashesResponse.ThreatHash) -> Bool {
    if lhs.threatTypes != rhs.threatTypes {return false}
...
extension Google_Cloud_Webrisk_V1beta1_ThreatEntryAdditions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_ThreatEntryAdditions, rhs: Google_Cloud_Webrisk_V1beta1_ThreatEntryAdditions) -> Bool {
...
extension Google_Cloud_Webrisk_V1beta1_ThreatEntryRemovals: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_ThreatEntryRemovals, rhs: Google_Cloud_Webrisk_V1beta1_ThreatEntryRemovals) -> Bool {
...
extension Google_Cloud_Webrisk_V1beta1_RawIndices: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_RawIndices, rhs: Google_Cloud_Webrisk_V1beta1_RawIndices) -> Bool {
...
extension Google_Cloud_Webrisk_V1beta1_RawHashes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_RawHashes, rhs: Google_Cloud_Webrisk_V1beta1_RawHashes) -> Bool {
...
extension Google_Cloud_Webrisk_V1beta1_RiceDeltaEncoding: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Webrisk_V1beta1_RiceDeltaEncoding, rhs: Google_Cloud_Webrisk_V1beta1_RiceDeltaEncoding) -> Bool {
