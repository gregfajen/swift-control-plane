...
public struct Google_Cloud_Osconfig_Agentendpoint_V1beta_ReceiveTaskNotificationRequest {
...
public struct Google_Cloud_Osconfig_Agentendpoint_V1beta_ReceiveTaskNotificationResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Osconfig_Agentendpoint_V1beta_StartNextTaskRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Osconfig_Agentendpoint_V1beta_StartNextTaskResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var task: Google_Cloud_Osconfig_Agentendpoint_V1beta_Task {
    get {return _task ?? Google_Cloud_Osconfig_Agentendpoint_V1beta_Task()}
    set {_task = newValue}
  }
  ...
  fileprivate var _task: Google_Cloud_Osconfig_Agentendpoint_V1beta_Task? = nil
}

/// A request message for reporting the progress of current task.
public struct Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskProgressRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var taskType: Google_Cloud_Osconfig_Agentendpoint_V1beta_TaskType = .unspecified

  /// Intermediate progress of the current task.
  public var progress: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskProgressRequest.OneOf_Progress? = nil

  /// Details about the progress of the apply patches task.
  public var applyPatchesTaskProgress: Google_Cloud_Osconfig_Agentendpoint_V1beta_ApplyPatchesTaskProgress {
    get {
      if case .applyPatchesTaskProgress(let v)? = progress {return v}
      return Google_Cloud_Osconfig_Agentendpoint_V1beta_ApplyPatchesTaskProgress()
    }
    set {progress = .applyPatchesTaskProgress(newValue)}
  }

  /// Details about the progress of the exec step task.
  public var execStepTaskProgress: Google_Cloud_Osconfig_Agentendpoint_V1beta_ExecStepTaskProgress {
    get {
      if case .execStepTaskProgress(let v)? = progress {return v}
      return Google_Cloud_Osconfig_Agentendpoint_V1beta_ExecStepTaskProgress()
    }
  ...
  public enum OneOf_Progress: Equatable {
    /// Details about the progress of the apply patches task.
    case applyPatchesTaskProgress(Google_Cloud_Osconfig_Agentendpoint_V1beta_ApplyPatchesTaskProgress)
    /// Details about the progress of the exec step task.
    case execStepTaskProgress(Google_Cloud_Osconfig_Agentendpoint_V1beta_ExecStepTaskProgress)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskProgressRequest.OneOf_Progress, rhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskProgressRequest.OneOf_Progress) -> Bool {
...
public struct Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskProgressResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Instructs agent to continue or not.
  public var taskDirective: Google_Cloud_Osconfig_Agentendpoint_V1beta_TaskDirective = .unspecified
...
public struct Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskCompleteRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var output: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskCompleteRequest.OneOf_Output? = nil

  /// Final output details of the apply patches task;
  public var applyPatchesTaskOutput: Google_Cloud_Osconfig_Agentendpoint_V1beta_ApplyPatchesTaskOutput {
    get {
      if case .applyPatchesTaskOutput(let v)? = output {return v}
      return Google_Cloud_Osconfig_Agentendpoint_V1beta_ApplyPatchesTaskOutput()
    }
    set {output = .applyPatchesTaskOutput(newValue)}
  }

  /// Final output details of the exec step task;
  public var execStepTaskOutput: Google_Cloud_Osconfig_Agentendpoint_V1beta_ExecStepTaskOutput {
    get {
      if case .execStepTaskOutput(let v)? = output {return v}
      return Google_Cloud_Osconfig_Agentendpoint_V1beta_ExecStepTaskOutput()
    }
  ...
  public enum OneOf_Output: Equatable {
    /// Final output details of the apply patches task;
    case applyPatchesTaskOutput(Google_Cloud_Osconfig_Agentendpoint_V1beta_ApplyPatchesTaskOutput)
    /// Final output details of the exec step task;
    case execStepTaskOutput(Google_Cloud_Osconfig_Agentendpoint_V1beta_ExecStepTaskOutput)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskCompleteRequest.OneOf_Output, rhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskCompleteRequest.OneOf_Output) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskCompleteResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Osconfig_Agentendpoint_V1beta_RegisterAgentRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Osconfig_Agentendpoint_V1beta_RegisterAgentResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Osconfig_Agentendpoint_V1beta_ReceiveTaskNotificationRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReceiveTaskNotificationRequest, rhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReceiveTaskNotificationRequest) -> Bool {
...
extension Google_Cloud_Osconfig_Agentendpoint_V1beta_ReceiveTaskNotificationResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReceiveTaskNotificationResponse, rhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReceiveTaskNotificationResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Google_Cloud_Osconfig_Agentendpoint_V1beta_StartNextTaskRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_StartNextTaskRequest, rhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_StartNextTaskRequest) -> Bool {
    if lhs.instanceIDToken != rhs.instanceIDToken {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Google_Cloud_Osconfig_Agentendpoint_V1beta_StartNextTaskResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_StartNextTaskResponse, rhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_StartNextTaskResponse) -> Bool {
...
extension Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskProgressRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try {
        var v: Google_Cloud_Osconfig_Agentendpoint_V1beta_ApplyPatchesTaskProgress?
      ...
      case 5: try {
        var v: Google_Cloud_Osconfig_Agentendpoint_V1beta_ExecStepTaskProgress?
        if let current = self.progress {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskProgressRequest, rhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskProgressRequest) -> Bool {
    if lhs.instanceIDToken != rhs.instanceIDToken {return false}
...
extension Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskProgressResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskProgressResponse, rhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskProgressResponse) -> Bool {
...
extension Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskCompleteRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try {
        var v: Google_Cloud_Osconfig_Agentendpoint_V1beta_ApplyPatchesTaskOutput?
      ...
      case 6: try {
        var v: Google_Cloud_Osconfig_Agentendpoint_V1beta_ExecStepTaskOutput?
        if let current = self.output {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskCompleteRequest, rhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskCompleteRequest) -> Bool {
    if lhs.instanceIDToken != rhs.instanceIDToken {return false}
    if lhs.taskID != rhs.taskID {return false}
    if lhs.taskType != rhs.taskType {return false}
...
extension Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskCompleteResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskCompleteResponse, rhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_ReportTaskCompleteResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Google_Cloud_Osconfig_Agentendpoint_V1beta_RegisterAgentRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_RegisterAgentRequest, rhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_RegisterAgentRequest) -> Bool {
    if lhs.instanceIDToken != rhs.instanceIDToken {return false}
    if lhs.agentVersion != rhs.agentVersion {return false}
...
extension Google_Cloud_Osconfig_Agentendpoint_V1beta_RegisterAgentResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_RegisterAgentResponse, rhs: Google_Cloud_Osconfig_Agentendpoint_V1beta_RegisterAgentResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
