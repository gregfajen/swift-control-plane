...
public struct Google_Cloud_Documentai_V1beta2_Document {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Original source document from the user.
  public var source: Google_Cloud_Documentai_V1beta2_Document.OneOf_Source? = nil
  ...
  public var textStyles: [Google_Cloud_Documentai_V1beta2_Document.Style] = []

  /// Visual page layout for the [Document][google.cloud.documentai.v1beta2.Document].
  public var pages: [Google_Cloud_Documentai_V1beta2_Document.Page] = []

  /// A list of entities detected on [Document.text][google.cloud.documentai.v1beta2.Document.text]. For document shards,
  /// entities in this list may cross shard boundaries.
  public var entities: [Google_Cloud_Documentai_V1beta2_Document.Entity] = []

  /// Relationship among [Document.entities][google.cloud.documentai.v1beta2.Document.entities].
  public var entityRelations: [Google_Cloud_Documentai_V1beta2_Document.EntityRelation] = []

  /// Information about the sharding if this document is sharded part of a larger
  /// document. If the document is not sharded, this message is not specified.
  public var shardInfo: Google_Cloud_Documentai_V1beta2_Document.ShardInfo {
    get {return _shardInfo ?? Google_Cloud_Documentai_V1beta2_Document.ShardInfo()}
  ...
  public var labels: [Google_Cloud_Documentai_V1beta2_Document.Label] = []
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.OneOf_Source, rhs: Google_Cloud_Documentai_V1beta2_Document.OneOf_Source) -> Bool {
  ...
  public struct Label {
    ...
    public var source: Google_Cloud_Documentai_V1beta2_Document.Label.OneOf_Source? = nil
    ...
    public var automlModel: String {
      get {
        if case .automlModel(let v)? = source {return v}
        return String()
      }
      set {source = .automlModel(newValue)}
    }
    ...
    public enum OneOf_Source: Equatable {
      ...
      /// Format:
      /// `projects/{project-id}/locations/{location-id}/models/{model-id}`
      case automlModel(String)

    #if !swift(>=4.1)
      public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Label.OneOf_Source, rhs: Google_Cloud_Documentai_V1beta2_Document.Label.OneOf_Source) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
        case (.automlModel, .automlModel): return {
          guard case .automlModel(let l) = lhs, case .automlModel(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        }
      }
  ...
  public struct Style {
    ...
    public var textAnchor: Google_Cloud_Documentai_V1beta2_Document.TextAnchor {
      get {return _textAnchor ?? Google_Cloud_Documentai_V1beta2_Document.TextAnchor()}
    ...
    /// Font size.
    public var fontSize: Google_Cloud_Documentai_V1beta2_Document.Style.FontSize {
      get {return _fontSize ?? Google_Cloud_Documentai_V1beta2_Document.Style.FontSize()}
    ...
    fileprivate var _textAnchor: Google_Cloud_Documentai_V1beta2_Document.TextAnchor? = nil
    fileprivate var _color: Google_Type_Color? = nil
    fileprivate var _backgroundColor: Google_Type_Color? = nil
    fileprivate var _fontSize: Google_Cloud_Documentai_V1beta2_Document.Style.FontSize? = nil
  }
  ...
  public struct Page {
    ...
    public var dimension: Google_Cloud_Documentai_V1beta2_Document.Page.Dimension {
      get {return _storage._dimension ?? Google_Cloud_Documentai_V1beta2_Document.Page.Dimension()}
    ...
    public var layout: Google_Cloud_Documentai_V1beta2_Document.Page.Layout {
      get {return _storage._layout ?? Google_Cloud_Documentai_V1beta2_Document.Page.Layout()}
    ...
    public var detectedLanguages: [Google_Cloud_Documentai_V1beta2_Document.Page.DetectedLanguage] {
    ...
    public var blocks: [Google_Cloud_Documentai_V1beta2_Document.Page.Block] {
    ...
    public var paragraphs: [Google_Cloud_Documentai_V1beta2_Document.Page.Paragraph] {
    ...
    public var lines: [Google_Cloud_Documentai_V1beta2_Document.Page.Line] {
      get {return _storage._lines}
      set {_uniqueStorage()._lines = newValue}
    }

    /// A list of visually detected tokens on the page.
    public var tokens: [Google_Cloud_Documentai_V1beta2_Document.Page.Token] {
    ...
    public var visualElements: [Google_Cloud_Documentai_V1beta2_Document.Page.VisualElement] {
      get {return _storage._visualElements}
      set {_uniqueStorage()._visualElements = newValue}
    }

    /// A list of visually detected tables on the page.
    public var tables: [Google_Cloud_Documentai_V1beta2_Document.Page.Table] {
      get {return _storage._tables}
      set {_uniqueStorage()._tables = newValue}
    }

    /// A list of visually detected form fields on the page.
    public var formFields: [Google_Cloud_Documentai_V1beta2_Document.Page.FormField] {
    ...
    public struct Layout {
      ...
      public var boundingPoly: Google_Cloud_Documentai_V1beta2_BoundingPoly {
        get {return _boundingPoly ?? Google_Cloud_Documentai_V1beta2_BoundingPoly()}
      ...
      public var orientation: Google_Cloud_Documentai_V1beta2_Document.Page.Layout.Orientation = .unspecified
      ...
      fileprivate var _textAnchor: Google_Cloud_Documentai_V1beta2_Document.TextAnchor? = nil
      fileprivate var _boundingPoly: Google_Cloud_Documentai_V1beta2_BoundingPoly? = nil
    }
    ...
    public struct Block {
      ...
      public var layout: Google_Cloud_Documentai_V1beta2_Document.Page.Layout {
        get {return _layout ?? Google_Cloud_Documentai_V1beta2_Document.Page.Layout()}
      ...
      fileprivate var _layout: Google_Cloud_Documentai_V1beta2_Document.Page.Layout? = nil
    }
    ...
    public struct Token {
      ...
      public var detectedBreak: Google_Cloud_Documentai_V1beta2_Document.Page.Token.DetectedBreak {
        get {return _detectedBreak ?? Google_Cloud_Documentai_V1beta2_Document.Page.Token.DetectedBreak()}
      ...
      public struct DetectedBreak {
        ...
        /// Detected break type.
        public var type: Google_Cloud_Documentai_V1beta2_Document.Page.Token.DetectedBreak.TypeEnum = .unspecified
      ...
      fileprivate var _layout: Google_Cloud_Documentai_V1beta2_Document.Page.Layout? = nil
      fileprivate var _detectedBreak: Google_Cloud_Documentai_V1beta2_Document.Page.Token.DetectedBreak? = nil
    }
    ...
    public struct Table {
      ...
      public var headerRows: [Google_Cloud_Documentai_V1beta2_Document.Page.Table.TableRow] = []

      /// Body rows of the table.
      public var bodyRows: [Google_Cloud_Documentai_V1beta2_Document.Page.Table.TableRow] = []
      ...
      public struct TableRow {
        ...
        public var cells: [Google_Cloud_Documentai_V1beta2_Document.Page.Table.TableCell] = []
    ...
    public struct FormField {
      ...
      public var fieldName: Google_Cloud_Documentai_V1beta2_Document.Page.Layout {
        get {return _storage._fieldName ?? Google_Cloud_Documentai_V1beta2_Document.Page.Layout()}
        set {_uniqueStorage()._fieldName = newValue}
      }
      /// Returns true if `fieldName` has been explicitly set.
      public var hasFieldName: Bool {return _storage._fieldName != nil}
      /// Clears the value of `fieldName`. Subsequent reads from it will return its default value.
      public mutating func clearFieldName() {_uniqueStorage()._fieldName = nil}
      ...
      public var fieldValue: Google_Cloud_Documentai_V1beta2_Document.Page.Layout {
        get {return _storage._fieldValue ?? Google_Cloud_Documentai_V1beta2_Document.Page.Layout()}
        set {_uniqueStorage()._fieldValue = newValue}
      }
      /// Returns true if `fieldValue` has been explicitly set.
      public var hasFieldValue: Bool {return _storage._fieldValue != nil}
      /// Clears the value of `fieldValue`. Subsequent reads from it will return its default value.
      public mutating func clearFieldValue() {_uniqueStorage()._fieldValue = nil}

      /// A list of detected languages for name together with confidence.
      public var nameDetectedLanguages: [Google_Cloud_Documentai_V1beta2_Document.Page.DetectedLanguage] {
        get {return _storage._nameDetectedLanguages}
        set {_uniqueStorage()._nameDetectedLanguages = newValue}
      }

      /// A list of detected languages for value together with confidence.
      public var valueDetectedLanguages: [Google_Cloud_Documentai_V1beta2_Document.Page.DetectedLanguage] {
        get {return _storage._valueDetectedLanguages}
        set {_uniqueStorage()._valueDetectedLanguages = newValue}
      }
      ...
      public var correctedKeyText: String {
        get {return _storage._correctedKeyText}
        set {_uniqueStorage()._correctedKeyText = newValue}
      }

      /// An internal field, created for Labeling UI to export value text.
      public var correctedValueText: String {
        get {return _storage._correctedValueText}
        set {_uniqueStorage()._correctedValueText = newValue}
      }
  ...
  public struct Entity {
    ...
    public var pageAnchor: Google_Cloud_Documentai_V1beta2_Document.PageAnchor {
      get {return _pageAnchor ?? Google_Cloud_Documentai_V1beta2_Document.PageAnchor()}
      set {_pageAnchor = newValue}
    }
    /// Returns true if `pageAnchor` has been explicitly set.
    public var hasPageAnchor: Bool {return self._pageAnchor != nil}
    /// Clears the value of `pageAnchor`. Subsequent reads from it will return its default value.
    public mutating func clearPageAnchor() {self._pageAnchor = nil}
    ...
    public var boundingPolyForDemoFrontend: Google_Cloud_Documentai_V1beta2_BoundingPoly {
      get {return _boundingPolyForDemoFrontend ?? Google_Cloud_Documentai_V1beta2_BoundingPoly()}
      set {_boundingPolyForDemoFrontend = newValue}
    }
    /// Returns true if `boundingPolyForDemoFrontend` has been explicitly set.
    public var hasBoundingPolyForDemoFrontend: Bool {return self._boundingPolyForDemoFrontend != nil}
    /// Clears the value of `boundingPolyForDemoFrontend`. Subsequent reads from it will return its default value.
    public mutating func clearBoundingPolyForDemoFrontend() {self._boundingPolyForDemoFrontend = nil}
    ...
    fileprivate var _textAnchor: Google_Cloud_Documentai_V1beta2_Document.TextAnchor? = nil
    fileprivate var _pageAnchor: Google_Cloud_Documentai_V1beta2_Document.PageAnchor? = nil
    fileprivate var _boundingPolyForDemoFrontend: Google_Cloud_Documentai_V1beta2_BoundingPoly? = nil
  }
  ...
  public struct TextAnchor {
    ...
    public var textSegments: [Google_Cloud_Documentai_V1beta2_Document.TextAnchor.TextSegment] = []
  ...
  public struct PageAnchor {
    ...
    public var pageRefs: [Google_Cloud_Documentai_V1beta2_Document.PageAnchor.PageRef] = []
    ...
    public struct PageRef {
      ...
      public var layoutType: Google_Cloud_Documentai_V1beta2_Document.PageAnchor.PageRef.LayoutType = .unspecified
  ...
  fileprivate var _shardInfo: Google_Cloud_Documentai_V1beta2_Document.ShardInfo? = nil
  fileprivate var _error: Google_Rpc_Status? = nil
}

#if swift(>=4.2)

extension Google_Cloud_Documentai_V1beta2_Document.Page.Layout.Orientation: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Documentai_V1beta2_Document.Page.Layout.Orientation] = [
    .unspecified,
    .pageUp,
    .pageRight,
    .pageDown,
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.Token.DetectedBreak.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Documentai_V1beta2_Document.Page.Token.DetectedBreak.TypeEnum] = [
    .unspecified,
    .space,
    .wideSpace,
    .hyphen,
...
extension Google_Cloud_Documentai_V1beta2_Document.PageAnchor.PageRef.LayoutType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Documentai_V1beta2_Document.PageAnchor.PageRef.LayoutType] = [
    .unspecified,
    .block,
    .paragraph,
    .line,
...
extension Google_Cloud_Documentai_V1beta2_Document: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 11: try { try decoder.decodeRepeatedMessageField(value: &self.labels) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.labels.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.labels, fieldNumber: 11)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document, rhs: Google_Cloud_Documentai_V1beta2_Document) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.ShardInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.protoMessageName + ".ShardInfo"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.ShardInfo, rhs: Google_Cloud_Documentai_V1beta2_Document.ShardInfo) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.Label: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.protoMessageName + ".Label"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        ...
        var v: String?
        try decoder.decodeSingularStringField(value: &v)
        if let v = v {self.source = .automlModel(v)}
      }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if case .automlModel(let v)? = self.source {
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Label, rhs: Google_Cloud_Documentai_V1beta2_Document.Label) -> Bool {
    if lhs.source != rhs.source {return false}
...
extension Google_Cloud_Documentai_V1beta2_Document.Style: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.protoMessageName + ".Style"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Style, rhs: Google_Cloud_Documentai_V1beta2_Document.Style) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.Style.FontSize: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.Style.protoMessageName + ".FontSize"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "size"),
    2: .same(proto: "unit"),
  ]
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Style.FontSize, rhs: Google_Cloud_Documentai_V1beta2_Document.Style.FontSize) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.Page: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.protoMessageName + ".Page"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  fileprivate class _StorageClass {
    ...
    var _dimension: Google_Cloud_Documentai_V1beta2_Document.Page.Dimension? = nil
    var _layout: Google_Cloud_Documentai_V1beta2_Document.Page.Layout? = nil
    var _detectedLanguages: [Google_Cloud_Documentai_V1beta2_Document.Page.DetectedLanguage] = []
    var _blocks: [Google_Cloud_Documentai_V1beta2_Document.Page.Block] = []
    var _paragraphs: [Google_Cloud_Documentai_V1beta2_Document.Page.Paragraph] = []
    var _lines: [Google_Cloud_Documentai_V1beta2_Document.Page.Line] = []
    var _tokens: [Google_Cloud_Documentai_V1beta2_Document.Page.Token] = []
    var _visualElements: [Google_Cloud_Documentai_V1beta2_Document.Page.VisualElement] = []
    var _tables: [Google_Cloud_Documentai_V1beta2_Document.Page.Table] = []
    var _formFields: [Google_Cloud_Documentai_V1beta2_Document.Page.FormField] = []
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Page, rhs: Google_Cloud_Documentai_V1beta2_Document.Page) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.Dimension: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.Page.protoMessageName + ".Dimension"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "width"),
    2: .same(proto: "height"),
    3: .same(proto: "unit"),
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Page.Dimension, rhs: Google_Cloud_Documentai_V1beta2_Document.Page.Dimension) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.Layout: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.Page.protoMessageName + ".Layout"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "text_anchor"),
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Page.Layout, rhs: Google_Cloud_Documentai_V1beta2_Document.Page.Layout) -> Bool {
    if lhs._textAnchor != rhs._textAnchor {return false}
    if lhs.confidence != rhs.confidence {return false}
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.Layout.Orientation: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.Block: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.Page.protoMessageName + ".Block"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "layout"),
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Page.Block, rhs: Google_Cloud_Documentai_V1beta2_Document.Page.Block) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.Paragraph: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.Page.protoMessageName + ".Paragraph"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "layout"),
    2: .standard(proto: "detected_languages"),
  ]
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Page.Paragraph, rhs: Google_Cloud_Documentai_V1beta2_Document.Page.Paragraph) -> Bool {
    if lhs._layout != rhs._layout {return false}
    if lhs.detectedLanguages != rhs.detectedLanguages {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.Line: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.Page.protoMessageName + ".Line"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "layout"),
    2: .standard(proto: "detected_languages"),
  ]
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Page.Line, rhs: Google_Cloud_Documentai_V1beta2_Document.Page.Line) -> Bool {
    if lhs._layout != rhs._layout {return false}
    if lhs.detectedLanguages != rhs.detectedLanguages {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.Token: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.Page.protoMessageName + ".Token"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "layout"),
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Page.Token, rhs: Google_Cloud_Documentai_V1beta2_Document.Page.Token) -> Bool {
    if lhs._layout != rhs._layout {return false}
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.Token.DetectedBreak: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.Page.Token.protoMessageName + ".DetectedBreak"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "type"),
  ]
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Page.Token.DetectedBreak, rhs: Google_Cloud_Documentai_V1beta2_Document.Page.Token.DetectedBreak) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.Token.DetectedBreak.TypeEnum: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.VisualElement: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.Page.protoMessageName + ".VisualElement"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "layout"),
    2: .same(proto: "type"),
    3: .standard(proto: "detected_languages"),
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Page.VisualElement, rhs: Google_Cloud_Documentai_V1beta2_Document.Page.VisualElement) -> Bool {
    if lhs._layout != rhs._layout {return false}
    if lhs.type != rhs.type {return false}
    if lhs.detectedLanguages != rhs.detectedLanguages {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.Table: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.Page.protoMessageName + ".Table"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "layout"),
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Page.Table, rhs: Google_Cloud_Documentai_V1beta2_Document.Page.Table) -> Bool {
    if lhs._layout != rhs._layout {return false}
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.Table.TableRow: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.Page.Table.protoMessageName + ".TableRow"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "cells"),
  ]
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Page.Table.TableRow, rhs: Google_Cloud_Documentai_V1beta2_Document.Page.Table.TableRow) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.Table.TableCell: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.Page.Table.protoMessageName + ".TableCell"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "layout"),
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Page.Table.TableCell, rhs: Google_Cloud_Documentai_V1beta2_Document.Page.Table.TableCell) -> Bool {
    if lhs._layout != rhs._layout {return false}
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.FormField: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.Page.protoMessageName + ".FormField"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    6: .standard(proto: "corrected_key_text"),
    7: .standard(proto: "corrected_value_text"),
  ]

  fileprivate class _StorageClass {
    var _fieldName: Google_Cloud_Documentai_V1beta2_Document.Page.Layout? = nil
    var _fieldValue: Google_Cloud_Documentai_V1beta2_Document.Page.Layout? = nil
    var _nameDetectedLanguages: [Google_Cloud_Documentai_V1beta2_Document.Page.DetectedLanguage] = []
    var _valueDetectedLanguages: [Google_Cloud_Documentai_V1beta2_Document.Page.DetectedLanguage] = []
    var _valueType: String = String()
    var _correctedKeyText: String = String()
    var _correctedValueText: String = String()
    ...
    init(copying source: _StorageClass) {
      ...
      _nameDetectedLanguages = source._nameDetectedLanguages
      _valueDetectedLanguages = source._valueDetectedLanguages
      _valueType = source._valueType
      _correctedKeyText = source._correctedKeyText
      _correctedValueText = source._correctedValueText
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularMessageField(value: &_storage._fieldName) }()
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._fieldValue) }()
        case 3: try { try decoder.decodeRepeatedMessageField(value: &_storage._nameDetectedLanguages) }()
        case 4: try { try decoder.decodeRepeatedMessageField(value: &_storage._valueDetectedLanguages) }()
        case 5: try { try decoder.decodeSingularStringField(value: &_storage._valueType) }()
        case 6: try { try decoder.decodeSingularStringField(value: &_storage._correctedKeyText) }()
        case 7: try { try decoder.decodeSingularStringField(value: &_storage._correctedValueText) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      if let v = _storage._fieldName {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
      }
      if let v = _storage._fieldValue {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
      }
      if !_storage._nameDetectedLanguages.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._nameDetectedLanguages, fieldNumber: 3)
      }
      if !_storage._valueDetectedLanguages.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._valueDetectedLanguages, fieldNumber: 4)
      }
      if !_storage._valueType.isEmpty {
        try visitor.visitSingularStringField(value: _storage._valueType, fieldNumber: 5)
      }
      if !_storage._correctedKeyText.isEmpty {
        try visitor.visitSingularStringField(value: _storage._correctedKeyText, fieldNumber: 6)
      }
      if !_storage._correctedValueText.isEmpty {
        try visitor.visitSingularStringField(value: _storage._correctedValueText, fieldNumber: 7)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Page.FormField, rhs: Google_Cloud_Documentai_V1beta2_Document.Page.FormField) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        ...
        if _storage._nameDetectedLanguages != rhs_storage._nameDetectedLanguages {return false}
        if _storage._valueDetectedLanguages != rhs_storage._valueDetectedLanguages {return false}
        if _storage._valueType != rhs_storage._valueType {return false}
        if _storage._correctedKeyText != rhs_storage._correctedKeyText {return false}
        if _storage._correctedValueText != rhs_storage._correctedValueText {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Google_Cloud_Documentai_V1beta2_Document.Page.DetectedLanguage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.Page.protoMessageName + ".DetectedLanguage"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Page.DetectedLanguage, rhs: Google_Cloud_Documentai_V1beta2_Document.Page.DetectedLanguage) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.Entity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.protoMessageName + ".Entity"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "text_anchor"),
    2: .same(proto: "type"),
    ...
    7: .same(proto: "id"),
    8: .standard(proto: "bounding_poly_for_demo_frontend"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularMessageField(value: &self._pageAnchor) }()
      case 7: try { try decoder.decodeSingularStringField(value: &self.id) }()
      case 8: try { try decoder.decodeSingularMessageField(value: &self._boundingPolyForDemoFrontend) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._pageAnchor {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
    }
    if !self.id.isEmpty {
      try visitor.visitSingularStringField(value: self.id, fieldNumber: 7)
    }
    if let v = self._boundingPolyForDemoFrontend {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 8)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.Entity, rhs: Google_Cloud_Documentai_V1beta2_Document.Entity) -> Bool {
    if lhs._textAnchor != rhs._textAnchor {return false}
    if lhs.type != rhs.type {return false}
    if lhs.mentionText != rhs.mentionText {return false}
    if lhs.mentionID != rhs.mentionID {return false}
    if lhs.confidence != rhs.confidence {return false}
    if lhs._pageAnchor != rhs._pageAnchor {return false}
    if lhs.id != rhs.id {return false}
    if lhs._boundingPolyForDemoFrontend != rhs._boundingPolyForDemoFrontend {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Google_Cloud_Documentai_V1beta2_Document.EntityRelation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.protoMessageName + ".EntityRelation"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.EntityRelation, rhs: Google_Cloud_Documentai_V1beta2_Document.EntityRelation) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.TextAnchor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.protoMessageName + ".TextAnchor"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.TextAnchor, rhs: Google_Cloud_Documentai_V1beta2_Document.TextAnchor) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.TextAnchor.TextSegment: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.TextAnchor.protoMessageName + ".TextSegment"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.TextAnchor.TextSegment, rhs: Google_Cloud_Documentai_V1beta2_Document.TextAnchor.TextSegment) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.PageAnchor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.protoMessageName + ".PageAnchor"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.PageAnchor, rhs: Google_Cloud_Documentai_V1beta2_Document.PageAnchor) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.PageAnchor.PageRef: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Documentai_V1beta2_Document.PageAnchor.protoMessageName + ".PageRef"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "page"),
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Document.PageAnchor.PageRef, rhs: Google_Cloud_Documentai_V1beta2_Document.PageAnchor.PageRef) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_Document.PageAnchor.PageRef.LayoutType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
