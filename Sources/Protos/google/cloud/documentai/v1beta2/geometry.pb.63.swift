...
public struct Google_Cloud_Documentai_V1beta2_Vertex {
...
public struct Google_Cloud_Documentai_V1beta2_NormalizedVertex {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Documentai_V1beta2_BoundingPoly {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The bounding polygon vertices.
  public var vertices: [Google_Cloud_Documentai_V1beta2_Vertex] = []

  /// The bounding polygon normalized vertices.
  public var normalizedVertices: [Google_Cloud_Documentai_V1beta2_NormalizedVertex] = []
...
extension Google_Cloud_Documentai_V1beta2_Vertex: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_Vertex, rhs: Google_Cloud_Documentai_V1beta2_Vertex) -> Bool {
...
extension Google_Cloud_Documentai_V1beta2_NormalizedVertex: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_NormalizedVertex, rhs: Google_Cloud_Documentai_V1beta2_NormalizedVertex) -> Bool {
    if lhs.x != rhs.x {return false}
    if lhs.y != rhs.y {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Google_Cloud_Documentai_V1beta2_BoundingPoly: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Documentai_V1beta2_BoundingPoly, rhs: Google_Cloud_Documentai_V1beta2_BoundingPoly) -> Bool {
