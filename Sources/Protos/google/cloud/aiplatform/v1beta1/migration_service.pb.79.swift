...
public struct Google_Cloud_Aiplatform_V1beta1_SearchMigratableResourcesRequest {
...
public struct Google_Cloud_Aiplatform_V1beta1_SearchMigratableResourcesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var migratableResources: [Google_Cloud_Aiplatform_V1beta1_MigratableResource] = []
...
public struct Google_Cloud_Aiplatform_V1beta1_BatchMigrateResourcesRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var migrateResourceRequests: [Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest] = []
...
public struct Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var request: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.OneOf_Request? = nil

  /// Config for migrating Version in ml.googleapis.com to AI Platform's Model.
  public var migrateMlEngineModelVersionConfig: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateMlEngineModelVersionConfig {
    get {
      if case .migrateMlEngineModelVersionConfig(let v)? = request {return v}
      return Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateMlEngineModelVersionConfig()
    }
  ...
  /// Model.
  public var migrateAutomlModelConfig: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateAutomlModelConfig {
    get {
      if case .migrateAutomlModelConfig(let v)? = request {return v}
      return Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateAutomlModelConfig()
    }
  ...
  /// Dataset.
  public var migrateAutomlDatasetConfig: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateAutomlDatasetConfig {
    get {
      if case .migrateAutomlDatasetConfig(let v)? = request {return v}
      return Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateAutomlDatasetConfig()
    }
  ...
  public var migrateDataLabelingDatasetConfig: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateDataLabelingDatasetConfig {
    get {
      if case .migrateDataLabelingDatasetConfig(let v)? = request {return v}
      return Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateDataLabelingDatasetConfig()
    }
  ...
  public enum OneOf_Request: Equatable {
    /// Config for migrating Version in ml.googleapis.com to AI Platform's Model.
    case migrateMlEngineModelVersionConfig(Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateMlEngineModelVersionConfig)
    /// Config for migrating Model in automl.googleapis.com to AI Platform's
    /// Model.
    case migrateAutomlModelConfig(Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateAutomlModelConfig)
    /// Config for migrating Dataset in automl.googleapis.com to AI Platform's
    /// Dataset.
    case migrateAutomlDatasetConfig(Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateAutomlDatasetConfig)
    /// Config for migrating Dataset in datalabeling.googleapis.com to
    /// AI Platform's Dataset.
    case migrateDataLabelingDatasetConfig(Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateDataLabelingDatasetConfig)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.OneOf_Request, rhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.OneOf_Request) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.migrateMlEngineModelVersionConfig, .migrateMlEngineModelVersionConfig): return {
        guard case .migrateMlEngineModelVersionConfig(let l) = lhs, case .migrateMlEngineModelVersionConfig(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.migrateAutomlModelConfig, .migrateAutomlModelConfig): return {
        guard case .migrateAutomlModelConfig(let l) = lhs, case .migrateAutomlModelConfig(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.migrateAutomlDatasetConfig, .migrateAutomlDatasetConfig): return {
        guard case .migrateAutomlDatasetConfig(let l) = lhs, case .migrateAutomlDatasetConfig(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.migrateDataLabelingDatasetConfig, .migrateDataLabelingDatasetConfig): return {
        guard case .migrateDataLabelingDatasetConfig(let l) = lhs, case .migrateDataLabelingDatasetConfig(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
  ...
  /// Config for migrating version in ml.googleapis.com to AI Platform's Model.
  public struct MigrateMlEngineModelVersionConfig {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct MigrateAutomlModelConfig {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  /// Config for migrating Dataset in automl.googleapis.com to AI Platform's
  /// Dataset.
  public struct MigrateAutomlDatasetConfig {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  /// Platform's Dataset.
  public struct MigrateDataLabelingDatasetConfig {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var migrateDataLabelingAnnotatedDatasetConfigs: [Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateDataLabelingDatasetConfig.MigrateDataLabelingAnnotatedDatasetConfig] = []

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    /// Config for migrating AnnotatedDataset in datalabeling.googleapis.com to
    /// AI Platform's SavedQuery.
    public struct MigrateDataLabelingAnnotatedDatasetConfig {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
...
public struct Google_Cloud_Aiplatform_V1beta1_BatchMigrateResourcesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Successfully migrated resources.
  public var migrateResourceResponses: [Google_Cloud_Aiplatform_V1beta1_MigrateResourceResponse] = []
...
public struct Google_Cloud_Aiplatform_V1beta1_MigrateResourceResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// After migration, the resource name in AI Platform.
  public var migratedResource: Google_Cloud_Aiplatform_V1beta1_MigrateResourceResponse.OneOf_MigratedResource? = nil
  ...
  public var migratableResource: Google_Cloud_Aiplatform_V1beta1_MigratableResource {
    get {return _migratableResource ?? Google_Cloud_Aiplatform_V1beta1_MigratableResource()}
  ...
  /// After migration, the resource name in AI Platform.
  public enum OneOf_MigratedResource: Equatable {
    /// Migrated Dataset's resource name.
    case dataset(String)
    /// Migrated Model's resource name.
    case model(String)
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceResponse.OneOf_MigratedResource, rhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceResponse.OneOf_MigratedResource) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
  ...
  fileprivate var _migratableResource: Google_Cloud_Aiplatform_V1beta1_MigratableResource? = nil
}
...
public struct Google_Cloud_Aiplatform_V1beta1_BatchMigrateResourcesOperationMetadata {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Aiplatform_V1beta1_SearchMigratableResourcesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_SearchMigratableResourcesRequest, rhs: Google_Cloud_Aiplatform_V1beta1_SearchMigratableResourcesRequest) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_SearchMigratableResourcesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_SearchMigratableResourcesResponse, rhs: Google_Cloud_Aiplatform_V1beta1_SearchMigratableResourcesResponse) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_BatchMigrateResourcesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_BatchMigrateResourcesRequest, rhs: Google_Cloud_Aiplatform_V1beta1_BatchMigrateResourcesRequest) -> Bool {
    if lhs.parent != rhs.parent {return false}
...
extension Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateMlEngineModelVersionConfig?
        if let current = self.request {
          try decoder.handleConflictingOneOf()
          if case .migrateMlEngineModelVersionConfig(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.request = .migrateMlEngineModelVersionConfig(v)}
      }()
      case 2: try {
        var v: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateAutomlModelConfig?
        if let current = self.request {
          try decoder.handleConflictingOneOf()
          if case .migrateAutomlModelConfig(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.request = .migrateAutomlModelConfig(v)}
      }()
      case 3: try {
        var v: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateAutomlDatasetConfig?
        if let current = self.request {
          try decoder.handleConflictingOneOf()
          if case .migrateAutomlDatasetConfig(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.request = .migrateAutomlDatasetConfig(v)}
      }()
      case 4: try {
        var v: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateDataLabelingDatasetConfig?
        if let current = self.request {
          try decoder.handleConflictingOneOf()
          if case .migrateDataLabelingDatasetConfig(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.request = .migrateDataLabelingDatasetConfig(v)}
      }()
      default: break
      }
    }
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest, rhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateMlEngineModelVersionConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.protoMessageName + ".MigrateMlEngineModelVersionConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateMlEngineModelVersionConfig, rhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateMlEngineModelVersionConfig) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateAutomlModelConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.protoMessageName + ".MigrateAutomlModelConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "model"),
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateAutomlModelConfig, rhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateAutomlModelConfig) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateAutomlDatasetConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.protoMessageName + ".MigrateAutomlDatasetConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateAutomlDatasetConfig, rhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateAutomlDatasetConfig) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateDataLabelingDatasetConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.protoMessageName + ".MigrateDataLabelingDatasetConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "dataset"),
    2: .standard(proto: "dataset_display_name"),
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateDataLabelingDatasetConfig, rhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateDataLabelingDatasetConfig) -> Bool {
    if lhs.dataset != rhs.dataset {return false}
    if lhs.datasetDisplayName != rhs.datasetDisplayName {return false}
...
extension Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateDataLabelingDatasetConfig.MigrateDataLabelingAnnotatedDatasetConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateDataLabelingDatasetConfig.protoMessageName + ".MigrateDataLabelingAnnotatedDatasetConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateDataLabelingDatasetConfig.MigrateDataLabelingAnnotatedDatasetConfig, rhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceRequest.MigrateDataLabelingDatasetConfig.MigrateDataLabelingAnnotatedDatasetConfig) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_BatchMigrateResourcesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_BatchMigrateResourcesResponse, rhs: Google_Cloud_Aiplatform_V1beta1_BatchMigrateResourcesResponse) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_MigrateResourceResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try {
        ...
        if let v = v {self.migratedResource = .dataset(v)}
      }()
      case 2: try {
        if self.migratedResource != nil {try decoder.handleConflictingOneOf()}
        var v: String?
        try decoder.decodeSingularStringField(value: &v)
        if let v = v {self.migratedResource = .model(v)}
      }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._migratableResource {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceResponse, rhs: Google_Cloud_Aiplatform_V1beta1_MigrateResourceResponse) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_BatchMigrateResourcesOperationMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_BatchMigrateResourcesOperationMetadata, rhs: Google_Cloud_Aiplatform_V1beta1_BatchMigrateResourcesOperationMetadata) -> Bool {
