...
public struct Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata {
  ...
  public var inputs: Dictionary<String,Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata> = [:]
  ...
  public var outputs: Dictionary<String,Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.OutputMetadata> = [:]
  ...
  public struct InputMetadata {
    ...
    /// IDENTITY.
    public var encoding: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Encoding {
    ...
    public var featureValueDomain: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.FeatureValueDomain {
      get {return _storage._featureValueDomain ?? Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.FeatureValueDomain()}
    ...
    public var visualization: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization {
      get {return _storage._visualization ?? Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization()}
    ...
    public struct FeatureValueDomain {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
    ...
    public struct Visualization {
      ...
      public var type: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.TypeEnum = .unspecified

      /// Whether to only highlight pixels with positive contributions, negative
      /// or both. Defaults to POSITIVE.
      public var polarity: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.Polarity = .unspecified
      ...
      /// influential in blue.
      public var colorMap: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.ColorMap = .unspecified
      ...
      public var overlayType: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.OverlayType = .unspecified
      ...
      /// Whether to only highlight pixels with positive contributions, negative
      /// or both. Defaults to POSITIVE.
      public enum Polarity: SwiftProtobuf.Enum {
        public typealias RawValue = Int
      ...
      /// How the original image is displayed in the visualization.
      public enum OverlayType: SwiftProtobuf.Enum {
        public typealias RawValue = Int
  ...
  public struct OutputMetadata {
    ...
    public var displayNameMapping: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.OutputMetadata.OneOf_DisplayNameMapping? = nil
    ...
    /// If neither of the fields are specified,
    /// [Attribution.output_display_name][google.cloud.aiplatform.v1beta1.Attribution.output_display_name] will not be populated.
    public enum OneOf_DisplayNameMapping: Equatable {
      /// Static mapping between the index and display name.
      ///
      /// Use this if the outputs are a deterministic n-dimensional array, e.g. a
      /// list of scores of all the classes in a pre-defined order for a
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.OutputMetadata.OneOf_DisplayNameMapping, rhs: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.OutputMetadata.OneOf_DisplayNameMapping) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
        case (.indexDisplayNameMapping, .indexDisplayNameMapping): return {
          guard case .indexDisplayNameMapping(let l) = lhs, case .indexDisplayNameMapping(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
        case (.displayNameMappingKey, .displayNameMappingKey): return {
          guard case .displayNameMappingKey(let l) = lhs, case .displayNameMappingKey(let r) = rhs else { preconditionFailure() }
          return l == r
        }()
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Encoding: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Encoding] = [
    .unspecified,
    .identity,
    .bagOfFeatures,
    .bagOfFeaturesSparse,
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.TypeEnum] = [
    .unspecified,
    .pixels,
    .outlines,
  ]
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.Polarity: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.Polarity] = [
    .unspecified,
    .positive,
    .negative,
    .both,
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.ColorMap: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.ColorMap] = [
    .unspecified,
    .pinkGreen,
    .viridis,
    .red,
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.OverlayType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.OverlayType] = [
    .unspecified,
    .none,
    .original,
    .grayscale,
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata>.self, value: &self.inputs) }()
      case 2: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.OutputMetadata>.self, value: &self.outputs) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.inputs.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata>.self, value: self.inputs, fieldNumber: 1)
    }
    if !self.outputs.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.OutputMetadata>.self, value: self.outputs, fieldNumber: 2)
    }
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata, rhs: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.protoMessageName + ".InputMetadata"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  fileprivate class _StorageClass {
    ...
    var _encoding: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Encoding = .unspecified
    var _modality: String = String()
    var _featureValueDomain: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.FeatureValueDomain? = nil
    ...
    var _visualization: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization? = nil
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._featureValueDomain {
      ...
      if let v = _storage._visualization {
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata, rhs: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Encoding: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.FeatureValueDomain: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.protoMessageName + ".FeatureValueDomain"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.originalMean != 0 {
      try visitor.visitSingularFloatField(value: self.originalMean, fieldNumber: 3)
    }
    if self.originalStddev != 0 {
      try visitor.visitSingularFloatField(value: self.originalStddev, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.FeatureValueDomain, rhs: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.FeatureValueDomain) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.protoMessageName + ".Visualization"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "type"),
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization, rhs: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.TypeEnum: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.Polarity: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.ColorMap: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.InputMetadata.Visualization.OverlayType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.OutputMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.protoMessageName + ".OutputMetadata"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try {
        ...
        if let v = v {self.displayNameMapping = .indexDisplayNameMapping(v)}
      }()
      case 2: try {
        if self.displayNameMapping != nil {try decoder.handleConflictingOneOf()}
        var v: String?
        try decoder.decodeSingularStringField(value: &v)
        if let v = v {self.displayNameMapping = .displayNameMappingKey(v)}
      }()
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.OutputMetadata, rhs: Google_Cloud_Aiplatform_V1beta1_ExplanationMetadata.OutputMetadata) -> Bool {
