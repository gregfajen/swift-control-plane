...
public struct Google_Cloud_Aiplatform_V1beta1_UserActionReference {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var reference: Google_Cloud_Aiplatform_V1beta1_UserActionReference.OneOf_Reference? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_UserActionReference.OneOf_Reference, rhs: Google_Cloud_Aiplatform_V1beta1_UserActionReference.OneOf_Reference) -> Bool {
      ...
      case (.dataLabelingJob, .dataLabelingJob): return {
        guard case .dataLabelingJob(let l) = lhs, case .dataLabelingJob(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
extension Google_Cloud_Aiplatform_V1beta1_UserActionReference: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try {
        ...
        if let v = v {self.reference = .operation(v)}
      }()
      case 2: try {
        if self.reference != nil {try decoder.handleConflictingOneOf()}
        var v: String?
        try decoder.decodeSingularStringField(value: &v)
        if let v = v {self.reference = .dataLabelingJob(v)}
      }()
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_UserActionReference, rhs: Google_Cloud_Aiplatform_V1beta1_UserActionReference) -> Bool {
