...
public struct Google_Cloud_Aiplatform_V1beta1_MigratableResource {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var resource: Google_Cloud_Aiplatform_V1beta1_MigratableResource.OneOf_Resource? = nil

  /// Output only. Represents one Version in ml.googleapis.com.
  public var mlEngineModelVersion: Google_Cloud_Aiplatform_V1beta1_MigratableResource.MlEngineModelVersion {
    get {
      if case .mlEngineModelVersion(let v)? = resource {return v}
      return Google_Cloud_Aiplatform_V1beta1_MigratableResource.MlEngineModelVersion()
    }
    set {resource = .mlEngineModelVersion(newValue)}
  }

  /// Output only. Represents one Model in automl.googleapis.com.
  public var automlModel: Google_Cloud_Aiplatform_V1beta1_MigratableResource.AutomlModel {
    get {
      if case .automlModel(let v)? = resource {return v}
      return Google_Cloud_Aiplatform_V1beta1_MigratableResource.AutomlModel()
    }
    set {resource = .automlModel(newValue)}
  }

  /// Output only. Represents one Dataset in automl.googleapis.com.
  public var automlDataset: Google_Cloud_Aiplatform_V1beta1_MigratableResource.AutomlDataset {
    get {
      if case .automlDataset(let v)? = resource {return v}
      return Google_Cloud_Aiplatform_V1beta1_MigratableResource.AutomlDataset()
    }
    set {resource = .automlDataset(newValue)}
  }

  /// Output only. Represents one Dataset in datalabeling.googleapis.com.
  public var dataLabelingDataset: Google_Cloud_Aiplatform_V1beta1_MigratableResource.DataLabelingDataset {
    get {
      if case .dataLabelingDataset(let v)? = resource {return v}
      return Google_Cloud_Aiplatform_V1beta1_MigratableResource.DataLabelingDataset()
    }
  ...
  public enum OneOf_Resource: Equatable {
    /// Output only. Represents one Version in ml.googleapis.com.
    case mlEngineModelVersion(Google_Cloud_Aiplatform_V1beta1_MigratableResource.MlEngineModelVersion)
    /// Output only. Represents one Model in automl.googleapis.com.
    case automlModel(Google_Cloud_Aiplatform_V1beta1_MigratableResource.AutomlModel)
    /// Output only. Represents one Dataset in automl.googleapis.com.
    case automlDataset(Google_Cloud_Aiplatform_V1beta1_MigratableResource.AutomlDataset)
    /// Output only. Represents one Dataset in datalabeling.googleapis.com.
    case dataLabelingDataset(Google_Cloud_Aiplatform_V1beta1_MigratableResource.DataLabelingDataset)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigratableResource.OneOf_Resource, rhs: Google_Cloud_Aiplatform_V1beta1_MigratableResource.OneOf_Resource) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.mlEngineModelVersion, .mlEngineModelVersion): return {
        guard case .mlEngineModelVersion(let l) = lhs, case .mlEngineModelVersion(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      ...
      case (.automlDataset, .automlDataset): return {
        guard case .automlDataset(let l) = lhs, case .automlDataset(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.dataLabelingDataset, .dataLabelingDataset): return {
        guard case .dataLabelingDataset(let l) = lhs, case .dataLabelingDataset(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
  ...
  public struct MlEngineModelVersion {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct DataLabelingDataset {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var dataLabelingAnnotatedDatasets: [Google_Cloud_Aiplatform_V1beta1_MigratableResource.DataLabelingDataset.DataLabelingAnnotatedDataset] = []

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    /// Represents one AnnotatedDataset in datalabeling.googleapis.com.
    public struct DataLabelingAnnotatedDataset {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
...
extension Google_Cloud_Aiplatform_V1beta1_MigratableResource: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Google_Cloud_Aiplatform_V1beta1_MigratableResource.MlEngineModelVersion?
        if let current = self.resource {
          try decoder.handleConflictingOneOf()
          if case .mlEngineModelVersion(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.resource = .mlEngineModelVersion(v)}
      }()
      case 2: try {
        var v: Google_Cloud_Aiplatform_V1beta1_MigratableResource.AutomlModel?
        if let current = self.resource {
          try decoder.handleConflictingOneOf()
          if case .automlModel(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.resource = .automlModel(v)}
      }()
      case 3: try {
        var v: Google_Cloud_Aiplatform_V1beta1_MigratableResource.AutomlDataset?
        if let current = self.resource {
          try decoder.handleConflictingOneOf()
          if case .automlDataset(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.resource = .automlDataset(v)}
      }()
      case 4: try {
        var v: Google_Cloud_Aiplatform_V1beta1_MigratableResource.DataLabelingDataset?
        if let current = self.resource {
          try decoder.handleConflictingOneOf()
          if case .dataLabelingDataset(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.resource = .dataLabelingDataset(v)}
      }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._lastMigrateTime {
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigratableResource, rhs: Google_Cloud_Aiplatform_V1beta1_MigratableResource) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_MigratableResource.MlEngineModelVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Aiplatform_V1beta1_MigratableResource.protoMessageName + ".MlEngineModelVersion"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigratableResource.MlEngineModelVersion, rhs: Google_Cloud_Aiplatform_V1beta1_MigratableResource.MlEngineModelVersion) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_MigratableResource.AutomlModel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Aiplatform_V1beta1_MigratableResource.protoMessageName + ".AutomlModel"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "model"),
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigratableResource.AutomlModel, rhs: Google_Cloud_Aiplatform_V1beta1_MigratableResource.AutomlModel) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_MigratableResource.AutomlDataset: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Aiplatform_V1beta1_MigratableResource.protoMessageName + ".AutomlDataset"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigratableResource.AutomlDataset, rhs: Google_Cloud_Aiplatform_V1beta1_MigratableResource.AutomlDataset) -> Bool {
...
extension Google_Cloud_Aiplatform_V1beta1_MigratableResource.DataLabelingDataset: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Aiplatform_V1beta1_MigratableResource.protoMessageName + ".DataLabelingDataset"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "dataset"),
    4: .standard(proto: "dataset_display_name"),
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigratableResource.DataLabelingDataset, rhs: Google_Cloud_Aiplatform_V1beta1_MigratableResource.DataLabelingDataset) -> Bool {
    if lhs.dataset != rhs.dataset {return false}
    if lhs.datasetDisplayName != rhs.datasetDisplayName {return false}
...
extension Google_Cloud_Aiplatform_V1beta1_MigratableResource.DataLabelingDataset.DataLabelingAnnotatedDataset: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Aiplatform_V1beta1_MigratableResource.DataLabelingDataset.protoMessageName + ".DataLabelingAnnotatedDataset"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_V1beta1_MigratableResource.DataLabelingDataset.DataLabelingAnnotatedDataset, rhs: Google_Cloud_Aiplatform_V1beta1_MigratableResource.DataLabelingDataset.DataLabelingAnnotatedDataset) -> Bool {
