...
public struct Google_Cloud_Aiplatform_Logging_OnlinePredictionLogEntry {
  ...
  public var instanceCount: Int64 = 0
...
fileprivate let _protobuf_package = "google.cloud.aiplatform.logging"

extension Google_Cloud_Aiplatform_Logging_OnlinePredictionLogEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".OnlinePredictionLogEntry"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "endpoint"),
    2: .standard(proto: "deployed_model_id"),
    3: .standard(proto: "instance_count"),
    4: .standard(proto: "prediction_count"),
    5: .same(proto: "error"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularInt64Field(value: &self.instanceCount) }()
      case 4: try { try decoder.decodeSingularInt64Field(value: &self.predictionCount) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.instanceCount != 0 {
      try visitor.visitSingularInt64Field(value: self.instanceCount, fieldNumber: 3)
    }
    if self.predictionCount != 0 {
      try visitor.visitSingularInt64Field(value: self.predictionCount, fieldNumber: 4)
    }
  ...
  public static func ==(lhs: Google_Cloud_Aiplatform_Logging_OnlinePredictionLogEntry, rhs: Google_Cloud_Aiplatform_Logging_OnlinePredictionLogEntry) -> Bool {
