...
public struct Google_Cloud_Talent_V4beta1_Job {
  ...
  public var applicationInfo: Google_Cloud_Talent_V4beta1_Job.ApplicationInfo {
    get {return _storage._applicationInfo ?? Google_Cloud_Talent_V4beta1_Job.ApplicationInfo()}
  ...
  public var jobBenefits: [Google_Cloud_Talent_V4beta1_JobBenefit] {
  ...
  public var compensationInfo: Google_Cloud_Talent_V4beta1_CompensationInfo {
    get {return _storage._compensationInfo ?? Google_Cloud_Talent_V4beta1_CompensationInfo()}
  ...
  public var degreeTypes: [Google_Cloud_Talent_V4beta1_DegreeType] {
  ...
  public var jobLevel: Google_Cloud_Talent_V4beta1_JobLevel {
  ...
  public var postingRegion: Google_Cloud_Talent_V4beta1_PostingRegion {
  ...
  public var visibility: Google_Cloud_Talent_V4beta1_Visibility {
  ...
  public var derivedInfo: Google_Cloud_Talent_V4beta1_Job.DerivedInfo {
    get {return _storage._derivedInfo ?? Google_Cloud_Talent_V4beta1_Job.DerivedInfo()}
  ...
  public var processingOptions: Google_Cloud_Talent_V4beta1_Job.ProcessingOptions {
    get {return _storage._processingOptions ?? Google_Cloud_Talent_V4beta1_Job.ProcessingOptions()}
  ...
  public struct DerivedInfo {
    ...
    /// order.
    public var locations: [Google_Cloud_Talent_V4beta1_Location] = []
  ...
  public struct ProcessingOptions {
    ...
    public var htmlSanitization: Google_Cloud_Talent_V4beta1_HtmlSanitization = .unspecified
...
extension Google_Cloud_Talent_V4beta1_Job: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _applicationInfo: Google_Cloud_Talent_V4beta1_Job.ApplicationInfo? = nil
    var _jobBenefits: [Google_Cloud_Talent_V4beta1_JobBenefit] = []
    var _compensationInfo: Google_Cloud_Talent_V4beta1_CompensationInfo? = nil
    var _customAttributes: Dictionary<String,Google_Cloud_Talent_V4beta1_CustomAttribute> = [:]
    var _degreeTypes: [Google_Cloud_Talent_V4beta1_DegreeType] = []
    ...
    var _jobLevel: Google_Cloud_Talent_V4beta1_JobLevel = .unspecified
    var _promotionValue: Int32 = 0
    var _qualifications: String = String()
    var _responsibilities: String = String()
    var _postingRegion: Google_Cloud_Talent_V4beta1_PostingRegion = .unspecified
    var _visibility: Google_Cloud_Talent_V4beta1_Visibility = .unspecified
    ...
    var _derivedInfo: Google_Cloud_Talent_V4beta1_Job.DerivedInfo? = nil
    var _processingOptions: Google_Cloud_Talent_V4beta1_Job.ProcessingOptions? = nil
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 10: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Talent_V4beta1_CustomAttribute>.self, value: &_storage._customAttributes) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._customAttributes.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Talent_V4beta1_CustomAttribute>.self, value: _storage._customAttributes, fieldNumber: 10)
      }
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_Job, rhs: Google_Cloud_Talent_V4beta1_Job) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_Job.ApplicationInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Talent_V4beta1_Job.protoMessageName + ".ApplicationInfo"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "emails"),
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_Job.ApplicationInfo, rhs: Google_Cloud_Talent_V4beta1_Job.ApplicationInfo) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_Job.DerivedInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Talent_V4beta1_Job.protoMessageName + ".DerivedInfo"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_Job.DerivedInfo, rhs: Google_Cloud_Talent_V4beta1_Job.DerivedInfo) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_Job.ProcessingOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Talent_V4beta1_Job.protoMessageName + ".ProcessingOptions"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_Job.ProcessingOptions, rhs: Google_Cloud_Talent_V4beta1_Job.ProcessingOptions) -> Bool {
