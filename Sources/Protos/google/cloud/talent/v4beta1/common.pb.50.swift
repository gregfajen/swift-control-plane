...
public enum Google_Cloud_Talent_V4beta1_CompanySize: SwiftProtobuf.Enum {
...
extension Google_Cloud_Talent_V4beta1_CompanySize: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_CompanySize] = [
    .unspecified,
    .mini,
    .small,
    .smedium,
...
public enum Google_Cloud_Talent_V4beta1_JobBenefit: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Talent_V4beta1_JobBenefit: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_JobBenefit] = [
    .unspecified,
    .childCare,
    .dental,
    .domesticPartner,
...
/// of Education (ISCED).
public enum Google_Cloud_Talent_V4beta1_DegreeType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Talent_V4beta1_DegreeType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_DegreeType] = [
    .unspecified,
    .primaryEducation,
...
public enum Google_Cloud_Talent_V4beta1_EmploymentType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Talent_V4beta1_EmploymentType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_EmploymentType] = [
    .unspecified,
    .fullTime,
    .partTime,
    .contractor,
...
public enum Google_Cloud_Talent_V4beta1_JobLevel: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Talent_V4beta1_JobLevel: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_JobLevel] = [
    .unspecified,
    .entryLevel,
    .experienced,
    .manager,
...
public enum Google_Cloud_Talent_V4beta1_JobCategory: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Talent_V4beta1_JobCategory: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_JobCategory] = [
    .unspecified,
...
public enum Google_Cloud_Talent_V4beta1_PostingRegion: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Talent_V4beta1_PostingRegion: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_PostingRegion] = [
    .unspecified,
    .administrativeArea,
    .nation,
    .telecommute,
...
public enum Google_Cloud_Talent_V4beta1_Visibility: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Talent_V4beta1_Visibility: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_Visibility] = [
    .unspecified,
    .accountOnly,
    .sharedWithGoogle,
    .sharedWithPublic,
...
public enum Google_Cloud_Talent_V4beta1_ContactInfoUsage: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Talent_V4beta1_ContactInfoUsage: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_ContactInfoUsage] = [
    .unspecified,
    .personal,
    .work,
    .school,
...
public enum Google_Cloud_Talent_V4beta1_HtmlSanitization: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Talent_V4beta1_HtmlSanitization: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_HtmlSanitization] = [
    .unspecified,
    .disabled,
...
/// Method for commute.
public enum Google_Cloud_Talent_V4beta1_CommuteMethod: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Talent_V4beta1_CommuteMethod: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_CommuteMethod] = [
    .unspecified,
    .driving,
    .transit,
    .walking,
...
public enum Google_Cloud_Talent_V4beta1_SkillProficiencyLevel: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  ...
  public init?(rawValue: Int) {
    switch rawValue {
    case 0: self = .unspecified
    case 1: self = .fundamentalAwareness
    case 2: self = .novice
    case 3: self = .intermediate
    case 4: self = .advanced
    case 5: self = .expert
    case 6: self = .unskilled
    default: self = .UNRECOGNIZED(rawValue)
    }
  }
  ...
  public var rawValue: Int {
    switch self {
    case .unspecified: return 0
    case .fundamentalAwareness: return 1
    case .novice: return 2
    case .intermediate: return 3
    case .advanced: return 4
    case .expert: return 5
    case .unskilled: return 6
    case .UNRECOGNIZED(let i): return i
    }
  }
...
extension Google_Cloud_Talent_V4beta1_SkillProficiencyLevel: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_SkillProficiencyLevel] = [
    .unspecified,
    .unskilled,
...
public enum Google_Cloud_Talent_V4beta1_Outcome: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Talent_V4beta1_Outcome: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_Outcome] = [
    .unspecified,
    .positive,
    .neutral,
    .negative,
...
public enum Google_Cloud_Talent_V4beta1_AvailabilitySignalType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  ...
  public init?(rawValue: Int) {
    switch rawValue {
    case 0: self = .unspecified
    case 1: self = .jobApplication
    case 2: self = .resumeUpdate
    case 3: self = .candidateUpdate
    case 4: self = .clientSubmission
    default: self = .UNRECOGNIZED(rawValue)
    }
  }
  ...
  public var rawValue: Int {
    switch self {
    case .unspecified: return 0
    case .jobApplication: return 1
    case .resumeUpdate: return 2
    case .candidateUpdate: return 3
    case .clientSubmission: return 4
    case .UNRECOGNIZED(let i): return i
    }
  }
...
extension Google_Cloud_Talent_V4beta1_AvailabilitySignalType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_AvailabilitySignalType] = [
    .unspecified,
    .jobApplication,
    .resumeUpdate,
    .candidateUpdate,
...
public struct Google_Cloud_Talent_V4beta1_TimestampRange {
...
public struct Google_Cloud_Talent_V4beta1_Location {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var locationType: Google_Cloud_Talent_V4beta1_Location.LocationType = .unspecified
...
extension Google_Cloud_Talent_V4beta1_Location.LocationType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_Location.LocationType] = [
    .unspecified,
    .country,
    .administrativeArea,
...
public struct Google_Cloud_Talent_V4beta1_RequestMetadata {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// service.
  public var deviceInfo: Google_Cloud_Talent_V4beta1_DeviceInfo {
    get {return _deviceInfo ?? Google_Cloud_Talent_V4beta1_DeviceInfo()}
  ...
  fileprivate var _deviceInfo: Google_Cloud_Talent_V4beta1_DeviceInfo? = nil
}

/// Additional information returned to client, such as debugging information.
public struct Google_Cloud_Talent_V4beta1_ResponseMetadata {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Talent_V4beta1_DeviceInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Type of the device.
  public var deviceType: Google_Cloud_Talent_V4beta1_DeviceInfo.DeviceType = .unspecified
...
extension Google_Cloud_Talent_V4beta1_DeviceInfo.DeviceType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_DeviceInfo.DeviceType] = [
    .unspecified,
    .web,
    .mobileWeb,
    .android,
...
public struct Google_Cloud_Talent_V4beta1_CustomAttribute {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Spell check result.
public struct Google_Cloud_Talent_V4beta1_SpellingCorrection {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Talent_V4beta1_CompensationInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var entries: [Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationEntry] = []
  ...
  public var annualizedBaseCompensationRange: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationRange {
    get {return _annualizedBaseCompensationRange ?? Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationRange()}
  ...
  ///
  /// See [CompensationEntry][google.cloud.talent.v4beta1.CompensationInfo.CompensationEntry] for explanation on compensation annualization.
  public var annualizedTotalCompensationRange: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationRange {
    get {return _annualizedTotalCompensationRange ?? Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationRange()}
  ...
  public struct CompensationEntry {
    ...
    public var type: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationType = .unspecified
    ...
    public var unit: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationUnit = .unspecified

    /// Compensation amount. It could be a fixed amount or a floating range.
    public var compensationAmount: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationEntry.OneOf_CompensationAmount? = nil
    ...
    public var range: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationRange {
      get {
        ...
        return Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationRange()
      }
    ...
    public enum OneOf_CompensationAmount: Equatable {
      ...
      /// Compensation range.
      case range(Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationRange)

    #if !swift(>=4.1)
      public static func ==(lhs: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationEntry.OneOf_CompensationAmount, rhs: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationEntry.OneOf_CompensationAmount) -> Bool {
  ...
  fileprivate var _annualizedBaseCompensationRange: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationRange? = nil
  fileprivate var _annualizedTotalCompensationRange: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationRange? = nil
}

#if swift(>=4.2)

extension Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationType] = [
    .unspecified,
    .base,
    .bonus,
    .signingBonus,
...
extension Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationUnit: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationUnit] = [
    .unspecified,
    .hourly,
    .daily,
    .weekly,
...
public struct Google_Cloud_Talent_V4beta1_Certification {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var acquireDate: Google_Type_Date {
    get {return _acquireDate ?? Google_Type_Date()}
    set {_acquireDate = newValue}
  }
  /// Returns true if `acquireDate` has been explicitly set.
  public var hasAcquireDate: Bool {return self._acquireDate != nil}
  /// Clears the value of `acquireDate`. Subsequent reads from it will return its default value.
  public mutating func clearAcquireDate() {self._acquireDate = nil}

  /// Expiration date of license of certification.
  public var expireDate: Google_Type_Date {
    get {return _expireDate ?? Google_Type_Date()}
  ...
  fileprivate var _acquireDate: Google_Type_Date? = nil
  fileprivate var _expireDate: Google_Type_Date? = nil
}

/// Resource that represents a skill of a candidate.
public struct Google_Cloud_Talent_V4beta1_Skill {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var lastUsedDate: Google_Type_Date {
    get {return _lastUsedDate ?? Google_Type_Date()}
    set {_lastUsedDate = newValue}
  }
  /// Returns true if `lastUsedDate` has been explicitly set.
  public var hasLastUsedDate: Bool {return self._lastUsedDate != nil}
  /// Clears the value of `lastUsedDate`. Subsequent reads from it will return its default value.
  public mutating func clearLastUsedDate() {self._lastUsedDate = nil}

  /// Skill proficiency level which indicates how proficient the candidate is at
  /// this skill.
  public var level: Google_Cloud_Talent_V4beta1_SkillProficiencyLevel = .unspecified
  ...
  /// query.
  public var skillNameSnippet: String = String()

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _lastUsedDate: Google_Type_Date? = nil
}

/// Details of an interview.
public struct Google_Cloud_Talent_V4beta1_Interview {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The rating on this interview.
  public var rating: Google_Cloud_Talent_V4beta1_Rating {
    get {return _rating ?? Google_Cloud_Talent_V4beta1_Rating()}
  ...
  /// nuetral).
  public var outcome: Google_Cloud_Talent_V4beta1_Outcome = .unspecified

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _rating: Google_Cloud_Talent_V4beta1_Rating? = nil
}

/// The details of the score received for an assessment or interview.
public struct Google_Cloud_Talent_V4beta1_Rating {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Talent_V4beta1_BatchOperationMetadata {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The state of a long running operation.
  public var state: Google_Cloud_Talent_V4beta1_BatchOperationMetadata.State = .unspecified
...
extension Google_Cloud_Talent_V4beta1_BatchOperationMetadata.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_BatchOperationMetadata.State] = [
    .unspecified,
    .initializing,
    .processing,
    .succeeded,
...
extension Google_Cloud_Talent_V4beta1_CompanySize: SwiftProtobuf._ProtoNameProviding {
...
extension Google_Cloud_Talent_V4beta1_JobBenefit: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Talent_V4beta1_DegreeType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Talent_V4beta1_EmploymentType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Talent_V4beta1_JobLevel: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Talent_V4beta1_JobCategory: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Talent_V4beta1_PostingRegion: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Talent_V4beta1_Visibility: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Talent_V4beta1_ContactInfoUsage: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "CONTACT_INFO_USAGE_UNSPECIFIED"),
...
extension Google_Cloud_Talent_V4beta1_HtmlSanitization: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Talent_V4beta1_CommuteMethod: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "COMMUTE_METHOD_UNSPECIFIED"),
    1: .same(proto: "DRIVING"),
    2: .same(proto: "TRANSIT"),
    3: .same(proto: "WALKING"),
    4: .same(proto: "CYCLING"),
  ]
}

extension Google_Cloud_Talent_V4beta1_SkillProficiencyLevel: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "SKILL_PROFICIENCY_LEVEL_UNSPECIFIED"),
    1: .same(proto: "FUNDAMENTAL_AWARENESS"),
    2: .same(proto: "NOVICE"),
    3: .same(proto: "INTERMEDIATE"),
    4: .same(proto: "ADVANCED"),
    5: .same(proto: "EXPERT"),
    6: .same(proto: "UNSKILLED"),
  ]
}

extension Google_Cloud_Talent_V4beta1_Outcome: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "OUTCOME_UNSPECIFIED"),
    1: .same(proto: "POSITIVE"),
    2: .same(proto: "NEUTRAL"),
    3: .same(proto: "NEGATIVE"),
    4: .same(proto: "OUTCOME_NOT_AVAILABLE"),
  ]
}

extension Google_Cloud_Talent_V4beta1_AvailabilitySignalType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "AVAILABILITY_SIGNAL_TYPE_UNSPECIFIED"),
    1: .same(proto: "JOB_APPLICATION"),
    2: .same(proto: "RESUME_UPDATE"),
    3: .same(proto: "CANDIDATE_UPDATE"),
    4: .same(proto: "CLIENT_SUBMISSION"),
  ]
}

extension Google_Cloud_Talent_V4beta1_TimestampRange: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_TimestampRange, rhs: Google_Cloud_Talent_V4beta1_TimestampRange) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_Location: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_Location, rhs: Google_Cloud_Talent_V4beta1_Location) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_Location.LocationType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Talent_V4beta1_RequestMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_RequestMetadata, rhs: Google_Cloud_Talent_V4beta1_RequestMetadata) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_ResponseMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_ResponseMetadata, rhs: Google_Cloud_Talent_V4beta1_ResponseMetadata) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_DeviceInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_DeviceInfo, rhs: Google_Cloud_Talent_V4beta1_DeviceInfo) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_DeviceInfo.DeviceType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Talent_V4beta1_CustomAttribute: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_CustomAttribute, rhs: Google_Cloud_Talent_V4beta1_CustomAttribute) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_SpellingCorrection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_SpellingCorrection, rhs: Google_Cloud_Talent_V4beta1_SpellingCorrection) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_CompensationInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_CompensationInfo, rhs: Google_Cloud_Talent_V4beta1_CompensationInfo) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationUnit: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Talent_V4beta1_CompensationInfo.protoMessageName + ".CompensationEntry"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "type"),
    2: .same(proto: "unit"),
    3: .same(proto: "amount"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try {
        var v: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationRange?
        if let current = self.compensationAmount {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationEntry, rhs: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationEntry) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationRange: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Talent_V4beta1_CompensationInfo.protoMessageName + ".CompensationRange"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationRange, rhs: Google_Cloud_Talent_V4beta1_CompensationInfo.CompensationRange) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_Certification: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Certification"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "display_name"),
    2: .standard(proto: "acquire_date"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._acquireDate) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._expireDate) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._acquireDate {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }
    if let v = self._expireDate {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_Certification, rhs: Google_Cloud_Talent_V4beta1_Certification) -> Bool {
    if lhs.displayName != rhs.displayName {return false}
    if lhs._acquireDate != rhs._acquireDate {return false}
...
extension Google_Cloud_Talent_V4beta1_Skill: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Skill"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "display_name"),
    2: .standard(proto: "last_used_date"),
    3: .same(proto: "level"),
    4: .same(proto: "context"),
    5: .standard(proto: "skill_name_snippet"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.displayName) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._lastUsedDate) }()
      ...
      case 5: try { try decoder.decodeSingularStringField(value: &self.skillNameSnippet) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.skillNameSnippet.isEmpty {
      try visitor.visitSingularStringField(value: self.skillNameSnippet, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Talent_V4beta1_Skill, rhs: Google_Cloud_Talent_V4beta1_Skill) -> Bool {
    if lhs.displayName != rhs.displayName {return false}
    if lhs._lastUsedDate != rhs._lastUsedDate {return false}
    if lhs.level != rhs.level {return false}
    if lhs.context != rhs.context {return false}
    if lhs.skillNameSnippet != rhs.skillNameSnippet {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Google_Cloud_Talent_V4beta1_Interview: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Interview"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    6: .same(proto: "rating"),
    7: .same(proto: "outcome"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 6: try { try decoder.decodeSingularMessageField(value: &self._rating) }()
      case 7: try { try decoder.decodeSingularEnumField(value: &self.outcome) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.outcome != .unspecified {
      try visitor.visitSingularEnumField(value: self.outcome, fieldNumber: 7)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Talent_V4beta1_Interview, rhs: Google_Cloud_Talent_V4beta1_Interview) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_Rating: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Rating"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularDoubleField(value: &self.overall) }()
      ...
      case 4: try { try decoder.decodeSingularDoubleField(value: &self.interval) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.overall != 0 {
      try visitor.visitSingularDoubleField(value: self.overall, fieldNumber: 1)
    }
    if self.min != 0 {
    ...
    if self.interval != 0 {
      try visitor.visitSingularDoubleField(value: self.interval, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Talent_V4beta1_Rating, rhs: Google_Cloud_Talent_V4beta1_Rating) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_BatchOperationMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_BatchOperationMetadata, rhs: Google_Cloud_Talent_V4beta1_BatchOperationMetadata) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_BatchOperationMetadata.State: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
