...
public struct Google_Cloud_Talent_V4beta1_ClientEvent {
  ...
  public var event: Google_Cloud_Talent_V4beta1_ClientEvent.OneOf_Event? = nil

  /// An event issued when a job seeker interacts with the application that
  /// implements Cloud Talent Solution.
  public var jobEvent: Google_Cloud_Talent_V4beta1_JobEvent {
    get {
      if case .jobEvent(let v)? = event {return v}
      return Google_Cloud_Talent_V4beta1_JobEvent()
    }
  ...
  public var profileEvent: Google_Cloud_Talent_V4beta1_ProfileEvent {
    get {
      if case .profileEvent(let v)? = event {return v}
      return Google_Cloud_Talent_V4beta1_ProfileEvent()
    }
    set {event = .profileEvent(newValue)}
  }
  ...
  public enum OneOf_Event: Equatable {
    /// An event issued when a job seeker interacts with the application that
    /// implements Cloud Talent Solution.
    case jobEvent(Google_Cloud_Talent_V4beta1_JobEvent)
    /// An event issued when a profile searcher interacts with the application
    /// that implements Cloud Talent Solution.
    case profileEvent(Google_Cloud_Talent_V4beta1_ProfileEvent)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Talent_V4beta1_ClientEvent.OneOf_Event, rhs: Google_Cloud_Talent_V4beta1_ClientEvent.OneOf_Event) -> Bool {
      ...
      case (.profileEvent, .profileEvent): return {
        guard case .profileEvent(let l) = lhs, case .profileEvent(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
/// An event issued when a job seeker interacts with the application that
/// implements Cloud Talent Solution.
public struct Google_Cloud_Talent_V4beta1_JobEvent {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Required. The type of the event (see [JobEventType][google.cloud.talent.v4beta1.JobEvent.JobEventType]).
  public var type: Google_Cloud_Talent_V4beta1_JobEvent.JobEventType = .unspecified
...
extension Google_Cloud_Talent_V4beta1_JobEvent.JobEventType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_JobEvent.JobEventType] = [
    .unspecified,
    .impression,
    .view,
    .viewRedirect,
...
/// An event issued when a profile searcher interacts with the application
/// that implements Cloud Talent Solution.
public struct Google_Cloud_Talent_V4beta1_ProfileEvent {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Required. Type of event.
  public var type: Google_Cloud_Talent_V4beta1_ProfileEvent.ProfileEventType = .unspecified
  ...
  public enum ProfileEventType: SwiftProtobuf.Enum {
    public typealias RawValue = Int
...
extension Google_Cloud_Talent_V4beta1_ProfileEvent.ProfileEventType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Talent_V4beta1_ProfileEvent.ProfileEventType] = [
    .unspecified,
    .impression,
    .view,
    .bookmark,
...
extension Google_Cloud_Talent_V4beta1_ClientEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    6: .standard(proto: "profile_event"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try {
        var v: Google_Cloud_Talent_V4beta1_JobEvent?
      ...
      case 6: try {
        var v: Google_Cloud_Talent_V4beta1_ProfileEvent?
        if let current = self.event {
          try decoder.handleConflictingOneOf()
          if case .profileEvent(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.event = .profileEvent(v)}
      }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    switch self.event {
    case .jobEvent?: try {
      guard case .jobEvent(let v)? = self.event else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
    }()
    case .profileEvent?: try {
      guard case .profileEvent(let v)? = self.event else { preconditionFailure() }
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_ClientEvent, rhs: Google_Cloud_Talent_V4beta1_ClientEvent) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_JobEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Talent_V4beta1_JobEvent, rhs: Google_Cloud_Talent_V4beta1_JobEvent) -> Bool {
...
extension Google_Cloud_Talent_V4beta1_JobEvent.JobEventType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Talent_V4beta1_ProfileEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ProfileEvent"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "type"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeRepeatedStringField(value: &self.jobs) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.jobs.isEmpty {
      try visitor.visitRepeatedStringField(value: self.jobs, fieldNumber: 6)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Talent_V4beta1_ProfileEvent, rhs: Google_Cloud_Talent_V4beta1_ProfileEvent) -> Bool {
    if lhs.type != rhs.type {return false}
...
extension Google_Cloud_Talent_V4beta1_ProfileEvent.ProfileEventType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "PROFILE_EVENT_TYPE_UNSPECIFIED"),
    1: .same(proto: "IMPRESSION"),
    2: .same(proto: "VIEW"),
    3: .same(proto: "BOOKMARK"),
  ]
}
