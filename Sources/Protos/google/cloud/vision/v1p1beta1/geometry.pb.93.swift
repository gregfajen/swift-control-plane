...
public struct Google_Cloud_Vision_V1p1beta1_Vertex {
...
public struct Google_Cloud_Vision_V1p1beta1_BoundingPoly {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The bounding polygon vertices.
  public var vertices: [Google_Cloud_Vision_V1p1beta1_Vertex] = []
...
public struct Google_Cloud_Vision_V1p1beta1_Position {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Vision_V1p1beta1_Vertex: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Vision_V1p1beta1_Vertex, rhs: Google_Cloud_Vision_V1p1beta1_Vertex) -> Bool {
...
extension Google_Cloud_Vision_V1p1beta1_BoundingPoly: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Vision_V1p1beta1_BoundingPoly, rhs: Google_Cloud_Vision_V1p1beta1_BoundingPoly) -> Bool {
...
extension Google_Cloud_Vision_V1p1beta1_Position: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Vision_V1p1beta1_Position, rhs: Google_Cloud_Vision_V1p1beta1_Position) -> Bool {
    if lhs.x != rhs.x {return false}
    if lhs.y != rhs.y {return false}
