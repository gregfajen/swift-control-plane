...
public struct Google_Cloud_Vision_V1p1beta1_WebDetection {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Deduced entities from similar images on the Internet.
  public var webEntities: [Google_Cloud_Vision_V1p1beta1_WebDetection.WebEntity] = []

  /// Fully matching images from the Internet.
  /// Can include resized copies of the query image.
  public var fullMatchingImages: [Google_Cloud_Vision_V1p1beta1_WebDetection.WebImage] = []

  /// Partial matching images from the Internet.
  /// Those images are similar enough to share some key-point features. For
  /// example an original image will likely have partial matching for its crops.
  public var partialMatchingImages: [Google_Cloud_Vision_V1p1beta1_WebDetection.WebImage] = []

  /// Web pages containing the matching images from the Internet.
  public var pagesWithMatchingImages: [Google_Cloud_Vision_V1p1beta1_WebDetection.WebPage] = []

  /// The visually similar image results.
  public var visuallySimilarImages: [Google_Cloud_Vision_V1p1beta1_WebDetection.WebImage] = []

  /// Best guess text labels for the request image.
  public var bestGuessLabels: [Google_Cloud_Vision_V1p1beta1_WebDetection.WebLabel] = []
...
extension Google_Cloud_Vision_V1p1beta1_WebDetection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Vision_V1p1beta1_WebDetection, rhs: Google_Cloud_Vision_V1p1beta1_WebDetection) -> Bool {
...
extension Google_Cloud_Vision_V1p1beta1_WebDetection.WebEntity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Vision_V1p1beta1_WebDetection.protoMessageName + ".WebEntity"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Vision_V1p1beta1_WebDetection.WebEntity, rhs: Google_Cloud_Vision_V1p1beta1_WebDetection.WebEntity) -> Bool {
...
extension Google_Cloud_Vision_V1p1beta1_WebDetection.WebImage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Vision_V1p1beta1_WebDetection.protoMessageName + ".WebImage"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "url"),
    2: .same(proto: "score"),
  ]
  ...
  public static func ==(lhs: Google_Cloud_Vision_V1p1beta1_WebDetection.WebImage, rhs: Google_Cloud_Vision_V1p1beta1_WebDetection.WebImage) -> Bool {
...
extension Google_Cloud_Vision_V1p1beta1_WebDetection.WebPage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Vision_V1p1beta1_WebDetection.protoMessageName + ".WebPage"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "url"),
    2: .same(proto: "score"),
  ...
  public static func ==(lhs: Google_Cloud_Vision_V1p1beta1_WebDetection.WebPage, rhs: Google_Cloud_Vision_V1p1beta1_WebDetection.WebPage) -> Bool {
    if lhs.url != rhs.url {return false}
    if lhs.score != rhs.score {return false}
...
extension Google_Cloud_Vision_V1p1beta1_WebDetection.WebLabel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Vision_V1p1beta1_WebDetection.protoMessageName + ".WebLabel"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "label"),
  ...
  public static func ==(lhs: Google_Cloud_Vision_V1p1beta1_WebDetection.WebLabel, rhs: Google_Cloud_Vision_V1p1beta1_WebDetection.WebLabel) -> Bool {
