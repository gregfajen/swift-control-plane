...
public struct Google_Cloud_Vision_V1p4beta1_ProductSearchParams {
...
public struct Google_Cloud_Vision_V1p4beta1_ProductSearchResults {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var results: [Google_Cloud_Vision_V1p4beta1_ProductSearchResults.Result] = []

  /// List of results grouped by products detected in the query image. Each entry
  /// corresponds to one bounding polygon in the query image, and contains the
  /// matching products specific to that region. There may be duplicate product
  /// matches in the union of all the per-product results.
  public var productGroupedResults: [Google_Cloud_Vision_V1p4beta1_ProductSearchResults.GroupedResult] = []
  ...
  public struct GroupedResult {
    ...
    public var objectAnnotations: [Google_Cloud_Vision_V1p4beta1_ProductSearchResults.ObjectAnnotation] = []
...
extension Google_Cloud_Vision_V1p4beta1_ProductSearchParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Vision_V1p4beta1_ProductSearchParams, rhs: Google_Cloud_Vision_V1p4beta1_ProductSearchParams) -> Bool {
...
extension Google_Cloud_Vision_V1p4beta1_ProductSearchResults: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Vision_V1p4beta1_ProductSearchResults, rhs: Google_Cloud_Vision_V1p4beta1_ProductSearchResults) -> Bool {
...
extension Google_Cloud_Vision_V1p4beta1_ProductSearchResults.Result: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Vision_V1p4beta1_ProductSearchResults.protoMessageName + ".Result"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Vision_V1p4beta1_ProductSearchResults.Result, rhs: Google_Cloud_Vision_V1p4beta1_ProductSearchResults.Result) -> Bool {
...
extension Google_Cloud_Vision_V1p4beta1_ProductSearchResults.ObjectAnnotation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Vision_V1p4beta1_ProductSearchResults.protoMessageName + ".ObjectAnnotation"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "mid"),
  ...
  public static func ==(lhs: Google_Cloud_Vision_V1p4beta1_ProductSearchResults.ObjectAnnotation, rhs: Google_Cloud_Vision_V1p4beta1_ProductSearchResults.ObjectAnnotation) -> Bool {
...
extension Google_Cloud_Vision_V1p4beta1_ProductSearchResults.GroupedResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Vision_V1p4beta1_ProductSearchResults.protoMessageName + ".GroupedResult"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Vision_V1p4beta1_ProductSearchResults.GroupedResult, rhs: Google_Cloud_Vision_V1p4beta1_ProductSearchResults.GroupedResult) -> Bool {
    if lhs._boundingPoly != rhs._boundingPoly {return false}
    if lhs.results != rhs.results {return false}
