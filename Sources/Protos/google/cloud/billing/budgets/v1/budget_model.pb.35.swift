...
public struct Google_Cloud_Billing_Budgets_V1_Budget {
  ...
  public var budgetFilter: Google_Cloud_Billing_Budgets_V1_Filter {
    get {return _storage._budgetFilter ?? Google_Cloud_Billing_Budgets_V1_Filter()}
  ...
  public var amount: Google_Cloud_Billing_Budgets_V1_BudgetAmount {
    get {return _storage._amount ?? Google_Cloud_Billing_Budgets_V1_BudgetAmount()}
  ...
  public var thresholdRules: [Google_Cloud_Billing_Budgets_V1_ThresholdRule] {
  ...
  /// thresholds.
  public var notificationsRule: Google_Cloud_Billing_Budgets_V1_NotificationsRule {
    get {return _storage._notificationsRule ?? Google_Cloud_Billing_Budgets_V1_NotificationsRule()}
    set {_uniqueStorage()._notificationsRule = newValue}
  }
  /// Returns true if `notificationsRule` has been explicitly set.
  public var hasNotificationsRule: Bool {return _storage._notificationsRule != nil}
  /// Clears the value of `notificationsRule`. Subsequent reads from it will return its default value.
  public mutating func clearNotificationsRule() {_uniqueStorage()._notificationsRule = nil}
...
public struct Google_Cloud_Billing_Budgets_V1_BudgetAmount {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Specification for what amount to use as the budget.
  public var budgetAmount: Google_Cloud_Billing_Budgets_V1_BudgetAmount.OneOf_BudgetAmount? = nil
  ...
  public var lastPeriodAmount: Google_Cloud_Billing_Budgets_V1_LastPeriodAmount {
    get {
      if case .lastPeriodAmount(let v)? = budgetAmount {return v}
      return Google_Cloud_Billing_Budgets_V1_LastPeriodAmount()
    }
  ...
  public enum OneOf_BudgetAmount: Equatable {
    ...
    /// Use the last period's actual spend as the budget for the present period.
    case lastPeriodAmount(Google_Cloud_Billing_Budgets_V1_LastPeriodAmount)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Billing_Budgets_V1_BudgetAmount.OneOf_BudgetAmount, rhs: Google_Cloud_Billing_Budgets_V1_BudgetAmount.OneOf_BudgetAmount) -> Bool {
...
public struct Google_Cloud_Billing_Budgets_V1_LastPeriodAmount {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Billing_Budgets_V1_ThresholdRule {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var spendBasis: Google_Cloud_Billing_Budgets_V1_ThresholdRule.Basis = .unspecified
...
extension Google_Cloud_Billing_Budgets_V1_ThresholdRule.Basis: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Billing_Budgets_V1_ThresholdRule.Basis] = [
    .unspecified,
    .currentSpend,
    .forecastedSpend,
  ]
...
/// and thresholds.
public struct Google_Cloud_Billing_Budgets_V1_NotificationsRule {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Billing_Budgets_V1_Filter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var creditTypesTreatment: Google_Cloud_Billing_Budgets_V1_Filter.CreditTypesTreatment = .unspecified
...
extension Google_Cloud_Billing_Budgets_V1_Filter.CreditTypesTreatment: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Billing_Budgets_V1_Filter.CreditTypesTreatment] = [
    .unspecified,
    .includeAllCredits,
    .excludeAllCredits,
...
fileprivate let _protobuf_package = "google.cloud.billing.budgets.v1"

extension Google_Cloud_Billing_Budgets_V1_Budget: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    6: .standard(proto: "notifications_rule"),
    7: .same(proto: "etag"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _budgetFilter: Google_Cloud_Billing_Budgets_V1_Filter? = nil
    var _amount: Google_Cloud_Billing_Budgets_V1_BudgetAmount? = nil
    var _thresholdRules: [Google_Cloud_Billing_Budgets_V1_ThresholdRule] = []
    var _notificationsRule: Google_Cloud_Billing_Budgets_V1_NotificationsRule? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _notificationsRule = source._notificationsRule
      _etag = source._etag
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 6: try { try decoder.decodeSingularMessageField(value: &_storage._notificationsRule) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._notificationsRule {
  ...
  public static func ==(lhs: Google_Cloud_Billing_Budgets_V1_Budget, rhs: Google_Cloud_Billing_Budgets_V1_Budget) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._notificationsRule != rhs_storage._notificationsRule {return false}
...
extension Google_Cloud_Billing_Budgets_V1_BudgetAmount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Google_Cloud_Billing_Budgets_V1_LastPeriodAmount?
        if let current = self.budgetAmount {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Cloud_Billing_Budgets_V1_BudgetAmount, rhs: Google_Cloud_Billing_Budgets_V1_BudgetAmount) -> Bool {
...
extension Google_Cloud_Billing_Budgets_V1_LastPeriodAmount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Billing_Budgets_V1_LastPeriodAmount, rhs: Google_Cloud_Billing_Budgets_V1_LastPeriodAmount) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Google_Cloud_Billing_Budgets_V1_ThresholdRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Billing_Budgets_V1_ThresholdRule, rhs: Google_Cloud_Billing_Budgets_V1_ThresholdRule) -> Bool {
...
extension Google_Cloud_Billing_Budgets_V1_ThresholdRule.Basis: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Billing_Budgets_V1_NotificationsRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".NotificationsRule"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Billing_Budgets_V1_NotificationsRule, rhs: Google_Cloud_Billing_Budgets_V1_NotificationsRule) -> Bool {
...
extension Google_Cloud_Billing_Budgets_V1_Filter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Billing_Budgets_V1_Filter, rhs: Google_Cloud_Billing_Budgets_V1_Filter) -> Bool {
...
extension Google_Cloud_Billing_Budgets_V1_Filter.CreditTypesTreatment: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
