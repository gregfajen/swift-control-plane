...
public struct Google_Cloud_Billing_Budgets_V1beta1_Budget {
  ...
  public var budgetFilter: Google_Cloud_Billing_Budgets_V1beta1_Filter {
    get {return _storage._budgetFilter ?? Google_Cloud_Billing_Budgets_V1beta1_Filter()}
  ...
  public var amount: Google_Cloud_Billing_Budgets_V1beta1_BudgetAmount {
    get {return _storage._amount ?? Google_Cloud_Billing_Budgets_V1beta1_BudgetAmount()}
  ...
  public var thresholdRules: [Google_Cloud_Billing_Budgets_V1beta1_ThresholdRule] {
  ...
  /// thresholds.
  public var allUpdatesRule: Google_Cloud_Billing_Budgets_V1beta1_AllUpdatesRule {
    get {return _storage._allUpdatesRule ?? Google_Cloud_Billing_Budgets_V1beta1_AllUpdatesRule()}
...
public struct Google_Cloud_Billing_Budgets_V1beta1_BudgetAmount {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Specification for what amount to use as the budget.
  public var budgetAmount: Google_Cloud_Billing_Budgets_V1beta1_BudgetAmount.OneOf_BudgetAmount? = nil
  ...
  public var lastPeriodAmount: Google_Cloud_Billing_Budgets_V1beta1_LastPeriodAmount {
    get {
      if case .lastPeriodAmount(let v)? = budgetAmount {return v}
      return Google_Cloud_Billing_Budgets_V1beta1_LastPeriodAmount()
    }
  ...
  public enum OneOf_BudgetAmount: Equatable {
    ...
    /// Use the last period's actual spend as the budget for the present period.
    case lastPeriodAmount(Google_Cloud_Billing_Budgets_V1beta1_LastPeriodAmount)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Billing_Budgets_V1beta1_BudgetAmount.OneOf_BudgetAmount, rhs: Google_Cloud_Billing_Budgets_V1beta1_BudgetAmount.OneOf_BudgetAmount) -> Bool {
...
public struct Google_Cloud_Billing_Budgets_V1beta1_LastPeriodAmount {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Billing_Budgets_V1beta1_ThresholdRule {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var spendBasis: Google_Cloud_Billing_Budgets_V1beta1_ThresholdRule.Basis = .unspecified
...
extension Google_Cloud_Billing_Budgets_V1beta1_ThresholdRule.Basis: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Billing_Budgets_V1beta1_ThresholdRule.Basis] = [
    .unspecified,
    .currentSpend,
    .forecastedSpend,
  ]
...
/// and thresholds.
public struct Google_Cloud_Billing_Budgets_V1beta1_AllUpdatesRule {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Billing_Budgets_V1beta1_Filter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var creditTypesTreatment: Google_Cloud_Billing_Budgets_V1beta1_Filter.CreditTypesTreatment = .unspecified
...
extension Google_Cloud_Billing_Budgets_V1beta1_Filter.CreditTypesTreatment: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Billing_Budgets_V1beta1_Filter.CreditTypesTreatment] = [
    .unspecified,
    .includeAllCredits,
    .excludeAllCredits,
...
extension Google_Cloud_Billing_Budgets_V1beta1_Budget: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _budgetFilter: Google_Cloud_Billing_Budgets_V1beta1_Filter? = nil
    var _amount: Google_Cloud_Billing_Budgets_V1beta1_BudgetAmount? = nil
    var _thresholdRules: [Google_Cloud_Billing_Budgets_V1beta1_ThresholdRule] = []
    var _allUpdatesRule: Google_Cloud_Billing_Budgets_V1beta1_AllUpdatesRule? = nil
  ...
  public static func ==(lhs: Google_Cloud_Billing_Budgets_V1beta1_Budget, rhs: Google_Cloud_Billing_Budgets_V1beta1_Budget) -> Bool {
...
extension Google_Cloud_Billing_Budgets_V1beta1_BudgetAmount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Google_Cloud_Billing_Budgets_V1beta1_LastPeriodAmount?
        if let current = self.budgetAmount {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Cloud_Billing_Budgets_V1beta1_BudgetAmount, rhs: Google_Cloud_Billing_Budgets_V1beta1_BudgetAmount) -> Bool {
...
extension Google_Cloud_Billing_Budgets_V1beta1_LastPeriodAmount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Billing_Budgets_V1beta1_LastPeriodAmount, rhs: Google_Cloud_Billing_Budgets_V1beta1_LastPeriodAmount) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Google_Cloud_Billing_Budgets_V1beta1_ThresholdRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Billing_Budgets_V1beta1_ThresholdRule, rhs: Google_Cloud_Billing_Budgets_V1beta1_ThresholdRule) -> Bool {
...
extension Google_Cloud_Billing_Budgets_V1beta1_ThresholdRule.Basis: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Billing_Budgets_V1beta1_AllUpdatesRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Billing_Budgets_V1beta1_AllUpdatesRule, rhs: Google_Cloud_Billing_Budgets_V1beta1_AllUpdatesRule) -> Bool {
...
extension Google_Cloud_Billing_Budgets_V1beta1_Filter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Billing_Budgets_V1beta1_Filter, rhs: Google_Cloud_Billing_Budgets_V1beta1_Filter) -> Bool {
...
extension Google_Cloud_Billing_Budgets_V1beta1_Filter.CreditTypesTreatment: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
