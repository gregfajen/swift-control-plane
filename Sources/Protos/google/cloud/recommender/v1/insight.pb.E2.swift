...
public struct Google_Cloud_Recommender_V1_Insight {
  ...
  public var stateInfo: Google_Cloud_Recommender_V1_InsightStateInfo {
    get {return _stateInfo ?? Google_Cloud_Recommender_V1_InsightStateInfo()}
  ...
  public var category: Google_Cloud_Recommender_V1_Insight.Category = .unspecified
  ...
  public var associatedRecommendations: [Google_Cloud_Recommender_V1_Insight.RecommendationReference] = []
  ...
  fileprivate var _stateInfo: Google_Cloud_Recommender_V1_InsightStateInfo? = nil
}

#if swift(>=4.2)

extension Google_Cloud_Recommender_V1_Insight.Category: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Recommender_V1_Insight.Category] = [
    .unspecified,
    .cost,
    .security,
    .performance,
...
public struct Google_Cloud_Recommender_V1_InsightStateInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Recommender_V1_InsightStateInfo.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Recommender_V1_InsightStateInfo.State] = [
    .unspecified,
    .active,
    .accepted,
    .dismissed,
...
extension Google_Cloud_Recommender_V1_Insight: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Recommender_V1_Insight, rhs: Google_Cloud_Recommender_V1_Insight) -> Bool {
...
extension Google_Cloud_Recommender_V1_Insight.Category: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Recommender_V1_Insight.RecommendationReference: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Recommender_V1_Insight.protoMessageName + ".RecommendationReference"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Recommender_V1_Insight.RecommendationReference, rhs: Google_Cloud_Recommender_V1_Insight.RecommendationReference) -> Bool {
...
extension Google_Cloud_Recommender_V1_InsightStateInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Recommender_V1_InsightStateInfo, rhs: Google_Cloud_Recommender_V1_InsightStateInfo) -> Bool {
...
extension Google_Cloud_Recommender_V1_InsightStateInfo.State: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
