...
public struct Google_Cloud_Recommender_V1beta1_Recommendation {
  ...
  public var primaryImpact: Google_Cloud_Recommender_V1beta1_Impact {
    get {return _storage._primaryImpact ?? Google_Cloud_Recommender_V1beta1_Impact()}
  ...
  /// or negative.
  public var additionalImpact: [Google_Cloud_Recommender_V1beta1_Impact] {
    get {return _storage._additionalImpact}
    set {_uniqueStorage()._additionalImpact = newValue}
  }

  /// Content of the recommendation describing recommended changes to resources.
  public var content: Google_Cloud_Recommender_V1beta1_RecommendationContent {
    get {return _storage._content ?? Google_Cloud_Recommender_V1beta1_RecommendationContent()}
  ...
  public var stateInfo: Google_Cloud_Recommender_V1beta1_RecommendationStateInfo {
    get {return _storage._stateInfo ?? Google_Cloud_Recommender_V1beta1_RecommendationStateInfo()}
  ...
  public var associatedInsights: [Google_Cloud_Recommender_V1beta1_Recommendation.InsightReference] {
...
public struct Google_Cloud_Recommender_V1beta1_RecommendationContent {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var operationGroups: [Google_Cloud_Recommender_V1beta1_OperationGroup] = []
...
public struct Google_Cloud_Recommender_V1beta1_OperationGroup {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var operations: [Google_Cloud_Recommender_V1beta1_Operation] = []
...
public struct Google_Cloud_Recommender_V1beta1_Operation {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var pathValue: Google_Cloud_Recommender_V1beta1_Operation.OneOf_PathValue? = nil
  ...
  public var valueMatcher: Google_Cloud_Recommender_V1beta1_ValueMatcher {
    get {
      if case .valueMatcher(let v)? = pathValue {return v}
      return Google_Cloud_Recommender_V1beta1_ValueMatcher()
    }
  ...
  /// When both path_filters and path_value_matchers are set, an implicit AND
  /// must be performed.
  public var pathValueMatchers: Dictionary<String,Google_Cloud_Recommender_V1beta1_ValueMatcher> = [:]
  ...
  public enum OneOf_PathValue: Equatable {
    ...
    /// Can be set for action 'test' for advanced matching for the value of
    /// 'path' field. Either this or `value` will be set for 'test' operation.
    case valueMatcher(Google_Cloud_Recommender_V1beta1_ValueMatcher)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Recommender_V1beta1_Operation.OneOf_PathValue, rhs: Google_Cloud_Recommender_V1beta1_Operation.OneOf_PathValue) -> Bool {
...
public struct Google_Cloud_Recommender_V1beta1_ValueMatcher {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var matchVariant: Google_Cloud_Recommender_V1beta1_ValueMatcher.OneOf_MatchVariant? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Recommender_V1beta1_ValueMatcher.OneOf_MatchVariant, rhs: Google_Cloud_Recommender_V1beta1_ValueMatcher.OneOf_MatchVariant) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Google_Cloud_Recommender_V1beta1_CostProjection {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Recommender_V1beta1_Impact {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Category that is being targeted.
  public var category: Google_Cloud_Recommender_V1beta1_Impact.Category = .unspecified

  /// Contains projections (if any) for this category.
  public var projection: Google_Cloud_Recommender_V1beta1_Impact.OneOf_Projection? = nil

  /// Use with CategoryType.COST
  public var costProjection: Google_Cloud_Recommender_V1beta1_CostProjection {
    get {
      if case .costProjection(let v)? = projection {return v}
      return Google_Cloud_Recommender_V1beta1_CostProjection()
    }
  ...
  public enum OneOf_Projection: Equatable {
    /// Use with CategoryType.COST
    case costProjection(Google_Cloud_Recommender_V1beta1_CostProjection)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Recommender_V1beta1_Impact.OneOf_Projection, rhs: Google_Cloud_Recommender_V1beta1_Impact.OneOf_Projection) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
extension Google_Cloud_Recommender_V1beta1_Impact.Category: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Recommender_V1beta1_Impact.Category] = [
    .unspecified,
    .cost,
    .security,
    .performance,
...
/// Information for state. Contains state and metadata.
public struct Google_Cloud_Recommender_V1beta1_RecommendationStateInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The state of the recommendation, Eg ACTIVE, SUCCEEDED, FAILED.
  public var state: Google_Cloud_Recommender_V1beta1_RecommendationStateInfo.State = .unspecified
...
extension Google_Cloud_Recommender_V1beta1_RecommendationStateInfo.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Recommender_V1beta1_RecommendationStateInfo.State] = [
    .unspecified,
    .active,
    .claimed,
    .succeeded,
...
extension Google_Cloud_Recommender_V1beta1_Recommendation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _primaryImpact: Google_Cloud_Recommender_V1beta1_Impact? = nil
    var _additionalImpact: [Google_Cloud_Recommender_V1beta1_Impact] = []
    var _content: Google_Cloud_Recommender_V1beta1_RecommendationContent? = nil
    var _stateInfo: Google_Cloud_Recommender_V1beta1_RecommendationStateInfo? = nil
    var _etag: String = String()
    var _associatedInsights: [Google_Cloud_Recommender_V1beta1_Recommendation.InsightReference] = []
  ...
  public static func ==(lhs: Google_Cloud_Recommender_V1beta1_Recommendation, rhs: Google_Cloud_Recommender_V1beta1_Recommendation) -> Bool {
...
extension Google_Cloud_Recommender_V1beta1_Recommendation.InsightReference: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Recommender_V1beta1_Recommendation.protoMessageName + ".InsightReference"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Recommender_V1beta1_Recommendation.InsightReference, rhs: Google_Cloud_Recommender_V1beta1_Recommendation.InsightReference) -> Bool {
...
extension Google_Cloud_Recommender_V1beta1_RecommendationContent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Recommender_V1beta1_RecommendationContent, rhs: Google_Cloud_Recommender_V1beta1_RecommendationContent) -> Bool {
...
extension Google_Cloud_Recommender_V1beta1_OperationGroup: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Recommender_V1beta1_OperationGroup, rhs: Google_Cloud_Recommender_V1beta1_OperationGroup) -> Bool {
...
extension Google_Cloud_Recommender_V1beta1_Operation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try {
        var v: Google_Cloud_Recommender_V1beta1_ValueMatcher?
        if let current = self.pathValue {
          try decoder.handleConflictingOneOf()
      ...
      case 11: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Recommender_V1beta1_ValueMatcher>.self, value: &self.pathValueMatchers) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.pathValueMatchers.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Cloud_Recommender_V1beta1_ValueMatcher>.self, value: self.pathValueMatchers, fieldNumber: 11)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Recommender_V1beta1_Operation, rhs: Google_Cloud_Recommender_V1beta1_Operation) -> Bool {
...
extension Google_Cloud_Recommender_V1beta1_ValueMatcher: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Recommender_V1beta1_ValueMatcher, rhs: Google_Cloud_Recommender_V1beta1_ValueMatcher) -> Bool {
...
extension Google_Cloud_Recommender_V1beta1_CostProjection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Recommender_V1beta1_CostProjection, rhs: Google_Cloud_Recommender_V1beta1_CostProjection) -> Bool {
...
extension Google_Cloud_Recommender_V1beta1_Impact: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 100: try {
        var v: Google_Cloud_Recommender_V1beta1_CostProjection?
  ...
  public static func ==(lhs: Google_Cloud_Recommender_V1beta1_Impact, rhs: Google_Cloud_Recommender_V1beta1_Impact) -> Bool {
...
extension Google_Cloud_Recommender_V1beta1_Impact.Category: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Recommender_V1beta1_RecommendationStateInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Recommender_V1beta1_RecommendationStateInfo, rhs: Google_Cloud_Recommender_V1beta1_RecommendationStateInfo) -> Bool {
...
extension Google_Cloud_Recommender_V1beta1_RecommendationStateInfo.State: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
