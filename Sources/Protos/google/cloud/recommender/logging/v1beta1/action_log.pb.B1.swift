...
public struct Google_Cloud_Recommender_Logging_V1beta1_ActionLog {
...
public struct Google_Cloud_Recommender_Logging_V1beta1_InsightActionLog {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "google.cloud.recommender.logging.v1beta1"

extension Google_Cloud_Recommender_Logging_V1beta1_ActionLog: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Recommender_Logging_V1beta1_ActionLog, rhs: Google_Cloud_Recommender_Logging_V1beta1_ActionLog) -> Bool {
...
extension Google_Cloud_Recommender_Logging_V1beta1_InsightActionLog: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Recommender_Logging_V1beta1_InsightActionLog, rhs: Google_Cloud_Recommender_Logging_V1beta1_InsightActionLog) -> Bool {
    if lhs.actor != rhs.actor {return false}
    if lhs.state != rhs.state {return false}
    if lhs.stateMetadata != rhs.stateMetadata {return false}
