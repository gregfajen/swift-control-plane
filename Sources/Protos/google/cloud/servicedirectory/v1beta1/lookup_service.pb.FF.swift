...
public struct Google_Cloud_Servicedirectory_V1beta1_ResolveServiceRequest {
...
public struct Google_Cloud_Servicedirectory_V1beta1_ResolveServiceResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Servicedirectory_V1beta1_ResolveServiceRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Servicedirectory_V1beta1_ResolveServiceRequest, rhs: Google_Cloud_Servicedirectory_V1beta1_ResolveServiceRequest) -> Bool {
...
extension Google_Cloud_Servicedirectory_V1beta1_ResolveServiceResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Servicedirectory_V1beta1_ResolveServiceResponse, rhs: Google_Cloud_Servicedirectory_V1beta1_ResolveServiceResponse) -> Bool {
