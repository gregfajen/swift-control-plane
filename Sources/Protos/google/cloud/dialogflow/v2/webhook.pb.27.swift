...
public struct Google_Cloud_Dialogflow_V2_WebhookRequest {
  ...
  public var originalDetectIntentRequest: Google_Cloud_Dialogflow_V2_OriginalDetectIntentRequest {
    get {return _storage._originalDetectIntentRequest ?? Google_Cloud_Dialogflow_V2_OriginalDetectIntentRequest()}
    set {_uniqueStorage()._originalDetectIntentRequest = newValue}
  }
  /// Returns true if `originalDetectIntentRequest` has been explicitly set.
  public var hasOriginalDetectIntentRequest: Bool {return _storage._originalDetectIntentRequest != nil}
  /// Clears the value of `originalDetectIntentRequest`. Subsequent reads from it will return its default value.
  public mutating func clearOriginalDetectIntentRequest() {_uniqueStorage()._originalDetectIntentRequest = nil}
...
public struct Google_Cloud_Dialogflow_V2_WebhookResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var followupEventInput: Google_Cloud_Dialogflow_V2_EventInput {
    get {return _followupEventInput ?? Google_Cloud_Dialogflow_V2_EventInput()}
  ...
  fileprivate var _followupEventInput: Google_Cloud_Dialogflow_V2_EventInput? = nil
}

/// Represents the contents of the original request that was passed to
/// the `[Streaming]DetectIntent` call.
public struct Google_Cloud_Dialogflow_V2_OriginalDetectIntentRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Dialogflow_V2_WebhookRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _originalDetectIntentRequest: Google_Cloud_Dialogflow_V2_OriginalDetectIntentRequest? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _originalDetectIntentRequest = source._originalDetectIntentRequest
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._originalDetectIntentRequest) }()
        case 4: try { try decoder.decodeSingularStringField(value: &_storage._session) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._originalDetectIntentRequest {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_V2_WebhookRequest, rhs: Google_Cloud_Dialogflow_V2_WebhookRequest) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._originalDetectIntentRequest != rhs_storage._originalDetectIntentRequest {return false}
        return true
      }
...
extension Google_Cloud_Dialogflow_V2_WebhookResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_V2_WebhookResponse, rhs: Google_Cloud_Dialogflow_V2_WebhookResponse) -> Bool {
...
extension Google_Cloud_Dialogflow_V2_OriginalDetectIntentRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_V2_OriginalDetectIntentRequest, rhs: Google_Cloud_Dialogflow_V2_OriginalDetectIntentRequest) -> Bool {
    if lhs.source != rhs.source {return false}
