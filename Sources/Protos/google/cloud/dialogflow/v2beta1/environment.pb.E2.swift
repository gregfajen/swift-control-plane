...
public struct Google_Cloud_Dialogflow_V2beta1_Environment {
  ...
  public var state: Google_Cloud_Dialogflow_V2beta1_Environment.State = .unspecified
...
extension Google_Cloud_Dialogflow_V2beta1_Environment.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Dialogflow_V2beta1_Environment.State] = [
    .unspecified,
    .stopped,
    .loading,
    .running,
...
public struct Google_Cloud_Dialogflow_V2beta1_ListEnvironmentsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Dialogflow_V2beta1_ListEnvironmentsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var environments: [Google_Cloud_Dialogflow_V2beta1_Environment] = []
...
extension Google_Cloud_Dialogflow_V2beta1_Environment: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_V2beta1_Environment, rhs: Google_Cloud_Dialogflow_V2beta1_Environment) -> Bool {
...
extension Google_Cloud_Dialogflow_V2beta1_Environment.State: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Dialogflow_V2beta1_ListEnvironmentsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_V2beta1_ListEnvironmentsRequest, rhs: Google_Cloud_Dialogflow_V2beta1_ListEnvironmentsRequest) -> Bool {
...
extension Google_Cloud_Dialogflow_V2beta1_ListEnvironmentsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_V2beta1_ListEnvironmentsResponse, rhs: Google_Cloud_Dialogflow_V2beta1_ListEnvironmentsResponse) -> Bool {
