...
public struct Google_Cloud_Dialogflow_V2beta1_ValidationError {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The severity of the error.
  public var severity: Google_Cloud_Dialogflow_V2beta1_ValidationError.Severity = .unspecified
...
extension Google_Cloud_Dialogflow_V2beta1_ValidationError.Severity: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Dialogflow_V2beta1_ValidationError.Severity] = [
    .unspecified,
    .info,
    .warning,
    .error,
...
public struct Google_Cloud_Dialogflow_V2beta1_ValidationResult {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Contains all validation errors.
  public var validationErrors: [Google_Cloud_Dialogflow_V2beta1_ValidationError] = []
...
extension Google_Cloud_Dialogflow_V2beta1_ValidationError: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_V2beta1_ValidationError, rhs: Google_Cloud_Dialogflow_V2beta1_ValidationError) -> Bool {
...
extension Google_Cloud_Dialogflow_V2beta1_ValidationError.Severity: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Dialogflow_V2beta1_ValidationResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_V2beta1_ValidationResult, rhs: Google_Cloud_Dialogflow_V2beta1_ValidationResult) -> Bool {
