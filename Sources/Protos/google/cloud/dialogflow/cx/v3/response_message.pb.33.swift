...
public struct Google_Cloud_Dialogflow_Cx_V3_ResponseMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Required. The rich response message.
  public var message: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.OneOf_Message? = nil

  /// Returns a text response.
  public var text: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.Text {
    get {
      if case .text(let v)? = message {return v}
      return Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.Text()
    }
  ...
  public var conversationSuccess: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.ConversationSuccess {
    get {
      if case .conversationSuccess(let v)? = message {return v}
      return Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.ConversationSuccess()
    }
  ...
  public var outputAudioText: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.OutputAudioText {
    get {
      if case .outputAudioText(let v)? = message {return v}
      return Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.OutputAudioText()
    }
    set {message = .outputAudioText(newValue)}
  }

  /// Hands off conversation to a human agent.
  public var liveAgentHandoff: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.LiveAgentHandoff {
    get {
      if case .liveAgentHandoff(let v)? = message {return v}
      return Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.LiveAgentHandoff()
    }
  ...
  public var endInteraction: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.EndInteraction {
    get {
      if case .endInteraction(let v)? = message {return v}
      return Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.EndInteraction()
    }
  ...
  public var playAudio: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.PlayAudio {
    get {
      if case .playAudio(let v)? = message {return v}
      return Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.PlayAudio()
    }
  ...
  /// defined by the user.
  public var mixedAudio: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio {
    get {
      if case .mixedAudio(let v)? = message {return v}
      return Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio()
    }
  ...
  public enum OneOf_Message: Equatable {
    /// Returns a text response.
    case text(Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.Text)
    /// Returns a response containing a custom, platform-specific payload.
    case payload(SwiftProtobuf.Google_Protobuf_Struct)
    /// Indicates that the conversation succeeded.
    case conversationSuccess(Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.ConversationSuccess)
    /// A text or ssml response that is preferentially used for TTS output audio
    /// synthesis, as described in the comment on the ResponseMessage message.
    case outputAudioText(Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.OutputAudioText)
    /// Hands off conversation to a human agent.
    case liveAgentHandoff(Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.LiveAgentHandoff)
    /// Output only. A signal that indicates the interaction with the Dialogflow agent has
    /// ended.
    /// This message is generated by Dialogflow only when the conversation
    /// reaches `END_SESSION` or `END_PAGE` page. It is not supposed to be
    /// defined by the user.
    /// It's guaranteed that there is at most one such message in each response.
    case endInteraction(Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.EndInteraction)
    /// Signal that the client should play an audio clip hosted at a
    /// client-specific URI. Dialogflow uses this to construct
    /// [mixed_audio][google.cloud.dialogflow.cx.v3.ResponseMessage.mixed_audio]. However, Dialogflow itself
    /// does not try to read or process the URI in any way.
    case playAudio(Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.PlayAudio)
    /// Output only. An audio response message composed of both the synthesized Dialogflow
    /// agent responses and responses defined via
    /// [play_audio][google.cloud.dialogflow.cx.v3.ResponseMessage.play_audio].
    /// This message is generated by Dialogflow only and not supposed to be
    /// defined by the user.
    case mixedAudio(Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.OneOf_Message, rhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.OneOf_Message) -> Bool {
  ...
  public struct OutputAudioText {
    ...
    public var source: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.OutputAudioText.OneOf_Source? = nil
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.OutputAudioText.OneOf_Source, rhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.OutputAudioText.OneOf_Source) -> Bool {
        // The use of inline closures is to circumvent an issue where the compiler
        // allocates stack space for every case branch when no optimizations are
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch (lhs, rhs) {
  ...
  public struct MixedAudio {
    ...
    public var segments: [Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio.Segment] = []
    ...
    public struct Segment {
      ...
      public var content: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio.Segment.OneOf_Content? = nil
      ...
      #if !swift(>=4.1)
        public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio.Segment.OneOf_Content, rhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio.Segment.OneOf_Content) -> Bool {
          // The use of inline closures is to circumvent an issue where the compiler
          // allocates stack space for every case branch when no optimizations are
          // enabled. https://github.com/apple/swift-protobuf/issues/1034
          switch (lhs, rhs) {
...
extension Google_Cloud_Dialogflow_Cx_V3_ResponseMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.Text?
      ...
      case 8: try {
        var v: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.OutputAudioText?
        if let current = self.message {
          try decoder.handleConflictingOneOf()
      ...
      case 9: try {
        var v: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.ConversationSuccess?
        if let current = self.message {
          try decoder.handleConflictingOneOf()
      ...
      case 10: try {
        var v: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.LiveAgentHandoff?
        if let current = self.message {
          try decoder.handleConflictingOneOf()
      ...
      case 11: try {
        var v: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.EndInteraction?
        if let current = self.message {
          try decoder.handleConflictingOneOf()
      ...
      case 12: try {
        var v: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.PlayAudio?
        if let current = self.message {
          try decoder.handleConflictingOneOf()
      ...
      case 13: try {
        var v: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio?
        if let current = self.message {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage, rhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.Text: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.protoMessageName + ".Text"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "text"),
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.Text, rhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.Text) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.LiveAgentHandoff: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.protoMessageName + ".LiveAgentHandoff"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.LiveAgentHandoff, rhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.LiveAgentHandoff) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.ConversationSuccess: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.protoMessageName + ".ConversationSuccess"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "metadata"),
  ]
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.ConversationSuccess, rhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.ConversationSuccess) -> Bool {
    if lhs._metadata != rhs._metadata {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.OutputAudioText: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.protoMessageName + ".OutputAudioText"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "text"),
    2: .same(proto: "ssml"),
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.OutputAudioText, rhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.OutputAudioText) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.EndInteraction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.protoMessageName + ".EndInteraction"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.EndInteraction, rhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.EndInteraction) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.PlayAudio: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.protoMessageName + ".PlayAudio"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.PlayAudio, rhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.PlayAudio) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.protoMessageName + ".MixedAudio"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio, rhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio.Segment: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio.protoMessageName + ".Segment"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "audio"),
    2: .same(proto: "uri"),
    3: .standard(proto: "allow_playback_interruption"),
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio.Segment, rhs: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage.MixedAudio.Segment) -> Bool {
