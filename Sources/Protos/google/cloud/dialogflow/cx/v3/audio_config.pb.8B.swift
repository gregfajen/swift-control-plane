...
/// details.
public enum Google_Cloud_Dialogflow_Cx_V3_AudioEncoding: SwiftProtobuf.Enum {
...
extension Google_Cloud_Dialogflow_Cx_V3_AudioEncoding: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Dialogflow_Cx_V3_AudioEncoding] = [
    .unspecified,
    .linear16,
    .flac,
    .mulaw,
...
public enum Google_Cloud_Dialogflow_Cx_V3_SpeechModelVariant: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Dialogflow_Cx_V3_SpeechModelVariant: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Dialogflow_Cx_V3_SpeechModelVariant] = [
    .unspecified,
    .useBestAvailable,
    .useStandard,
    .useEnhanced,
...
public enum Google_Cloud_Dialogflow_Cx_V3_SsmlVoiceGender: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Dialogflow_Cx_V3_SsmlVoiceGender: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Dialogflow_Cx_V3_SsmlVoiceGender] = [
    .unspecified,
    .male,
    .female,
    .neutral,
...
public enum Google_Cloud_Dialogflow_Cx_V3_OutputAudioEncoding: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Google_Cloud_Dialogflow_Cx_V3_OutputAudioEncoding: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Dialogflow_Cx_V3_OutputAudioEncoding] = [
    .unspecified,
    .linear16,
    .mp3,
    .mp364Kbps,
...
public struct Google_Cloud_Dialogflow_Cx_V3_SpeechWordInfo {
...
public struct Google_Cloud_Dialogflow_Cx_V3_InputAudioConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Required. Audio encoding of the audio content to process.
  public var audioEncoding: Google_Cloud_Dialogflow_Cx_V3_AudioEncoding = .unspecified
  ...
  public var modelVariant: Google_Cloud_Dialogflow_Cx_V3_SpeechModelVariant = .unspecified
...
public struct Google_Cloud_Dialogflow_Cx_V3_VoiceSelectionParams {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var ssmlGender: Google_Cloud_Dialogflow_Cx_V3_SsmlVoiceGender = .unspecified
...
public struct Google_Cloud_Dialogflow_Cx_V3_SynthesizeSpeechConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var voice: Google_Cloud_Dialogflow_Cx_V3_VoiceSelectionParams {
    get {return _voice ?? Google_Cloud_Dialogflow_Cx_V3_VoiceSelectionParams()}
    set {_voice = newValue}
  }
  ...
  fileprivate var _voice: Google_Cloud_Dialogflow_Cx_V3_VoiceSelectionParams? = nil
}

/// Instructs the speech synthesizer how to generate the output audio content.
public struct Google_Cloud_Dialogflow_Cx_V3_OutputAudioConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Required. Audio encoding of the synthesized audio content.
  public var audioEncoding: Google_Cloud_Dialogflow_Cx_V3_OutputAudioEncoding = .unspecified
  ...
  public var synthesizeSpeechConfig: Google_Cloud_Dialogflow_Cx_V3_SynthesizeSpeechConfig {
    get {return _synthesizeSpeechConfig ?? Google_Cloud_Dialogflow_Cx_V3_SynthesizeSpeechConfig()}
  ...
  fileprivate var _synthesizeSpeechConfig: Google_Cloud_Dialogflow_Cx_V3_SynthesizeSpeechConfig? = nil
}
...
extension Google_Cloud_Dialogflow_Cx_V3_AudioEncoding: SwiftProtobuf._ProtoNameProviding {
...
extension Google_Cloud_Dialogflow_Cx_V3_SpeechModelVariant: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Dialogflow_Cx_V3_SsmlVoiceGender: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Dialogflow_Cx_V3_OutputAudioEncoding: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Dialogflow_Cx_V3_SpeechWordInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_SpeechWordInfo, rhs: Google_Cloud_Dialogflow_Cx_V3_SpeechWordInfo) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_InputAudioConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_InputAudioConfig, rhs: Google_Cloud_Dialogflow_Cx_V3_InputAudioConfig) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_VoiceSelectionParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_VoiceSelectionParams, rhs: Google_Cloud_Dialogflow_Cx_V3_VoiceSelectionParams) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_SynthesizeSpeechConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_SynthesizeSpeechConfig, rhs: Google_Cloud_Dialogflow_Cx_V3_SynthesizeSpeechConfig) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_OutputAudioConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_OutputAudioConfig, rhs: Google_Cloud_Dialogflow_Cx_V3_OutputAudioConfig) -> Bool {
    if lhs.audioEncoding != rhs.audioEncoding {return false}
    if lhs.sampleRateHertz != rhs.sampleRateHertz {return false}
