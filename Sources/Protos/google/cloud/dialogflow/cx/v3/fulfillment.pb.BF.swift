...
public struct Google_Cloud_Dialogflow_Cx_V3_Fulfillment {
  ...
  public var setParameterActions: [Google_Cloud_Dialogflow_Cx_V3_Fulfillment.SetParameterAction] = []

  /// Conditional cases for this fulfillment.
  public var conditionalCases: [Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases] = []
  ...
  public struct ConditionalCases {
    ...
    public var cases: [Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases.Case] = []
    ...
    public struct Case {
      ...
      public var caseContent: [Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases.Case.CaseContent] = []
      ...
      public struct CaseContent {
        ...
        public var casesOrMessage: Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases.Case.CaseContent.OneOf_CasesOrMessage? = nil

        /// Returned message.
        public var message: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage {
          get {
            if case .message(let v)? = casesOrMessage {return v}
            return Google_Cloud_Dialogflow_Cx_V3_ResponseMessage()
          }
          set {casesOrMessage = .message(newValue)}
        }

        /// Additional cases to be evaluated.
        public var additionalCases: Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases {
          get {
            if case .additionalCases(let v)? = casesOrMessage {return v}
            return Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases()
          }
        ...
        public enum OneOf_CasesOrMessage: Equatable {
          /// Returned message.
          case message(Google_Cloud_Dialogflow_Cx_V3_ResponseMessage)
          /// Additional cases to be evaluated.
          case additionalCases(Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases)

        #if !swift(>=4.1)
          public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases.Case.CaseContent.OneOf_CasesOrMessage, rhs: Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases.Case.CaseContent.OneOf_CasesOrMessage) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_Fulfillment: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_Fulfillment, rhs: Google_Cloud_Dialogflow_Cx_V3_Fulfillment) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_Fulfillment.SetParameterAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Dialogflow_Cx_V3_Fulfillment.protoMessageName + ".SetParameterAction"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_Fulfillment.SetParameterAction, rhs: Google_Cloud_Dialogflow_Cx_V3_Fulfillment.SetParameterAction) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Dialogflow_Cx_V3_Fulfillment.protoMessageName + ".ConditionalCases"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "cases"),
  ]
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases, rhs: Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases.Case: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases.protoMessageName + ".Case"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases.Case, rhs: Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases.Case) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases.Case.CaseContent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases.Case.protoMessageName + ".CaseContent"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Google_Cloud_Dialogflow_Cx_V3_ResponseMessage?
      ...
      case 2: try {
        var v: Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases?
        if let current = self.casesOrMessage {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases.Case.CaseContent, rhs: Google_Cloud_Dialogflow_Cx_V3_Fulfillment.ConditionalCases.Case.CaseContent) -> Bool {
