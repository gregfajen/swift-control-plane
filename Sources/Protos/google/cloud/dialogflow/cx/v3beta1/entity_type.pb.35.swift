...
public struct Google_Cloud_Dialogflow_Cx_V3beta1_EntityType {
  ...
  public var kind: Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.Kind = .unspecified

  /// Indicates whether the entity type can be automatically expanded.
  public var autoExpansionMode: Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.AutoExpansionMode = .unspecified

  /// The collection of entity entries associated with the entity type.
  public var entities: [Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.Entity] = []
  ...
  public var excludedPhrases: [Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.ExcludedPhrase] = []
...
extension Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.Kind: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.Kind] = [
    .unspecified,
    .map,
    .list,
    .regexp,
...
extension Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.AutoExpansionMode: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.AutoExpansionMode] = [
    .unspecified,
    .default,
  ]
}
...
public struct Google_Cloud_Dialogflow_Cx_V3beta1_ListEntityTypesRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Dialogflow_Cx_V3beta1_ListEntityTypesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var entityTypes: [Google_Cloud_Dialogflow_Cx_V3beta1_EntityType] = []
...
public struct Google_Cloud_Dialogflow_Cx_V3beta1_GetEntityTypeRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Dialogflow_Cx_V3beta1_CreateEntityTypeRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var entityType: Google_Cloud_Dialogflow_Cx_V3beta1_EntityType {
    get {return _entityType ?? Google_Cloud_Dialogflow_Cx_V3beta1_EntityType()}
  ...
  fileprivate var _entityType: Google_Cloud_Dialogflow_Cx_V3beta1_EntityType? = nil
}

/// The request message for [EntityTypes.UpdateEntityType][google.cloud.dialogflow.cx.v3beta1.EntityTypes.UpdateEntityType].
public struct Google_Cloud_Dialogflow_Cx_V3beta1_UpdateEntityTypeRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Dialogflow_Cx_V3beta1_DeleteEntityTypeRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Dialogflow_Cx_V3beta1_EntityType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3beta1_EntityType, rhs: Google_Cloud_Dialogflow_Cx_V3beta1_EntityType) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.Kind: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.AutoExpansionMode: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.Entity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.protoMessageName + ".Entity"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "value"),
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.Entity, rhs: Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.Entity) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.ExcludedPhrase: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.protoMessageName + ".ExcludedPhrase"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "value"),
  ]
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.ExcludedPhrase, rhs: Google_Cloud_Dialogflow_Cx_V3beta1_EntityType.ExcludedPhrase) -> Bool {
    if lhs.value != rhs.value {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Google_Cloud_Dialogflow_Cx_V3beta1_ListEntityTypesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3beta1_ListEntityTypesRequest, rhs: Google_Cloud_Dialogflow_Cx_V3beta1_ListEntityTypesRequest) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3beta1_ListEntityTypesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3beta1_ListEntityTypesResponse, rhs: Google_Cloud_Dialogflow_Cx_V3beta1_ListEntityTypesResponse) -> Bool {
...
extension Google_Cloud_Dialogflow_Cx_V3beta1_GetEntityTypeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3beta1_GetEntityTypeRequest, rhs: Google_Cloud_Dialogflow_Cx_V3beta1_GetEntityTypeRequest) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.languageCode != rhs.languageCode {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Google_Cloud_Dialogflow_Cx_V3beta1_CreateEntityTypeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3beta1_CreateEntityTypeRequest, rhs: Google_Cloud_Dialogflow_Cx_V3beta1_CreateEntityTypeRequest) -> Bool {
    if lhs.parent != rhs.parent {return false}
...
extension Google_Cloud_Dialogflow_Cx_V3beta1_UpdateEntityTypeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3beta1_UpdateEntityTypeRequest, rhs: Google_Cloud_Dialogflow_Cx_V3beta1_UpdateEntityTypeRequest) -> Bool {
    if lhs._entityType != rhs._entityType {return false}
    if lhs.languageCode != rhs.languageCode {return false}
...
extension Google_Cloud_Dialogflow_Cx_V3beta1_DeleteEntityTypeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Dialogflow_Cx_V3beta1_DeleteEntityTypeRequest, rhs: Google_Cloud_Dialogflow_Cx_V3beta1_DeleteEntityTypeRequest) -> Bool {
    if lhs.name != rhs.name {return false}
