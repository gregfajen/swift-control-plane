...
/// Next id: 12
public struct Google_Cloud_Websecurityscanner_V1_ScanRun {
  ...
  public var executionState: Google_Cloud_Websecurityscanner_V1_ScanRun.ExecutionState = .unspecified

  /// Output only. The result state of the ScanRun. This field is only available after the
  /// execution state reaches "FINISHED".
  public var resultState: Google_Cloud_Websecurityscanner_V1_ScanRun.ResultState = .unspecified
  ...
  public var errorTrace: Google_Cloud_Websecurityscanner_V1_ScanRunErrorTrace {
    get {return _errorTrace ?? Google_Cloud_Websecurityscanner_V1_ScanRunErrorTrace()}
  ...
  public var warningTraces: [Google_Cloud_Websecurityscanner_V1_ScanRunWarningTrace] = []
  ...
  fileprivate var _errorTrace: Google_Cloud_Websecurityscanner_V1_ScanRunErrorTrace? = nil
}

#if swift(>=4.2)

extension Google_Cloud_Websecurityscanner_V1_ScanRun.ExecutionState: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Websecurityscanner_V1_ScanRun.ExecutionState] = [
    .unspecified,
    .queued,
    .scanning,
    .finished,
...
extension Google_Cloud_Websecurityscanner_V1_ScanRun.ResultState: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Websecurityscanner_V1_ScanRun.ResultState] = [
    .unspecified,
    .success,
    .error,
    .killed,
...
extension Google_Cloud_Websecurityscanner_V1_ScanRun: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Websecurityscanner_V1_ScanRun, rhs: Google_Cloud_Websecurityscanner_V1_ScanRun) -> Bool {
...
extension Google_Cloud_Websecurityscanner_V1_ScanRun.ExecutionState: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Websecurityscanner_V1_ScanRun.ResultState: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
