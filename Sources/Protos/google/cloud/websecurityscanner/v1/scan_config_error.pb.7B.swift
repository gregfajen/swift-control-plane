...
/// configuration error.
public struct Google_Cloud_Websecurityscanner_V1_ScanConfigError {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Output only. Indicates the reason code for a configuration failure.
  public var code: Google_Cloud_Websecurityscanner_V1_ScanConfigError.Code = .unspecified
...
extension Google_Cloud_Websecurityscanner_V1_ScanConfigError.Code: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Websecurityscanner_V1_ScanConfigError.Code] = [
    .unspecified,
    .internalError,
...
extension Google_Cloud_Websecurityscanner_V1_ScanConfigError: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Websecurityscanner_V1_ScanConfigError, rhs: Google_Cloud_Websecurityscanner_V1_ScanConfigError) -> Bool {
...
extension Google_Cloud_Websecurityscanner_V1_ScanConfigError.Code: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
