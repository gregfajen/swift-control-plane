...
public struct Google_Cloud_Websecurityscanner_V1_ScanRunWarningTrace {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Output only. Indicates the warning code.
  public var code: Google_Cloud_Websecurityscanner_V1_ScanRunWarningTrace.Code = .unspecified
...
extension Google_Cloud_Websecurityscanner_V1_ScanRunWarningTrace.Code: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Websecurityscanner_V1_ScanRunWarningTrace.Code] = [
    .unspecified,
...
extension Google_Cloud_Websecurityscanner_V1_ScanRunWarningTrace: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Websecurityscanner_V1_ScanRunWarningTrace, rhs: Google_Cloud_Websecurityscanner_V1_ScanRunWarningTrace) -> Bool {
...
extension Google_Cloud_Websecurityscanner_V1_ScanRunWarningTrace.Code: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
