...
/// Next id: 12
public struct Google_Cloud_Websecurityscanner_V1beta_ScanRun {
  ...
  public var executionState: Google_Cloud_Websecurityscanner_V1beta_ScanRun.ExecutionState = .unspecified

  /// The result state of the ScanRun. This field is only available after the
  /// execution state reaches "FINISHED".
  public var resultState: Google_Cloud_Websecurityscanner_V1beta_ScanRun.ResultState = .unspecified
  ...
  public var errorTrace: Google_Cloud_Websecurityscanner_V1beta_ScanRunErrorTrace {
    get {return _errorTrace ?? Google_Cloud_Websecurityscanner_V1beta_ScanRunErrorTrace()}
    set {_errorTrace = newValue}
  }
  /// Returns true if `errorTrace` has been explicitly set.
  public var hasErrorTrace: Bool {return self._errorTrace != nil}
  /// Clears the value of `errorTrace`. Subsequent reads from it will return its default value.
  public mutating func clearErrorTrace() {self._errorTrace = nil}

  /// A list of warnings, if such are encountered during this scan run.
  public var warningTraces: [Google_Cloud_Websecurityscanner_V1beta_ScanRunWarningTrace] = []
  ...
  fileprivate var _errorTrace: Google_Cloud_Websecurityscanner_V1beta_ScanRunErrorTrace? = nil
}

#if swift(>=4.2)

extension Google_Cloud_Websecurityscanner_V1beta_ScanRun.ExecutionState: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Websecurityscanner_V1beta_ScanRun.ExecutionState] = [
    .unspecified,
    .queued,
    .scanning,
    .finished,
...
extension Google_Cloud_Websecurityscanner_V1beta_ScanRun.ResultState: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Websecurityscanner_V1beta_ScanRun.ResultState] = [
    .unspecified,
    .success,
    .error,
    .killed,
...
extension Google_Cloud_Websecurityscanner_V1beta_ScanRun: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    10: .standard(proto: "error_trace"),
    11: .standard(proto: "warning_traces"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try { try decoder.decodeSingularMessageField(value: &self._errorTrace) }()
      case 11: try { try decoder.decodeRepeatedMessageField(value: &self.warningTraces) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._errorTrace {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 10)
    }
    if !self.warningTraces.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.warningTraces, fieldNumber: 11)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Websecurityscanner_V1beta_ScanRun, rhs: Google_Cloud_Websecurityscanner_V1beta_ScanRun) -> Bool {
    ...
    if lhs._errorTrace != rhs._errorTrace {return false}
    if lhs.warningTraces != rhs.warningTraces {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Google_Cloud_Websecurityscanner_V1beta_ScanRun.ExecutionState: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Websecurityscanner_V1beta_ScanRun.ResultState: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
