...
public struct Google_Cloud_Automl_V1_Model {
  ...
  public var translationModelMetadata: Google_Cloud_Automl_V1_TranslationModelMetadata {
    get {
      if case .translationModelMetadata(let v)? = _storage._modelMetadata {return v}
      return Google_Cloud_Automl_V1_TranslationModelMetadata()
    }
    set {_uniqueStorage()._modelMetadata = .translationModelMetadata(newValue)}
  }

  /// Metadata for image classification models.
  public var imageClassificationModelMetadata: Google_Cloud_Automl_V1_ImageClassificationModelMetadata {
    get {
      if case .imageClassificationModelMetadata(let v)? = _storage._modelMetadata {return v}
      return Google_Cloud_Automl_V1_ImageClassificationModelMetadata()
    }
    set {_uniqueStorage()._modelMetadata = .imageClassificationModelMetadata(newValue)}
  }

  /// Metadata for text classification models.
  public var textClassificationModelMetadata: Google_Cloud_Automl_V1_TextClassificationModelMetadata {
    get {
      if case .textClassificationModelMetadata(let v)? = _storage._modelMetadata {return v}
      return Google_Cloud_Automl_V1_TextClassificationModelMetadata()
    }
    set {_uniqueStorage()._modelMetadata = .textClassificationModelMetadata(newValue)}
  }

  /// Metadata for image object detection models.
  public var imageObjectDetectionModelMetadata: Google_Cloud_Automl_V1_ImageObjectDetectionModelMetadata {
    get {
      if case .imageObjectDetectionModelMetadata(let v)? = _storage._modelMetadata {return v}
      return Google_Cloud_Automl_V1_ImageObjectDetectionModelMetadata()
    }
    set {_uniqueStorage()._modelMetadata = .imageObjectDetectionModelMetadata(newValue)}
  }

  /// Metadata for text extraction models.
  public var textExtractionModelMetadata: Google_Cloud_Automl_V1_TextExtractionModelMetadata {
    get {
      if case .textExtractionModelMetadata(let v)? = _storage._modelMetadata {return v}
      return Google_Cloud_Automl_V1_TextExtractionModelMetadata()
    }
    set {_uniqueStorage()._modelMetadata = .textExtractionModelMetadata(newValue)}
  }

  /// Metadata for text sentiment models.
  public var textSentimentModelMetadata: Google_Cloud_Automl_V1_TextSentimentModelMetadata {
    get {
      if case .textSentimentModelMetadata(let v)? = _storage._modelMetadata {return v}
      return Google_Cloud_Automl_V1_TextSentimentModelMetadata()
    }
  ...
  public var deploymentState: Google_Cloud_Automl_V1_Model.DeploymentState {
  ...
  public enum OneOf_ModelMetadata: Equatable {
    /// Metadata for translation models.
    case translationModelMetadata(Google_Cloud_Automl_V1_TranslationModelMetadata)
    /// Metadata for image classification models.
    case imageClassificationModelMetadata(Google_Cloud_Automl_V1_ImageClassificationModelMetadata)
    /// Metadata for text classification models.
    case textClassificationModelMetadata(Google_Cloud_Automl_V1_TextClassificationModelMetadata)
    /// Metadata for image object detection models.
    case imageObjectDetectionModelMetadata(Google_Cloud_Automl_V1_ImageObjectDetectionModelMetadata)
    /// Metadata for text extraction models.
    case textExtractionModelMetadata(Google_Cloud_Automl_V1_TextExtractionModelMetadata)
    /// Metadata for text sentiment models.
    case textSentimentModelMetadata(Google_Cloud_Automl_V1_TextSentimentModelMetadata)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Automl_V1_Model.OneOf_ModelMetadata, rhs: Google_Cloud_Automl_V1_Model.OneOf_ModelMetadata) -> Bool {
...
extension Google_Cloud_Automl_V1_Model.DeploymentState: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Automl_V1_Model.DeploymentState] = [
    .unspecified,
    .deployed,
    .undeployed,
  ]
...
extension Google_Cloud_Automl_V1_Model: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    10: .same(proto: "etag"),
    34: .same(proto: "labels"),
  ]

  fileprivate class _StorageClass {
    var _modelMetadata: Google_Cloud_Automl_V1_Model.OneOf_ModelMetadata?
    var _name: String = String()
    var _displayName: String = String()
    var _datasetID: String = String()
    var _createTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _updateTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _deploymentState: Google_Cloud_Automl_V1_Model.DeploymentState = .unspecified
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 10: try { try decoder.decodeSingularStringField(value: &_storage._etag) }()
        case 11: try { try decoder.decodeSingularMessageField(value: &_storage._updateTime) }()
        case 13: try {
          var v: Google_Cloud_Automl_V1_ImageClassificationModelMetadata?
        ...
        case 14: try {
          var v: Google_Cloud_Automl_V1_TextClassificationModelMetadata?
          if let current = _storage._modelMetadata {
            try decoder.handleConflictingOneOf()
        ...
        case 15: try {
          var v: Google_Cloud_Automl_V1_TranslationModelMetadata?
          if let current = _storage._modelMetadata {
            try decoder.handleConflictingOneOf()
        ...
        case 19: try {
          var v: Google_Cloud_Automl_V1_TextExtractionModelMetadata?
          if let current = _storage._modelMetadata {
            try decoder.handleConflictingOneOf()
        ...
        case 20: try {
          var v: Google_Cloud_Automl_V1_ImageObjectDetectionModelMetadata?
          if let current = _storage._modelMetadata {
            try decoder.handleConflictingOneOf()
        ...
        case 22: try {
          var v: Google_Cloud_Automl_V1_TextSentimentModelMetadata?
          if let current = _storage._modelMetadata {
            try decoder.handleConflictingOneOf()
        ...
        case 34: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.ProtobufString>.self, value: &_storage._labels) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._etag.isEmpty {
        try visitor.visitSingularStringField(value: _storage._etag, fieldNumber: 10)
      }
      ...
      if !_storage._labels.isEmpty {
        try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMap<SwiftProtobuf.ProtobufString,SwiftProtobuf.ProtobufString>.self, value: _storage._labels, fieldNumber: 34)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Automl_V1_Model, rhs: Google_Cloud_Automl_V1_Model) -> Bool {
...
extension Google_Cloud_Automl_V1_Model.DeploymentState: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
