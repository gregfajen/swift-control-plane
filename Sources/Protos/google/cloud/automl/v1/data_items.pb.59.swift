...
public struct Google_Cloud_Automl_V1_Image {
  ...
  public var data: Google_Cloud_Automl_V1_Image.OneOf_Data? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Automl_V1_Image.OneOf_Data, rhs: Google_Cloud_Automl_V1_Image.OneOf_Data) -> Bool {
...
public struct Google_Cloud_Automl_V1_TextSnippet {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Automl_V1_DocumentDimensions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Unit of the dimension.
  public var unit: Google_Cloud_Automl_V1_DocumentDimensions.DocumentDimensionUnit = .unspecified
...
extension Google_Cloud_Automl_V1_DocumentDimensions.DocumentDimensionUnit: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Automl_V1_DocumentDimensions.DocumentDimensionUnit] = [
    .unspecified,
    .inch,
    .centimeter,
    .point,
...
public struct Google_Cloud_Automl_V1_Document {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// An input config specifying the content of the document.
  public var inputConfig: Google_Cloud_Automl_V1_DocumentInputConfig {
    get {return _inputConfig ?? Google_Cloud_Automl_V1_DocumentInputConfig()}
  ...
  public var documentText: Google_Cloud_Automl_V1_TextSnippet {
    get {return _documentText ?? Google_Cloud_Automl_V1_TextSnippet()}
  ...
  public var layout: [Google_Cloud_Automl_V1_Document.Layout] = []

  /// The dimensions of the page in the document.
  public var documentDimensions: Google_Cloud_Automl_V1_DocumentDimensions {
    get {return _documentDimensions ?? Google_Cloud_Automl_V1_DocumentDimensions()}
  ...
  public struct Layout {
    ...
    public var textSegment: Google_Cloud_Automl_V1_TextSegment {
      get {return _textSegment ?? Google_Cloud_Automl_V1_TextSegment()}
    ...
    public var boundingPoly: Google_Cloud_Automl_V1_BoundingPoly {
      get {return _boundingPoly ?? Google_Cloud_Automl_V1_BoundingPoly()}
    ...
    public var textSegmentType: Google_Cloud_Automl_V1_Document.Layout.TextSegmentType = .unspecified
    ...
    fileprivate var _textSegment: Google_Cloud_Automl_V1_TextSegment? = nil
    fileprivate var _boundingPoly: Google_Cloud_Automl_V1_BoundingPoly? = nil
  }

  public init() {}

  fileprivate var _inputConfig: Google_Cloud_Automl_V1_DocumentInputConfig? = nil
  fileprivate var _documentText: Google_Cloud_Automl_V1_TextSnippet? = nil
  fileprivate var _documentDimensions: Google_Cloud_Automl_V1_DocumentDimensions? = nil
}

#if swift(>=4.2)

extension Google_Cloud_Automl_V1_Document.Layout.TextSegmentType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Automl_V1_Document.Layout.TextSegmentType] = [
    .unspecified,
    .token,
    .paragraph,
    .formField,
...
public struct Google_Cloud_Automl_V1_ExamplePayload {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Required. The example data.
  public var payload: Google_Cloud_Automl_V1_ExamplePayload.OneOf_Payload? = nil

  /// Example image.
  public var image: Google_Cloud_Automl_V1_Image {
    get {
      if case .image(let v)? = payload {return v}
      return Google_Cloud_Automl_V1_Image()
    }
    set {payload = .image(newValue)}
  }

  /// Example text.
  public var textSnippet: Google_Cloud_Automl_V1_TextSnippet {
    get {
      if case .textSnippet(let v)? = payload {return v}
      return Google_Cloud_Automl_V1_TextSnippet()
    }
    set {payload = .textSnippet(newValue)}
  }

  /// Example document.
  public var document: Google_Cloud_Automl_V1_Document {
    get {
      if case .document(let v)? = payload {return v}
      return Google_Cloud_Automl_V1_Document()
    }
  ...
  public enum OneOf_Payload: Equatable {
    /// Example image.
    case image(Google_Cloud_Automl_V1_Image)
    /// Example text.
    case textSnippet(Google_Cloud_Automl_V1_TextSnippet)
    /// Example document.
    case document(Google_Cloud_Automl_V1_Document)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Automl_V1_ExamplePayload.OneOf_Payload, rhs: Google_Cloud_Automl_V1_ExamplePayload.OneOf_Payload) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
extension Google_Cloud_Automl_V1_Image: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Automl_V1_Image, rhs: Google_Cloud_Automl_V1_Image) -> Bool {
...
extension Google_Cloud_Automl_V1_TextSnippet: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Automl_V1_TextSnippet, rhs: Google_Cloud_Automl_V1_TextSnippet) -> Bool {
...
extension Google_Cloud_Automl_V1_DocumentDimensions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Automl_V1_DocumentDimensions, rhs: Google_Cloud_Automl_V1_DocumentDimensions) -> Bool {
...
extension Google_Cloud_Automl_V1_DocumentDimensions.DocumentDimensionUnit: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Automl_V1_Document: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Automl_V1_Document, rhs: Google_Cloud_Automl_V1_Document) -> Bool {
...
extension Google_Cloud_Automl_V1_Document.Layout: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Automl_V1_Document.protoMessageName + ".Layout"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Automl_V1_Document.Layout, rhs: Google_Cloud_Automl_V1_Document.Layout) -> Bool {
...
extension Google_Cloud_Automl_V1_Document.Layout.TextSegmentType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Automl_V1_ExamplePayload: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Google_Cloud_Automl_V1_Image?
      ...
      case 2: try {
        var v: Google_Cloud_Automl_V1_TextSnippet?
        if let current = self.payload {
          try decoder.handleConflictingOneOf()
      ...
      case 4: try {
        var v: Google_Cloud_Automl_V1_Document?
        if let current = self.payload {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Cloud_Automl_V1_ExamplePayload, rhs: Google_Cloud_Automl_V1_ExamplePayload) -> Bool {
