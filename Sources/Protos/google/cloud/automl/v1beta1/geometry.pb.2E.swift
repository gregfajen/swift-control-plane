...
public struct Google_Cloud_Automl_V1beta1_NormalizedVertex {
...
public struct Google_Cloud_Automl_V1beta1_BoundingPoly {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Output only . The bounding polygon normalized vertices.
  public var normalizedVertices: [Google_Cloud_Automl_V1beta1_NormalizedVertex] = []
...
extension Google_Cloud_Automl_V1beta1_NormalizedVertex: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Automl_V1beta1_NormalizedVertex, rhs: Google_Cloud_Automl_V1beta1_NormalizedVertex) -> Bool {
...
extension Google_Cloud_Automl_V1beta1_BoundingPoly: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Automl_V1beta1_BoundingPoly, rhs: Google_Cloud_Automl_V1beta1_BoundingPoly) -> Bool {
