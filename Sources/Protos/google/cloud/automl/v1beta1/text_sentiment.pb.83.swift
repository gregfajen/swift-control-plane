...
public struct Google_Cloud_Automl_V1beta1_TextSentimentAnnotation {
...
public struct Google_Cloud_Automl_V1beta1_TextSentimentEvaluationMetrics {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Automl_V1beta1_TextSentimentAnnotation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Automl_V1beta1_TextSentimentAnnotation, rhs: Google_Cloud_Automl_V1beta1_TextSentimentAnnotation) -> Bool {
...
extension Google_Cloud_Automl_V1beta1_TextSentimentEvaluationMetrics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    9: .standard(proto: "annotation_spec_id"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 9: try { try decoder.decodeRepeatedStringField(value: &self.annotationSpecID) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.annotationSpecID.isEmpty {
      try visitor.visitRepeatedStringField(value: self.annotationSpecID, fieldNumber: 9)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Automl_V1beta1_TextSentimentEvaluationMetrics, rhs: Google_Cloud_Automl_V1beta1_TextSentimentEvaluationMetrics) -> Bool {
