...
public struct Google_Cloud_Automl_V1beta1_TextExtractionAnnotation {
  ...
  /// text relation.
  public var annotation: Google_Cloud_Automl_V1beta1_TextExtractionAnnotation.OneOf_Annotation? = nil
  ...
  public var textSegment: Google_Cloud_Automl_V1beta1_TextSegment {
    get {
      ...
      return Google_Cloud_Automl_V1beta1_TextSegment()
    }
  ...
  public enum OneOf_Annotation: Equatable {
    /// An entity annotation will set this, which is the part of the original
    /// text to which the annotation pertains.
    case textSegment(Google_Cloud_Automl_V1beta1_TextSegment)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Automl_V1beta1_TextExtractionAnnotation.OneOf_Annotation, rhs: Google_Cloud_Automl_V1beta1_TextExtractionAnnotation.OneOf_Annotation) -> Bool {
...
public struct Google_Cloud_Automl_V1beta1_TextExtractionEvaluationMetrics {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var confidenceMetricsEntries: [Google_Cloud_Automl_V1beta1_TextExtractionEvaluationMetrics.ConfidenceMetricsEntry] = []
...
extension Google_Cloud_Automl_V1beta1_TextExtractionAnnotation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try {
        var v: Google_Cloud_Automl_V1beta1_TextSegment?
  ...
  public static func ==(lhs: Google_Cloud_Automl_V1beta1_TextExtractionAnnotation, rhs: Google_Cloud_Automl_V1beta1_TextExtractionAnnotation) -> Bool {
...
extension Google_Cloud_Automl_V1beta1_TextExtractionEvaluationMetrics: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Automl_V1beta1_TextExtractionEvaluationMetrics, rhs: Google_Cloud_Automl_V1beta1_TextExtractionEvaluationMetrics) -> Bool {
...
extension Google_Cloud_Automl_V1beta1_TextExtractionEvaluationMetrics.ConfidenceMetricsEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Cloud_Automl_V1beta1_TextExtractionEvaluationMetrics.protoMessageName + ".ConfidenceMetricsEntry"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Cloud_Automl_V1beta1_TextExtractionEvaluationMetrics.ConfidenceMetricsEntry, rhs: Google_Cloud_Automl_V1beta1_TextExtractionEvaluationMetrics.ConfidenceMetricsEntry) -> Bool {
