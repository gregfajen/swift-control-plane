...
public enum Google_Cloud_Tasks_V2_HttpMethod: SwiftProtobuf.Enum {
...
extension Google_Cloud_Tasks_V2_HttpMethod: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Tasks_V2_HttpMethod] = [
    .unspecified,
    .post,
    .get,
    .head,
...
public struct Google_Cloud_Tasks_V2_HttpRequest {
  ...
  public var httpMethod: Google_Cloud_Tasks_V2_HttpMethod = .unspecified
  ...
  public var authorizationHeader: Google_Cloud_Tasks_V2_HttpRequest.OneOf_AuthorizationHeader? = nil
  ...
  public var oauthToken: Google_Cloud_Tasks_V2_OAuthToken {
    get {
      if case .oauthToken(let v)? = authorizationHeader {return v}
      return Google_Cloud_Tasks_V2_OAuthToken()
    }
  ...
  /// yourself.
  public var oidcToken: Google_Cloud_Tasks_V2_OidcToken {
    get {
      if case .oidcToken(let v)? = authorizationHeader {return v}
      return Google_Cloud_Tasks_V2_OidcToken()
    }
  ...
  public enum OneOf_AuthorizationHeader: Equatable {
    ...
    /// This type of authorization should generally only be used when calling
    /// Google APIs hosted on *.googleapis.com.
    case oauthToken(Google_Cloud_Tasks_V2_OAuthToken)
    /// If specified, an
    /// [OIDC](https://developers.google.com/identity/protocols/OpenIDConnect)
    /// token will be generated and attached as an `Authorization` header in the
    /// HTTP request.
    ...
    /// calling Cloud Run, or endpoints where you intend to validate the token
    /// yourself.
    case oidcToken(Google_Cloud_Tasks_V2_OidcToken)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Tasks_V2_HttpRequest.OneOf_AuthorizationHeader, rhs: Google_Cloud_Tasks_V2_HttpRequest.OneOf_AuthorizationHeader) -> Bool {
...
public struct Google_Cloud_Tasks_V2_AppEngineHttpRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  ///    tasks in the queue, no matter what the setting is for the [task-level
  ///    app_engine_routing][AppEngineHttpRequest.app_engine_routing].
  public var appEngineRouting: Google_Cloud_Tasks_V2_AppEngineRouting {
    get {return _appEngineRouting ?? Google_Cloud_Tasks_V2_AppEngineRouting()}
  ...
  fileprivate var _appEngineRouting: Google_Cloud_Tasks_V2_AppEngineRouting? = nil
}
...
///
/// `https://www.googleapis.com/auth/cloud-platform`
public struct Google_Cloud_Tasks_V2_AppEngineRouting {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Tasks_V2_OAuthToken {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// calling Cloud Run, or endpoints where you intend to validate the token
/// yourself.
public struct Google_Cloud_Tasks_V2_OidcToken {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Tasks_V2_HttpMethod: SwiftProtobuf._ProtoNameProviding {
...
extension Google_Cloud_Tasks_V2_HttpRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try {
        var v: Google_Cloud_Tasks_V2_OAuthToken?
      ...
      case 6: try {
        var v: Google_Cloud_Tasks_V2_OidcToken?
        if let current = self.authorizationHeader {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Cloud_Tasks_V2_HttpRequest, rhs: Google_Cloud_Tasks_V2_HttpRequest) -> Bool {
...
extension Google_Cloud_Tasks_V2_AppEngineHttpRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Tasks_V2_AppEngineHttpRequest, rhs: Google_Cloud_Tasks_V2_AppEngineHttpRequest) -> Bool {
    if lhs.httpMethod != rhs.httpMethod {return false}
...
extension Google_Cloud_Tasks_V2_AppEngineRouting: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Tasks_V2_AppEngineRouting, rhs: Google_Cloud_Tasks_V2_AppEngineRouting) -> Bool {
...
extension Google_Cloud_Tasks_V2_OAuthToken: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Tasks_V2_OAuthToken, rhs: Google_Cloud_Tasks_V2_OAuthToken) -> Bool {
...
extension Google_Cloud_Tasks_V2_OidcToken: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Tasks_V2_OidcToken, rhs: Google_Cloud_Tasks_V2_OidcToken) -> Bool {
    if lhs.serviceAccountEmail != rhs.serviceAccountEmail {return false}
