...
public struct Google_Cloud_Tasks_V2_Task {
  ...
  public var appEngineHTTPRequest: Google_Cloud_Tasks_V2_AppEngineHttpRequest {
    get {
      if case .appEngineHTTPRequest(let v)? = _storage._messageType {return v}
      return Google_Cloud_Tasks_V2_AppEngineHttpRequest()
    }
    set {_uniqueStorage()._messageType = .appEngineHTTPRequest(newValue)}
  }

  /// HTTP request that is sent to the worker.
  ///
  /// An HTTP task is a task that has [HttpRequest][google.cloud.tasks.v2.HttpRequest] set.
  public var httpRequest: Google_Cloud_Tasks_V2_HttpRequest {
    get {
      if case .httpRequest(let v)? = _storage._messageType {return v}
      return Google_Cloud_Tasks_V2_HttpRequest()
    }
    set {_uniqueStorage()._messageType = .httpRequest(newValue)}
  }
  ...
  public var firstAttempt: Google_Cloud_Tasks_V2_Attempt {
    get {return _storage._firstAttempt ?? Google_Cloud_Tasks_V2_Attempt()}
  ...
  public var lastAttempt: Google_Cloud_Tasks_V2_Attempt {
    get {return _storage._lastAttempt ?? Google_Cloud_Tasks_V2_Attempt()}
  ...
  /// been returned.
  public var view: Google_Cloud_Tasks_V2_Task.View {
  ...
  public enum OneOf_MessageType: Equatable {
    ...
    ///
    /// An App Engine task is a task that has [AppEngineHttpRequest][google.cloud.tasks.v2.AppEngineHttpRequest] set.
    case appEngineHTTPRequest(Google_Cloud_Tasks_V2_AppEngineHttpRequest)
    /// HTTP request that is sent to the worker.
    ///
    /// An HTTP task is a task that has [HttpRequest][google.cloud.tasks.v2.HttpRequest] set.
    case httpRequest(Google_Cloud_Tasks_V2_HttpRequest)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Cloud_Tasks_V2_Task.OneOf_MessageType, rhs: Google_Cloud_Tasks_V2_Task.OneOf_MessageType) -> Bool {
...
extension Google_Cloud_Tasks_V2_Task.View: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Tasks_V2_Task.View] = [
    .unspecified,
    .basic,
    .full,
  ]
...
public struct Google_Cloud_Tasks_V2_Attempt {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Tasks_V2_Task: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Task"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .standard(proto: "app_engine_http_request"),
    3: .standard(proto: "http_request"),
    4: .standard(proto: "schedule_time"),
    5: .standard(proto: "create_time"),
    6: .standard(proto: "dispatch_deadline"),
    7: .standard(proto: "dispatch_count"),
    8: .standard(proto: "response_count"),
    9: .standard(proto: "first_attempt"),
    10: .standard(proto: "last_attempt"),
    11: .same(proto: "view"),
  ]

  fileprivate class _StorageClass {
    var _name: String = String()
    var _messageType: Google_Cloud_Tasks_V2_Task.OneOf_MessageType?
    ...
    var _firstAttempt: Google_Cloud_Tasks_V2_Attempt? = nil
    var _lastAttempt: Google_Cloud_Tasks_V2_Attempt? = nil
    var _view: Google_Cloud_Tasks_V2_Task.View = .unspecified
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try {
          var v: Google_Cloud_Tasks_V2_AppEngineHttpRequest?
          if let current = _storage._messageType {
            try decoder.handleConflictingOneOf()
            if case .appEngineHTTPRequest(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._messageType = .appEngineHTTPRequest(v)}
        }()
        case 3: try {
          var v: Google_Cloud_Tasks_V2_HttpRequest?
          if let current = _storage._messageType {
            try decoder.handleConflictingOneOf()
            if case .httpRequest(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._messageType = .httpRequest(v)}
        }()
        ...
        case 6: try { try decoder.decodeSingularMessageField(value: &_storage._dispatchDeadline) }()
        case 7: try { try decoder.decodeSingularInt32Field(value: &_storage._dispatchCount) }()
        case 8: try { try decoder.decodeSingularInt32Field(value: &_storage._responseCount) }()
        case 9: try { try decoder.decodeSingularMessageField(value: &_storage._firstAttempt) }()
        case 10: try { try decoder.decodeSingularMessageField(value: &_storage._lastAttempt) }()
        case 11: try { try decoder.decodeSingularEnumField(value: &_storage._view) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .appEngineHTTPRequest?: try {
        guard case .appEngineHTTPRequest(let v)? = _storage._messageType else { preconditionFailure() }
        try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
      }()
      case .httpRequest?: try {
        guard case .httpRequest(let v)? = _storage._messageType else { preconditionFailure() }
      ...
      if _storage._dispatchCount != 0 {
        try visitor.visitSingularInt32Field(value: _storage._dispatchCount, fieldNumber: 7)
      }
      if _storage._responseCount != 0 {
        try visitor.visitSingularInt32Field(value: _storage._responseCount, fieldNumber: 8)
      }
      ...
      if _storage._view != .unspecified {
        try visitor.visitSingularEnumField(value: _storage._view, fieldNumber: 11)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Cloud_Tasks_V2_Task, rhs: Google_Cloud_Tasks_V2_Task) -> Bool {
...
extension Google_Cloud_Tasks_V2_Task.View: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Tasks_V2_Attempt: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Tasks_V2_Attempt, rhs: Google_Cloud_Tasks_V2_Attempt) -> Bool {
