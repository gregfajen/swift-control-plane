...
public struct Google_Cloud_Tasks_V2_Queue {
  ...
  /// setting is for the
  /// [task-level app_engine_routing][google.cloud.tasks.v2.AppEngineHttpRequest.app_engine_routing].
  public var appEngineRoutingOverride: Google_Cloud_Tasks_V2_AppEngineRouting {
    get {return _storage._appEngineRoutingOverride ?? Google_Cloud_Tasks_V2_AppEngineRouting()}
    set {_uniqueStorage()._appEngineRoutingOverride = newValue}
  }
  /// Returns true if `appEngineRoutingOverride` has been explicitly set.
  public var hasAppEngineRoutingOverride: Bool {return _storage._appEngineRoutingOverride != nil}
  /// Clears the value of `appEngineRoutingOverride`. Subsequent reads from it will return its default value.
  public mutating func clearAppEngineRoutingOverride() {_uniqueStorage()._appEngineRoutingOverride = nil}
  ...
  public var rateLimits: Google_Cloud_Tasks_V2_RateLimits {
    get {return _storage._rateLimits ?? Google_Cloud_Tasks_V2_RateLimits()}
  ...
  public var retryConfig: Google_Cloud_Tasks_V2_RetryConfig {
    get {return _storage._retryConfig ?? Google_Cloud_Tasks_V2_RetryConfig()}
  ...
  public var state: Google_Cloud_Tasks_V2_Queue.State {
  ...
  public var stackdriverLoggingConfig: Google_Cloud_Tasks_V2_StackdriverLoggingConfig {
    get {return _storage._stackdriverLoggingConfig ?? Google_Cloud_Tasks_V2_StackdriverLoggingConfig()}
...
extension Google_Cloud_Tasks_V2_Queue.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Cloud_Tasks_V2_Queue.State] = [
    .unspecified,
    .running,
    .paused,
    .disabled,
...
public struct Google_Cloud_Tasks_V2_RateLimits {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Tasks_V2_RetryConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Cloud_Tasks_V2_StackdriverLoggingConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Cloud_Tasks_V2_Queue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Queue"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
    2: .standard(proto: "app_engine_routing_override"),
    3: .standard(proto: "rate_limits"),
    4: .standard(proto: "retry_config"),
    5: .same(proto: "state"),
    6: .standard(proto: "purge_time"),
    9: .standard(proto: "stackdriver_logging_config"),
  ]

  fileprivate class _StorageClass {
    var _name: String = String()
    var _appEngineRoutingOverride: Google_Cloud_Tasks_V2_AppEngineRouting? = nil
    var _rateLimits: Google_Cloud_Tasks_V2_RateLimits? = nil
    var _retryConfig: Google_Cloud_Tasks_V2_RetryConfig? = nil
    var _state: Google_Cloud_Tasks_V2_Queue.State = .unspecified
    var _purgeTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _stackdriverLoggingConfig: Google_Cloud_Tasks_V2_StackdriverLoggingConfig? = nil
    ...
    init(copying source: _StorageClass) {
      _name = source._name
      _appEngineRoutingOverride = source._appEngineRoutingOverride
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._appEngineRoutingOverride) }()
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._rateLimits) }()
        case 4: try { try decoder.decodeSingularMessageField(value: &_storage._retryConfig) }()
        case 5: try { try decoder.decodeSingularEnumField(value: &_storage._state) }()
        case 6: try { try decoder.decodeSingularMessageField(value: &_storage._purgeTime) }()
        case 9: try { try decoder.decodeSingularMessageField(value: &_storage._stackdriverLoggingConfig) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._appEngineRoutingOverride {
  ...
  public static func ==(lhs: Google_Cloud_Tasks_V2_Queue, rhs: Google_Cloud_Tasks_V2_Queue) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._name != rhs_storage._name {return false}
        if _storage._appEngineRoutingOverride != rhs_storage._appEngineRoutingOverride {return false}
...
extension Google_Cloud_Tasks_V2_Queue.State: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Cloud_Tasks_V2_RateLimits: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Tasks_V2_RateLimits, rhs: Google_Cloud_Tasks_V2_RateLimits) -> Bool {
...
extension Google_Cloud_Tasks_V2_RetryConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Tasks_V2_RetryConfig, rhs: Google_Cloud_Tasks_V2_RetryConfig) -> Bool {
...
extension Google_Cloud_Tasks_V2_StackdriverLoggingConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Cloud_Tasks_V2_StackdriverLoggingConfig, rhs: Google_Cloud_Tasks_V2_StackdriverLoggingConfig) -> Bool {
