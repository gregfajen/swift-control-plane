...
public struct Google_Firestore_Admin_V1beta2_Field {
  ...
  public var indexConfig: Google_Firestore_Admin_V1beta2_Field.IndexConfig {
    get {return _indexConfig ?? Google_Firestore_Admin_V1beta2_Field.IndexConfig()}
  ...
  fileprivate var _indexConfig: Google_Firestore_Admin_V1beta2_Field.IndexConfig? = nil
}
...
extension Google_Firestore_Admin_V1beta2_Field: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Firestore_Admin_V1beta2_Field, rhs: Google_Firestore_Admin_V1beta2_Field) -> Bool {
...
extension Google_Firestore_Admin_V1beta2_Field.IndexConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Firestore_Admin_V1beta2_Field.protoMessageName + ".IndexConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Firestore_Admin_V1beta2_Field.IndexConfig, rhs: Google_Firestore_Admin_V1beta2_Field.IndexConfig) -> Bool {
