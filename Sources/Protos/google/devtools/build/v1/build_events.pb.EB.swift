  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 51: try {
        ...
        if let v = v {self.event = .invocationAttemptStarted(v)}
      }()
      case 52: try {
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.event = .invocationAttemptFinished(v)}
      }()
      case 53: try {
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.event = .buildEnqueued(v)}
      }()
      case 55: try {
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.event = .buildFinished(v)}
      }()
      case 56: try {
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.event = .consoleOutput(v)}
      }()
      case 59: try {
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.event = .componentStreamFinished(v)}
      }()
      case 60: try {
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.event = .bazelEvent(v)}
      }()
      case 61: try {
        var v: SwiftProtobuf.Google_Protobuf_Any?
        if let current = self.event {
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.event = .buildExecutionEvent(v)}
      }()
      case 62: try {
        var v: SwiftProtobuf.Google_Protobuf_Any?
        if let current = self.event {
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.event = .sourceFetchEvent(v)}
      }()
      default: break
      }
    }
...
extension Google_Devtools_Build_V1_BuildEvent.InvocationAttemptFinished: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._invocationStatus {
