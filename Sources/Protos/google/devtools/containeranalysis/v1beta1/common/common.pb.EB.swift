...
public enum Grafeas_V1beta1_NoteKind: SwiftProtobuf.Enum {
...
extension Grafeas_V1beta1_NoteKind: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Grafeas_V1beta1_NoteKind] = [
    .unspecified,
    .vulnerability,
    .build,
    .image,
...
public struct Grafeas_V1beta1_RelatedUrl {
...
public struct Grafeas_V1beta1_Signature {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Grafeas_V1beta1_NoteKind: SwiftProtobuf._ProtoNameProviding {
...
extension Grafeas_V1beta1_RelatedUrl: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Grafeas_V1beta1_RelatedUrl, rhs: Grafeas_V1beta1_RelatedUrl) -> Bool {
...
extension Grafeas_V1beta1_Signature: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.publicKeyID) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: Grafeas_V1beta1_Signature, rhs: Grafeas_V1beta1_Signature) -> Bool {
