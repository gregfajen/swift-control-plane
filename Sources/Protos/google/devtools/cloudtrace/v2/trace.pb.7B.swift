...
public struct Google_Devtools_Cloudtrace_V2_Span {
  ...
  public var displayName: Google_Devtools_Cloudtrace_V2_TruncatableString {
  ...
  /// span.
  public var attributes: Google_Devtools_Cloudtrace_V2_Span.Attributes {
  ...
  public var stackTrace: Google_Devtools_Cloudtrace_V2_StackTrace {
  ...
  /// events per span.
  public var timeEvents: Google_Devtools_Cloudtrace_V2_Span.TimeEvents {
  ...
  public var links: Google_Devtools_Cloudtrace_V2_Span.Links {
  ...
  public var childSpanCount: SwiftProtobuf.Google_Protobuf_Int32Value {
  ...
  public var spanKind: Google_Devtools_Cloudtrace_V2_Span.SpanKind {
  ...
  public struct Attributes {
    ...
    public var attributeMap: Dictionary<String,Google_Devtools_Cloudtrace_V2_AttributeValue> = [:]
  ...
  public struct TimeEvent {
    ...
    public var value: Google_Devtools_Cloudtrace_V2_Span.TimeEvent.OneOf_Value? = nil

    /// Text annotation with a set of attributes.
    public var annotation: Google_Devtools_Cloudtrace_V2_Span.TimeEvent.Annotation {
      get {
    ...
    public var messageEvent: Google_Devtools_Cloudtrace_V2_Span.TimeEvent.MessageEvent {
      get {
    ...
    #if !swift(>=4.1)
      public static func ==(lhs: Google_Devtools_Cloudtrace_V2_Span.TimeEvent.OneOf_Value, rhs: Google_Devtools_Cloudtrace_V2_Span.TimeEvent.OneOf_Value) -> Bool {
    ...
    public struct Annotation {
      ...
      public var description_p: Google_Devtools_Cloudtrace_V2_TruncatableString {
    ...
    public struct MessageEvent {
      ...
      /// received.
      public var type: Google_Devtools_Cloudtrace_V2_Span.TimeEvent.MessageEvent.TypeEnum = .unspecified
      ...
      public var uncompressedSizeBytes: Int64 = 0

      /// The number of compressed bytes sent or received. If missing assumed to
      /// be the same size as uncompressed.
      public var compressedSizeBytes: Int64 = 0
  ...
  public struct TimeEvents {
    ...
    public var timeEvent: [Google_Devtools_Cloudtrace_V2_Span.TimeEvent] = []
  ...
  public struct Link {
    ...
    public var type: Google_Devtools_Cloudtrace_V2_Span.Link.TypeEnum = .unspecified
  ...
  public struct Links {
    ...
    public var link: [Google_Devtools_Cloudtrace_V2_Span.Link] = []
...
extension Google_Devtools_Cloudtrace_V2_Span.SpanKind: CaseIterable {
  ...
  public static var allCases: [Google_Devtools_Cloudtrace_V2_Span.SpanKind] = [
    .unspecified,
    .internal,
    .server,
    .client,
...
extension Google_Devtools_Cloudtrace_V2_Span.TimeEvent.MessageEvent.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Devtools_Cloudtrace_V2_Span.TimeEvent.MessageEvent.TypeEnum] = [
    .unspecified,
    .sent,
    .received,
  ]
...
extension Google_Devtools_Cloudtrace_V2_Span.Link.TypeEnum: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Devtools_Cloudtrace_V2_Span.Link.TypeEnum] = [
    .unspecified,
    .childLinkedSpan,
    .parentLinkedSpan,
  ]
...
public struct Google_Devtools_Cloudtrace_V2_AttributeValue {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The type of the value.
  public var value: Google_Devtools_Cloudtrace_V2_AttributeValue.OneOf_Value? = nil

  /// A string up to 256 bytes long.
  public var stringValue: Google_Devtools_Cloudtrace_V2_TruncatableString {
    get {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Google_Devtools_Cloudtrace_V2_AttributeValue.OneOf_Value, rhs: Google_Devtools_Cloudtrace_V2_AttributeValue.OneOf_Value) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
public struct Google_Devtools_Cloudtrace_V2_StackTrace {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Stack frames in this stack trace. A maximum of 128 frames are allowed.
  public var stackFrames: Google_Devtools_Cloudtrace_V2_StackTrace.StackFrames {
  ...
  public var stackTraceHashID: Int64 = 0
  ...
  public struct StackFrame {
    ...
    public var functionName: Google_Devtools_Cloudtrace_V2_TruncatableString {
    ...
    public var originalFunctionName: Google_Devtools_Cloudtrace_V2_TruncatableString {
    ...
    /// bytes).
    public var fileName: Google_Devtools_Cloudtrace_V2_TruncatableString {
    ...
    public var loadModule: Google_Devtools_Cloudtrace_V2_Module {
    ...
    public var sourceVersion: Google_Devtools_Cloudtrace_V2_TruncatableString {
  ...
  public struct StackFrames {
    ...
    public var frame: [Google_Devtools_Cloudtrace_V2_StackTrace.StackFrame] = []
...
/// Binary module.
public struct Google_Devtools_Cloudtrace_V2_Module {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var module: Google_Devtools_Cloudtrace_V2_TruncatableString {
  ...
  public var buildID: Google_Devtools_Cloudtrace_V2_TruncatableString {
...
public struct Google_Devtools_Cloudtrace_V2_TruncatableString {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Devtools_Cloudtrace_V2_Span: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Devtools_Cloudtrace_V2_Span, rhs: Google_Devtools_Cloudtrace_V2_Span) -> Bool {
...
extension Google_Devtools_Cloudtrace_V2_Span.Attributes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Devtools_Cloudtrace_V2_Span.protoMessageName + ".Attributes"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Devtools_Cloudtrace_V2_Span.Attributes, rhs: Google_Devtools_Cloudtrace_V2_Span.Attributes) -> Bool {
...
extension Google_Devtools_Cloudtrace_V2_Span.TimeEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Devtools_Cloudtrace_V2_Span.protoMessageName + ".TimeEvent"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "time"),
  ...
  public static func ==(lhs: Google_Devtools_Cloudtrace_V2_Span.TimeEvent, rhs: Google_Devtools_Cloudtrace_V2_Span.TimeEvent) -> Bool {
...
extension Google_Devtools_Cloudtrace_V2_Span.TimeEvent.Annotation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Devtools_Cloudtrace_V2_Span.TimeEvent.protoMessageName + ".Annotation"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Devtools_Cloudtrace_V2_Span.TimeEvent.Annotation, rhs: Google_Devtools_Cloudtrace_V2_Span.TimeEvent.Annotation) -> Bool {
...
extension Google_Devtools_Cloudtrace_V2_Span.TimeEvent.MessageEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Devtools_Cloudtrace_V2_Span.TimeEvent.protoMessageName + ".MessageEvent"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "type"),
    2: .same(proto: "id"),
  ...
  public static func ==(lhs: Google_Devtools_Cloudtrace_V2_Span.TimeEvent.MessageEvent, rhs: Google_Devtools_Cloudtrace_V2_Span.TimeEvent.MessageEvent) -> Bool {
...
extension Google_Devtools_Cloudtrace_V2_Span.TimeEvents: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Devtools_Cloudtrace_V2_Span.protoMessageName + ".TimeEvents"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Devtools_Cloudtrace_V2_Span.TimeEvents, rhs: Google_Devtools_Cloudtrace_V2_Span.TimeEvents) -> Bool {
...
extension Google_Devtools_Cloudtrace_V2_Span.Link: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Devtools_Cloudtrace_V2_Span.protoMessageName + ".Link"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Devtools_Cloudtrace_V2_Span.Link, rhs: Google_Devtools_Cloudtrace_V2_Span.Link) -> Bool {
...
extension Google_Devtools_Cloudtrace_V2_Span.Links: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Devtools_Cloudtrace_V2_Span.protoMessageName + ".Links"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "link"),
  ...
  public static func ==(lhs: Google_Devtools_Cloudtrace_V2_Span.Links, rhs: Google_Devtools_Cloudtrace_V2_Span.Links) -> Bool {
...
extension Google_Devtools_Cloudtrace_V2_AttributeValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Devtools_Cloudtrace_V2_AttributeValue, rhs: Google_Devtools_Cloudtrace_V2_AttributeValue) -> Bool {
    if lhs.value != rhs.value {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Google_Devtools_Cloudtrace_V2_StackTrace: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Devtools_Cloudtrace_V2_StackTrace, rhs: Google_Devtools_Cloudtrace_V2_StackTrace) -> Bool {
...
extension Google_Devtools_Cloudtrace_V2_StackTrace.StackFrame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Devtools_Cloudtrace_V2_StackTrace.protoMessageName + ".StackFrame"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Devtools_Cloudtrace_V2_StackTrace.StackFrame, rhs: Google_Devtools_Cloudtrace_V2_StackTrace.StackFrame) -> Bool {
...
extension Google_Devtools_Cloudtrace_V2_StackTrace.StackFrames: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Devtools_Cloudtrace_V2_StackTrace.protoMessageName + ".StackFrames"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "frame"),
  ...
  public static func ==(lhs: Google_Devtools_Cloudtrace_V2_StackTrace.StackFrames, rhs: Google_Devtools_Cloudtrace_V2_StackTrace.StackFrames) -> Bool {
...
extension Google_Devtools_Cloudtrace_V2_Module: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Devtools_Cloudtrace_V2_Module, rhs: Google_Devtools_Cloudtrace_V2_Module) -> Bool {
...
extension Google_Devtools_Cloudtrace_V2_TruncatableString: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Devtools_Cloudtrace_V2_TruncatableString, rhs: Google_Devtools_Cloudtrace_V2_TruncatableString) -> Bool {
    if lhs.value != rhs.value {return false}
