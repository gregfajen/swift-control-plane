...
public struct Google_Bigtable_V1_Row {
  ...
  public var families: [Google_Bigtable_V1_Family] = []
...
public struct Google_Bigtable_V1_Family {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var columns: [Google_Bigtable_V1_Column] = []
...
public struct Google_Bigtable_V1_Column {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var cells: [Google_Bigtable_V1_Cell] = []
...
public struct Google_Bigtable_V1_Cell {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Bigtable_V1_RowRange {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Inclusive lower bound. If left empty, interpreted as the empty string.
  public var startKey: Data = Data()

  /// Exclusive upper bound. If left empty, interpreted as infinity.
  public var endKey: Data = Data()
...
public struct Google_Bigtable_V1_RowSet {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var rowRanges: [Google_Bigtable_V1_RowRange] = []
...
/// exclusive.
public struct Google_Bigtable_V1_ColumnRange {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var startQualifier: Google_Bigtable_V1_ColumnRange.OneOf_StartQualifier? = nil

  /// Used when giving an inclusive lower bound for the range.
  public var startQualifierInclusive: Data {
    get {
      if case .startQualifierInclusive(let v)? = startQualifier {return v}
      return Data()
    }
    set {startQualifier = .startQualifierInclusive(newValue)}
  }

  /// Used when giving an exclusive lower bound for the range.
  public var startQualifierExclusive: Data {
    get {
      if case .startQualifierExclusive(let v)? = startQualifier {return v}
      return Data()
    }
    set {startQualifier = .startQualifierExclusive(newValue)}
  }

  /// The column qualifier at which to end the range (within 'column_family').
  /// If neither field is set, interpreted as the infinite string, exclusive.
  public var endQualifier: Google_Bigtable_V1_ColumnRange.OneOf_EndQualifier? = nil

  /// Used when giving an inclusive upper bound for the range.
  public var endQualifierInclusive: Data {
    get {
      if case .endQualifierInclusive(let v)? = endQualifier {return v}
      return Data()
    }
    set {endQualifier = .endQualifierInclusive(newValue)}
  }

  /// Used when giving an exclusive upper bound for the range.
  public var endQualifierExclusive: Data {
    get {
      if case .endQualifierExclusive(let v)? = endQualifier {return v}
      return Data()
    }
    set {endQualifier = .endQualifierExclusive(newValue)}
  }
  ...
  public enum OneOf_StartQualifier: Equatable {
    /// Used when giving an inclusive lower bound for the range.
    case startQualifierInclusive(Data)
    /// Used when giving an exclusive lower bound for the range.
    case startQualifierExclusive(Data)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Bigtable_V1_ColumnRange.OneOf_StartQualifier, rhs: Google_Bigtable_V1_ColumnRange.OneOf_StartQualifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.startQualifierInclusive, .startQualifierInclusive): return {
        guard case .startQualifierInclusive(let l) = lhs, case .startQualifierInclusive(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.startQualifierExclusive, .startQualifierExclusive): return {
        guard case .startQualifierExclusive(let l) = lhs, case .startQualifierExclusive(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
  ...
  public enum OneOf_EndQualifier: Equatable {
    /// Used when giving an inclusive upper bound for the range.
    case endQualifierInclusive(Data)
    /// Used when giving an exclusive upper bound for the range.
    case endQualifierExclusive(Data)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Bigtable_V1_ColumnRange.OneOf_EndQualifier, rhs: Google_Bigtable_V1_ColumnRange.OneOf_EndQualifier) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.endQualifierInclusive, .endQualifierInclusive): return {
        guard case .endQualifierInclusive(let l) = lhs, case .endQualifierInclusive(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.endQualifierExclusive, .endQualifierExclusive): return {
        guard case .endQualifierExclusive(let l) = lhs, case .endQualifierExclusive(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
public struct Google_Bigtable_V1_TimestampRange {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Bigtable_V1_ValueRange {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// If neither field is set, interpreted as the empty string, inclusive.
  public var startValue: Google_Bigtable_V1_ValueRange.OneOf_StartValue? = nil

  /// Used when giving an inclusive lower bound for the range.
  public var startValueInclusive: Data {
    get {
      if case .startValueInclusive(let v)? = startValue {return v}
      return Data()
    }
    set {startValue = .startValueInclusive(newValue)}
  }

  /// Used when giving an exclusive lower bound for the range.
  public var startValueExclusive: Data {
    get {
      if case .startValueExclusive(let v)? = startValue {return v}
      return Data()
    }
    set {startValue = .startValueExclusive(newValue)}
  }

  /// The value at which to end the range.
  /// If neither field is set, interpreted as the infinite string, exclusive.
  public var endValue: Google_Bigtable_V1_ValueRange.OneOf_EndValue? = nil

  /// Used when giving an inclusive upper bound for the range.
  public var endValueInclusive: Data {
    get {
      if case .endValueInclusive(let v)? = endValue {return v}
      return Data()
    }
    set {endValue = .endValueInclusive(newValue)}
  }

  /// Used when giving an exclusive upper bound for the range.
  public var endValueExclusive: Data {
    get {
      if case .endValueExclusive(let v)? = endValue {return v}
      return Data()
    }
    set {endValue = .endValueExclusive(newValue)}
  }
  ...
  public enum OneOf_StartValue: Equatable {
    /// Used when giving an inclusive lower bound for the range.
    case startValueInclusive(Data)
    /// Used when giving an exclusive lower bound for the range.
    case startValueExclusive(Data)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Bigtable_V1_ValueRange.OneOf_StartValue, rhs: Google_Bigtable_V1_ValueRange.OneOf_StartValue) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.startValueInclusive, .startValueInclusive): return {
        guard case .startValueInclusive(let l) = lhs, case .startValueInclusive(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.startValueExclusive, .startValueExclusive): return {
        guard case .startValueExclusive(let l) = lhs, case .startValueExclusive(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
  ...
  public enum OneOf_EndValue: Equatable {
    /// Used when giving an inclusive upper bound for the range.
    case endValueInclusive(Data)
    /// Used when giving an exclusive upper bound for the range.
    case endValueExclusive(Data)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Bigtable_V1_ValueRange.OneOf_EndValue, rhs: Google_Bigtable_V1_ValueRange.OneOf_EndValue) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
      case (.endValueInclusive, .endValueInclusive): return {
        guard case .endValueInclusive(let l) = lhs, case .endValueInclusive(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.endValueExclusive, .endValueExclusive): return {
        guard case .endValueExclusive(let l) = lhs, case .endValueExclusive(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
public struct Google_Bigtable_V1_RowFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var chain: Google_Bigtable_V1_RowFilter.Chain {
    get {
      if case .chain(let v)? = _storage._filter {return v}
      return Google_Bigtable_V1_RowFilter.Chain()
    }
  ...
  /// results.
  public var interleave: Google_Bigtable_V1_RowFilter.Interleave {
    get {
      if case .interleave(let v)? = _storage._filter {return v}
      return Google_Bigtable_V1_RowFilter.Interleave()
    }
  ...
  public var condition: Google_Bigtable_V1_RowFilter.Condition {
    get {
      if case .condition(let v)? = _storage._filter {return v}
      return Google_Bigtable_V1_RowFilter.Condition()
    }
  ...
  public var columnRangeFilter: Google_Bigtable_V1_ColumnRange {
    get {
      if case .columnRangeFilter(let v)? = _storage._filter {return v}
      return Google_Bigtable_V1_ColumnRange()
    }
    set {_uniqueStorage()._filter = .columnRangeFilter(newValue)}
  }

  /// Matches only cells with timestamps within the given range.
  public var timestampRangeFilter: Google_Bigtable_V1_TimestampRange {
    get {
      if case .timestampRangeFilter(let v)? = _storage._filter {return v}
      return Google_Bigtable_V1_TimestampRange()
    }
  ...
  public var valueRangeFilter: Google_Bigtable_V1_ValueRange {
    get {
      if case .valueRangeFilter(let v)? = _storage._filter {return v}
      return Google_Bigtable_V1_ValueRange()
    }
  ...
  public enum OneOf_Filter: Equatable {
    /// Applies several RowFilters to the data in sequence, progressively
    /// narrowing the results.
    case chain(Google_Bigtable_V1_RowFilter.Chain)
    /// Applies several RowFilters to the data in parallel and combines the
    /// results.
    case interleave(Google_Bigtable_V1_RowFilter.Interleave)
    /// Applies one of two possible RowFilters to the data based on the output of
    /// a predicate RowFilter.
    case condition(Google_Bigtable_V1_RowFilter.Condition)
    /// ADVANCED USE ONLY.
    /// Hook for introspection into the RowFilter. Outputs all cells directly to
    /// the output of the read rather than to any parent filter. Consider the
    /// following example:
    ...
    /// Matches only cells from columns within the given range.
    case columnRangeFilter(Google_Bigtable_V1_ColumnRange)
    /// Matches only cells with timestamps within the given range.
    case timestampRangeFilter(Google_Bigtable_V1_TimestampRange)
    /// Matches only cells with values that satisfy the given regular expression.
    /// Note that, since cell values can contain arbitrary bytes, the '\C' escape
    /// sequence must be used if a true wildcard is desired. The '.' character
    /// will not match the new line character '\n', which may be present in a
    ...
    /// Matches only cells with values that fall within the given range.
    case valueRangeFilter(Google_Bigtable_V1_ValueRange)
    /// Skips the first N cells of each row, matching all subsequent cells.
    /// If duplicate cells are present, as is possible when using an Interleave,
    /// each copy of the cell is counted separately.
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Google_Bigtable_V1_RowFilter.OneOf_Filter, rhs: Google_Bigtable_V1_RowFilter.OneOf_Filter) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
  ...
  public struct Chain {
    ...
    public var filters: [Google_Bigtable_V1_RowFilter] = []
  ...
  public struct Condition {
    ...
    public var predicateFilter: Google_Bigtable_V1_RowFilter {
      get {return _storage._predicateFilter ?? Google_Bigtable_V1_RowFilter()}
    ...
    public var trueFilter: Google_Bigtable_V1_RowFilter {
      get {return _storage._trueFilter ?? Google_Bigtable_V1_RowFilter()}
    ...
    /// false case.
    public var falseFilter: Google_Bigtable_V1_RowFilter {
      get {return _storage._falseFilter ?? Google_Bigtable_V1_RowFilter()}
...
public struct Google_Bigtable_V1_Mutation {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Which of the possible Mutation types to apply.
  public var mutation: Google_Bigtable_V1_Mutation.OneOf_Mutation? = nil

  /// Set a cell's value.
  public var setCell: Google_Bigtable_V1_Mutation.SetCell {
    get {
      if case .setCell(let v)? = mutation {return v}
      return Google_Bigtable_V1_Mutation.SetCell()
    }
    set {mutation = .setCell(newValue)}
  }

  /// Deletes cells from a column.
  public var deleteFromColumn: Google_Bigtable_V1_Mutation.DeleteFromColumn {
    get {
      if case .deleteFromColumn(let v)? = mutation {return v}
      return Google_Bigtable_V1_Mutation.DeleteFromColumn()
    }
    set {mutation = .deleteFromColumn(newValue)}
  }

  /// Deletes cells from a column family.
  public var deleteFromFamily: Google_Bigtable_V1_Mutation.DeleteFromFamily {
    get {
      if case .deleteFromFamily(let v)? = mutation {return v}
      return Google_Bigtable_V1_Mutation.DeleteFromFamily()
    }
    set {mutation = .deleteFromFamily(newValue)}
  }

  /// Deletes cells from the entire row.
  public var deleteFromRow: Google_Bigtable_V1_Mutation.DeleteFromRow {
    get {
      if case .deleteFromRow(let v)? = mutation {return v}
      return Google_Bigtable_V1_Mutation.DeleteFromRow()
    }
  ...
  public enum OneOf_Mutation: Equatable {
    /// Set a cell's value.
    case setCell(Google_Bigtable_V1_Mutation.SetCell)
    /// Deletes cells from a column.
    case deleteFromColumn(Google_Bigtable_V1_Mutation.DeleteFromColumn)
    /// Deletes cells from a column family.
    case deleteFromFamily(Google_Bigtable_V1_Mutation.DeleteFromFamily)
    /// Deletes cells from the entire row.
    case deleteFromRow(Google_Bigtable_V1_Mutation.DeleteFromRow)

  #if !swift(>=4.1)
    public static func ==(lhs: Google_Bigtable_V1_Mutation.OneOf_Mutation, rhs: Google_Bigtable_V1_Mutation.OneOf_Mutation) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
  ...
  public struct DeleteFromColumn {
    ...
    public var timeRange: Google_Bigtable_V1_TimestampRange {
      get {return _timeRange ?? Google_Bigtable_V1_TimestampRange()}
    ...
    fileprivate var _timeRange: Google_Bigtable_V1_TimestampRange? = nil
  }
...
/// specified column.
public struct Google_Bigtable_V1_ReadModifyWriteRule {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// latest value.
  public var rule: Google_Bigtable_V1_ReadModifyWriteRule.OneOf_Rule? = nil
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Google_Bigtable_V1_ReadModifyWriteRule.OneOf_Rule, rhs: Google_Bigtable_V1_ReadModifyWriteRule.OneOf_Rule) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
extension Google_Bigtable_V1_Row: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Bigtable_V1_Row, rhs: Google_Bigtable_V1_Row) -> Bool {
...
extension Google_Bigtable_V1_Family: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Bigtable_V1_Family, rhs: Google_Bigtable_V1_Family) -> Bool {
...
extension Google_Bigtable_V1_Column: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Bigtable_V1_Column, rhs: Google_Bigtable_V1_Column) -> Bool {
...
extension Google_Bigtable_V1_Cell: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Bigtable_V1_Cell, rhs: Google_Bigtable_V1_Cell) -> Bool {
...
extension Google_Bigtable_V1_RowRange: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RowRange"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    2: .standard(proto: "start_key"),
    3: .standard(proto: "end_key"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 2: try { try decoder.decodeSingularBytesField(value: &self.startKey) }()
      case 3: try { try decoder.decodeSingularBytesField(value: &self.endKey) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.startKey.isEmpty {
      try visitor.visitSingularBytesField(value: self.startKey, fieldNumber: 2)
    }
    if !self.endKey.isEmpty {
      try visitor.visitSingularBytesField(value: self.endKey, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Google_Bigtable_V1_RowRange, rhs: Google_Bigtable_V1_RowRange) -> Bool {
...
extension Google_Bigtable_V1_RowSet: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Bigtable_V1_RowSet, rhs: Google_Bigtable_V1_RowSet) -> Bool {
...
extension Google_Bigtable_V1_ColumnRange: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ColumnRange"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "family_name"),
    2: .standard(proto: "start_qualifier_inclusive"),
    3: .standard(proto: "start_qualifier_exclusive"),
    4: .standard(proto: "end_qualifier_inclusive"),
    5: .standard(proto: "end_qualifier_exclusive"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        ...
        if let v = v {self.startQualifier = .startQualifierInclusive(v)}
      }()
      case 3: try {
        if self.startQualifier != nil {try decoder.handleConflictingOneOf()}
        var v: Data?
        try decoder.decodeSingularBytesField(value: &v)
        if let v = v {self.startQualifier = .startQualifierExclusive(v)}
      }()
      case 4: try {
        if self.endQualifier != nil {try decoder.handleConflictingOneOf()}
        var v: Data?
        try decoder.decodeSingularBytesField(value: &v)
        if let v = v {self.endQualifier = .endQualifierInclusive(v)}
      }()
      case 5: try {
        if self.endQualifier != nil {try decoder.handleConflictingOneOf()}
        var v: Data?
        try decoder.decodeSingularBytesField(value: &v)
        if let v = v {self.endQualifier = .endQualifierExclusive(v)}
      }()
      default: break
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .startQualifierInclusive?: try {
      guard case .startQualifierInclusive(let v)? = self.startQualifier else { preconditionFailure() }
      try visitor.visitSingularBytesField(value: v, fieldNumber: 2)
    }()
    case .startQualifierExclusive?: try {
      guard case .startQualifierExclusive(let v)? = self.startQualifier else { preconditionFailure() }
    ...
    case .endQualifierInclusive?: try {
      guard case .endQualifierInclusive(let v)? = self.endQualifier else { preconditionFailure() }
      try visitor.visitSingularBytesField(value: v, fieldNumber: 4)
    }()
    case .endQualifierExclusive?: try {
      guard case .endQualifierExclusive(let v)? = self.endQualifier else { preconditionFailure() }
  ...
  public static func ==(lhs: Google_Bigtable_V1_ColumnRange, rhs: Google_Bigtable_V1_ColumnRange) -> Bool {
...
extension Google_Bigtable_V1_TimestampRange: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Bigtable_V1_TimestampRange, rhs: Google_Bigtable_V1_TimestampRange) -> Bool {
...
extension Google_Bigtable_V1_ValueRange: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ValueRange"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "start_value_inclusive"),
    2: .standard(proto: "start_value_exclusive"),
    3: .standard(proto: "end_value_inclusive"),
    4: .standard(proto: "end_value_exclusive"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try {
        ...
        var v: Data?
        try decoder.decodeSingularBytesField(value: &v)
        if let v = v {self.startValue = .startValueInclusive(v)}
      }()
      case 2: try {
        if self.startValue != nil {try decoder.handleConflictingOneOf()}
        var v: Data?
        try decoder.decodeSingularBytesField(value: &v)
        if let v = v {self.startValue = .startValueExclusive(v)}
      }()
      case 3: try {
        if self.endValue != nil {try decoder.handleConflictingOneOf()}
        var v: Data?
        try decoder.decodeSingularBytesField(value: &v)
        if let v = v {self.endValue = .endValueInclusive(v)}
      }()
      case 4: try {
        if self.endValue != nil {try decoder.handleConflictingOneOf()}
        var v: Data?
        try decoder.decodeSingularBytesField(value: &v)
        if let v = v {self.endValue = .endValueExclusive(v)}
      }()
      default: break
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .startValueInclusive?: try {
      guard case .startValueInclusive(let v)? = self.startValue else { preconditionFailure() }
      try visitor.visitSingularBytesField(value: v, fieldNumber: 1)
    }()
    case .startValueExclusive?: try {
      guard case .startValueExclusive(let v)? = self.startValue else { preconditionFailure() }
      try visitor.visitSingularBytesField(value: v, fieldNumber: 2)
    }()
    case nil: break
    }
    ...
    case .endValueInclusive?: try {
      guard case .endValueInclusive(let v)? = self.endValue else { preconditionFailure() }
      try visitor.visitSingularBytesField(value: v, fieldNumber: 3)
    }()
    case .endValueExclusive?: try {
      guard case .endValueExclusive(let v)? = self.endValue else { preconditionFailure() }
      try visitor.visitSingularBytesField(value: v, fieldNumber: 4)
    }()
    case nil: break
    }
  ...
  public static func ==(lhs: Google_Bigtable_V1_ValueRange, rhs: Google_Bigtable_V1_ValueRange) -> Bool {
...
extension Google_Bigtable_V1_RowFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _filter: Google_Bigtable_V1_RowFilter.OneOf_Filter?
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        switch fieldNumber {
        case 1: try {
          var v: Google_Bigtable_V1_RowFilter.Chain?
        ...
        case 2: try {
          var v: Google_Bigtable_V1_RowFilter.Interleave?
          if let current = _storage._filter {
            try decoder.handleConflictingOneOf()
        ...
        case 3: try {
          var v: Google_Bigtable_V1_RowFilter.Condition?
          if let current = _storage._filter {
            try decoder.handleConflictingOneOf()
        ...
        case 7: try {
          var v: Google_Bigtable_V1_ColumnRange?
          if let current = _storage._filter {
            try decoder.handleConflictingOneOf()
        ...
        case 8: try {
          var v: Google_Bigtable_V1_TimestampRange?
          if let current = _storage._filter {
            try decoder.handleConflictingOneOf()
        ...
        case 15: try {
          var v: Google_Bigtable_V1_ValueRange?
          if let current = _storage._filter {
            try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Bigtable_V1_RowFilter, rhs: Google_Bigtable_V1_RowFilter) -> Bool {
...
extension Google_Bigtable_V1_RowFilter.Chain: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Bigtable_V1_RowFilter.protoMessageName + ".Chain"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Bigtable_V1_RowFilter.Chain, rhs: Google_Bigtable_V1_RowFilter.Chain) -> Bool {
...
extension Google_Bigtable_V1_RowFilter.Interleave: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Bigtable_V1_RowFilter.protoMessageName + ".Interleave"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "filters"),
  ]
  ...
  public static func ==(lhs: Google_Bigtable_V1_RowFilter.Interleave, rhs: Google_Bigtable_V1_RowFilter.Interleave) -> Bool {
    if lhs.filters != rhs.filters {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Google_Bigtable_V1_RowFilter.Condition: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Bigtable_V1_RowFilter.protoMessageName + ".Condition"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  fileprivate class _StorageClass {
    var _predicateFilter: Google_Bigtable_V1_RowFilter? = nil
    var _trueFilter: Google_Bigtable_V1_RowFilter? = nil
    var _falseFilter: Google_Bigtable_V1_RowFilter? = nil
  ...
  public static func ==(lhs: Google_Bigtable_V1_RowFilter.Condition, rhs: Google_Bigtable_V1_RowFilter.Condition) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Google_Bigtable_V1_Mutation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Google_Bigtable_V1_Mutation.SetCell?
      ...
      case 2: try {
        var v: Google_Bigtable_V1_Mutation.DeleteFromColumn?
        if let current = self.mutation {
          try decoder.handleConflictingOneOf()
      ...
      case 3: try {
        var v: Google_Bigtable_V1_Mutation.DeleteFromFamily?
        if let current = self.mutation {
          try decoder.handleConflictingOneOf()
      ...
      case 4: try {
        var v: Google_Bigtable_V1_Mutation.DeleteFromRow?
        if let current = self.mutation {
          try decoder.handleConflictingOneOf()
  ...
  public static func ==(lhs: Google_Bigtable_V1_Mutation, rhs: Google_Bigtable_V1_Mutation) -> Bool {
...
extension Google_Bigtable_V1_Mutation.SetCell: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Bigtable_V1_Mutation.protoMessageName + ".SetCell"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "family_name"),
  ...
  public static func ==(lhs: Google_Bigtable_V1_Mutation.SetCell, rhs: Google_Bigtable_V1_Mutation.SetCell) -> Bool {
    if lhs.familyName != rhs.familyName {return false}
...
extension Google_Bigtable_V1_Mutation.DeleteFromColumn: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Bigtable_V1_Mutation.protoMessageName + ".DeleteFromColumn"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "family_name"),
    2: .standard(proto: "column_qualifier"),
  ...
  public static func ==(lhs: Google_Bigtable_V1_Mutation.DeleteFromColumn, rhs: Google_Bigtable_V1_Mutation.DeleteFromColumn) -> Bool {
    if lhs.familyName != rhs.familyName {return false}
    if lhs.columnQualifier != rhs.columnQualifier {return false}
...
extension Google_Bigtable_V1_Mutation.DeleteFromFamily: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Bigtable_V1_Mutation.protoMessageName + ".DeleteFromFamily"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "family_name"),
  ]
  ...
  public static func ==(lhs: Google_Bigtable_V1_Mutation.DeleteFromFamily, rhs: Google_Bigtable_V1_Mutation.DeleteFromFamily) -> Bool {
    if lhs.familyName != rhs.familyName {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Google_Bigtable_V1_Mutation.DeleteFromRow: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Bigtable_V1_Mutation.protoMessageName + ".DeleteFromRow"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Google_Bigtable_V1_Mutation.DeleteFromRow, rhs: Google_Bigtable_V1_Mutation.DeleteFromRow) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Google_Bigtable_V1_ReadModifyWriteRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Bigtable_V1_ReadModifyWriteRule, rhs: Google_Bigtable_V1_ReadModifyWriteRule) -> Bool {
    if lhs.familyName != rhs.familyName {return false}
    if lhs.columnQualifier != rhs.columnQualifier {return false}
