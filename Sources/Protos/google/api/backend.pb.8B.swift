...
public struct Google_Api_BackendRule {
  ...
  public enum OneOf_Authentication: Equatable {
    ...
    public static func ==(lhs: Google_Api_BackendRule.OneOf_Authentication, rhs: Google_Api_BackendRule.OneOf_Authentication) -> Bool {
      ...
      switch (lhs, rhs) {
      case (.jwtAudience, .jwtAudience): return {
        guard case .jwtAudience(let l) = lhs, case .jwtAudience(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.disableAuth, .disableAuth): return {
        guard case .disableAuth(let l) = lhs, case .disableAuth(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
