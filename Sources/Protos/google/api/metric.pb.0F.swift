...
public struct Google_Api_MetricDescriptor {
  ...
  public struct MetricDescriptorMetadata {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var hasSamplePeriod: Bool {return self._samplePeriod != nil}
    ...
    public var hasIngestDelay: Bool {return self._ingestDelay != nil}
...
extension Google_Api_MetricDescriptor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try decoder.decodeSingularMessageField(value: &self._metadata)
      case 12: try decoder.decodeSingularEnumField(value: &self.launchStage)
      default: break
      }
    }
  }
...
extension Google_Api_MetricDescriptor.MetricDescriptorMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularEnumField(value: &self.launchStage)
      case 2: try decoder.decodeSingularMessageField(value: &self._samplePeriod)
      case 3: try decoder.decodeSingularMessageField(value: &self._ingestDelay)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._samplePeriod {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }
    if let v = self._ingestDelay {
