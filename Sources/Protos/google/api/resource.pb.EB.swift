...
/// An annotation that describes a resource reference, see
/// [ResourceReference][].
let Google_Api_Extensions_resource_reference = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<Google_Api_ResourceReference>, SwiftProtobuf.Google_Protobuf_FieldOptions>(
...
/// An annotation that describes a resource definition without a corresponding
/// message; see [ResourceDescriptor][].
let Google_Api_Extensions_resource_definition = SwiftProtobuf.MessageExtension<SwiftProtobuf.RepeatedMessageExtensionField<Google_Api_ResourceDescriptor>, SwiftProtobuf.Google_Protobuf_FileOptions>(
...
/// An annotation that describes a resource definition, see
/// [ResourceDescriptor][].
let Google_Api_Extensions_resource = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<Google_Api_ResourceDescriptor>, SwiftProtobuf.Google_Protobuf_MessageOptions>(
  _protobuf_fieldNumber: 1053,
...
extension Google_Api_ResourceDescriptor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeRepeatedStringField(value: &self.pattern)
      case 3: try decoder.decodeSingularStringField(value: &self.nameField)
      case 4: try decoder.decodeSingularEnumField(value: &self.history)
      case 5: try decoder.decodeSingularStringField(value: &self.plural)
      case 6: try decoder.decodeSingularStringField(value: &self.singular)
      default: break
      }
    }
  }
...
extension Google_Api_ResourceReference: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.type)
      case 2: try decoder.decodeSingularStringField(value: &self.childType)
      default: break
      }
    }
  }
