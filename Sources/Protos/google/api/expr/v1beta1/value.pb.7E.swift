...
/// range of values.
public struct Google_Api_Expr_V1beta1_Value {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Google_Api_Expr_V1beta1_Value.OneOf_Kind, rhs: Google_Api_Expr_V1beta1_Value.OneOf_Kind) -> Bool {
      switch (lhs, rhs) {
      ...
      case (.enumValue(let l), .enumValue(let r)): return l == r
      case (.objectValue(let l), .objectValue(let r)): return l == r
      case (.mapValue(let l), .mapValue(let r)): return l == r
      case (.listValue(let l), .listValue(let r)): return l == r
      case (.typeValue(let l), .typeValue(let r)): return l == r
...
/// An enum value.
public struct Google_Api_Expr_V1beta1_EnumValue {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Api_Expr_V1beta1_ListValue {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Wrapped in a message so 'not set' and empty can be differentiated, which is
/// required for use in a 'oneof'.
public struct Google_Api_Expr_V1beta1_MapValue {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
