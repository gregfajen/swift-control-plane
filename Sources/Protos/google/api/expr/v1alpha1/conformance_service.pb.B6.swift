...
public struct Google_Api_Expr_V1alpha1_EvalRequest {
  ...
  public enum OneOf_ExprKind: Equatable {
    ...
    public static func ==(lhs: Google_Api_Expr_V1alpha1_EvalRequest.OneOf_ExprKind, rhs: Google_Api_Expr_V1alpha1_EvalRequest.OneOf_ExprKind) -> Bool {
      switch (lhs, rhs) {
      case (.parsedExpr(let l), .parsedExpr(let r)): return l == r
      case (.checkedExpr(let l), .checkedExpr(let r)): return l == r
...
extension Google_Api_Expr_V1alpha1_ParseRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.celSource)
      case 2: try decoder.decodeSingularStringField(value: &self.syntaxVersion)
      case 3: try decoder.decodeSingularStringField(value: &self.sourceLocation)
      case 4: try decoder.decodeSingularBoolField(value: &self.disableMacros)
      default: break
      }
    }
  }
...
extension Google_Api_Expr_V1alpha1_ParseResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._parsedExpr)
      case 2: try decoder.decodeRepeatedMessageField(value: &self.issues)
      default: break
      }
    }
  }
...
extension Google_Api_Expr_V1alpha1_CheckRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._parsedExpr)
      case 2: try decoder.decodeRepeatedMessageField(value: &self.typeEnv)
      case 3: try decoder.decodeSingularStringField(value: &self.container)
      case 4: try decoder.decodeSingularBoolField(value: &self.noStdEnv)
      default: break
      }
    }
  }
...
extension Google_Api_Expr_V1alpha1_CheckResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._checkedExpr)
      case 2: try decoder.decodeRepeatedMessageField(value: &self.issues)
      default: break
      }
    }
...
extension Google_Api_Expr_V1alpha1_EvalRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Api_Expr_V1alpha1_ExprValue>.self, value: &self.bindings)
      case 4: try decoder.decodeSingularStringField(value: &self.container)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .parsedExpr(let v)?:
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    case .checkedExpr(let v)?:
