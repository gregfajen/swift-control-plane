...
public struct Google_Api_Expr_V1alpha1_Expr {
  ...
  public enum OneOf_ExprKind: Equatable {
    ...
    public static func ==(lhs: Google_Api_Expr_V1alpha1_Expr.OneOf_ExprKind, rhs: Google_Api_Expr_V1alpha1_Expr.OneOf_ExprKind) -> Bool {
      ...
      switch (lhs, rhs) {
      case (.constExpr, .constExpr): return {
        guard case .constExpr(let l) = lhs, case .constExpr(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
public struct Google_Api_Expr_V1alpha1_Constant {
  ...
  public enum OneOf_ConstantKind: Equatable {
    ...
    public static func ==(lhs: Google_Api_Expr_V1alpha1_Constant.OneOf_ConstantKind, rhs: Google_Api_Expr_V1alpha1_Constant.OneOf_ConstantKind) -> Bool {
      ...
      case (.durationValue, .durationValue): return {
        guard case .durationValue(let l) = lhs, case .durationValue(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
