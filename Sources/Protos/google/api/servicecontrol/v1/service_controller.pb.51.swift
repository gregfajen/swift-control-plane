...
public struct Google_Api_Servicecontrol_V1_CheckResponse {
  ...
  public struct CheckInfo {
    ...
    public var unusedArguments: [String] = []
  ...
  public struct ConsumerInfo {
    ...
    public var type: Google_Api_Servicecontrol_V1_CheckResponse.ConsumerInfo.ConsumerType = .unspecified

    /// The consumer identity number, can be Google cloud project number, folder
    /// number or organization number e.g. 1234567890. A value of 0 indicates no
    /// consumer number is found.
    public var consumerNumber: Int64 = 0

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    /// The type of the consumer as defined in
    /// [Google Resource Manager](https://cloud.google.com/resource-manager/).
    public enum ConsumerType: SwiftProtobuf.Enum {
...
extension Google_Api_Servicecontrol_V1_CheckResponse.ConsumerInfo.ConsumerType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Api_Servicecontrol_V1_CheckResponse.ConsumerInfo.ConsumerType] = [
    .unspecified,
    .project,
    .folder,
    .organization,
...
extension Google_Api_Servicecontrol_V1_CheckResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedMessageField(value: &self.checkErrors) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.serviceConfigID) }()
      case 6: try { try decoder.decodeSingularMessageField(value: &self._checkInfo) }()
      case 11: try { try decoder.decodeSingularStringField(value: &self.serviceRolloutID) }()
      default: break
      }
    }
  }
...
extension Google_Api_Servicecontrol_V1_CheckResponse.CheckInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "unused_arguments"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedStringField(value: &self.unusedArguments) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._consumerInfo) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.unusedArguments.isEmpty {
      try visitor.visitRepeatedStringField(value: self.unusedArguments, fieldNumber: 1)
    }
  ...
  public static func ==(lhs: Google_Api_Servicecontrol_V1_CheckResponse.CheckInfo, rhs: Google_Api_Servicecontrol_V1_CheckResponse.CheckInfo) -> Bool {
    if lhs.unusedArguments != rhs.unusedArguments {return false}
...
extension Google_Api_Servicecontrol_V1_CheckResponse.ConsumerInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .same(proto: "type"),
    3: .standard(proto: "consumer_number"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt64Field(value: &self.projectNumber) }()
      case 2: try { try decoder.decodeSingularEnumField(value: &self.type) }()
      case 3: try { try decoder.decodeSingularInt64Field(value: &self.consumerNumber) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.consumerNumber != 0 {
      try visitor.visitSingularInt64Field(value: self.consumerNumber, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Google_Api_Servicecontrol_V1_CheckResponse.ConsumerInfo, rhs: Google_Api_Servicecontrol_V1_CheckResponse.ConsumerInfo) -> Bool {
    ...
    if lhs.consumerNumber != rhs.consumerNumber {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Google_Api_Servicecontrol_V1_CheckResponse.ConsumerInfo.ConsumerType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "CONSUMER_TYPE_UNSPECIFIED"),
    1: .same(proto: "PROJECT"),
    2: .same(proto: "FOLDER"),
    3: .same(proto: "ORGANIZATION"),
    4: .same(proto: "SERVICE_SPECIFIC"),
  ]
}
...
extension Google_Api_Servicecontrol_V1_ReportRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.serviceConfigID) }()
      default: break
      }
    }
  }
...
extension Google_Api_Servicecontrol_V1_ReportResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.reportErrors) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.serviceConfigID) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.serviceRolloutID) }()
      default: break
      }
    }
  }
