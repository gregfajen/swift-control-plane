...
extension Google_Api_Servicecontrol_V1_Operation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularStringField(value: &self.operationName)
      case 3: try decoder.decodeSingularStringField(value: &self.consumerID)
      ...
      case 7: try decoder.decodeRepeatedMessageField(value: &self.metricValueSets)
      case 8: try decoder.decodeRepeatedMessageField(value: &self.logEntries)
      case 11: try decoder.decodeSingularEnumField(value: &self.importance)
      default: break
      }
    }
  }
