...
extension Google_Type_PostalAddress: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularStringField(value: &self.sortingCode) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self.administrativeArea) }()
      case 7: try { try decoder.decodeSingularStringField(value: &self.locality) }()
      case 8: try { try decoder.decodeSingularStringField(value: &self.sublocality) }()
      case 9: try { try decoder.decodeRepeatedStringField(value: &self.addressLines) }()
      case 10: try { try decoder.decodeRepeatedStringField(value: &self.recipients) }()
      case 11: try { try decoder.decodeSingularStringField(value: &self.organization) }()
      default: break
      }
    }
  }
