...
public struct Google_Appengine_V1beta_Service {
  ...
  public var split: Google_Appengine_V1beta_TrafficSplit {
    get {return _split ?? Google_Appengine_V1beta_TrafficSplit()}
    set {_split = newValue}
  }
  ...
  fileprivate var _split: Google_Appengine_V1beta_TrafficSplit? = nil
}

/// Traffic routing configuration for versions within a single service. Traffic
/// splits define how traffic directed to the service is assigned to versions.
public struct Google_Appengine_V1beta_TrafficSplit {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var shardBy: Google_Appengine_V1beta_TrafficSplit.ShardBy = .unspecified
...
extension Google_Appengine_V1beta_TrafficSplit.ShardBy: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Appengine_V1beta_TrafficSplit.ShardBy] = [
    .unspecified,
    .cookie,
    .ip,
    .random,
...
extension Google_Appengine_V1beta_Service: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Appengine_V1beta_Service, rhs: Google_Appengine_V1beta_Service) -> Bool {
...
extension Google_Appengine_V1beta_TrafficSplit: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Appengine_V1beta_TrafficSplit, rhs: Google_Appengine_V1beta_TrafficSplit) -> Bool {
...
extension Google_Appengine_V1beta_TrafficSplit.ShardBy: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
