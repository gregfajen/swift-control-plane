...
public struct Google_Appengine_V1beta_FirewallRule {
  ...
  public var action: Google_Appengine_V1beta_FirewallRule.Action = .unspecifiedAction
...
extension Google_Appengine_V1beta_FirewallRule.Action: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Appengine_V1beta_FirewallRule.Action] = [
    .unspecifiedAction,
    .allow,
    .deny,
  ]
...
extension Google_Appengine_V1beta_FirewallRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Appengine_V1beta_FirewallRule, rhs: Google_Appengine_V1beta_FirewallRule) -> Bool {
...
extension Google_Appengine_V1beta_FirewallRule.Action: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
