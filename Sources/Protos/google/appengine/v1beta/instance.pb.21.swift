...
public struct Google_Appengine_V1beta_Instance {
  ...
  ///
  /// @OutputOnly
  public var availability: Google_Appengine_V1beta_Instance.Availability {
...
extension Google_Appengine_V1beta_Instance.Availability: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Appengine_V1beta_Instance.Availability] = [
    .unspecified,
    .resident,
    .dynamic,
  ]
...
extension Google_Appengine_V1beta_Instance: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _availability: Google_Appengine_V1beta_Instance.Availability = .unspecified
  ...
  public static func ==(lhs: Google_Appengine_V1beta_Instance, rhs: Google_Appengine_V1beta_Instance) -> Bool {
...
extension Google_Appengine_V1beta_Instance.Availability: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
