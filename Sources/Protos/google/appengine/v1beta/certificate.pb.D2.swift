...
public enum Google_Appengine_V1beta_ManagementStatus: SwiftProtobuf.Enum {
...
extension Google_Appengine_V1beta_ManagementStatus: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Appengine_V1beta_ManagementStatus] = [
    .unspecified,
    .ok,
    .pending,
...
/// authorized domains.
public struct Google_Appengine_V1beta_AuthorizedCertificate {
  ...
  public var certificateRawData: Google_Appengine_V1beta_CertificateRawData {
    get {return _certificateRawData ?? Google_Appengine_V1beta_CertificateRawData()}
  ...
  ///
  /// @OutputOnly
  public var managedCertificate: Google_Appengine_V1beta_ManagedCertificate {
    get {return _managedCertificate ?? Google_Appengine_V1beta_ManagedCertificate()}
  ...
  fileprivate var _certificateRawData: Google_Appengine_V1beta_CertificateRawData? = nil
  fileprivate var _managedCertificate: Google_Appengine_V1beta_ManagedCertificate? = nil
}

/// An SSL certificate obtained from a certificate authority.
public struct Google_Appengine_V1beta_CertificateRawData {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Appengine_V1beta_ManagedCertificate {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  ///
  /// @OutputOnly
  public var status: Google_Appengine_V1beta_ManagementStatus = .unspecified
...
extension Google_Appengine_V1beta_ManagementStatus: SwiftProtobuf._ProtoNameProviding {
...
extension Google_Appengine_V1beta_AuthorizedCertificate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Appengine_V1beta_AuthorizedCertificate, rhs: Google_Appengine_V1beta_AuthorizedCertificate) -> Bool {
...
extension Google_Appengine_V1beta_CertificateRawData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Appengine_V1beta_CertificateRawData, rhs: Google_Appengine_V1beta_CertificateRawData) -> Bool {
...
extension Google_Appengine_V1beta_ManagedCertificate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Appengine_V1beta_ManagedCertificate, rhs: Google_Appengine_V1beta_ManagedCertificate) -> Bool {
