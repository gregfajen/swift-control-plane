...
/// Engine application.
public struct Google_Appengine_V1beta_Application {
  ...
  public var dispatchRules: [Google_Appengine_V1beta_UrlDispatchRule] {
  ...
  public var servingStatus: Google_Appengine_V1beta_Application.ServingStatus {
  ...
  public var iap: Google_Appengine_V1beta_Application.IdentityAwareProxy {
    get {return _storage._iap ?? Google_Appengine_V1beta_Application.IdentityAwareProxy()}
  ...
  /// this application.
  public var databaseType: Google_Appengine_V1beta_Application.DatabaseType {
    get {return _storage._databaseType}
    set {_uniqueStorage()._databaseType = newValue}
  }

  /// The feature specific settings to be used in the application.
  public var featureSettings: Google_Appengine_V1beta_Application.FeatureSettings {
    get {return _storage._featureSettings ?? Google_Appengine_V1beta_Application.FeatureSettings()}
...
extension Google_Appengine_V1beta_Application.ServingStatus: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Appengine_V1beta_Application.ServingStatus] = [
    .unspecified,
    .serving,
    .userDisabled,
    .systemDisabled,
...
extension Google_Appengine_V1beta_Application.DatabaseType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Google_Appengine_V1beta_Application.DatabaseType] = [
    .unspecified,
    .cloudDatastore,
    .cloudFirestore,
...
public struct Google_Appengine_V1beta_UrlDispatchRule {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Appengine_V1beta_Application: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _dispatchRules: [Google_Appengine_V1beta_UrlDispatchRule] = []
    ...
    var _servingStatus: Google_Appengine_V1beta_Application.ServingStatus = .unspecified
    var _defaultHostname: String = String()
    var _defaultBucket: String = String()
    var _iap: Google_Appengine_V1beta_Application.IdentityAwareProxy? = nil
    var _gcrDomain: String = String()
    var _databaseType: Google_Appengine_V1beta_Application.DatabaseType = .unspecified
    var _featureSettings: Google_Appengine_V1beta_Application.FeatureSettings? = nil
  ...
  public static func ==(lhs: Google_Appengine_V1beta_Application, rhs: Google_Appengine_V1beta_Application) -> Bool {
...
extension Google_Appengine_V1beta_Application.ServingStatus: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Appengine_V1beta_Application.DatabaseType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Appengine_V1beta_Application.IdentityAwareProxy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Appengine_V1beta_Application.protoMessageName + ".IdentityAwareProxy"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Appengine_V1beta_Application.IdentityAwareProxy, rhs: Google_Appengine_V1beta_Application.IdentityAwareProxy) -> Bool {
...
extension Google_Appengine_V1beta_Application.FeatureSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Google_Appengine_V1beta_Application.protoMessageName + ".FeatureSettings"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Appengine_V1beta_Application.FeatureSettings, rhs: Google_Appengine_V1beta_Application.FeatureSettings) -> Bool {
...
extension Google_Appengine_V1beta_UrlDispatchRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Google_Appengine_V1beta_UrlDispatchRule, rhs: Google_Appengine_V1beta_UrlDispatchRule) -> Bool {
