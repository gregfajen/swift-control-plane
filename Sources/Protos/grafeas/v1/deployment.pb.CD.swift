...
extension Grafeas_V1_DeploymentNote: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedStringField(value: &self.resourceUri)
      default: break
      }
    }
  }
...
extension Grafeas_V1_DeploymentOccurrence: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.userEmail)
      case 2: try decoder.decodeSingularMessageField(value: &self._deployTime)
      case 3: try decoder.decodeSingularMessageField(value: &self._undeployTime)
      case 4: try decoder.decodeSingularStringField(value: &self.config)
      case 5: try decoder.decodeSingularStringField(value: &self.address)
      case 6: try decoder.decodeRepeatedStringField(value: &self.resourceUri)
      case 7: try decoder.decodeSingularEnumField(value: &self.platform)
      default: break
      }
    }
  }
