...
public protocol Grafeas_V1_GrafeasClientProtocol: GRPCClient {
  func getOccurrence(
    _ request: Grafeas_V1_GetOccurrenceRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Grafeas_V1_GetOccurrenceRequest, Grafeas_V1_Occurrence>

  func listOccurrences(
    _ request: Grafeas_V1_ListOccurrencesRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Grafeas_V1_ListOccurrencesRequest, Grafeas_V1_ListOccurrencesResponse>

  func deleteOccurrence(
    _ request: Grafeas_V1_DeleteOccurrenceRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Grafeas_V1_DeleteOccurrenceRequest, SwiftProtobuf.Google_Protobuf_Empty>

  func createOccurrence(
    _ request: Grafeas_V1_CreateOccurrenceRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Grafeas_V1_CreateOccurrenceRequest, Grafeas_V1_Occurrence>

  func batchCreateOccurrences(
    _ request: Grafeas_V1_BatchCreateOccurrencesRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Grafeas_V1_BatchCreateOccurrencesRequest, Grafeas_V1_BatchCreateOccurrencesResponse>

  func updateOccurrence(
    _ request: Grafeas_V1_UpdateOccurrenceRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Grafeas_V1_UpdateOccurrenceRequest, Grafeas_V1_Occurrence>

  func getOccurrenceNote(
    _ request: Grafeas_V1_GetOccurrenceNoteRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Grafeas_V1_GetOccurrenceNoteRequest, Grafeas_V1_Note>

  func getNote(
    _ request: Grafeas_V1_GetNoteRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Grafeas_V1_GetNoteRequest, Grafeas_V1_Note>

  func listNotes(
    _ request: Grafeas_V1_ListNotesRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Grafeas_V1_ListNotesRequest, Grafeas_V1_ListNotesResponse>

  func deleteNote(
    _ request: Grafeas_V1_DeleteNoteRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Grafeas_V1_DeleteNoteRequest, SwiftProtobuf.Google_Protobuf_Empty>

  func createNote(
    _ request: Grafeas_V1_CreateNoteRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Grafeas_V1_CreateNoteRequest, Grafeas_V1_Note>

  func batchCreateNotes(
    _ request: Grafeas_V1_BatchCreateNotesRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Grafeas_V1_BatchCreateNotesRequest, Grafeas_V1_BatchCreateNotesResponse>

  func updateNote(
    _ request: Grafeas_V1_UpdateNoteRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Grafeas_V1_UpdateNoteRequest, Grafeas_V1_Note>

  func listNoteOccurrences(
    _ request: Grafeas_V1_ListNoteOccurrencesRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Grafeas_V1_ListNoteOccurrencesRequest, Grafeas_V1_ListNoteOccurrencesResponse>

}

extension Grafeas_V1_GrafeasClientProtocol {
  ...
  public func getOccurrence(
    ...
    return self.makeUnaryCall(
      path: "/grafeas.v1.Grafeas/GetOccurrence",
      request: request,
  ...
  public func listOccurrences(
    ...
    return self.makeUnaryCall(
      path: "/grafeas.v1.Grafeas/ListOccurrences",
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
  ...
  public func deleteOccurrence(
    ...
    return self.makeUnaryCall(
      path: "/grafeas.v1.Grafeas/DeleteOccurrence",
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
  ...
  public func createOccurrence(
    ...
    return self.makeUnaryCall(
      path: "/grafeas.v1.Grafeas/CreateOccurrence",
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
  ...
  public func batchCreateOccurrences(
    ...
    return self.makeUnaryCall(
      path: "/grafeas.v1.Grafeas/BatchCreateOccurrences",
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
  ...
  public func updateOccurrence(
    ...
    return self.makeUnaryCall(
      path: "/grafeas.v1.Grafeas/UpdateOccurrence",
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
  ...
  public func getOccurrenceNote(
    ...
    return self.makeUnaryCall(
      path: "/grafeas.v1.Grafeas/GetOccurrenceNote",
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
  ...
  public func getNote(
    ...
    return self.makeUnaryCall(
      path: "/grafeas.v1.Grafeas/GetNote",
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
  ...
  public func listNotes(
    ...
    return self.makeUnaryCall(
      path: "/grafeas.v1.Grafeas/ListNotes",
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
  ...
  public func deleteNote(
    ...
    return self.makeUnaryCall(
      path: "/grafeas.v1.Grafeas/DeleteNote",
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
  ...
  public func createNote(
    ...
    return self.makeUnaryCall(
      path: "/grafeas.v1.Grafeas/CreateNote",
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
  ...
  public func batchCreateNotes(
    ...
    return self.makeUnaryCall(
      path: "/grafeas.v1.Grafeas/BatchCreateNotes",
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
  ...
  public func updateNote(
    ...
    return self.makeUnaryCall(
      path: "/grafeas.v1.Grafeas/UpdateNote",
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
  ...
  public func listNoteOccurrences(
    ...
    return self.makeUnaryCall(
      path: "/grafeas.v1.Grafeas/ListNoteOccurrences",
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions
    )
  }
...
public final class Grafeas_V1_GrafeasClient: Grafeas_V1_GrafeasClientProtocol {
...
extension Grafeas_V1_GrafeasProvider {
  public var serviceName: Substring { return "grafeas.v1.Grafeas" }
