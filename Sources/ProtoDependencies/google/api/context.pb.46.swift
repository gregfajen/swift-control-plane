...
extension Google_Api_ContextRule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    4: .standard(proto: "allowed_request_extensions"),
    5: .standard(proto: "allowed_response_extensions"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try decoder.decodeRepeatedStringField(value: &self.allowedRequestExtensions)
      case 5: try decoder.decodeRepeatedStringField(value: &self.allowedResponseExtensions)
      default: break
      }
    }
  }
