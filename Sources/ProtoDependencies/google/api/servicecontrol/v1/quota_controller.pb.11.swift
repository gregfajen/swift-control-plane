...
extension Google_Api_Servicecontrol_V1_AllocateQuotaRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularMessageField(value: &self._allocateOperation)
...
extension Google_Api_Servicecontrol_V1_QuotaOperation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try decoder.decodeRepeatedMessageField(value: &self.quotaMetrics)
      case 6: try decoder.decodeSingularEnumField(value: &self.quotaMode)
      default: break
      }
    }
  }
...
extension Google_Api_Servicecontrol_V1_AllocateQuotaResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.operationID)
      case 2: try decoder.decodeRepeatedMessageField(value: &self.allocateErrors)
      case 3: try decoder.decodeRepeatedMessageField(value: &self.quotaMetrics)
      case 4: try decoder.decodeSingularStringField(value: &self.serviceConfigID)
      default: break
      }
    }
