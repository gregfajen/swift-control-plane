...
extension Google_Api_Servicecontrol_V1_Distribution: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeSingularDoubleField(value: &self.minimum)
      case 4: try decoder.decodeSingularDoubleField(value: &self.maximum)
      case 5: try decoder.decodeSingularDoubleField(value: &self.sumOfSquaredDeviation)
