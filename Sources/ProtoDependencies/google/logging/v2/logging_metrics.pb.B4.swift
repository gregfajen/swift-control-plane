...
public struct Google_Logging_V2_LogMetric {
  ...
  public var valueExtractor: String = String()
  ...
  public var labelExtractors: Dictionary<String,String> = [:]
  ...
  public var version: Google_Logging_V2_LogMetric.ApiVersion = .v2
...
extension Google_Logging_V2_LogMetric.ApiVersion: CaseIterable {
  ...
  public static var allCases: [Google_Logging_V2_LogMetric.ApiVersion] = [
    .v2,
    .v1,
  ]
}
...
public struct Google_Logging_V2_ListLogMetricsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Logging_V2_ListLogMetricsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// A list of logs-based metrics.
  public var metrics: [Google_Logging_V2_LogMetric] = []
...
public struct Google_Logging_V2_GetLogMetricRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Logging_V2_CreateLogMetricRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// already exists.
  public var metric: Google_Logging_V2_LogMetric {
...
public struct Google_Logging_V2_UpdateLogMetricRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Logging_V2_DeleteLogMetricRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Logging_V2_LogMetric: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".LogMetric"
  ...
  public static func ==(lhs: Google_Logging_V2_LogMetric, rhs: Google_Logging_V2_LogMetric) -> Bool {
...
extension Google_Logging_V2_ListLogMetricsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ListLogMetricsRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "parent"),
  ...
  public static func ==(lhs: Google_Logging_V2_ListLogMetricsRequest, rhs: Google_Logging_V2_ListLogMetricsRequest) -> Bool {
...
extension Google_Logging_V2_ListLogMetricsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ListLogMetricsResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Logging_V2_ListLogMetricsResponse, rhs: Google_Logging_V2_ListLogMetricsResponse) -> Bool {
...
extension Google_Logging_V2_GetLogMetricRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetLogMetricRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Google_Logging_V2_GetLogMetricRequest, rhs: Google_Logging_V2_GetLogMetricRequest) -> Bool {
...
extension Google_Logging_V2_CreateLogMetricRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".CreateLogMetricRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "parent"),
    2: .same(proto: "metric"),
  ]
  ...
  public static func ==(lhs: Google_Logging_V2_CreateLogMetricRequest, rhs: Google_Logging_V2_CreateLogMetricRequest) -> Bool {
    if lhs.parent != rhs.parent {return false}
...
extension Google_Logging_V2_UpdateLogMetricRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".UpdateLogMetricRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "metric_name"),
    2: .same(proto: "metric"),
  ]
  ...
  public static func ==(lhs: Google_Logging_V2_UpdateLogMetricRequest, rhs: Google_Logging_V2_UpdateLogMetricRequest) -> Bool {
    if lhs.metricName != rhs.metricName {return false}
    if lhs._metric != rhs._metric {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Google_Logging_V2_DeleteLogMetricRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DeleteLogMetricRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "metric_name"),
  ]
  ...
  public static func ==(lhs: Google_Logging_V2_DeleteLogMetricRequest, rhs: Google_Logging_V2_DeleteLogMetricRequest) -> Bool {
    if lhs.metricName != rhs.metricName {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
