...
public struct Grafeas_V1_UpgradeOccurrence {
  ...
  fileprivate var _parsedVersion: Grafeas_V1_Version? = nil
  fileprivate var _distribution: Grafeas_V1_UpgradeDistribution? = nil
  fileprivate var _windowsUpdate: Grafeas_V1_WindowsUpdate? = nil
}
...
extension Grafeas_V1_UpgradeNote: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.package)
      case 2: try decoder.decodeSingularMessageField(value: &self._version)
      case 3: try decoder.decodeRepeatedMessageField(value: &self.distributions)
      case 4: try decoder.decodeSingularMessageField(value: &self._windowsUpdate)
      default: break
      }
    }
  }
...
extension Grafeas_V1_UpgradeDistribution: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularStringField(value: &self.classification)
      case 3: try decoder.decodeSingularStringField(value: &self.severity)
      case 4: try decoder.decodeRepeatedStringField(value: &self.cve)
      default: break
      }
    }
  }
...
extension Grafeas_V1_WindowsUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try decoder.decodeRepeatedMessageField(value: &self.categories)
      case 5: try decoder.decodeRepeatedStringField(value: &self.kbArticleIds)
      case 6: try decoder.decodeSingularStringField(value: &self.supportURL)
      case 7: try decoder.decodeSingularMessageField(value: &self._lastPublishedTimestamp)
      default: break
      }
    }
  }
...
extension Grafeas_V1_WindowsUpdate.Identity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.updateID)
      case 2: try decoder.decodeSingularInt32Field(value: &self.revision)
      default: break
      }
    }
  }
...
extension Grafeas_V1_WindowsUpdate.Category: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.categoryID)
...
extension Grafeas_V1_UpgradeOccurrence: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.package)
      case 3: try decoder.decodeSingularMessageField(value: &self._parsedVersion)
      case 4: try decoder.decodeSingularMessageField(value: &self._distribution)
      case 5: try decoder.decodeSingularMessageField(value: &self._windowsUpdate)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._parsedVersion {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }
    if let v = self._distribution {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }
    if let v = self._windowsUpdate {
  ...
  public static func ==(lhs: Grafeas_V1_UpgradeOccurrence, rhs: Grafeas_V1_UpgradeOccurrence) -> Bool {
    if lhs.package != rhs.package {return false}
    if lhs._parsedVersion != rhs._parsedVersion {return false}
