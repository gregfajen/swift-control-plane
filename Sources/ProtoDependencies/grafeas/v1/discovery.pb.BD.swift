...
extension Grafeas_V1_DiscoveryNote: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularEnumField(value: &self.analysisKind)
      default: break
      }
    }
  }
...
extension Grafeas_V1_DiscoveryOccurrence: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularEnumField(value: &self.continuousAnalysis)
      case 2: try decoder.decodeSingularEnumField(value: &self.analysisStatus)
      case 3: try decoder.decodeSingularMessageField(value: &self._analysisStatusError)
      case 4: try decoder.decodeSingularStringField(value: &self.cpe)
      case 5: try decoder.decodeSingularMessageField(value: &self._lastScanTime)
      default: break
      }
    }
  }
