...
public struct Opencensus_Proto_Stats_V1_View {
  ...
  public enum OneOf_Aggregation: Equatable {
    ...
    public static func ==(lhs: Opencensus_Proto_Stats_V1_View.OneOf_Aggregation, rhs: Opencensus_Proto_Stats_V1_View.OneOf_Aggregation) -> Bool {
      switch (lhs, rhs) {
      case (.countAggregation(let l), .countAggregation(let r)): return l == r
      case (.sumAggregation(let l), .sumAggregation(let r)): return l == r
      case (.lastValueAggregation(let l), .lastValueAggregation(let r)): return l == r
      case (.distributionAggregation(let l), .distributionAggregation(let r)): return l == r
...
extension Opencensus_Proto_Stats_V1_View: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try decoder.decodeSingularStringField(value: &self.name)
      case 2: try decoder.decodeSingularStringField(value: &self.description_p)
      case 3: try decoder.decodeSingularMessageField(value: &self._measure)
      case 4: try decoder.decodeRepeatedStringField(value: &self.columns)
      case 5:
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .countAggregation(let v)?:
      try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
    case .sumAggregation(let v)?:
      try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
    case .lastValueAggregation(let v)?:
      try visitor.visitSingularMessageField(value: v, fieldNumber: 7)
    case .distributionAggregation(let v)?:
...
extension Opencensus_Proto_Stats_V1_DistributionAggregation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedDoubleField(value: &self.bucketBounds)
      default: break
      }
    }
  }
...
extension Opencensus_Proto_Stats_V1_Measurement: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularStringField(value: &self.measureName)
      case 3:
      ...
      case 5: try decoder.decodeSingularMessageField(value: &self._time)
      default: break
      }
    }
  }
