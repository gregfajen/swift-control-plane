...
extension Envoy_Extensions_Filters_Http_AwsLambda_V3_Config: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.arn)
      case 2: try decoder.decodeSingularBoolField(value: &self.payloadPassthrough)
      case 3: try decoder.decodeSingularEnumField(value: &self.invocationMode)
      default: break
      }
    }
  }
...
extension Envoy_Extensions_Filters_Http_AwsLambda_V3_PerRouteConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._invokeConfig)
      default: break
      }
    }
  }
